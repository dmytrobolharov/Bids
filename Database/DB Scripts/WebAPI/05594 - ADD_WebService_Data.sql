...
BEGIN
	...
	IF (SELECT COUNT(WebServiceItemName)
		...
		WHERE UPPER(WebServiceItemName) = UPPER('Style Measurement Sample Size')) < 1
	BEGIN
		-- Style Measurement Sample Size
		INSERT INTO sWebServiceItem(WebServiceID, WebServiceItemID, WebServiceItemName, WebServiceItemDefaultSchema, Active)
		VALUES (@WebServiceID, NEWID(), 'Style Measurement Sample Size', '', 1)
	END
END
GO
...
VALUES ('DB_Version', '0.5.0.0000', '05594', GetDate())
GO
