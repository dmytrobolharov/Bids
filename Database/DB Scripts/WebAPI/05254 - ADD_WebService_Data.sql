...
IF (SELECT COUNT(WebServiceItemName)
	...
	WHERE UPPER(WebServiceItemName) = UPPER('Style Image')) < 1
BEGIN
	-- Style Image
	INSERT INTO sWebServiceItem(WebServiceID, WebServiceItemID, WebServiceItemName, WebServiceItemDefaultSchema, Active)
	VALUES ('56BDAD9B-B6AF-4380-94D7-70588FD8E66A', '80D2C08B-AACB-41EA-A4E9-5025E480748E', 'Style Image', '', 1)
END
GO


INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
VALUES ('DB_Version', '0.5.0000', '05254', GetDate())
GO
