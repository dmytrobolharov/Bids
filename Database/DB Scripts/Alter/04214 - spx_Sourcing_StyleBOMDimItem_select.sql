...
/****** Object:  StoredProcedure [dbo].[spx_Sourcing_StyleBOMDimItem_select]    Script Date: 10/16/2012 10:10:30 ******/
		...
		begin											
			if @DimLevel=1
				begin
					INSERT INTO #tmpDimItem (DimID, DimName, Sort)
						...
						and StyleQuoteItemId=@StyleQuoteItemId	 and ItemDim1Id is not null order by ItemDim1Sort, ItemDim1Name
			...
			if @DimLevel=2
				begin
					...
					and StyleQuoteItemId=@StyleQuoteItemId	and ItemDim2Id is not null order by ItemDim2Sort, ItemDim2Name
			...
			if @DimLevel=3
				begin
					...
					and StyleQuoteItemId=@StyleQuoteItemId	and ItemDim3Id is not null order by ItemDim3Sort, ItemDim3Name
...
VALUES     ('DB_Version', '5.0.0000', '04214', GetDate())
GO