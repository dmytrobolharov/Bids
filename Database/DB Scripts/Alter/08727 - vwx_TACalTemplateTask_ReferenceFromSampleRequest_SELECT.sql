/****** Object:  View [dbo].[vwx_TACalTemplateTask_ReferenceFromSampleRequest_SELECT]    Script Date: 08/10/2014 17:45:05 ******/
...
srw.StartDate AS TaskActualStart, srsb.EndDate AS TaskActualEnd, crt.TaskRevisedlStart, crt.TaskRevisedEnd,crt.TACalTemplateTaskId,
...
VALUES ('DB_Version', '0.5.0000', '08727', GetDate())
GO
