...
SELECT psy.PlanningID, psy.SeasonYearID AS DstSeasonYearID, pli.PlanningItemID, pli.StyleBOMDimensionID, 
	   ...
	   sh.StyleType, ST.StyleTypeDescription as StyleTypeName, sh.WorkflowType, sh.RefNo, sh.StyleNo, sh.TempID, sh.TempNo, sh.CustomerNo, sh.DevelopmentID, 
	   sh.DevelopmentNo, sh.ConceptID, sh.ConceptNo, sh.SpecNo, sh.Description, sh.StyleCategory, SCat.StyleCategory as StyleCategoryName, 
	   ...
	   sh.CustomField37, sh.CustomField38, sh.CustomField39, sh.CustomField40, sh.Distribution, sh.IntroSeasonYearID, SY.Season + ' ' + SY.[Year] as IntroSeasonYearName, sh.UserCID, 
...
INNER JOIN pSeasonYear SY ON SY.SeasonYearID = SH.IntroSeasonYearID
INNER JOIN pStyleType ST ON ST.StyleTypeID = SH.StyleType
LEFT JOIN pStyleCategory SCat ON SCat.StyleCategoryId = SH.StyleCategory
...
VALUES ('DB_Version', '6.1.0000', '10423', GetUTCDate())
GO