/****** Object:  StoredProcedure [dbo].[spx_Commitment_INSERT]    Script Date: 08/09/2014 21:15:28 ******/
...
CREATE PROCEDURE [dbo].[spx_Commitment_INSERT]
	...
	@MUser NVARCHAR(200),
	@MDate DATETIME,
	@CommitmentID UNIQUEIDENTIFIER = NULL OUT
AS 
...
set @CommitmentBOMId =  NEWID()
	...
	insert into pSourcingCommitmentItem( SourcingCommitmentItemID, StyleQuoteItemID, 
                      ...
                      CUser, CDate, MUser, MDate, QuoteFolderSort, 
                      AgentView, StyleColorID, StyleSourcingID, 
                      StyleSeasonYearID, BOMCost, BOLCost, 
                      BOLCurr, StyleQuotaVendorDutyID, SourcingHeaderID, StyleSKUItemID, ActualStart)
                       select
                      ...
                      StyleCostingCustomField35, 
                      StyleQuoteItem_EcomUnits, StyleQuoteItem_EcomPriceUnit,
                      @MUser, @MDate, @MUser, @MDate, QuoteFolderSort, 
                      AgentView, StyleColorID, StyleSourcingID, 
                      StyleSeasonYearID, BOMCost, BOLCost, 
                      BOLCurr, StyleQuotaVendorDutyID, SourcingHeaderID, StyleSKUItemID, @MDate
...
VALUES ('DB_Version', '0.5.0000', '08691', GetDate())
GO
