/****** Object:  StoredProcedure [dbo].[spx_TACalReferenceFromSourcingCommitment_CREATE]    Script Date: 08/22/2014 17:12:25 ******/
...
BEGIN
	...
	WHERE tw.WorkflowFolder='SOURCING COMMITMENT' AND tt.TACalTemplateId=@TACalTemplateId AND (tt.New=1 OR @New = 0)
...
VALUES ('DB_Version', '6.0.0000', '08979', GetDate())
GO
