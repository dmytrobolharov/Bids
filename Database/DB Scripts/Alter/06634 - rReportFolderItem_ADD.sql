IF NOT EXISTS (SELECT * FROM rReportFolderItem WHERE ReportFormName = 'v5_Line_List_Internal_11x17')
BEGIN
	...
	(
		NEWID(),
		@ReportFolderID,
		'v5_Line_List_Internal_11x17',
		'Internal Line List (11x17)',
		'Internal Line List (11x17)',
		'../Report/Report_Main.aspx?R=/' + @ReportFolder + '/v5_Line_List_Internal_11x17',
...
VALUES     ('DB_Version', '0.5.0000', '06634', GetDate())
GO
