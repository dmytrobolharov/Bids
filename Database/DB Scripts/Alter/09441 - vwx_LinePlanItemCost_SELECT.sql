IF OBJECT_ID(N'[dbo].[vwx_LinePlanItemCost_SELECT]') IS NOT NULL
...
SELECT a.StyleID, a.StyleCostingTypeID, a.StyleQuotaDutyID, a.StyleCostingDate, a.StyleCostingStatus, a.StyleCostingCustomField1, a.StyleCostingCustomField2, 
	   ...
	   f.AttributeName, g.LinePlanAttributeText2 AS Brand, g.LinePlanAttributeText3 AS Category, c.SeasonYearID, a.StyleCostingCustomField35, a.StyleCostingHeaderID
FROM pStyleCostingHeader AS a 
INNER JOIN pStyleHeader AS b ON b.StyleID = a.StyleID 
LEFT JOIN pStyleSeasonYear AS c ON c.StyleSeasonYearID = a.StyleSeasonYearID 
LEFT JOIN pLinePlanItem AS d ON c.LinePlanItemID = d.LinePlanItemID 
LEFT JOIN pLinePlanStyleAttributeItem AS e ON e.LinePlanStyleAttributeItemID = d.LinePlanStyleAttributeItemID 
LEFT JOIN pLinePlanStyleAttribute AS f ON f.LinePlanStyleAttributeID = e.LineplanStyleAttributeID 
INNER JOIN pLinePlanRange AS g ON d.LinePlanRangeID = g.LinePlanRangeID
...
VALUES ('DB_Version', '6.1.0000', '09441', GetDate())
GO
