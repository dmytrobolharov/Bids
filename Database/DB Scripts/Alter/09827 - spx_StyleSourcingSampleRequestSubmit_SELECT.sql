IF OBJECT_ID(N'[dbo].[spx_StyleSourcingSampleRequestSubmit_SELECT]') IS NOT NULL
...
g.StyleColorName, f.StyleNo, COALESCE(sc.Custom, f.SizeClass) AS SizeClass, f.Description, f.StyleSet, 
...
LEFT JOIN pSizeClass sc ON sc.CustomID = f.SizeClassId
...
f.StyleNo, COALESCE(sc.Custom, f.SizeClass) , f.Description, f.StyleSet, b.TechPackID, f.DueDate 
'
...
VALUES ('DB_Version', '6.1.0000', '09827', GetDate())
GO
