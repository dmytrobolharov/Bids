/****** Object:  StoredProcedure [dbo].[spx_TACalReferenceFromSourcingQuote_CREATE]    Script Date: 08/22/2014 17:05:34 ******/
...
BEGIN
	...
	WHERE tw.WorkflowFolder='SOURCING QUOTATION' AND tt.TACalTemplateId=@TACalTemplateId AND (tt.New=1 OR @New = 0)
...
VALUES ('DB_Version', '6.0.0000', '08980', GetDate())
GO
