...
/****** Object:  StoredProcedure [dbo].[rpx_Style_SeasonalMaterialColorway_SELECT]    Script Date: 11/28/2011 17:33:35 ******/
...
(
	...
	,MaterialSort nvarchar(5)			--Comment #04
...
SELECT
	...
	,dbo.fnx_GetStreamingColorImagePath(pColorPalette.ColorFolderID,pStyleColorway.ColorPaletteID) AS MainColorFilePath	
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02210'))
BEGIN
	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES ('DB_Version', '5.0.0000', '03216', GetDate())
END
GO
