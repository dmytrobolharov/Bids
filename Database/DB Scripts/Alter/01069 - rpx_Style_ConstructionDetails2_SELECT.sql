IF EXISTS (select * from sysobjects where id = object_id('rpx_Style_ConstructionDetails2_SELECT') and sysstat & 0xf = 4)
    drop procedure rpx_Style_ConstructionDetails2_SELECT
GO
...
VALUES ('DB_Version', '4.0.0000', '01069', GetDate())
GO