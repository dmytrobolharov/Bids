IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[dpx_Style_Quotation_Tracking_SELECT]') AND type in (N'P', N'PC'))
...
INSERT INTO #TempStyleQuoteFinal (StyleID, StyleNo, Descrip, StyleSet, SizeClass, 
...
UPDATE s  set imageShowFlag = 1,
			  FilePath =	(SELECT TOP 1 dbo.fnx_GetStreamingImagePath(hImage.ImageID, hImage.[Version], 2000)	--Comment #01
...
VALUES ('DB_Version', '6.1.0000', '10091', GetUTCDate())
GO