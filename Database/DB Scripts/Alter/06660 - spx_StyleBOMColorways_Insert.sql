...
AS 
	...
	IF NOT EXISTS ( SELECT * FROM pStyleColorwaySeasonYear WHERE StyleSeasonYearID = @StyleSeasonYearID AND ColorPaletteID = @ColorPaletteID)   
	BEGIN  
...
VALUES     ('DB_Version', '0.5.0000', '06660', GetDate())
GO
