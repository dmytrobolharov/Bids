...
BEGIN
	...
	SELECT @StyleBOMDimensionID, ISNULL(DimBOM,1), ISNULL(DefaultBOMPage,1), ISNULL(FillColorway,1), ISNULL(ActiveColor,1)
	...
	BEGIN
		INSERT INTO pStyleBOMConfig (StyleBOMDimensionID, DimBOM, DefaultBOMPage, FillColorway, ActiveColor)
		SELECT @StyleBOMDimensionID, 1, 1, 1, 1
	END
...
VALUES ('DB_Version', '0.5.0000', '06210', GetDate())
GO
