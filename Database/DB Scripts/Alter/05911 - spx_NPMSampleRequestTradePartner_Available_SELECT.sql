/****** Object:  StoredProcedure [dbo].[spx_NPMSampleRequestTradePartner_Available_SELECT]    Script Date: 06/25/2013 16:46:09 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_NPMSampleRequestTradePartner_Available_SELECT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_NPMSampleRequestTradePartner_Available_SELECT]
GO

CREATE PROCEDURE [dbo].[spx_NPMSampleRequestTradePartner_Available_SELECT]
...
VALUES ('DB_Version', '0.5.0000', '05911', GetDate())
GO
