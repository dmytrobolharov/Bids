IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[rpx_Style_Model_1x0_Imperial_SELECT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[rpx_Style_Model_1x0_Imperial_SELECT]
GO
...
CREATE PROCEDURE [dbo].[rpx_Style_Model_1x0_Imperial_SELECT]
(
	@StyleId NVARCHAR(50)
	,@StyleSet INT
)
...
SELECT
	...
	,dbo.fnx_GetStreamingImageCADStyleModelPiecePath(pBodyPatternSheetModel.StyleId, pBodyPatternSheetModel.Id, pBodyPatternSheetPiece.Id) AS PieceImageFilePath
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02233'))
BEGIN
	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '02233', GetDate())
END
GO