/****** Object:  StoredProcedure [dbo].[spx_SourcingCostSummaryOptionDetail_Select]    Script Date: 03/12/2013 12:31:38 ******/
...
SELECT    dbo.pSourcingCostOptionDetail.SourcingCostOptionDetailID, dbo.pSourcingCostOptionDetail.SourcingCostOptionId, 
                      ...
                      dbo.pSourcingCostOption.OptionNo,'' as BOMOptionName, pSourcingCostOption.BOMOption
...
NEWID(), MinQuantity, MaxQuantity, 
                     ...
                     '','',null, 
                     null,null,null, 
                     null,null, OptionName,'1' AS orderbysort,OptionNo,'' as BOMOptionName, BOMOption
...
VALUES ('DB_Version', '0.5.0000', '05283', GetDate())
GO
