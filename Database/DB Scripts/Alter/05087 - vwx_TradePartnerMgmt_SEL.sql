/****** Object:  View [dbo].[vwx_TradePartnerMgmt_SEL]    Script Date: 02/21/2013 13:45:02 ******/
...
c as (
	...
	CAST(tp.TradePartnerID as VARCHAR(MAX)) as TradePartnerIDChain,
	...
	c.TradePartnerIDChain + ',' + CAST(tpr.TradePartnerID as VARCHAR(40)) as TradePartnerIDChain,
	(
...
VALUES ('DB_Version', '5.0.0000', '05087', GetDate())
GO