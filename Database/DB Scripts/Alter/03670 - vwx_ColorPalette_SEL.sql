/****** Object:  View [dbo].[vwx_ColorPalette_SEL]    Script Date: 06/20/2012 12:50:51 ******/
...
SELECT     '<img src=''../System/Control/ColorStream.ashx?S=25&CFID=' + CAST(ISNULL(dbo.pColorPalette.ColorFolderID, '00000000-0000-0000-0000-000000000000') 
                      ...
                      dbo.pColorPalette.ColorPaletteCustom4, dbo.pColorPalette.ColorPaletteCustom5, dbo.pColorPalette.ColorPaletteCustom6, 
                      dbo.pColorPalette.ColorPaletteCustom7
...
VALUES     ('DB_Version', '5.0.0000', '03670', GetDate())
GO