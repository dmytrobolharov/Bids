/****** Object:  StoredProcedure [dbo].[rpx_SampleRequestActivityCalendarAgent_INSERT]    Script Date: 06/17/2014 12:27:43 ******/
...
FROM    pSampleRequestSubmit WITH (NOLOCK) INNER JOIN
		...
		fnx_Permissions_GetIntProductType_WorkflowPermissions(@TeamID, 5, NULL) access ON pSampleWorkflow.SampleWorkflowGUID = access.WorkflowId AND pStyleHeader.StyleType = access.ProductTypeID
...
VALUES ('DB_Version', '0.5.0000', '08018', GetDate())
GO