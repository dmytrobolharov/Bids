...
/****** Object:  StoredProcedure [dbo].[spx_Sourcing_StyleBOMHdrDimItem_select]    Script Date: 11/06/2012 13:50:24 ******/
	...
	begin		
		if @DimLevel=1
			begin
				...
				FROM pSourcingQuoteStyleBOM  where StyleBOMDimensionId = @StyleBOMDimensionId and ItemDim1Active=1
				and StyleQuoteItemId=@StyleQuoteItemId
		...
		if @DimLevel=2
			begin
				...
				FROM pSourcingQuoteStyleBOM  where StyleBOMDimensionId = @StyleBOMDimensionId and ItemDim2Active=1
				and StyleQuoteItemId=@StyleQuoteItemId
		...
		if @DimLevel=3
			begin
				...
				FROM pSourcingQuoteStyleBOM  where StyleBOMDimensionId = @StyleBOMDimensionId and ItemDim3Active=1
				and StyleQuoteItemId=@StyleQuoteItemId
...
VALUES     ('DB_Version', '5.0.0000', '04300', GetDate())
GO
