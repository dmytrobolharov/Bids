...
SELECT b.Map, b.MapDetail, b.MapUrl, c.WorkflowStatus, c.WorkflowStatusImage, a.StyleWorkflowID, a.StyleID, a.StyleSet, a.WorkflowID, a.WorkflowType, a.WorkflowOrder, 
       ...
       a.WorkflowTemplateItemID, WorkflowAssignedTo, WorkflowAssignedToName, WorkEscalateTo, WorkflowEscalateToName, WorkflowAlerts,
...
INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES ('DB_Version', '5.0.0000', '03454', GetDate())
