...
/****** Object:  View [dbo].[vwx_SelectChangeLogWorkflowsMR]    Script Date: 10/10/2012 17:33:56 ******/
...
FROM         dbo.pMaterialRequestToChangeTable INNER JOIN
                      dbo.pMaterialRequestWorkflow ON dbo.pMaterialRequestToChangeTable.MaterialRequestWorkflowID = dbo.pMaterialRequestWorkflow.MaterialRequestWorkflowID
...
VALUES     ('DB_Version', '5.0.0000', '04141', GetDate())
GO
