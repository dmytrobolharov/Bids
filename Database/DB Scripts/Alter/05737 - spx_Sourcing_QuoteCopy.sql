...
/****** Object:  StoredProcedure [dbo].[spx_Sourcing_QuoteCopy]    Script Date: 05/23/2013 10:28:22 ******/
...
SELECT     @strNewId, StyleQuoteItemShare, 
			CASE StyleQuoteItemStatusId 
				 WHEN 3 
				 THEN 0 
				 ELSE StyleQuoteItemStatusId 
			END as StyleQuoteItemStatusId, 
...
-- DEFAULT BOM OPTION
DECLARE @BOMOptionCopyID UNIQUEIDENTIFIER = (SELECT BOMOptionDefault FROM pStyleQuoteItem WHERE StyleQuoteItemID = @StyleQuoteItemID)

if @BOMOptionCopyID IS NOT NULL
begin
	DECLARE @BOMOptionID UNIQUEIDENTIFIER = NEWID();
	INSERT INTO pSourcingQuotationBOMOption(
		StyleOptionID, StyleQuoteItemID, SourcingHeaderId, SourcingStyleID, StyleID, styleset,
		WorkFlowID, WorkFlowItemID, StyleBOMDimensionId, OptionNo, OptionStatus, OptionSystem, 
		OptionName, XFactoryDate, OptionQuantity, OptionCost, CUser, CDate)
	SELECT @BOMOptionID, /*StyleQuoteItemID*/@strNewId, SourcingHeaderId, SourcingStyleID, StyleID, styleset,
		WorkFlowID, WorkFlowItemID, StyleBOMDimensionId, OptionNo, OptionStatus, OptionSystem, 
		OptionName, XFactoryDate, OptionQuantity, OptionCost, @MUser, @MDate
	FROM pSourcingQuotationBOMOption WHERE StyleOptionID = @BOMOptionCopyID
	
	INSERT INTO pSourcingQuotationBOMOptionItems(
		StyleQuoteItemID, SourcingHeaderID, SourcingStyleID,
		StyleMaterialID, StyleMaterialMasterID, CopyStyleMaterialID, SubstituteForID,
		StyleOptionID, OptionNo, MainMaterial, Development, MiscColor,
		StyleSet, StyleID, WorkflowId, WorkflowItemId, StyleBOMDimensionId,
		Dim1TypeSel, Dim2TypeSel, Dim3TypeSel, UOM, Qty, MaterialPrice, Ext,
		MaterialSize, MaterialID, MaterialPlacement, MaterialPlacementCode,
		MaterialPlacementDetail, MaterialImageID, MaterialImageVersion, NoColorMatch,
		...
		height, width, CDate, CUser, MDate, MUser, MChange, SChange, DChange, CChange,
		Action, ColorPlacement, Artwork, License, Colorway, MaterialSort, MaterialTrack,
		MaterialLinked, MaterialDimension,
		...
		MaterialSizeB0, MaterialSizeB1, MaterialSizeB2, MaterialSizeB3,
		MaterialSizeB4, MaterialSizeB5, MaterialSizeB6, MaterialSizeB7,
		MaterialSizeB8, MaterialSizeB9, MaterialSizeB10, MaterialSizeB11,
		MaterialSizeB12, MaterialSizeB13, MaterialSizeB14, MaterialSizeB15,
		MaterialSizeB16, MaterialSizeB17, MaterialSizeB18, MaterialSizeB19,
		...
		MaterialLinkID, MultiMaterialParentID,
	...
	SELECT /*StyleQuoteItemID*/@strNewId, SourcingHeaderID, SourcingStyleID,
		StyleMaterialID, StyleMaterialMasterID, CopyStyleMaterialID, SubstituteForID,
		/*StyleOptionID*/@BOMOptionID, OptionNo, MainMaterial, Development, MiscColor,
		StyleSet, StyleID, WorkflowId, WorkflowItemId, StyleBOMDimensionId,
		Dim1TypeSel, Dim2TypeSel, Dim3TypeSel, UOM, Qty, MaterialPrice, Ext,
		MaterialSize, MaterialID, MaterialPlacement, MaterialPlacementCode,
		MaterialPlacementDetail, MaterialImageID, MaterialImageVersion, NoColorMatch,
		...
		Source, Notes, Placement, VendorPrice, VolumePrice, VolumePriceMinimum,
		VendorProductionMin, VendorProductionLeadTime, DetailYesNo, ImageType,
		height, width, /*CDate*/@MDate, /*CUser*/@MUser, /*MDate*/NULL, /*MUser*/NULL, MChange, SChange, DChange, CChange,
		Action, ColorPlacement, Artwork, License, Colorway, MaterialSort, MaterialTrack,
		MaterialLinked, MaterialDimension,
		MaterialSizeA0, MaterialSizeA1, MaterialSizeA2, MaterialSizeA3,
		MaterialSizeA4, MaterialSizeA5, MaterialSizeA6, MaterialSizeA7,
		...
		WebPDMCustom_GroupDesc, WebPDMCustom_Dutiable, WebPDMCustom_WasteFactor, WebPDMCustom_UOM,
		WebPDMCustom_UOMPurchase, WebPDMCustom_Comments, AUTOCOLOR, Comments
	FROM pSourcingQuotationBOMOptionItems WHERE StyleOptionID = @BOMOptionCopyID
	
	UPDATE pStyleQuoteItem SET BOMOptionDefault = @BOMOptionID WHERE StyleQuoteItemID = @strNewId
end

GO

INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
VALUES     ('DB_Version', '0.5.0000', '05737', GetDate())
GO
