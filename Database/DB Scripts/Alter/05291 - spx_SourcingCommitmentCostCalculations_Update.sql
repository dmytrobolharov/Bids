...
--If @StyleBOMDimensionId <> '00000000-0000-0000-0000-000000000000'
	...
	Select @IntExtFOB = @TotalCost * (1 + (ISNULL(StyleQuoteItemCustomField9, '0.00')) + (ISNULL(StyleQuoteItemCustomField11, '0.00')) + ((ISNULL(StyleQuoteItemCustomField9, '0.00')) * (ISNULL(StyleQuoteItemCustomField11, '0.00'))))
	FROM pSourcingCommitmentItem WHERE SourcingCommitmentItemID=@SourcingCommitmentItemID and SourcingHeaderId=@SourcingHeaderId
...
VALUES ('DB_Version', '0.5.0000', '05291', GetDate())
GO
