...
SELECT  sy.Season as Season
	,sy.Year as MaterialYear
...
LEFT OUTER JOIN pSeasonYear sy ON tp.SeasonYearID = sy.SeasonYearID
WHERE
      (
...
VALUES ('DB_Version', '6.1.0000', '10088', GetUTCDate())
GO