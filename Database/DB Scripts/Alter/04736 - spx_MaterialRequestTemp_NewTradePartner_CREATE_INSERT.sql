/****** Object:  StoredProcedure [dbo].[spx_MaterialRequestTemp_NewTradePartner_CREATE_INSERT]    Script Date: 01/09/2013 12:28:20 ******/
...
BEGIN 
	...
	SELECT  @TradePartnerID = TradePartnerID  FROM #vendor WHERE ROW_ID = @Row_V
	...
	BEGIN
		...
		SELECT @MaterialTradePartnerID, @MaterialID ,  @TradePartnerID,
...
VALUES ('DB_Version', '5.0.0000', '04736', GetDate())
GO
