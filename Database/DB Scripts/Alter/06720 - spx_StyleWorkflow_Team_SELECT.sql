...
BEGIN
	...
	SELECT 1 As StyleSet, '70000000-0000-0000-0000-000000000001' As WorkflowID, 0 As Sort, MapDetail, MapUrl, MapEditUrl, MapEmlUrl, NULL as WorkflowSort  FROM Mapping WHERE Map = '70000000-0000-0000-0000-000000000001'
	UNION
...
VALUES     ('DB_Version', '0.5.0000', '06720', GetDate())
GO
