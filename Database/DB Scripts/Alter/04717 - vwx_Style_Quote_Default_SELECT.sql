IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vwx_Style_Quote_Default_SELECT]'))
...
SELECT DISTINCT 
                      ...
                      dbo.pStyleQuoteItem.StyleID, dbo.pStyleQuoteItem.StyleQuoteItemNo, dbo.pStyleQuoteItem.StyleQuoteItemStatusId, dbo.pStyleQuoteItem.StyleQuoteVariationId, 
                      dbo.pStyleQuoteItem.StyleQuoteID, dbo.pStyleQuoteItem.StyleQuotaDutyID, dbo.pStyleQuoteItem.StyleDevelopmentID, 
                      ...
                      dbo.pStyleQuoteItem.StyleCostingCustomField34, dbo.pStyleQuoteItem.StyleCostingCustomField35, dbo.uCountry.CountryName, dbo.pStyleHeader.StyleNo, 
                      dbo.pStyleHeader.SizeClass, dbo.pStyleHeader.MaterialNo, dbo.pStyleQuoteItemFreightCost.Margin, dbo.pStyleQuoteItemFreightCost.TotalLandCost, 
                      dbo.pStyleHeader.Pc1, dbo.pStyleQuoteItem.StyleQuoteItemDueDate, dbo.pStyleQuoteItem.MDate, dbo.pStyleQuoteItem.StyleColorID, 
                      dbo.pStyleQuoteItem.StyleSourcingID, dbo.pStyleColorway.StyleColorID AS Expr1, dbo.pStyleColorway.StyleColorName, 
...
FROM         dbo.pStyleQuoteItem INNER JOIN
                      ...
                      dbo.uCountry ON dbo.pStyleQuoteItem.StyleQuoteItemCustomField1 = dbo.uCountry.CountryCode
...
VALUES     ('DB_Version', '5.0.0000', '04717', GetDate())
GO
