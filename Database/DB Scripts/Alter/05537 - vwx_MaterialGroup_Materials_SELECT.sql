/****** Object:  View [dbo].[vwx_MaterialGroup_Materials_SELECT]    Script Date: 04/11/2013 11:30:57 ******/
...
SELECT     dbo.pMaterial.MaterialID, dbo.pMaterial.TempID, dbo.pMaterial.TempNo, dbo.pMaterial.MaterialImageID, dbo.pMaterial.MaterialImageVersion, 
                      ...
                      dbo.pMaterial.HeaderLocked, dbo.pMaterial.MaterialTemplateID, dbo.pMaterial.DutyCategoryID, dbo.pMaterial.DueDate, 
                      dbo.pMaterialCoreItem.MaterialCoreItemID
...
VALUES ('DB_Version', '5.0.0000', '05537', GetDate())
GO
