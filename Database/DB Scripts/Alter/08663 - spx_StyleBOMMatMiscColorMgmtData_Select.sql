...
BEGIN
	...
	SET @query = N'SELECT mat_id, styleMaterialPKId, stylematerialId, materialId, materialno, materialname, 
		...
		StyleBOMDimensionId, WorkflowId, WorkflowItemId, MaterialImageID, MaterialImageVersion, Main AS MainMaterial, TradePartner, MaterialSizeID, MaterialSize, DimBOM,  ' + @IncrCols + '
		FROM
			...
			t1.dtl_id, t3.MaterialColorId, t2.MaterialImageID, t2.MaterialImageVersion, t2.Main, t2.TradePartner, t2.MaterialSizeID, ms.MaterialSize, t2.DimBOM   
...
VALUES ('DB_Version', '0.5.0000', '08663', GetDate())
GO
