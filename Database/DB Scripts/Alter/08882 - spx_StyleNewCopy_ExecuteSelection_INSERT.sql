...
BEGIN 
	...
	INSERT INTO pStyleWorkflow(
		...
		WorkComments, WorkSort, CUser, CDate, MUser, MDate, WorkDay, StyleSeasonYearID, ActualStart, ActualEnd)
	SELECT NEWID() AS StyleWorkflowID, @NewStyleID AS StyleID, b.StyleSet, b.WorkflowID, b.WorkflowType, b.WorkflowOrder, b.WorkDate, b.WorkStart, 
		b.WorkDue, b.WorkAssignedTo, 0 AS WorkComplete, WorkStatus, NULL AS WorkStatusDate, NULL  AS WorkStatusBy, 0 AS WorkVersion, 
		b.WorkComments, b.WorkSort, @CUser, @CDate, @CUser, @CDate , b.WorkDay, 
		CASE WHEN m.IsSeasonal = 0 THEN NULL ELSE @StyleSeasonYearID END, ActualStart, ActualEnd
...
VALUES ('DB_Version', '6.0.0000', '08882', GetDate())
GO
