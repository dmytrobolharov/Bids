...
BEGIN
    ...
    SELECT StytleCostingScenarioItemsID, StyleCostingName, StyleCostingScenarioNo, 0 AS SystemCost
    FROM pStyleCostingScenarioItems
    WHERE StyleCostingID = @StyleCostingID
    UNION SELECT StyleCostingScenarioItemsId, StyleCostingName, StyleCostingScenarioNo, 1 AS SystemCost
    FROM pStyleCosting
    WHERE StyleCostingID = @StyleCostingID
...
VALUES     ('DB_Version', '5.0.0000', '03968', GetDate())
GO
