...
Declare @DisplaySizeDescription nvarchar(20) = (SELECT AppSettingValue FROM sAppSetting WHERE AppSettingKey = 'DisplaySizeDescription')
...
VALUES     ('DB_Version', '5.0.0000', '04387', GetDate())
GO
