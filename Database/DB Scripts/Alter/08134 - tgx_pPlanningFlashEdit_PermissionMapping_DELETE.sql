/****** Object:  Trigger [tgx_pPlanningFlashEdit_PermissionMapping_DELETE]    Script Date: 06/27/2014 15:36:27 ******/
IF  EXISTS (SELECT * FROM sys.triggers WHERE object_id = OBJECT_ID(N'[dbo].[tgx_pPlanningFlashEdit_PermissionMapping_DELETE]'))
DROP TRIGGER [dbo].[tgx_pPlanningFlashEdit_PermissionMapping_DELETE]
GO

/****** Object:  Trigger [dbo].[tgx_pPlanningFlashEdit_PermissionMapping_DELETE]    Script Date: 06/27/2014 15:36:27 ******/
SET ANSI_NULLS ON
GO
...
CREATE TRIGGER [dbo].[tgx_pPlanningFlashEdit_PermissionMapping_DELETE]
...
BEGIN
    ...
    BEGIN TRY
		...
		FOR SELECT PlanningFlashEditId FROM deleted
		OPEN DeletedBubbles
...
VALUES ('DB_Version', '0.5.0000', '08134', GetDate())
GO