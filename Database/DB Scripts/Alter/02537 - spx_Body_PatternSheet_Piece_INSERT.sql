IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_Body_PatternSheet_Piece_INSERT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_Body_PatternSheet_Piece_INSERT]
GO
...
CREATE procedure [dbo].[spx_Body_PatternSheet_Piece_INSERT]
(
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02537'))
BEGIN
	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.2.0000', '02537', GetDate())
END
GO
