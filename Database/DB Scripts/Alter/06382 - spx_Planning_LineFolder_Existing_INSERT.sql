...
BEGIN
	...
	SELECT lfi.StyleID, ssy.SeasonYearID FROM pLineFolderItem lfi
	INNER JOIN pStyleSeasonYear ssy ON lfi.StyleSeasonYearID = ssy.SeasonYearID
...
VALUES ('DB_Version', '0.5.0000', '06382', GetDate())
GO
