...
IF NOT EXISTS(SELECT * FROM sSystemPage WHERE MappingPage='Style_List_History.aspx')
	BEGIN
		INSERT INTO [sSystemPage] (MappingPage, CDate, CUser, sSystemFolderID)
		VALUES ('Style_List_History.aspx', GETDATE(), 'Administrator', (SELECT sSystemFolderID from sSystemFolder where sSystemFolder='Style'))
	END
	GO
...
VALUES     ('DB_Version', '5.0.0000', '04259', GetDate())
GO
