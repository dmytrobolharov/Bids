...
/****** Object:  StoredProcedure [dbo].[spx_LineFolderItemColorChip_SELECT]    Script Date: 01/13/2012 01:47:51 ******/
SET ANSI_NULLS ON
GO
...
GO
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02586'))
BEGIN
	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.2.0000', '02586', GetDate())
END
GO