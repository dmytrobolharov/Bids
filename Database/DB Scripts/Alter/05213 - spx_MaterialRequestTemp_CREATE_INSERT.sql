/****** Object:  StoredProcedure [dbo].[spx_MaterialRequestTemp_CREATE_INSERT]    Script Date: 03/01/2013 16:11:56 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_MaterialRequestTemp_CREATE_INSERT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_MaterialRequestTemp_CREATE_INSERT]
GO

CREATE PROCEDURE [dbo].[spx_MaterialRequestTemp_CREATE_INSERT] (
...
VALUES ('DB_Version', '5.0.0000', '05213', GetDate())
GO
