/****** Object:  View [dbo].[vwx_TACalTemplateTask_ReferenceFromImage_SELECT]    Script Date: 07/11/2014 16:32:33 ******/
...
AS
SELECT crt.TACalRefTaskId, 'Image' as RefType, im.ImageID, tw.WorkflowId, ct.SeasonYearId, im.ImageNo, im.ImageDescription, crt.TaskAssignedToId, crt.TaskStatusId,
...
VALUES     ('DB_Version', '0.5.0000', '08285', GetDate())
GO