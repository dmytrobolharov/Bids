/****** Object:  StoredProcedure [dbo].[spx_StyleNewCopy_ExecuteSelection_INSERT]    Script Date: 12/10/2014 16:31:01 ******/
...
BEGIN 
	...
	SELECT NEWID() AS StyleWorkflowID, @NewStyleID AS StyleID, b.StyleSet, b.WorkflowID, b.WorkflowType, b.WorkflowOrder, b.WorkDate, b.WorkStart, 
		b.WorkDue, b.WorkAssignedTo, 0 AS WorkComplete, CASE WHEN WorkStatus = 1 THEN WorkStatus ELSE 6 END, NULL AS WorkStatusDate, NULL  AS WorkStatusBy, 0 AS WorkVersion, 
...
VALUES ('DB_Version', '6.0.0001', '09183', GetDate())
GO
