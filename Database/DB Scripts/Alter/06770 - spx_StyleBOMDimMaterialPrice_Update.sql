IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_StyleBOMDimMaterialPrice_Update]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_StyleBOMDimMaterialPrice_Update]
GO


CREATE PROCEDURE [dbo].[spx_StyleBOMDimMaterialPrice_Update] (
...
VALUES     ('DB_Version', '0.5.0000', '06770', GetDate())
GO
