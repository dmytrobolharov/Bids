...
SELECT DISTINCT 
                      ...
                      dbo.pMaterial.MaterialCode, dbo.pMaterial.Active,  '<img src=''../System/Control/ImageStream.ashx?S=25&V=' + CAST(ISNULL(pStyleBOM.MaterialImageVersion, 0) AS NVARCHAR(5)) 
                      + '&IID=' + CAST(ISNULL(pStyleBOM.MaterialImageID, '00000000-0000-0000-0000-000000000000') AS NVARCHAR(50)) + ''' />' AS MaterialImage
...
VALUES     ('DB_Version', '0.5.0000', '08322', GetDate())
GO
