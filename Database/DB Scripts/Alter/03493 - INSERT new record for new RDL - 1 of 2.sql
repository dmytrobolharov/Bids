...
BEGIN
	...
	BEGIN
		SET @ReportMapId			= '60000000-0000-0000-0000-000000000666'	--Parent PK id.
		SET @ReportTemplateName		= 'Style_Header_LLT'						--Header RDL name.
		SET @ReportPageName			= 'Artwork Images - Details'				--Name of the new report to show on screen.
		SET @ReportPageDescription	= 'Artwork Images - Details'				--Additional name field, not shown on screen.
		SET @ReportServerType		= 'SQL'										--Report type.  'SQL' for RDLs and 'ASPX' for code-based reports.
		SET @ReportFormName			= 'Style_ArtworkImages_Details_Body_LLT'	--Body RDL name.
...
VALUES ('DB_Version', '5.0.0000', '03493', GetDate())
GO