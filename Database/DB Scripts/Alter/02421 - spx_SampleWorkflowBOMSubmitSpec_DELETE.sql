...
/****** Object:  StoredProcedure [dbo].[spx_SampleWorkflowBOMSubmitSpec_DELETE]    Script Date: 12/18/2011 18:43:02 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_SampleWorkflowBOMSubmitSpec_DELETE]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_SampleWorkflowBOMSubmitSpec_DELETE]
GO
...
Create PROCEDURE [dbo].[spx_SampleWorkflowBOMSubmitSpec_DELETE]
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02421'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '02421', GetDate())
