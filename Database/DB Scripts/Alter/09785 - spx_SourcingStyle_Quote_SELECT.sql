IF OBJECT_ID(N'[dbo].[spx_SourcingStyle_Quote_SELECT]') IS NOT NULL
...
BEGIN
	...
	WHERE pStyleQuoteItem.SourcingHeaderID = @SourcingHeaderID
...
VALUES ('DB_Version', '6.1.0000', '09785', GetDate())
GO
