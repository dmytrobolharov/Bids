IF OBJECT_ID(N'[dbo].[vwx_StyleMaterialSearch]') IS NOT NULL
 DROP VIEW [dbo].[vwx_StyleMaterialSearch]
GO

CREATE VIEW [dbo].[vwx_StyleMaterialSearch]
AS
SELECT sh.StyleID, sh.StyleMasterID, sh.StyleWorkflowID, sh.StyleType, sh.WorkflowType, sh.RefNo, sh.StyleNo, 
	   ...
	   sh.SizeRangeId, COALESCE(sr.SizeRangeCode, sh.SizeRange) AS SizeRange, sh.StyleSet, sh.TechPackId, sh.TechPackDate, 
	   ...
	   sh.CustomField14, sh.CustomField15, /*sh.Size0, sh.Size1, sh.Size2, sh.Size3, sh.Size4, sh.Size5, sh.Size6, sh.Size7, 
	   sh.Size8, sh.Size9, sh.Size10, sh.Size11, sh.Sel0, sh.Sel1, sh.Sel2, sh.Sel3, sh.Sel4, sh.Sel5, sh.Sel6, sh.Sel7, 
	   sh.Sel8, sh.Sel9, sh.Sel10, sh.Sel11,*/ sh.Pc1, sh.Pc2, sh.Pc3, sh.Pc4, sh.CUser, sh.CDate, sh.MUser, sh.MDate, 
       ...
       sh.CustomField17, sh.CustomField18, sh.CustomField19, sh.CustomField20, sh.CustomField21, sh.CustomField22, 
	   sh.CustomField23, sh.CustomField24, sh.CustomField25, sh.CustomField26, sh.CustomField27, sh.CustomField28, 
       sh.CustomField29, sh.CustomField30, sm.J, sm.Q
...
VALUES ('DB_Version', '6.1.0000', '09488', GetDate())
GO
