...
AND a.ColorPaletteID NOT IN (SELECT ColorPaletteID FROM pLineFolderItemColor WHERE LineFolderItemID = @LineFolderItemID AND ColorPaletteID IS NOT NULL)
ORDER BY SeasonYear
...
VALUES     ('DB_Version', '0.5.0000', '06694', GetDate())
GO
