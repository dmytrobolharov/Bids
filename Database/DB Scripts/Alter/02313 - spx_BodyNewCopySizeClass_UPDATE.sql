IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_BodyNewCopySizeClass_UPDATE]') AND type in (N'P', N'PC'))
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02313'))
BEGIN
	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '02313', GetDate())
END	
GO  