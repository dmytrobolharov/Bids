...
IF NOT EXISTS(SELECT * FROM sSystemPage WHERE MappingPage='Style_CostSheetItem_Edit.aspx')
BEGIN
	INSERT INTO [sSystemPage] (MappingPage, CDate, CUser, sSystemFolderID)
	VALUES ('Style_CostSheetItem_Edit.aspx', GETDATE(), 'Administrator', (SELECT sSystemFolderID from sSystemFolder where sSystemFolder='Style'))
END
	
IF NOT EXISTS(SELECT * FROM sSystemPage WHERE MappingPage='Style_CostSheetItem.aspx')
BEGIN
	INSERT INTO [sSystemPage] (MappingPage, CDate, CUser, sSystemFolderID)
	VALUES ('Style_CostSheetItem.aspx', GETDATE(), 'Administrator', (SELECT sSystemFolderID from sSystemFolder where sSystemFolder='Style'))
END
...
VALUES ('DB_Version', '5.0.0000', '04982', GetDate())
