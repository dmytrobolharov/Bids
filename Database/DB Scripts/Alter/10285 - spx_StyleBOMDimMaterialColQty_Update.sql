IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_StyleBOMDimMaterialColQty_Update]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_StyleBOMDimMaterialColQty_Update]
GO
/****** Object:  StoredProcedure [dbo].[spx_StyleBOMDimMaterialColQty_Update]    Script Date: 03/20/2015 18:42:54 ******/
SET ANSI_NULLS ON
GO
...
VALUES ('DB_Version', '6.1.0000', '10285', GetUTCDate())
GO
