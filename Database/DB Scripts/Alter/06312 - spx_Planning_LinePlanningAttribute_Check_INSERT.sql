...
BEGIN
	...
	SELECT @PlanningID, pf.PlanningFinancialID, pf.PlanningFinancialText, pf.PlanningFinancialSort, tal.CustomID, tal.Custom
	...
	WHERE pb.PlanningID = @PlanningID AND (pb.PlanningBrandID <> b.CustomID OR pb.PlanningBrandID IS NULL)
...
VALUES ('DB_Version', '0.5.0000', '06312', GetDate())
GO
