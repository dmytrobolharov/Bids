...
/****** Object:  StoredProcedure [dbo].[spx_SampleRequestWorkflowFinalBOM_INSERT]    Script Date: 12/18/2011 18:29:09 ******/
...
@NewSampleRequestWorkflowID varchar(50),
@StyleRequestWorkflowSetItemID varchar(50),
@SampleRequestTradeID varchar(50),
@TradePartnerID varchar(50),
@TechPackID varchar(50)
			...
			WHILE @I <= @Row_Count 
				...
				SELECT @SampleRequestTradeID = SampleRequestTradeID, @TradePartnerID = TradePartnerID FROM pSampleRequestWorkflowBOM WITH (NOLOCK) WHERE StyleRequestWorkflowSetItemID = @StyleRequestWorkflowSetItemID
						...
						BEGIN
							...
							SampleWorkflowID, StyleID, ItemDim1Id,ItemDim2Id,ItemDim3Id, StyleSet, 0 AS Status, 1 AS Submit, SubmitDays, AssignedTo, TechPackID, StartDate, DueDate, '1/1/1900', CUser, CDate, 
							MUser, MDate
						...
						BEGIN
							...
							1 AS Submit, 0 AS Status, AssignedTo, StartDate, RecDate, RecBy, RecCarrier, RecTrackNo, RecWeight, VendorWeight, VendorDate, VendorName, SubmitDays, 
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02395'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '02395', GetDate())
