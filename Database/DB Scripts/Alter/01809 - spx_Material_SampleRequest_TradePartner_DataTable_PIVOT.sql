...
--
GO
/****** Object:  StoredProcedure [dbo].[spx_Material_SampleRequest_TradePartner_DataTable_PIVOT]    Script Date: 09/02/2011 13:53:29 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_Material_SampleRequest_TradePartner_DataTable_PIVOT]') AND type = N'P' )
...
--***      
	...
	SELECT MaterialRequestWorkflow,MaterialRequestWorkflowSort 
	...
	BEGIN  
		...
		SELECT
			...
			WHERE l.Active=1 AND m.Active=1  AND b.TradepartnerId=@TradepartnerID 								
	...
	EXECUTE spx_Crosstab   
			'SELECT MaterialRequestWorkflow,
			Link,
			MaterialTradePartnerId,
			MaterialTradePartnerColorId,
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='01809'))
BEGIN
	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '01809', GetDate())
END
GO