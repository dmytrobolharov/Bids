/****** Object:  StoredProcedure [dbo].[spx_Commitment_INSERT]    Script Date: 11/23/2012 15:43:24 ******/
	...
	begin
		...
		begin			
			INSERT INTO pSourcingCommitmentBOMOption
			   ...
			   ,[MDate]
			   ,[OptionName])
			SELECT @SourcingCommitmentBOMOptionID
			   ,@CommitmentId
			   ,[StyleQuoteItemID]
			   ,[SourcingHeaderId]
			   ,[SourcingStyleID]
		...
		begin
		   ...
		   SELECT @SourcingCommitmentBOMOptionID
			   ...
			   ,[AUTOCOLOR]
			   ,[Comments]
		   FROM pSourcingQuotationBOMMaterials WHERE StyleQuoteItemID = @QuoteItemID
		end
	end
...
VALUES     ('DB_Version', '5.0.0000', '04448', GetDate())
GO