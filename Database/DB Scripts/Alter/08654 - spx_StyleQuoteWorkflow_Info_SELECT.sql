/****** Object:  StoredProcedure [dbo].[spx_StyleQuoteWorkflow_Info_SELECT]    Script Date: 08/08/2014 16:25:36 ******/
...
BEGIN
	...
	SELECT @TACalTemplateID = TACalTemplateId FROM pTACalReference WHERE ReferenceId = @StyleQuoteItemID AND TACalReferenceTypeId = @FolderID
	...
	BEGIN
		...
		INNER JOIN pTACalReferenceTask crt ON cr.TACalReferenceId = cr.TACalReferenceId
...
VALUES ('DB_Version', '0.5.0000', '08654', GetDate())
GO
