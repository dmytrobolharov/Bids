...
BEGIN
	...
	INSERT INTO pStyleNBOLItems
		(StyleID, StyleSet, WorkFlowID, WorkFlowItemID, TemplateItemID, ParentID, IsLinked,
		 Sort, Sort2, OperationID, ImageID, Code, Name, MachineID, CUser, CDate, MUser, MDate, IsException)
	SELECT @StyleID, @StyleSet, @WorkflowId, @WorkflowItemId, '00000000-0000-0000-0000-000000000000', @NewItemId, 0,
		 @vcCount, otm.Sort, o.OperationID, o.ImageID, o.OperationCode, o.OperationName, o.MachineID, @CUser, @CDate, @CUser, @CDate, @IsException
...
VALUES     ('DB_Version', '5.0.0000', '03540', GetDate())
GO