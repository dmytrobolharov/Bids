...
BEGIN
	...
	--SELECT clause changed from CultureCountry to CultureLanguage
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='03945'))
BEGIN
	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES ('DB_Version', '5.0.0000', '03945', GetDate())
END
