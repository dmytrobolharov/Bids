/****** Object:  StoredProcedure [dbo].[spx_SampleWorkflowSubmit_Logic_UPDATE]    Script Date: 12/19/2011 10:31:11 ******/
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02460'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '02460', GetDate())
