...
AS
	SELECT
		...
		, m.MaterialType
		, msy.SeasonYearID
		, 'javascript:window.open (''' + AppSettingValue + '/Material/Material_Frame.aspx?MTID=' + CAST(m.MaterialID AS NVARCHAR(50))+ ''');' AS MaterialLink
	FROM pMaterial m
...
VALUES ('DB_Version', '6.0.0000', '08838', GetDate())
GO
