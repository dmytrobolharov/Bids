...
BEGIN
    ...
    SELECT '00000000-0000-0000-0000-000000000001' AS PlanningItemID, 'Financial Plan' AS PlanningItemName, 
		...
		UNION
	SELECT '00000000-0000-0000-0000-000000000012' AS PlanningItemID, 'Storyboards' AS PlanningItemName, 
		'Calendars' AS PlanningItemDescription, 1 AS PlanningItemSort, '0' As Child
		UNION
	SELECT '00000000-0000-0000-0000-000000000011' AS PlanningItemID, 'Storyboards' AS PlanningItemName, 
		'Storyboards' AS PlanningItemDescription, 1 AS PlanningItemSort, '0' As Child
		UNION
	SELECT '00000000-0000-0000-0000-000000000002' AS PlanningItemID, 'Development Tracker' AS PlanningItemName, 
		'Development Tracker' AS PlanningItemDescription, 2 AS PlanningItemSort, '0' As Child
		UNION
	SELECT '00000000-0000-0000-0000-000000000003' AS PlanningItemID, 'SKU Plan' AS PlanningItemName, 
		'SKU Plan' AS PlanningItemDescription, 3 AS PlanningItemSort, '0' As Child
		UNION
	SELECT '00000000-0000-0000-0000-000000000004' AS PlanningItemID, 'Line List Plan' AS PlanningItemName, 
		'Line List Plan' AS PlanningItemDescription, 4 AS PlanningItemSort, '0' As Child
		UNION
	SELECT '00000000-0000-0000-0000-000000000005' AS PlanningItemID, 'Color Plan' AS PlanningItemName, 
		'Color Plan' AS PlanningItemDescription, 5 AS PlanningItemSort, '0' As Child
		UNION	
	SELECT '00000000-0000-0000-0000-000000000006' AS PlanningItemID, 'Flash Edit' AS PlanningItemName, 
		'Flash Edit' AS PlanningItemDescription, 6 AS PlanningItemSort, '0' As Child
		UNION		
    SELECT PlanningFlashEditId AS PlanningItemID, PlanningFlashEditName AS PlanningItemName, 
			PlanningFlashEditDescription AS PlanningItemDescription, PlanningFlashEditSort+6 AS PlanningItemSort, '1' As Child
	...
	SELECT '00000000-0000-0000-0000-000000000007' AS PlanningItemID, 'Material Plan' AS PlanningItemName, 
		...
		UNION		
	SELECT '00000000-0000-0000-0000-000000000010' AS PlanningItemID, 'Attachment' AS PlanningItemName, 
		'Attachments' AS PlanningItemDescription, 101 AS PlanningItemSort, '0' As Child
		UNION
	SELECT '00000000-0000-0000-0000-000000000008' AS PlanningItemID, 'BI' AS PlanningItemName,
		'BI' AS PlanningItemDescription, 102 AS PlanningItemSort, '0' As Child
		UNION
	SELECT dfi.DashFolderItemID AS PlanningItemID, dfi.DashFolderItemName AS PlanningItemName, dfi.DashFolderItemName AS LineListFlashEditDescription,
		 DashFolderItemSort+103 As PlanningItemSort, '1' As Child
...
VALUES ('DB_Version', '0.5.0000', '08786', GetDate())
GO
