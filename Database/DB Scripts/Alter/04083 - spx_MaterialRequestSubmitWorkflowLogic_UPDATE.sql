...
/****** Object:  StoredProcedure [dbo].[spx_MaterialRequestSubmitWorkflowLogic_UPDATE]    Script Date: 10/03/2012 11:51:52 ******/
...
BEGIN        
	...
	BEGIN        
		...
		BEGIN 
			...
			DECLARE 
				@MaterialRequestSubmitGroupID UNIQUEIDENTIFIER,
				@MaterialRequestSubmitID UNIQUEIDENTIFIER
			...
			INSERT INTO dbo.pMaterialRequestSubmitGroup(
				MaterialRequestSubmitGroupID ,MaterialTradePartnerID ,MaterialRequestWorkflowID ,MaterialTradePartnerColorID)
			VALUES(
				@MaterialRequestSubmitGroupID, @MaterialTradePartnerID ,@MaterialRequestWorkflowID ,@MaterialTradePartnerColorID)
		END 
...
SET DueDate = DATEADD( day, ISNULL(pMaterialRequestWorkflowTemplateItem.MaterialRequestWorkflowDays,0) * - 1  , pMaterialTradePartner.MaterialrequestWorkflowDueDate )        
...
VALUES     ('DB_Version', '5.0.0000', '04083', GetDate())
GO