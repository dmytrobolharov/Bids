...
BEGIN
	...
	BEGIN
		...
		CREATE TABLE #tmpXmlDocTable (XmlDocId INT IDENTITY(1, 1) NOT NULL, NAME NVARCHAR(200) NULL, Alias NVARCHAR(200) NULL, Visible NVARCHAR(5) NULL, StatusFlag NVARCHAR(5) NULL)

		EXEC sp_xml_preparedocument @idoc OUTPUT, @doc

		INSERT INTO #tmpXmlDocTable (NAME, Alias, Visible, StatusFlag)
		SELECT NAME, alias, Visible, StatusFlag
		FROM OPENXML(@idoc, '/NewDataSet/Table/column', 1) WITH (NAME NVARCHAR(200), alias NVARCHAR(200), Visible NVARCHAR(200), StatusFlag NVARCHAR(200))
		WHERE Visible = 'true'
	...
	UNPIVOT(DimensionColumnValue FOR DimensionColumnName IN (ItemDim1TypeId, ItemDim2TypeId, ItemDim3TypeId)) AS unpvt;
	...
	IF EXISTS (
			SELECT *
			FROM #tblStyleBOMDimension
			WHERE ItemDim1TypeName = 'COLOR' AND ItemDim2TypeName = 'COLOR' AND ItemDim3TypeName = 'COLOR'
			)
	BEGIN
	...
	FROM #tblStyleBOMDimension
	WHERE ItemDim1TypeName = 'COLOR' OR ItemDim2TypeName = 'COLOR' OR ItemDim3TypeName = 'COLOR'
	...
	BEGIN
		...
		BEGIN
			CREATE TABLE #tblFinalTable (
				SizeRowid INT NOT NULL IDENTITY(0, 1), MaterialType NVARCHAR(50), MaterialNo NVARCHAR(100), MaterialName NVARCHAR(100), MaterialID UNIQUEIDENTIFIER, MainMaterial INT, MaterialSort NVARCHAR(5), StyleMaterialID UNIQUEIDENTIFIER, Placement NVARCHAR(MAX), WIDTH NVARCHAR(200), ImagePath NVARCHAR(500), ItemDim1Name NVARCHAR(100), ItemDim2Name NVARCHAR(100), ItemDim3Name NVARCHAR(100), MaterialQuantity NUMERIC(18, 4), MaterialDimension UNIQUEIDENTIFIER, Comments NVARCHAR(1020), UOM NVARCHAR(100), StyleSet INT, WorkFlowID UNIQUEIDENTIFIER, Dimension1 NVARCHAR(500), Dimension2 NVARCHAR(500), Dimension3 NVARCHAR(500), Dim1TypeSel INT, Dim2TypeSel INT, Dim3TypeSel INT, DimComboSort INT, WorkFlowItemID UNIQUEIDENTIFIER, ItemDim1Sort INT, ItemDim2Sort INT, ItemDim3Sort INT, HeaderColorName NVARCHAR(100), HeaderColorCode NVARCHAR(100), HeaderColorImagePath NVARCHAR(2000), MaterialColorId UNIQUEIDENTIFIER, ItemColorName NVARCHAR(100), ItemColorCode NVARCHAR(100), ItemColorImagePath NVARCHAR(2000), TreatmentSize NVARCHAR(100), DimensionsFlag NVARCHAR(10), ColorStatus 
				NVARCHAR(10), ConfigColumnName NVARCHAR(50), ConfigColumnValue NVARCHAR(50)
				)
		END
		...
		CREATE TABLE #tblFinalTableWithGroupID (
			GroupID INT NOT NULL IDENTITY(0, 1), SizeRowid BIGINT, MaterialType NVARCHAR(50), MaterialNo NVARCHAR(100), MaterialName NVARCHAR(100), MaterialID UNIQUEIDENTIFIER, MainMaterial INT, MaterialSort NVARCHAR(5), StyleMaterialID UNIQUEIDENTIFIER, Placement NVARCHAR(MAX), WIDTH NVARCHAR(200), ImagePath NVARCHAR(500), ItemDim1Name NVARCHAR(100), ItemDim2Name NVARCHAR(100), ItemDim3Name NVARCHAR(100), MaterialQuantity NUMERIC(18, 4), MaterialDimension UNIQUEIDENTIFIER, Comments NVARCHAR(1020), UOM NVARCHAR(100), StyleSet INT, WorkFlowID UNIQUEIDENTIFIER, Dimension1 NVARCHAR(500), Dimension2 NVARCHAR(500), Dimension3 NVARCHAR(500), Dim1TypeSel INT, Dim2TypeSel INT, Dim3TypeSel INT, DimComboSort INT, WorkFlowItemID UNIQUEIDENTIFIER, ItemDim1Sort INT, ItemDim2Sort INT, ItemDim3Sort INT, HeaderColorName NVARCHAR(100), HeaderColorCode NVARCHAR(100), HeaderColorImagePath NVARCHAR(2000), MaterialColorId UNIQUEIDENTIFIER, ItemColorName NVARCHAR(100), ItemColorCode NVARCHAR(100), ItemColorImagePath NVARCHAR(2000), TreatmentSize NVARCHAR(100), DimensionsFlag NVARCHAR(10), 
			ColorStatus NVARCHAR(10), ConfigColumnName NVARCHAR(50), ConfigColumnValue NVARCHAR(50)
			)

		INSERT INTO #tblFinalTableWithGroupID
		SELECT *
		FROM #tblFinalTable
		ORDER BY MainMaterial DESC, MaterialSort, MaterialNo, MaterialName, ItemDim1Sort, ItemDim2Sort, ItemDim3Sort, StyleMaterialId
	...
	BEGIN
		CREATE TABLE #tblFinalTable2 (
			SizeRowid INT NOT NULL IDENTITY(0, 1), MaterialType NVARCHAR(50), MaterialNo NVARCHAR(100), MaterialName NVARCHAR(100), MaterialID UNIQUEIDENTIFIER, MainMaterial INT, MaterialSort NVARCHAR(5), StyleMaterialID UNIQUEIDENTIFIER, Placement NVARCHAR(MAX), WIDTH NVARCHAR(200), ImagePath NVARCHAR(500), ItemDim1Name NVARCHAR(100), ItemDim2Name NVARCHAR(100), ItemDim3Name NVARCHAR(100), MaterialQuantity NUMERIC(18, 4), MaterialDimension UNIQUEIDENTIFIER, Comments NVARCHAR(1020), UOM NVARCHAR(100), StyleSet INT, WorkFlowID UNIQUEIDENTIFIER, Dimension1 NVARCHAR(500), Dimension2 NVARCHAR(500), Dimension3 NVARCHAR(500), Dim1TypeSel INT, Dim2TypeSel INT, Dim3TypeSel INT, DimComboSort INT, WorkFlowItemID UNIQUEIDENTIFIER, ItemDim1Sort INT, ItemDim2Sort INT, ItemDim3Sort INT, HeaderColorName NVARCHAR(100), HeaderColorCode NVARCHAR(100), HeaderColorImagePath NVARCHAR(2000), MaterialColorId UNIQUEIDENTIFIER, ItemColorName NVARCHAR(100), ItemColorCode NVARCHAR(100), ItemColorImagePath NVARCHAR(2000), TreatmentSize NVARCHAR(100), DimensionsFlag NVARCHAR(10), ColorStatus NVARCHAR
			(10), ConfigColumnName NVARCHAR(50), ConfigColumnValue NVARCHAR(50)
			)
...
VALUES ('DB_Version', '0.5.0000', '06508', GetDate())
GO
