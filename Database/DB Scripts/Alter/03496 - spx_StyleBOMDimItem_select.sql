IF EXISTS(SELECT * FROM INFORMATION_SCHEMA.ROUTINES WHERE SPECIFIC_NAME = N'spx_StyleBOMDimItem_select')
   DROP PROCEDURE spx_StyleBOMDimItem_select
GO
...
VALUES ('DB_Version', '5.0.0000', '03496', GetDate())
GO