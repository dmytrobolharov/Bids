...
IF EXISTS (SELECT * FROM sysobjects WHERE id = object_id('spx_Body_PatternSheet_Piece_INSERT') and sysstat & 0xf = 4)
    DROP PROCEDURE spx_Body_PatternSheet_Piece_INSERT
GO
...
VALUES     ('DB_Version', '4.0.0000', '01281', GetDate())
GO
