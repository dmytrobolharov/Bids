IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_StyleBOM_MaterialFromMaterial_UPDATE]') AND type = N'P' )
	DROP PROCEDURE [dbo].[spx_StyleBOM_MaterialFromMaterial_UPDATE]
GO
/****** Object:  StoredProcedure [dbo].[spx_StyleBOM_MaterialFromMaterial_UPDATE]    Script Date: 09/07/2011 16:03:42 ******/
SET ANSI_NULLS ON
GO
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='01908'))
BEGIN
	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '01908', GetDate())
END
