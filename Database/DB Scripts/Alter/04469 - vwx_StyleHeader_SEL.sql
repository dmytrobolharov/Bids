...
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.VIEWS WHERE TABLE_NAME = N'vwx_StyleHeader_SEL')
...
SELECT dbo.pStyleHeader.StyleID, dbo.pStyleHeader.StyleMasterID, dbo.pStyleHeader.StyleWorkflowID, dbo.pStyleHeader.StyleType, dbo.pStyleHeader.WorkflowType, 
	...
	dbo.pStyleHeader.StyleLinkID,dbo.pStyleHeader.OwnerGroup, dbo.pStyleHeader.UserCID, dbo.pStyleHeader.UserMID
...
VALUES ('DB_Version', '5.0.0000', '04469', GetDate())
GO
