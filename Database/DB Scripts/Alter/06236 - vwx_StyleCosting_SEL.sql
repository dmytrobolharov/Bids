...
FROM         dbo.pStyleCosting INNER JOIN
                      ...
                      dbo.pStyleCostingDuty ON dbo.pStyleCosting.StyleCostingHTS = dbo.pStyleCostingDuty.CustomID 
...
FROM         dbo.pStyleCostingScenarioItems INNER JOIN
                      ...
                      dbo.pStyleCostingDuty ON dbo.pStyleCostingScenarioItems.StyleCostingHTS = dbo.pStyleCostingDuty.CustomID 
...
VALUES ('DB_Version', '0.5.0.0000', '06236', GetDate())
GO
