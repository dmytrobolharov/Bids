/****** Object:  StoredProcedure [dbo].[spx_StyleHeaderLogic_UPDATE]    Script Date: 01/14/2015 16:24:25 ******/
...
BEGIN
	...
	-- if the syle has only one season year — change it to match the intro one
...
VALUES ('DB_Version', '6.1.0000', '09242', GetDate())
GO
