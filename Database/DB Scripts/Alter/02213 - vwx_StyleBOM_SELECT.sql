...
--
--
/****** Object:  View [dbo].[vwx_StyleBOM_SELECT]    Script Date: 11/28/2011 16:38:38 ******/
...
SELECT DISTINCT 
                      ...
                      dbo.pStyleBOM.StyleMaterialID, dbo.pStyleBOM.StyleMaterialMasterID, dbo.pStyleBOM.CopyStyleMaterialID, dbo.pStyleBOM.MainMaterial, 
                      dbo.pStyleBOM.Development, dbo.pStyleBOM.MiscColor, dbo.pStyleBOM.StyleSet, dbo.pStyleBOM.WorkflowId, dbo.pStyleBOM.WorkflowItemId, 
                      dbo.pStyleBOM.StyleBOMDimensionId, dbo.pStyleBOM.StyleID, dbo.pStyleBOM.UOM, dbo.pStyleBOM.MaterialColorId, dbo.pStyleBOM.Qty, 
                      dbo.pStyleBOM.MaterialPrice, dbo.pStyleBOM.Ext, dbo.pStyleBOM.MaterialSize, dbo.pStyleBOM.MaterialID, dbo.pStyleBOM.MaterialPlacement, 
                      dbo.pStyleBOM.MaterialPlacementCode, dbo.pStyleBOM.MaterialPlacementDetail, dbo.pStyleBOM.MaterialImageID, dbo.pStyleBOM.MaterialImageVersion, 
                      dbo.pStyleBOM.NoColorMatch, dbo.pStyleBOM.SupplierID, dbo.pStyleBOM.ComponentTypeID, dbo.pStyleBOM.MaterialType, dbo.pStyleBOM.MaterialNo, 
...
FROM         dbo.uTradePartnerVendor RIGHT OUTER JOIN
                      ...
                      dbo.uTradePartnerVendor.TradePartnerVendorID = dbo.pStyleBOM.TradePartnerVendorID

GO

IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02213'))
	BEGIN
		INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
		VALUES ('DB_Version', '4.1.0000', '02213', GetDate())
	END
GO
