IF OBJECT_ID(N'[dbo].[spx_StyleMeasChangeSizeRange_Insert]') IS NOT NULL
 DROP PROCEDURE [dbo].[spx_StyleMeasChangeSizeRange_Insert]
GO

CREATE PROCEDURE [dbo].[spx_StyleMeasChangeSizeRange_Insert]
(
...
VALUES ('DB_Version', '6.1.0000', '09541', GetDate())
GO
