IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_Style_Model_Insert]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_Style_Model_Insert]
GO
...
VALUES     ('DB_Version', '4.0.0000', '01502', GetDate())
GO