...
SELECT     sh.StyleNo, sh.Description, sh.SizeClass, sh.SizeRange, sc.StyleCostingCustomField2 AS Weight, sc.StyleCostingCustomField1 AS TargetRetail, 
					  ...
					  dbo.fnx_GetStreamingImagePath(i.ImageID, i.[Version]) AS FilePath
FROM         pStyleCostingDuty AS scd RIGHT OUTER JOIN
                      ...
                      pStyleHeader AS sh ON sc.StyleID = sh.StyleID ON scd.Custom = sc.StyleCostingHTS LEFT OUTER JOIN
...
VALUES ('DB_Version', '5.0.0000', '05103', GetDate())
GO
