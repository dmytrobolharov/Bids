/****** Object:  StoredProcedure [dbo].[spx_LineFolderStyleTypes_SELECT]    Script Date: 03/16/2013 15:41:27 ******/
...
BEGIN
	...
	SELECT dst.StyleTypeID, StyleTypeDescription, 
	IsChecked = CASE 
...
VALUES ('DB_Version', '0.5.0000', '05320', GetDate())
GO
