/****** Object:  View [dbo].[vwx_LineList_Style_Search_SEL]    Script Date: 03/26/2013 17:01:47 ******/
...
/****** Object:  View [dbo].[vwx_LineList_Style_Search_SEL]    Script Date: 03/26/2013 17:01:48 ******/
SET ANSI_NULLS ON
GO
...
SELECT     dbo.pStyleHeader.StyleID, dbo.pStyleHeader.StyleMasterID, dbo.pStyleHeader.StyleWorkflowID, dbo.pStyleHeader.StyleType, dbo.pStyleHeader.WorkflowType, 
                      ...
                      dbo.pStyleSeasonYear.SeasonYearID, dbo.pStyleSeasonYear.StyleSeasonYearID, dbo.pStyleHeader.IntroSeasonYearID, dbo.pStyleHeader.DivisionID, 
                      dbo.pStyleCategory.StyleCategory AS Category, ISNULL(dbo.pSeasonYear.Season + ' ', '') + ISNULL(dbo.pSeasonYear.Year, '') AS SeasonYearName
FROM         dbo.pStyleHeader INNER JOIN
                      ...
                      dbo.pStyleMaterials ON dbo.pStyleHeader.StyleMaterialID = dbo.pStyleMaterials.StyleMaterialID INNER JOIN
                      dbo.pSeasonYear ON dbo.pSeasonYear.SeasonYearID = dbo.pStyleSeasonYear.SeasonYearID

GO

INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
VALUES     ('DB_Version', '0.5.0000', '05409', GetDate())
GO
