/****** Object:  StoredProcedure [dbo].[spx_BatchQJob_AddBOMMaterial_EXECUTE]    Script Date: 12/17/2012 18:26:35 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_BatchQJob_AddBOMMaterial_EXECUTE]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_BatchQJob_AddBOMMaterial_EXECUTE]
GO
...
CREATE PROCEDURE [dbo].[spx_BatchQJob_AddBOMMaterial_EXECUTE](
...
SET @ServiceQueueSql1 = 'dbo.spx_BatchQJob_AddBOMMaterial_EXECUTE_QUEUE ' + 
@pBatchQueueJobID  + ',' + 
@pMDate 
...
VALUES     ('DB_Version', '5.0.0000', '04662', GetDate())
GO
