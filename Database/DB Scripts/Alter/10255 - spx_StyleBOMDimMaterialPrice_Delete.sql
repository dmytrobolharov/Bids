IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_StyleBOMDimMaterialPrice_Delete]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_StyleBOMDimMaterialPrice_Delete]
GO


CREATE PROCEDURE [dbo].[spx_StyleBOMDimMaterialPrice_Delete] (
...
VALUES ('DB_Version', '6.1.0000', '10255', GetUTCDate())
GO
