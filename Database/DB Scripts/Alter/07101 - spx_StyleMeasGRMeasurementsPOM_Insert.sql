...
AND (@OldAMLMeasHdrId IS NULL OR POMTempItemID IN 
	(SELECT GRPOMCompanyId FROM pAMLMeasPOM WHERE AMLMeasHdrId = @OldAMLMeasHdrId AND GRPOMCompanyId IS NOT NULL)) -- WI#22831
...
VALUES ('DB_Version', '0.5.0000', '07101', GetDate())
GO
