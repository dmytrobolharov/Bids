...
/****** Object:  View [dbo].[vwx_SourcingCostOptionDetail]    Script Date: 01/24/2013 19:09:17 ******/
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vwx_SourcingCostOptionDetail]'))
DROP VIEW [dbo].[vwx_SourcingCostOptionDetail]
GO
...
CREATE VIEW [dbo].[vwx_SourcingCostOptionDetail]
AS
SELECT     TOP (100) PERCENT dbo.pSourcingCostOptionDetail.SourcingCostOptionDetailID, dbo.pSourcingCostOptionDetail.SourcingCostOptionId, 
                      ...
                      dbo.pSourcingQuotationBOMDetails.ItemDim2Active, dbo.pSourcingQuotationBOMDetails.ItemDim3Active, dbo.pSourcingCostOption.OptionName
...
ORDER BY dbo.pSourcingCostOption.OptionNo

GO
INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
VALUES     ('DB_Version', '5.0.0000', '04890', GetDate())
GO
