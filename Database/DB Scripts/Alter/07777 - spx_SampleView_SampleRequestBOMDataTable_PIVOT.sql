...
AND StyleTypeID IN (  SELECT StyleTypeID FROM sAccessStyleFolder WHERE TeamId = @TeamId AND (AccessRoleId = 3 OR AccessCreate = 1 ) )
...
VALUES ('DB_Version', '0.5.0000', '07777', GetDate())
GO