/****** Object:  StoredProcedure [dbo].[spx_StyleColorwayImages_SELECT_API]    Script Date: 11/15/2013 15:52:52 ******/
...
BEGIN
	...
	select COUNT(*) as amount from pStyleWorkflow where WorkflowID='40000000-0000-0000-0000-000000000888' and StyleID=@StyleID
END

GO

INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
VALUES     ('DB_Version', '0.5.0000', '06605', GetDate())
GO
