/****** Object:  StoredProcedure [dbo].[spx_MaterialRequestTemp_NewTradePartner_CREATE_INSERT]    Script Date: 02/28/2013 13:51:37 ******/
...
BEGIN 
	...
	WHERE MaterialID = @MaterialID AND TradePartnerID = @TradePartnerID 
	...
	BEGIN
		...
		EXEC dbo.spx_MaterialRequestWorkflow_ShareRequestHeader_UPDATE @MaterialTradePartnerID = @MaterialTradePartnerID
	...
	BEGIN
		...
		BEGIN 
			...
			EXEC dbo.spx_MaterialRequestWorkflow_ShareRequest_UPDATE @MaterialTradePartnerID = @MaterialTradePartnerID,
			@MaterialTradePartnerColorID = @MaterialTradePartnerColorID
...
VALUES ('DB_Version', '5.0.0000', '05193', GetDate())
