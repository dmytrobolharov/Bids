IF OBJECT_ID(N'[dbo].[spx_Material_TradePartnerColorAvaliable_SELECT]') IS NOT NULL
 DROP PROCEDURE [dbo].[spx_Material_TradePartnerColorAvaliable_SELECT]
GO

CREATE PROCEDURE [dbo].[spx_Material_TradePartnerColorAvaliable_SELECT] (
...
VALUES ('DB_Version', '6.1.0000', '10362', GetUTCDate())
GO
