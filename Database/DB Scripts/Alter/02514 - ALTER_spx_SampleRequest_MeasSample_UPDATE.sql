...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'spx_SampleRequest_MeasSample_UPDATE') AND type = N'P' )
...
VALUES              ('DB_Version', '4.1.0000', '02514', GetDate())
GO
