IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[rpx_SampleRequestSubmit_Decimals_SELECT]') AND type = N'P' )
...
VALUES     ('DB_Version', '4.1.0000', '03133', GetDate())
GO