/****** Object:  StoredProcedure [dbo].[spx_TACalendar_ImageWorkflowReferences_Progress_UPDATE]    Script Date: 08/21/2014 19:11:25 ******/
...
BEGIN
	...
	INNER JOIN pTATaskWorkflow tw ON tw.TATaskWorkflowId = tt.TaskWorkflowId AND UPPER(tw.WorkflowFolder) = 'IMAGE'
	...
	AND (cr.ReferenceId = @ImageID OR @ImageID IS NULL)
	AND (tw.WorkflowId = @ImageWorkflowTemplateItemID OR @ImageWorkflowTemplateItemID IS NULL)
...
VALUES ('DB_Version', '6.0.0000', '08933', GetDate())
GO
