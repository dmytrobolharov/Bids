/****** Object:  StoredProcedure [dbo].[spx_TACalendar_SourcingQuoteWorkflowReferences_Progress_UPDATE]    Script Date: 09/19/2014 14:44:45 ******/
...
BEGIN
	...
	INNER JOIN pTATaskWorkflow tw ON tw.TATaskWorkflowId = tt.TaskWorkflowId AND UPPER(tw.WorkflowFolder) = 'SOURCING QUOTATION'
	...
	AND (cr.ReferenceId = @StyleQuoteItemID OR @StyleQuoteItemID IS NULL)
...
VALUES   ('DB_Version', '6.0.0000', '09126', GetDate())
GO