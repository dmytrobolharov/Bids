/****** Object:  StoredProcedure [dbo].[spx_SourcingStyle_Quote_SELECT]    Script Date: 11/29/2012 12:04:43 ******/
...
BEGIN
	...
	INNER JOIN @Partners p ON p.SourcingTradePartnerID = pStyleQuoteItem.StyleQuoteTradePartnerID
...
VALUES ('DB_Version', '5.0.0000', '04487', GetDate())
GO