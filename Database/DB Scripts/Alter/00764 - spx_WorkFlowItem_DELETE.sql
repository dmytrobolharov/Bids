...
BEGIN
	...
	DELETE FROM pWorkFlowItem WHERE WorkFlowItemID = @WorkFlowItemId

	IF @@Error <> 0 OR @@RowCount <> 1 GOTO Error
	If @WorkFlowId = '80000000-0000-0000-0000-000000000008' 
		BEGIN
			DELETE FROM pConPageDetail WHERE WorkFlowItemID = @WorkFlowItemId
		END
...
VALUES     ('DB_Version', '4.0.0000', '764', GetDate())
