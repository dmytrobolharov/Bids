...
/****** Object:  Table [dbo].[pSourcingStyleBOMOptionItems]    Script Date: 11/19/2012 16:54:00 ******/
...
CREATE TABLE [dbo].[pSourcingStyleBOMOptionItems](
	...
	[AUTOCOLOR] [int] NULL,
 CONSTRAINT [PK_pSourcingStyleBOMOptionItems] PRIMARY KEY CLUSTERED 
(
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'pSourcingStyleBOMOptionItems', @level2type=N'COLUMN',@level2name=N'MaterialSizeA10'
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_StyleOptionItemID]  DEFAULT (newsequentialid()) FOR [StyleOptionItemID]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MainMaterial]  DEFAULT ((0)) FOR [MainMaterial]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_Artwork]  DEFAULT ((1)) FOR [Artwork]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_License]  DEFAULT ((1)) FOR [License]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_Colorway]  DEFAULT ((1)) FOR [Colorway]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSort]  DEFAULT ('0000') FOR [MaterialSort]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialTrack]  DEFAULT ((1)) FOR [MaterialTrack]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialLinked]  DEFAULT ((1)) FOR [MaterialLinked]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialDimension]  DEFAULT ((0)) FOR [MaterialDimension]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeA0]  DEFAULT ((0)) FOR [MaterialSizeA0]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeA1]  DEFAULT ((0)) FOR [MaterialSizeA1]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeA2]  DEFAULT ((0)) FOR [MaterialSizeA2]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeA3]  DEFAULT ((0)) FOR [MaterialSizeA3]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeA4]  DEFAULT ((0)) FOR [MaterialSizeA4]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeA5]  DEFAULT ((0)) FOR [MaterialSizeA5]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeA6]  DEFAULT ((0)) FOR [MaterialSizeA6]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeA7]  DEFAULT ((0)) FOR [MaterialSizeA7]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeA8]  DEFAULT ((0)) FOR [MaterialSizeA8]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeA9]  DEFAULT ((0)) FOR [MaterialSizeA9]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeA10]  DEFAULT ((0)) FOR [MaterialSizeA10]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeA11]  DEFAULT ((0)) FOR [MaterialSizeA11]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeA13]  DEFAULT ((0)) FOR [MaterialSizeA13]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeA14]  DEFAULT ((0)) FOR [MaterialSizeA14]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeA15]  DEFAULT ((0)) FOR [MaterialSizeA15]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeA16]  DEFAULT ((0)) FOR [MaterialSizeA16]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeA17]  DEFAULT ((0)) FOR [MaterialSizeA17]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeA18]  DEFAULT ((0)) FOR [MaterialSizeA18]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeA19]  DEFAULT ((0)) FOR [MaterialSizeA19]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeB0]  DEFAULT ((0)) FOR [MaterialSizeB0]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeB1]  DEFAULT ((0)) FOR [MaterialSizeB1]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeB2]  DEFAULT ((0)) FOR [MaterialSizeB2]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeB3]  DEFAULT ((0)) FOR [MaterialSizeB3]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeB4]  DEFAULT ((0)) FOR [MaterialSizeB4]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeB5]  DEFAULT ((0)) FOR [MaterialSizeB5]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeB6]  DEFAULT ((0)) FOR [MaterialSizeB6]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeB7]  DEFAULT ((0)) FOR [MaterialSizeB7]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeB8]  DEFAULT ((0)) FOR [MaterialSizeB8]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeB9]  DEFAULT ((0)) FOR [MaterialSizeB9]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeB10]  DEFAULT ((0)) FOR [MaterialSizeB10]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeB11]  DEFAULT ((0)) FOR [MaterialSizeB11]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeB12]  DEFAULT ((0)) FOR [MaterialSizeB12]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeB13]  DEFAULT ((0)) FOR [MaterialSizeB13]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeB14]  DEFAULT ((0)) FOR [MaterialSizeB14]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeB15]  DEFAULT ((0)) FOR [MaterialSizeB15]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeB16]  DEFAULT ((0)) FOR [MaterialSizeB16]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeB17]  DEFAULT ((0)) FOR [MaterialSizeB17]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeB18]  DEFAULT ((0)) FOR [MaterialSizeB18]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialSizeB19]  DEFAULT ((0)) FOR [MaterialSizeB19]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialLining]  DEFAULT ((0)) FOR [MaterialLining]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MaterialBOM]  DEFAULT ((1)) FOR [MaterialBOM]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_MultiCloth]  DEFAULT ((0)) FOR [MultiCloth]
GO

ALTER TABLE [dbo].[pSourcingStyleBOMOptionItems] ADD  CONSTRAINT [DF_pSourcingStyleBOMOptionItems_AUTOCOLOR] DEFAULT ((0)) FOR [AUTOCOLOR]
GO



INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
VALUES     ('DB_Version', '5.0.0000', '04383', GetDate())
GO