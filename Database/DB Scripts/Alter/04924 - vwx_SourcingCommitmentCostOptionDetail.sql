/****** Object:  View [dbo].[vwx_SourcingCommitmentCostOptionDetail]    Script Date: 01/30/2013 16:18:36 ******/
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vwx_SourcingCommitmentCostOptionDetail]'))
DROP VIEW [dbo].[vwx_SourcingCommitmentCostOptionDetail]
GO
...
CREATE VIEW [dbo].[vwx_SourcingCommitmentCostOptionDetail]
AS
SELECT     TOP (100) PERCENT dbo.pSourcingCommitmentCostOptionDetail.SourcingCommitmentCostOptionDetailID, 
                      ...
                      dbo.pSourcingCommitmentBOMDetails.ItemDim3Active, dbo.pSourcingCommitmentCostOption.OptionName
...
ORDER BY dbo.pSourcingCommitmentCostOption.OptionNo

GO

INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
VALUES ('DB_Version', '5.0.0000', '04924', GetDate())
GO