...
/****** Object:  View [dbo].[vwx_ImageCatalog_SELECT_API]    Script Date: 11/15/2013 03:02:21 ******/
...
(SELECT d.ImageCatalogID as  ImageCatalogID2,  b.CountOfType, COALESCE(p.ImageID,'00000000-0000-0000-0000-000000000000') as MostRecentlyModifiedImage,  p.mdate as LastModifiedDate, p.Version , 
					 ...
					 (SELECT  i.ImageCatalogID,   COUNT(DISTINCT e.ImageID) as CountOfType
...
VALUES     ('DB_Version', '0.5.0000', '06598', GetDate())
GO
