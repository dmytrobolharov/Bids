IF OBJECT_ID(N'[dbo].[spx_SampleRequest_TradePartner_DataTable_PIVOT]') IS NOT NULL
 DROP PROCEDURE [dbo].[spx_SampleRequest_TradePartner_DataTable_PIVOT]
GO

CREATE PROCEDURE [dbo].[spx_SampleRequest_TradePartner_DataTable_PIVOT]
(
...
AS
	...
	BEGIN  
		...
		+  
		CASE   
		WHEN d.ApprovedType = 1 THEN ISNULL(CONVERT(nVARCHAR(12),a.EndDate , 107),'NODATE')  
		WHEN a.Status = 4 THEN ISNULL(CONVERT(nVARCHAR(12),a.MDate , 107),'NODATE')  
		ELSE ISNULL(CONVERT(nVARCHAR(12),a.DueDate , 107),'NODATE')  
		END   
		+ '&nbsp;<b>('   
		...
		+ ''',  ''width=1024, height=700, location=yes, menubar=yes, status=yes, toolbar=yes, scrollbars=yes, resizable=yes'' '   
		+ ' );" >  '   
		+  ISNULL(CONVERT(nVARCHAR(12),g.DueDate , 107),'NODATE')+  '</a></TD></TR></TABLE>'  
		END AS TechPack,  
	...
	BEGIN  
		...
		+  
		CASE   
		WHEN d.ApprovedType = 1 THEN ISNULL(CONVERT(nVARCHAR(12),a.EndDate , 107),'NODATE') --CONVERT ( NVARCHAR(50), a.EndDate , 101)   
		WHEN a.Status = 4 THEN ISNULL(CONVERT(nVARCHAR(12),a.MDate, 107),'NODATE')--CONVERT ( NVARCHAR(50), a.MDate , 101)  
		ELSE ISNULL(CONVERT(nVARCHAR(12),a.DueDate, 107),'NODATE') --CONVERT ( NVARCHAR(50), a.DueDate , 101)  
		END   
		+ '&nbsp;<b>('   
		+  CAST(a.Submit AS NVARCHAR(5)) + ')</b></a></TD></TR></TABLE>'  
...
VALUES ('DB_Version', '6.1.0000', '09677', GetDate())
GO
