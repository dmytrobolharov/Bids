/****** Object:  Trigger [tgx_pComponentType_PermissionMapping_UPDATE]    Script Date: 16.02.2015 15:20:09 ******/
...
/****** Object:  Trigger [dbo].[tgx_pComponentType_PermissionMapping_UPDATE]    Script Date: 16.02.2015 15:20:09 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	BEGIN TRY
		UPDATE ppt
		SET Active = ct.Active, PermissionProductTypeName = ct.ComponentDescription
...
VALUES ('DB_Version', '6.1.0000', '09364', GetDate())
GO