...
BEGIN
	...
	INSERT INTO tmpMaterialTradePartner(MaterialID, TradePartnerRelationshipLevelID, StartDate, CDate)
	VALUES(@MaterialID, @TradePartnerRelationshipLevelID, GETDATE(), GETDATE())
...
VALUES ('DB_Version', '0.5.0000', '06161', GetDate())
GO
