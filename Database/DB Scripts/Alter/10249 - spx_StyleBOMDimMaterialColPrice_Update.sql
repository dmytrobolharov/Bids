IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_StyleBOMDimMaterialColPrice_Update]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_StyleBOMDimMaterialColPrice_Update]
GO



CREATE PROCEDURE [dbo].[spx_StyleBOMDimMaterialColPrice_Update] (
...
VALUES ('DB_Version', '6.1.0000', '10249', GetUTCDate())
GO
