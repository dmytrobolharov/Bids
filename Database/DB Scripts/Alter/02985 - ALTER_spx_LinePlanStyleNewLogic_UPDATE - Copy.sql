...
IF EXISTS (select * from sysobjects where id = object_id('spx_LinePlanStyleNewLogic_UPDATE') and sysstat & 0xf = 4)
    drop procedure spx_LinePlanStyleNewLogic_UPDATE
GO
...
CREATE PROCEDURE spx_LinePlanStyleNewLogic_UPDATE
(
...
VALUES ('DB_Version', '4.2.0000', '02985', GetDate())
GO
