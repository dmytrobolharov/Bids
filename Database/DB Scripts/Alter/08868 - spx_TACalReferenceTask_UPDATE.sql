...
where tw.WorkflowFolder='MATERIAL' and tt.TACalTemplateId=@TACalTemplateId  
	and ((tt.New=1 AND @SeasonYearId = ISNULL(mt.IntroSeasonYearID, '00000000-0000-0000-0000-000000000000')) 
	OR (tt.CarryOver = 1 AND @SeasonYearId <> ISNULL(mt.IntroSeasonYearID, '00000000-0000-0000-0000-000000000000')))  and tt.TACalTemplateTaskId = @TACalTemplateTaskID 
...
VALUES ('DB_Version', '6.0.0000', '08868', GetDate())
GO
