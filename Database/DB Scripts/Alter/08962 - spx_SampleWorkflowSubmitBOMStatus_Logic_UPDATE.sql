/****** Object:  StoredProcedure [dbo].[spx_SampleWorkflowSubmitBOMStatus_Logic_UPDATE]    Script Date: 08/22/2014 12:08:08 ******/
...
BEGIN
	...
	BEGIN
		...
		---** Submit disapproved
		---***
		UPDATE pSampleRequestSubmitBOM SET EndDate = NULL, EndBy = NULL WHERE SampleRequestSubmitID = @SampleRequestSubmitID
	END
...
VALUES ('DB_Version', '6.0.0000', '08962', GetDate())
GO
