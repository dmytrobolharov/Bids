/****** Object:  View [dbo].[vwx_ChangeLogItem_SEL]    Script Date: 09/03/2012 14:09:17 ******/
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vwx_ChangeLogItem_SEL]'))
DROP VIEW [dbo].[vwx_ChangeLogItem_SEL]
GO

/****** Object:  View [dbo].[vwx_ChangeLogItem_SEL]    Script Date: 09/03/2012 14:09:18 ******/
SET ANSI_NULLS ON
GO
...
SELECT     b.ChangeTableID, b.ChangeTablePKID, b.ChangeUserName, b.ChangeDate, a.ChangeLogItemID, a.ChangeTransID, a.ChangeLogID, a.ChangeFieldName, 
                      ...
                      c.ChangeSessionNo, c.ChangeTransNo, e.WorkflowID, e.Workflow
...
VALUES              ('DB_Version', '5.0.0000', '03845', GetDate())
GO