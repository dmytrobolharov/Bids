...
#03 - Ryan Cabanas - November 17, 2009
...
/************************/
BEGIN
	IF(@TradePartnerID IS NULL OR @TradePartnerID = '00000000-0000-0000-0000-000000000000' OR @TradePartnerID = '')		--Comment #03
		BEGIN
...
VALUES ('DB_Version', '4.1.0000', '02196', GetDate())
GO