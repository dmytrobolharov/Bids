/****** Object:  StoredProcedure [dbo].[spx_SampleRequestSilhoBOMDataTable_PIVOT]    Script Date: 07/01/2013 11:50:13 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_SampleRequestSilhoBOMDataTable_PIVOT]') AND type in (N'P', N'PC'))
...
VALUES ('DB_Version', '0.5.0000', '05935', GetDate())
GO
