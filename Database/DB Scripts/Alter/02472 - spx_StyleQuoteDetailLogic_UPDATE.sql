 ...
 BEGIN      
  ...
  IF (@QuoteDetail_StyleQuoteItemCustomField14 IS NULL OR @QuoteDetail_StyleQuoteItemCustomField14 = 0)      
   SET @QuoteDetail_StyleQuoteItemCustomField15 = 0      
    ELSE     
  SET @QuoteDetail_StyleQuoteItemCustomField15 = (@QuoteDetail_StyleQuoteItemCustomField2 - @QuoteDetail_StyleQuoteItemCustomField14) / @QuoteDetail_StyleQuoteItemCustomField14     
  ...
  ELSE      
   SET @QuoteDetail_StyleQuoteItemCustomField17 = (@QuoteDetail_StyleQuoteItemCustomField6 - @QuoteDetail_StyleQuoteItemCustomField2)      
               / @QuoteDetail_StyleQuoteItemCustomField2     
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02472'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '02472', GetDate())
