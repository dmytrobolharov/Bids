...
IF NOT EXISTS(SELECT * FROM sSystemPage WHERE MappingPage='Style_DesignDetail_MultigridCustom.aspx')
	BEGIN
		INSERT INTO [sSystemPage] (MappingPage, CDate, CUser, sSystemFolderID)
		VALUES ('Style_DesignDetail_MultigridCustom.aspx', GETDATE(), 'Administrator', (SELECT sSystemFolderID from sSystemFolder where sSystemFolder='Style'))
	END

IF NOT EXISTS(SELECT * FROM sSystemPage WHERE MappingPage='Style_DesignDetail_MultigridCustom_Edit.aspx')
	BEGIN
		INSERT INTO [sSystemPage] (MappingPage, CDate, CUser, sSystemFolderID)
		VALUES ('Style_DesignDetail_MultigridCustom_Edit.aspx', GETDATE(), 'Administrator', (SELECT sSystemFolderID from sSystemFolder where sSystemFolder='Style'))
	END
...
VALUES     ('DB_Version', '5.0.0000', '04388', GetDate())
GO
