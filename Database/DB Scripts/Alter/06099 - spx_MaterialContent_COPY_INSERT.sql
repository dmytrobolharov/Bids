...
BEGIN
	...
	***************************/
	...
	INSERT INTO @MaterialTradePartner(TradePartnerRelationshipLevelID)
	SELECT TradePartnerRelationshipLevelID FROM tmpMaterialTradePartner WHERE MaterialID = @MasterMaterialID
	...
	BEGIN
		...
		BEGIN
			...
			BEGIN
				...
				exec spx_MaterialRequestTemp_INSERT
					@MaterialRequestGroupID = @MaterialRequestGroupID,
					@MaterialID = @MaterialID,
				...
				DECLARE @MaterialRequestWorkflowTempID UNIQUEIDENTIFIER,
						@MaterialRequestWorkflowStartDate DATETIME,
...
VALUES     ('DB_Version', '0.5.0000', '06099', GetDate())
GO
