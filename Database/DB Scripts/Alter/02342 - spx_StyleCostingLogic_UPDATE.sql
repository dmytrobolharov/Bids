 ...
 BEGIN    
  ...
  IF (@pStyleCosting_StyleCostingCustomField14 IS NULL OR @pStyleCosting_StyleCostingCustomField14 = 0)    
   SET @pStyleCosting_StyleCostingCustomField23 = 0    
    ELSE   
  SET @pStyleCosting_StyleCostingCustomField23 = (@pStyleCosting_StyleCostingCustomField15 - @pStyleCosting_StyleCostingCustomField14) / @pStyleCosting_StyleCostingCustomField14   
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02342'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '02342', GetDate())
