...
IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[DF_pSampleRequestMaterialBOM_SampleRequestMaterialID]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[pSampleRequestMaterialBOM] DROP CONSTRAINT [DF_pSampleRequestMaterialBOM_SampleRequestMaterialID]
END
...
/****** Object:  Table [dbo].[pSampleRequestMaterialBOM]    Script Date: 12/18/2011 17:47:33 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[pSampleRequestMaterialBOM]') AND type in (N'U'))
DROP TABLE [dbo].[pSampleRequestMaterialBOM]
GO


/****** Object:  Table [dbo].[pSampleRequestMaterialBOM]    Script Date: 12/18/2011 17:47:37 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[pSampleRequestMaterialBOM](
	...
	[height] [nvarchar](18) NULL,
	[width] [nvarchar](18) NULL,
	[CDate] [datetime] NULL,
	...
	[SourcingTradePartnerVendorID] [uniqueidentifier] NULL,
	[StyleSourcingID] [uniqueidentifier] NULL,
 CONSTRAINT [PK_pSampleRequestMaterialBOM] PRIMARY KEY CLUSTERED 
(
...
ALTER TABLE [dbo].[pSampleRequestMaterialBOM] ADD  CONSTRAINT [DF_pSampleRequestMaterialBOM_SampleRequestMaterialID]  DEFAULT (newid()) FOR [SampleRequestMaterialID]
GO


IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02357'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '02357', GetDate())
