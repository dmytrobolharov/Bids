IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_StyleBOMPending_SELECT]') AND type in (N'P', N'PC'))
...
VALUES     ('DB_Version', '0.5.0000', '06643', GetDate())
GO
