/****** Object:  View [dbo].[vwx_LineFolderSKUHeader_StyleSKU_Matching_SEL]    Script Date: 06/30/2014 16:36:23 ******/
...
SELECT DISTINCT 
  ...
  ssh.PlanningID, lfsh.LineFolderSKUHeaderID, wfi.WorkFlowItemName, wfi.StyleID
...
VALUES ('DB_Version', '0.5.0000', '08176', GetDate())
GO
