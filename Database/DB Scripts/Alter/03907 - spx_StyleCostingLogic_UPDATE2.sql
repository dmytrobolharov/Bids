...
SELECT @pStyleCosting_AdditionalCost = SUM(AdditionalCost) 
...
SELECT @pStyleCosting_StyleCostingTypeId = StyleCostingTypeId
 ,@pStyleCosting_StyleCostingCustomField3 = ISNULL(StyleCostingCustomField3, 0)
 ,@pStyleCosting_StyleCostingCustomField4 = ISNULL(StyleCostingCustomField4, 0)
 ...
 ,@pStyleCosting_StyleCostingCustomField15 = ISNULL(StyleCostingCustomField15, 0)
 ,@pStyleCosting_StyleCostingCustomField16 = ISNULL(StyleCostingCustomField16, 0)
FROM pStyleCosting
WHERE StyleCostingId = @StyleCostingId
...
SET @pStyleCosting_StyleCostingCustomField37 = @pStyleCosting_StyleCostingCustomField16 - @pStyleCosting_StyleCostingCustomField15
...
VALUES     ('DB_Version', '5.0.0000', '03907', GetDate())
GO
