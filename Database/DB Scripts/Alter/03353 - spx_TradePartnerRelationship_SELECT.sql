...
SELECT     uTradePartner.TradePartnerID, uTradePartner.TradePartnerCode, uTradePartner.TradePartnerName,
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='03353'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '5.0.0000', '03353', GetDate())
