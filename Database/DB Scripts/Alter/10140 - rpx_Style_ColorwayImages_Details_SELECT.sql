IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[rpx_Style_ColorwayImages_Details_SELECT]') AND type in (N'P', N'PC'))
...
VALUES ('DB_Version', '6.1.0000', '10140', GetUTCDate())
GO