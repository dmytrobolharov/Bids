IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_StyleBOMDimMaterialSize_Delete]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_StyleBOMDimMaterialSize_Delete]
GO


Create PROCEDURE [dbo].[spx_StyleBOMDimMaterialSize_Delete] (
...
VALUES ('DB_Version', '6.1.0000', '10262', GetUTCDate())
GO
