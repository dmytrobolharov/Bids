...
IF @StyleCostingType = 1   -- IMPORT
 BEGIN      
  ...
  IF @QuoteDetail_StyleQuoteItemCustomField6 IS NULL OR @QuoteDetail_StyleQuoteItemCustomField6 = 0
   SET @QuoteDetail_StyleQuoteItemCustomField17 = 0      
  ELSE      
   SET @QuoteDetail_StyleQuoteItemCustomField17 = (@QuoteDetail_StyleQuoteItemCustomField6 - @QuoteDetail_StyleQuoteItemCustomField2) / @QuoteDetail_StyleQuoteItemCustomField6     
...
VALUES     ('DB_Version', '5.0.0000', '04459', GetDate())
GO
