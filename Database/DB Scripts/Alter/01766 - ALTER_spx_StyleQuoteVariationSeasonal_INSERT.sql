...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_StyleQuoteVariationSeasonal_INSERT]') AND type = N'P' )
...
IF (SELECT Count(*) 
	...
	BEGIN
		...
		SELECT @StyleQuoteItemCustomField2 = ISNULL(StyleCostingCustomField15, 0)
			  ...
			  ,@StyleQuoteItemCustomField15 = ISNULL(StyleCostingCustomField17, 0)
...
VALUES              ('DB_Version', '4.1.0000', '01766', GetDate())
GO
