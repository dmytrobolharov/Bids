...
SET @DVTableName = 'ComponentSizeHeaderName'
SET @ControlPanelName = 'Component Size Header Name'
...
BEGIN
	...
	-- Add records.
    INSERT INTO dvtComponentSizeHeaderName (ItemValue, ItemKey, Active, CUser, CDate, MUser, MDate, ItemSort)
    VALUES ('Size', 'Size', 1, 'administrator', getutcdate(), 'administrator', getutcdate(), '00001')

    INSERT INTO dvtComponentSizeHeaderName (ItemValue, ItemKey, Active, CUser, CDate, MUser, MDate, ItemSort)
    VALUES ('Treatment', 'Treatment', 1, 'administrator', getutcdate(), 'administrator', getutcdate(), '00002')
...
VALUES              ('DB_Version', '6.0.0000', '09014', GetDate())
GO
