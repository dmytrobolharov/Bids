IF OBJECT_ID(N'[dbo].[spx_StyleMeasChangeSizeClass_Insert]') IS NOT NULL
 DROP PROCEDURE [dbo].[spx_StyleMeasChangeSizeClass_Insert]
GO
...
VALUES ('DB_Version', '6.1.0000', '09540', GetDate())
GO
