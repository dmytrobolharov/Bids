/****** Object:  View [dbo].[vwx_TACalTemplateTask_ReferenceFromSampleRequest_SELECT]    Script Date: 08/01/2014 19:20:20 ******/
...
bdi.ItemDim1Name, bdi.ItemDim2Name, bdi.Itemdim3name,sw.SampleWorkflowID,
...
NULL AS ItemDim1Name, NULL AS ItemDim2Name, NULL AS ItemDim3Name, sw.SampleWorkflowID,
tpm.TradePartnerID, tpm.RelationshipLevelID, tpm.AgentID, tpm.AgentName, tpm.VendorID, tpm.VendorName, tpm.FactoryID, tpm.FactoryName
from pTACalReferenceTask crt
INNER JOIN pTACalReference cr ON crt.TACalReferenceId = cr.TACalReferenceId
...
VALUES ('DB_Version', '0.5.0000', '08520', GetDate())
GO
