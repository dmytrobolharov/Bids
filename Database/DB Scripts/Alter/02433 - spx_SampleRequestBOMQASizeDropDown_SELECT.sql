...
/****** Object:  StoredProcedure [dbo].[spx_SampleRequestBOMQASizeDropDown_SELECT]    Script Date: 12/18/2011 18:52:52 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_SampleRequestBOMQASizeDropDown_SELECT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_SampleRequestBOMQASizeDropDown_SELECT]
GO
...
Create PROCEDURE [dbo].[spx_SampleRequestBOMQASizeDropDown_SELECT]
(
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02433'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '02433', GetDate())
