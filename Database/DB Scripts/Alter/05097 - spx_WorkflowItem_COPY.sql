/****** Object:  StoredProcedure [dbo].[spx_WorkflowItem_COPY]    Script Date: 02/22/2013 12:09:45 ******/
...
BEGIN  
 ...
 IF @@Error <> 0 OR @@RowCount <> 1 GOTO Error  
  ...
  END  
  Else If @WorkflowID='40000000-0000-0000-0000-000000000023'
  BEGIN
	EXEC spx_Style_Marker_Copy @StyleID=@CopyStyleID, 
								@StyleSet=@CopyStyleSet, 
								@NewStyleID=@StyleID,
  ...
  Else If @WorkflowID = '40000000-0000-0000-0000-000000000037'
  BEGIN
	EXEC spx_Style_Model_Copy @StyleID=@CopyStyleID, 
								@StyleSet=@CopyStyleSet, 
								@NewStyleID=@StyleID,
								@NewStyleSet = @StyleSet,
								@MUser = @CUser,
...
VALUES ('DB_Version', '5.0.0000', '05097', GetDate())
GO
