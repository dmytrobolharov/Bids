...
/****** Object:  StoredProcedure [dbo].[spx_SampleRequestAgentNew_SELECT]    Script Date: 01/31/2012 23:20:56 ******/
...
BEGIN
    ...
    SET @SQLColumnString = ' SELECT a.SampleRequestTradeID, a.CDate, b.StyleID,
                            ...
                            c.VendorName, a.TradePartnerID, c.VendorCode, d.StyleSet,MAX(d.EndDate) AS ''EndDate'''
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='03066'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.2.0000', '03066', GetDate())
