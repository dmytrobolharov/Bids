...
AS
SELECT DISTINCT TOP (100) PERCENT sh.StyleID, ssy.SeasonYearID, sh.StyleNo, sh.Description, 
       sh.StyleCategory, sc.StyleCategory AS 'ProductCategoryName', 
	   sh.SizeClassId, scc.Custom AS SizeClass, sh.SizeRangeId, sr.SizeRangeCode AS SizeRange, 
...
VALUES ('DB_Version', '6.1.0000', '10316', GetUTCDate())
GO
