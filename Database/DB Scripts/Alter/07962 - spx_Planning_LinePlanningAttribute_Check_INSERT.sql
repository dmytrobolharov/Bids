...
BEGIN
	...
	DELETE FROM pPlanningBusiness WHERE PlanningID = @PlanningID AND SeasonYearID = @SeasonYearID AND PlanningBrandID IS NULL
...
VALUES ('DB_Version', '0.5.0000', '07962', GetDate())
GO
