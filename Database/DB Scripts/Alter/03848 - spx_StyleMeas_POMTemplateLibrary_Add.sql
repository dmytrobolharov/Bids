...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_StyleMeas_POMTemplateLibrary_Add]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_StyleMeas_POMTemplateLibrary_Add]
GO
...
Create PROCEDURE [dbo].[spx_StyleMeas_POMTemplateLibrary_Add]
(
...
VALUES              ('DB_Version', '5.0.0000', '03848', GetDate())
GO
