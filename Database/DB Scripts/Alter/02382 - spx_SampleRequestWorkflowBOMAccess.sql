...
--
--
/****** Object:  StoredProcedure [dbo].[spx_SampleRequestWorkflowBOMAccess]    Script Date: 12/18/2011 18:10:35 ******/
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02382'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '02382', GetDate())
