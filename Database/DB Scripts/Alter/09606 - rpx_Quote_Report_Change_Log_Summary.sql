IF OBJECT_ID(N'[dbo].[rpx_Quote_Report_Change_Log_Summary]') IS NOT NULL
...
BEGIN
	...
	GROUP BY
		...
		, soh.SourcingName, sh.StyleNo, sh.Description, COALESCE(scc.Custom, sh.SizeClass), sh.StyleCategory
		, sh.DesignSketchID, sh.DesignSketchVersion, sdi.StyleDevelopmentName, sdi.Variation, sc.StyleCategory
		, tprl.AgentName, tprl.VendorName, tprl.FactoryName
...
VALUES ('DB_Version', '6.1.0000', '09606', GetDate())
GO
