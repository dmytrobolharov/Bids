	...
	BEGIN
		...
		LEFT OUTER JOIN(
			SELECT rt.TACalReferenceId, tt.TaskPlanStart, tt.TaskPlanEnd, rt.TaskRevisedlStart, rt.TaskRevisedEnd, 
				tw.WorkflowId,tt.TaskAssignedToId,rt.TACalRefTaskId, tw.WorkflowName, tw.WorkflowFolder 
			...
			WHERE rt.TACalReferenceId = @TACalReferenceId) ds 
				ON vcwi.WorkflowName = ds.WorkflowName AND vcwi.WorkflowFolder = ds.WorkflowFolder
...
VALUES ('DB_Version', '0.5.0000', '08617', GetDate())
GO