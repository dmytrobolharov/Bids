...
IF EXISTS(SELECT * FROM INFORMATION_SCHEMA.ROUTINES WHERE SPECIFIC_NAME = N'spx_StyleCostingLogic_UPDATE')
   DROP PROCEDURE spx_StyleCostingLogic_UPDATE
GO


CREATE PROCEDURE spx_StyleCostingLogic_UPDATE
(
...
/********************************************************************************/
/*No logic necessary, therefore, just declare dummy variable to do something.	*/
/********************************************************************************/
...
VALUES              ('DB_Version', '5.0.0000', '03386', GetDate())
GO
