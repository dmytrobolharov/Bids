/****** Object:  StoredProcedure [dbo].[spx_NPMSampleRequestSubmitBOMItemSummary_SEL]    Script Date: 01/14/2013 14:48:17 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_NPMSampleRequestSubmitBOMItemSummary_SEL]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_NPMSampleRequestSubmitBOMItemSummary_SEL]
GO
...
CREATE PROCEDURE [dbo].[spx_NPMSampleRequestSubmitBOMItemSummary_SEL] (
...
a.VendorDate, 
a.EndDate, 
a.Submit, a.StyleID, a.StyleSet, a.TradePartnerID, a.SampleWorkflowID, a.SampleRequestWorkflowID,
...
AND a.TradePartnerID  = @TradePartnerID 
...
VALUES ('DB_Version', '5.0.0000', '04769', GetDate())
GO
