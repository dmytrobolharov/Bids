...
BEGIN
	...
	;WITH dims as (
		...
		CROSS APPLY (VALUES (ItemDim1Id, ItemDim1Name, ItemDim1Active, ItemDim1TypeId),
							(ItemDim2Id, ItemDim2Name, ItemDim2Active, ItemDim2TypeId),
							(ItemDim3Id, ItemDim3Name, ItemDim3Active, ItemDim3TypeId))
						   V(DimID,      DimName,      DimActive,      ItemDmTypeID)
...
VALUES ('DB_Version', '0.5.0000', '07010', GetDate())
GO
