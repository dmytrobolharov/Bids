IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[rpx_Style_Measurement_Worksheet_BodyInfo_SELECT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[rpx_Style_Measurement_Worksheet_BodyInfo_SELECT]
GO
...
CREATE PROCEDURE [dbo].[rpx_Style_Measurement_Worksheet_BodyInfo_SELECT]
(
	@StyleId NVARCHAR(50)
	,@StyleSet NVARCHAR(5)
...
VALUES     ('DB_Version', '5.0.0000', '07108', GetDate())
GO
