/****** Object:  StoredProcedure [dbo].[spx_TACalendar_EventProgress_UPDATE]    Script Date: 08/21/2014 19:07:46 ******/
...
BEGIN
	...
	BEGIN
		...
		SELECT @AvgTaskProgress = AVG(TaskProgress) FROM pTACalTemplateTask
...
VALUES ('DB_Version', '6.0.0000', '08931', GetDate())
GO
