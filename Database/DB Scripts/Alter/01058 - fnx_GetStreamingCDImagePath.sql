...
BEGIN
	...
	/*Build the path.*/
	SET @StreamingImagePath = @ImageServer + '/ImageStream.ashx?IT=CD&S=' + @ImageQualityValue + '&V=' + CAST(@ImageVersion AS varchar(5)) + '&ID=' + CAST(@ImageID AS varchar(255))
...
VALUES ('DB_Version', '4.0.0000', '01058', GetDate())
GO