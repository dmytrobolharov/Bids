...
/****** Object:  StoredProcedure [dbo].[spx_SampleWorkflowSubmitStatus_Logic_UPDATE]    Script Date: 02/03/2012 15:34:46 ******/
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='03079'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.2.0000', '03079', GetDate())
