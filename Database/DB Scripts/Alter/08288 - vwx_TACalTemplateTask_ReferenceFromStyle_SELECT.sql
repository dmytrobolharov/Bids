/****** Object:  View [dbo].[vwx_TACalTemplateTask_ReferenceFromStyle_SELECT]    Script Date: 07/11/2014 16:33:11 ******/
...
AS
SELECT     crt.TACalRefTaskId, 'Style' AS RefType, sh.StyleID, tw.WorkflowId, ct.SeasonYearId, sh.StyleNo, sh.Description, crt.TaskAssignedToId, crt.TaskStatusId, 
...
VALUES     ('DB_Version', '0.5.0000', '08288', GetDate())
GO
