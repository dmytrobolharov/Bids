...
-- =============================================
ALTER                          PROCEDURE [dbo].[dpx_UserGroup_StyleActivity_ToDoList_SELECT]
...
IF @SortBy = 1  -- by user name / default
    BEGIN 
		...
		UPDATE #TempStyleDevelopment SET FilePath=@ImageFolder + '/blank_jpeg.JPG' 
...
VALUES     ('DB_Version', '4.0.0000', '835', GetDate())
GO