...
SELECT     
 ...
 @RoyaltyCode = ISNULL(CAST(ISNULL(StyleQuoteItemCustomField3,0) as decimal(19,0)),0),    
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02279'))
BEGIN
	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '02279', GetDate())
END
GO