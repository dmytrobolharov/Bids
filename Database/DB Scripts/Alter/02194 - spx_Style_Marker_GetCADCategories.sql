...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02194'))
BEGIN
	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '02194', GetDate())
END	
GO
