...
AS 
        ...
        SELECT p.AMLMeasPOMId, p.IsLength, p.IsWidth, p.SortId, p.POM_Row, p.Refcode, p.Description, p.TolPlus, p.TolMinus,
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02456'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '02456', GetDate())
