IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[rpx_SampleRequestSubmit_Fractions_SELECT]') AND type = N'P' )
...
VALUES     ('DB_Version', '4.1.0000', '03134', GetDate())
GO