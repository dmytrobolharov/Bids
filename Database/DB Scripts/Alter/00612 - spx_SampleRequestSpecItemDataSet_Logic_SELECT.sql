IF EXISTS (select * from sysobjects where id = object_id('spx_SampleRequestSpecItemDataSet_Logic_SELECT') and sysstat & 0xf = 4)
    drop procedure spx_SampleRequestSpecItemDataSet_Logic_SELECT
GO
