...
BEGIN
	...
	SET @query = N'SELECT mat_id, styleMaterialPKId, stylematerialId, materialId, materialno, materialname, 
		...
		StyleBOMDimensionId, WorkflowId, WorkflowItemId, MaterialImageID, MaterialImageVersion, Main AS MainMaterial, TradePartner, Qty, MaterialSizeID, MaterialSize, DimBOM,  ' + @IncrCols + '
		FROM
...
VALUES ('DB_Version', '6.0.0000', '08879', GetDate())
GO
