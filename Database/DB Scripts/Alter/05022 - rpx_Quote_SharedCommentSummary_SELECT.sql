IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[rpx_Quote_SharedCommentSummary_SELECT]') AND type in (N'P', N'PC'))
...
VALUES ('DB_Version', '5.0.0000', '05022', GetDate())
GO
