...
BEGIN
	SELECT
		...
		, dbo.fnx_GetStreamingColorImagePath(cp.ColorFolderID, cp.ColorPaletteID) as FilePath
		, cp.ColorName
		, cp.ColorCode	
	FROM pPlanningItem pi
		...
		INNER JOIN pColorPalette cp ON sbdi.ItemDimId = cp.ColorPaletteID
...
VALUES ('DB_Version', '0.5.0000', '07147', GetDate())
GO
