...
IF EXISTS(SELECT * FROM INFORMATION_SCHEMA.ROUTINES WHERE SPECIFIC_NAME = N'spx_SampleRequestWorkflowVendorLate_SELECT')
   DROP PROCEDURE spx_SampleRequestWorkflowVendorLate_SELECT
GO

CREATE PROCEDURE spx_SampleRequestWorkflowVendorLate_SELECT
...
VALUES ('DB_Version', '4.1.0000', '01519', GetDate())
GO
