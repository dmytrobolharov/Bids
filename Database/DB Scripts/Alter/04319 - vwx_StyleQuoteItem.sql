/****** Object:  View [dbo].[vwx_StyleQuoteItem]    Script Date: 11/08/2012 16:35:46 ******/
...
FROM         dbo.pStyleQuoteItem LEFT OUTER JOIN
                      dbo.pStyleCostingDuty ON dbo.pStyleQuoteItem.StyleQuotaVendorDutyID = dbo.pStyleCostingDuty.CustomID
...
VALUES     ('DB_Version', '5.0.0000', '04319', GetDate())
GO
