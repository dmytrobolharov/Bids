IF OBJECT_ID(N'[dbo].[spx_Sample_StyleWorkflowTechPackLogic_SELECT]') IS NOT NULL
...
DECLARE @StyleSeasonYearID uniqueidentifier = (SELECT TOP 1 StyleSeasonYearID FROM pStyleSeasonYear WHERE StyleID = @StyleID AND SeasonYearID = @SeasonYearID)
...
VALUES ('DB_Version', '6.0.0001', '09215', GetDate())
GO
