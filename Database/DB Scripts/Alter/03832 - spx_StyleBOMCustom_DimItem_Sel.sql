/****** Object:  StoredProcedure [dbo].[spx_StyleBOMCustom_DimItem_Sel]    Script Date: 08/14/2012 15:16:56 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_StyleBOMCustom_DimItem_Sel]') AND type in (N'P', N'PC'))
...
Declare @ItemDim3TypeId nvarchar(50)	
	...
	SELECT * FROM #tmpDimCustomItem -- used for change management implemented in vb code
...
VALUES     ('DB_Version', '5.0.0000', '03832', GetDate())
GO