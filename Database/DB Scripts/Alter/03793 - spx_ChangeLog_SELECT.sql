/****** Object:  StoredProcedure [dbo].[spx_ChangeLog_SELECT]    Script Date: 08/22/2012 11:02:01 ******/
...
BEGIN
	...
	BEGIN
		SELECT * INTO #tmpChange FROM (
			...
			LEFT JOIN pWorkFlowItem wi ON wi.WorkFlowItemID = cli.ChangeTransTablePKID
...
VALUES ('DB_Version', '5.0.0000', '03793', GetDate())
GO