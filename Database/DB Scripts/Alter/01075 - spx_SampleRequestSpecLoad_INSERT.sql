IF  EXISTS (SELECT * FROM sys.procedures WHERE object_id = OBJECT_ID(N'[dbo].[spx_SampleRequestSpecLoad_INSERT]'))
DROP PROCEDURE spx_SampleRequestSpecLoad_INSERT
GO
...
VALUES     ('DB_Version', '4.0.0000', '01075', GetDate())
GO
