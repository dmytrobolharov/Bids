			...
			VALUES (
				...
				, (SELECT COALESCE(AgentID, VendorID, FactoryID)
					FROM vwx_TradePartnerRelationshipLevels_SEL tpm
						INNER JOIN pSampleRequestTrade srt ON tpm.TradePartnerRelationshipLevelID = srt.TradePartnerRelationshipLevelID
							...
							SELECT @SampleRequestWorkflowID = SampleRequestWorkflowID FROM ##SampleRequestWorkflowTemp WHERE ID_Num = @I
								BEGIN
									...
									INSERT INTO pSampleRequestWorkflow(
										...
										StartDate, DueDate, FinalDate, EndDate, CUser, CDate, MUser, MDate , SampleWorkflowFinalDate, SampleWorkflowPartnerTypeID)
									SELECT NULL, @TradePartnerID, @NewSampleRequestWorkflowID AS SampleRequestWorkflowID, @StyleRequestWorkflowSetItemID, 
										...
										StartDate, DueDate, FinalDate, '1/1/1900', CUser, CDate, MUser, MDate , SampleWorkflowFinalDate, SampleWorkflowPartnerTypeID 
...
VALUES ('DB_Version', '0.5.0000', '05334', GetDate())
GO
