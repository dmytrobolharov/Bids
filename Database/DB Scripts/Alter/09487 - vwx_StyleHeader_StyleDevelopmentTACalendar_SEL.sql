IF OBJECT_ID(N'[dbo].[vwx_StyleHeader_StyleDevelopmentTACalendar_SEL]') IS NOT NULL
...
SELECT sh.StyleID, sh.StyleMasterID, sh.StyleWorkflowID, sh.StyleType, sh.WorkflowType, sh.RefNo, sh.StyleNo, sh.TempID, 
	   ...
	   sh.CustomField37, sh.CustomField38, sh.CustomField39, sh.CustomField40, sh.Distribution, sh.IntroSeasonYearID, sh.OwnerGroup, 
	   sh.UserCID, sh.UserMID, sh.DivisionID, sh.StyleThemeID, stt.IsSilhouette, sh.DesignSketchBackID, sh.DesignSketchBackVersion
...
VALUES ('DB_Version', '6.1.0000', '09487', GetDate())
GO
