IF OBJECT_ID(N'[dbo].[spx_StyleMeasChangeCompany_Insert]') IS NOT NULL
 DROP PROCEDURE [dbo].[spx_StyleMeasChangeCompany_Insert]
GO
...
VALUES ('DB_Version', '6.1.0000', '09539', GetDate())
GO
