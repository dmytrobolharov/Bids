IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_StyleSKUItems_Logic_UPDATE]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_StyleSKUItems_Logic_UPDATE]
GO

CREATE PROCEDURE [dbo].[spx_StyleSKUItems_Logic_UPDATE]
...
VALUES ('DB_Version', '0.5.0000', '07188', GetDate())
GO
