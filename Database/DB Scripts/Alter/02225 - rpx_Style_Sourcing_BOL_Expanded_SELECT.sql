IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[rpx_Style_Sourcing_BOL_Expanded_SELECT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[rpx_Style_Sourcing_BOL_Expanded_SELECT]
GO
...
CREATE PROCEDURE [dbo].[rpx_Style_Sourcing_BOL_Expanded_SELECT] 
...
SELECT t.StyleSet, t.SetName, t.ExceptionName, e.CDate as ExceptionCDate, sc.StyleColorName, sc.Sort as StyleColorSort,
		t.Code, t.Name, t.MacroId, t.MacroParentId, t.sTotaltime, t.SourcingAdj, t.sCost, t.FactoryCurr, 
...
--WHERE t.MacroParentId IS NULL		-- don't show suboperation of macro
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02225'))
	BEGIN
		INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
		VALUES ('DB_Version', '4.1.0000', '02225', GetDate())
	END
GO