IF OBJECT_ID(N'[dbo].[spx_LineFolderItemStyle_SELECT]') IS NOT NULL
...
CREATE TABLE #temp
	...
	,SizeClass NVARCHAR(400)				--pStyleHeader.SizeClass
	,SizeRange NVARCHAR(200)				--pStyleHeader.SizeRange
...
VALUES ('DB_Version', '6.1.0000', '09629', GetDate())
GO
