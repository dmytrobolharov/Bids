...
BEGIN
	...
	BEGIN
		...
		BEGIN
			...
			SELECT wfi.WorkFlowItemID, wfi.WorkflowItemTypeId, wfi.WorkFlowItemName, rspi.ReportPageID, rspi.ReportMapID, rspi.ReportPageTypeID, 
	...
	BEGIN
		...
		SELECT ReportPageID, ReportMapID, ReportPageTypeID, ReportPageName, ReportPageDescription, ReportServerType, ReportPageURL, 
...
VALUES ('DB_Version', '4.2.0000', '03034', GetDate())
GO
