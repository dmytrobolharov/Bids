...
SELECT     dbo.pStyleHeader.StyleID, dbo.pStyleHeader.StyleMasterID, dbo.pStyleHeader.StyleWorkflowID, dbo.pStyleHeader.StyleType, dbo.pStyleHeader.WorkflowType, 
                      ...
                      dbo.pStyleCategory.StyleCategory AS Category, dbo.pStyleHeader.DesignSketchBackID, dbo.pStyleHeader.DesignSketchBackVersion
...
VALUES     ('DB_Version', '0.5.0000', '08325', GetDate())
GO