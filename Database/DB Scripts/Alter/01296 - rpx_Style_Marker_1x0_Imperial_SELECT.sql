IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[rpx_Style_Marker_1x0_Imperial_SELECT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[rpx_Style_Marker_1x0_Imperial_SELECT]
GO


CREATE PROCEDURE rpx_Style_Marker_1x0_Imperial_SELECT
(
	@StyleId NVARCHAR(50)
)
AS
...
SELECT
	...
	,CAST(Marker_Comments AS NVARCHAR(300)) AS Comments
...
VALUES     ('DB_Version', '4.0.0000', '01296', GetDate())
GO