/****** Object:  StoredProcedure [dbo].[spx_ChangeLog_SELECT]    Script Date: 11/15/2012 10:48:37 ******/
...
BEGIN
    ...
    BEGIN
		SELECT * INTO #tmpChangeLinePlan FROM (			
			...
			FROM pLinePlanAttributeItem a, pLinePlanAttributeItem b, pLinePlanAttributeItem c 
			WHERE a.LinePlanAttributeItemID=vwx_ChangeLogItem_SEL.ChangeTablePKID
			AND a.LinePlanAttributeItemParentID = b.LinePlanAttributeItemID 
			AND c.LinePlanAttributeItemID = b.LinePlanAttributeItemParentID
			) AS HierarchyPath
...
VALUES     ('DB_Version', '5.0.0000', '04345', GetDate())
GO
