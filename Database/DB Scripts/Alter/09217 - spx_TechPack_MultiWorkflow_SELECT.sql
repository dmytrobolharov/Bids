...
BEGIN
	...
	BEGIN
		SELECT DISTINCT ReportTechPackFolderID, ReportMapID, Mapping.MapDetail, pStyleWorkflow.WorkSort, pStyleWorkflow.StyleSet FROM rReportTechPackPageItem
...
VALUES ('DB_Version', '6.0.0001', '09217', GetDate())
GO
