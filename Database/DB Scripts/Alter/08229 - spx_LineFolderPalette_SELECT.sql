/****** Object:  StoredProcedure [dbo].[spx_LineFolderPalette_SELECT]    Script Date: 07/06/2014 18:59:14 ******/
...
BEGIN
	...
	CREATE TABLE #tmpLineListPlanningItems (
		...
		LinePaletteName NVARCHAR(200) COLLATE database_default,
		LinePaletteDescription NVARCHAR(200) COLLATE database_default,
		LinePaletteSort NVARCHAR(5) COLLATE database_default,
		Child NVARCHAR(5) COLLATE database_default
	)
	...
	VALUES ('00000000-0000-0000-0000-000000000020', 'Financial Plan', 'Financial Plan...', 1, '1'),
		...
		('00000000-0000-0000-0000-000000000024', 'Merchandise Tracker', 'Merchandise Tracker...', 5, '1')
...
VALUES ('DB_Version', '0.5.0000', '08229', GetDate())
GO