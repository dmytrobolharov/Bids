DELETE FROM sPermissionWorkflow WHERE workflowid = '00000000-0000-0000-0000-000000000010' AND PermissionProductTypeId IN
...
SELECT 
	...
	'00000000-0000-0000-0000-000000000010', 0, 0, 0, 0, 0, 0, 0, 
	'System', CURRENT_TIMESTAMP, 'System', CURRENT_TIMESTAMP, 'Attachment' 
...
VALUES ('DB_Version', '0.5.0000', '08191', GetDate())
GO
