IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_ReportStyleHeader_INSERT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_ReportStyleHeader_INSERT]
GO
...
CREATE  PROCEDURE [dbo].[spx_ReportStyleHeader_INSERT]
(
...
VALUES ('DB_Version', '5.0.0000', '04596', GetDate())
GO
