...
/****** Object:  StoredProcedure [dbo].[spx_SampleRequestTradeAllocation_INSERT]    Script Date: 05/10/2012 18:55:37 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_SampleRequestTradeAllocation_INSERT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_SampleRequestTradeAllocation_INSERT]
GO
...
CREATE PROCEDURE [dbo].[spx_SampleRequestTradeAllocation_INSERT]
...
GO
	...
	VALUES     ('DB_Version', '5.0.0000', '03432', GetDate())
