...
/****** Object:  StoredProcedure [dbo].[spx_MaterialCoreToStyleMaterialTempLogic_INSERT]    Script Date: 03/29/2012 12:47:41 ******/
...
SET @SQL=NULL
SET @SQL  = 'UPDATE pMaterialCoreItem SET ' + @Params + ' WHERE MaterialCoreItemID = ''' +  CAST(@MaterialCoreItemID AS NVARCHAR(50)) + ''''
EXEC (@SQL)


GO

IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='03266'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '5.0.0000', '03266', GetDate())
