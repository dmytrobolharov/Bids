IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_LinePlanShowroom_PIVOT]') AND type in (N'P', N'PC'))
...
VALUES ('DB_Version', '4.0.0000', '01303', GetDate())
