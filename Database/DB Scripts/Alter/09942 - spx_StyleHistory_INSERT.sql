...
BEGIN
	...
	;WITH sh AS (SELECT ROW_NUMBER() OVER (ORDER BY CDate DESC) AS RowNum, * FROM pStyleHistory WHERE IsSilho = @IsSilho)
	DELETE FROM sh WHERE sh.RowNum > 9

END
GO

INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
VALUES ('DB_Version', '6.1.0000', '09942', GetUTCDate())
GO
