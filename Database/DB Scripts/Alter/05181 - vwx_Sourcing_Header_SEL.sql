/****** Object:  View [dbo].[vwx_Sourcing_Header_SEL]    Script Date: 02/27/2013 17:19:25 ******/
...
AS
SELECT     dbo.pSourcingHeader.SourcingHeaderID, dbo.pSourcingHeader.SourcingName, dbo.pSourcingType.SourcingTypeName AS SourcingType, 
...
VALUES ('DB_Version', '5.0.0000', '05181', GetDate())
GO
