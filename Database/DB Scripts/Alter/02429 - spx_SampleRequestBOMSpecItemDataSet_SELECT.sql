...
/****** Object:  StoredProcedure [dbo].[spx_SampleRequestBOMSpecItemDataSet_SELECT]    Script Date: 12/18/2011 18:50:22 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_SampleRequestBOMSpecItemDataSet_SELECT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_SampleRequestBOMSpecItemDataSet_SELECT]
GO
...
Create  PROCEDURE [dbo].[spx_SampleRequestBOMSpecItemDataSet_SELECT] (
...
return false;" type="image" src="../System/Control/ImageStream.ashx?IT=P&S=75&ID='+  CAST(b.POMLibraryID AS NVARCHAR(40)) +'" 
style="border-width:0px;" />' as HowToImage
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02429'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '02429', GetDate())
