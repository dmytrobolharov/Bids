IF OBJECT_ID(N'[dbo].[spx_SampleRequestBOMGrid_Style_Tables_SELECT]') IS NOT NULL
...
BEGIN
	...
	c.StyleNo , c.DueDate as TechPack , COALESCE(sc.Custom, c.SizeClass) AS SizeClass, 
	c.TechPackID, a.WorkFlowItemID, a.StyleBOMDimensionID, a.StyleBOMDimensionItemID, 
...
VALUES ('DB_Version', '6.1.0000', '09692', GetDate())
GO
