/****** Object:  StoredProcedure [dbo].[spx_StyleBOMDimMaterialQty3D_Update]    Script Date: 01/27/2014 14:22:59 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_StyleBOMDimMaterialQty3D_Update]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_StyleBOMDimMaterialQty3D_Update]
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[spx_StyleBOMDimMaterialQty3D_Update] (
...
VALUES ('DB_Version', '0.5.0000', '07025', GetDate())
GO
