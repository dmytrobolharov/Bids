/****** Object:  StoredProcedure [dbo].[spx_SampleRequestSpec_Logic_UPDATE]    Script Date: 12/21/2011 18:01:04 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_SampleRequestSpec_Logic_UPDATE]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_SampleRequestSpec_Logic_UPDATE]
GO
...
CREATE  PROCEDURE [dbo].[spx_SampleRequestSpec_Logic_UPDATE] (
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02483'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '02483', GetDate())
