...
SET @query = N'select CustomId, SizeRangeCode, SizeRangeKey, Active, sizeid, sizename
 ...
 POMID, POMAlternatesID, POMCode, FitComID, Critical, IsonQA, IsLinked, How2MeasText, How2MeasName, Conv, Tolplus, Tolminus,  
...
VALUES     ('DB_Version', '0.5.0000', '06088', GetDate())
GO
