IF OBJECT_ID(N'[dbo].[spx_SourcingStyle_Commitment_SELECT]') IS NOT NULL
...
BEGIN
	...
	dbo.pSourcingCommitmentItem.StyleQuoteItem_EcomUnits, dbo.pSourcingCommitmentItem.StyleQuoteItem_EcomPriceUnit,
	sh.StyleNo, COALESCE(sc.Custom, sh.SizeClass) AS SizeClass, dbo.pStyleCategory.StyleCategory, sh.MaterialNo, dbo.pSourcingCommitmentItem.SourcingCommitmentItemID, 
	dbo.pSourcingCommitmentItem.StyleCommitmentNo, 
	--dbo.pStyleQuoteItemFreightCost.Margin, dbo.pStyleQuoteItemFreightCost.TotalLandCost,
	sh.Description, dbo.pSourcingCommitmentItem.StyleQuoteItemDueDate, dbo.pSourcingCommitmentItem.MDate, 
	...
	INNER JOIN dbo.pStyleHeader sh ON dbo.pSourcingCommitmentItem.StyleID = sh.StyleID 
	...
	LEFT OUTER JOIN dbo.pStyleSeasonYear ON dbo.pStyleSeasonYear.StyleSeasonYearID = pSourcingCommitmentItem.StyleSeasonYearID --sh.StyleID = dbo.pStyleSeasonYear.StyleID
	...
	WHERE pSourcingCommitmentItem.SourcingHeaderID = @SourcingHeaderID	
...
VALUES ('DB_Version', '6.1.0000', '09782', GetDate())
GO
