IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_StyleBOMDimMaterialColor_Delete]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_StyleBOMDimMaterialColor_Delete]
GO


Create PROCEDURE [dbo].[spx_StyleBOMDimMaterialColor_Delete] (
...
VALUES ('DB_Version', '6.1.0000', '10245', GetUTCDate())
GO
