IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_SampleRequest_TradePartner_DataTable_PIVOT]') AND type in (N'P', N'PC'))
...
WHERE TradePartnerID  = ''' +  CAST ( @TradepartnerID AS NVARCHAR(50))  + ''' '
...
SET @SQL_01 = 'INSERT INTO #tmpSample2 (SampleRequestTradeID, SampleWorkflow, StyleID, SampleRequestSubmitID,
...
ELSE 
	SET @SQL_01 = 'INSERT INTO #tmpSample3  
