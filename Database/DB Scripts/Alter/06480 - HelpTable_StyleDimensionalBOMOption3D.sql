...
GO
		...
		IF NOT EXISTS(SELECT * FROM sSystemPage WHERE MappingPage='Style_DimensionalBOM_Option3D.aspx')
	BEGIN
		INSERT INTO [sSystemPage] (MappingPage, CDate, CUser, sSystemFolderID)
		VALUES ('Style_DimensionalBOM_Option3D.aspx', GETDATE(), 'Administrator', (SELECT sSystemFolderID from sSystemFolder where sSystemFolder='Style'))
	END
	GO
...
VALUES ('DB_Version', '0.5.0000', '06480', GetDate())
GO