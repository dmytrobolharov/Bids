...
BEGIN
	...
	FROM
		...
		INNER JOIN pStyleWorkflow sw ON pli.StyleSeasonYearID = sw.StyleSeasonYearID AND sw.WorkflowID = '40000000-0000-0000-0000-000000000090'
...
VALUES     ('DB_Version', '0.5.0000', '08336', GetDate())
GO