/****** Object:  StoredProcedure [dbo].[spx_Sourcing_LinkStylesToFolder_INSERT]    Script Date: 11/12/2012 10:51:19 ******/
...
if @StyleCategoryID is null
	...
	WHERE 
	--a.CustomField1 = @DivisionID AND
	a.StyleCategory = @StyleCategoryID
...
VALUES     ('DB_Version', '5.0.0000', '04324', GetDate())
