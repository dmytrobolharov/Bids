...
SELECT TOP (100) PERCENT lfi.LineFolderID, ssy.SeasonYearID, sc.StyleCategory AS StyleCategoryName, st.StyleTypeDescription, sy.SeasonYear, d.Custom AS Division, lfi.LineFolderItemDrop, lfi.LineFolderItemDropDate, lfi.LineFolderItemDropUser, 'LineFolderID|' + CAST(lfi.LineFolderID AS nVARCHAR(50)) AS AddIDs, sh.*
...
ORDER BY lfi.Sort, sh.StyleNo	


GO

INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
VALUES ('DB_Version', '0.5.0000', '07508', GetDate())
GO