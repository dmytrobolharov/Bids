...
SELECT a.StyleID, a.StyleSeasonYearID, a.StyleSeason, a.StyleYear, FOO.MaterialCoreID, b.StyleID AS Expr1, b.StyleMasterID, b.StyleWorkflowID, b.StyleType, 
       ...
       b.StyleCategory, COALESCE(sc.Custom, b.SizeClass) AS SizeClass, COALESCE(sr.SizeRangeCode, b.SizeRange) AS SizeRange, 
...
VALUES ('DB_Version', '6.1.0000', '09447', GetDate())
GO
