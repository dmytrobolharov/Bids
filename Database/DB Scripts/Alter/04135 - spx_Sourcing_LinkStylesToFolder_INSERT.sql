/****** Object:  StoredProcedure [dbo].[spx_Sourcing_LinkStylesToFolder_INSERT]    Script Date: 10/10/2012 14:04:31 ******/
...
BEGIN
    ...
    FOR SELECT StyleID FROM pStyleHeader
	WHERE CustomField1 = @DivisionID
	AND StyleCategory = @StyleCategoryID
	AND IntroSeasonYearID = @SeasonYearID
	OPEN @StyleCursor
...
VALUES     ('DB_Version', '5.0.0000', '04135', GetDate())
GO
