/****** Object:  StoredProcedure [dbo].[spx_StyleNewCopy_ExecuteSelection_INSERT]    Script Date: 06/04/2013 11:14:34 ******/
...
BEGIN 
	...
	SELECT NEWID() AS StyleWorkflowID, @NewStyleID AS StyleID, b.StyleSet, b.WorkflowID, b.WorkflowType, b.WorkflowOrder, b.WorkDate, b.WorkStart, 
		...
		b.WorkComments, b.WorkSort, @CUser, @CDate, @CUser, @CDate , b.WorkDay, @StyleSeasonYearID
...
VALUES ('DB_Version', '0.5.0.0000', '05798', GetDate())
GO
