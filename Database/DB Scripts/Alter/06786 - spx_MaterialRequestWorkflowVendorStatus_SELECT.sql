...
FROM  pMaterialTradePartnerColor INNER JOIN
  ...
  pMaterialRequestSubmitWorkflowShare ON pMaterialRequestSubmitWorkflow.TradePartnerID = pMaterialRequestSubmitWorkflowShare.TradePartnerID
		AND pMaterialRequestSubmitWorkflow.MaterialRequestSubmitWorkflowID = pMaterialRequestSubmitWorkflowShare.MaterialRequestSubmitWorkflowID  INNER JOIN
...
VALUES ('DB_Version', '0.5.0000', '06786', GetDate())
GO
