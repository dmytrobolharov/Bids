...
SELECT     dbo.pPlanningItem.PlanningID, dbo.pPlanningItem.PlanningItemID, dbo.pPlanningItem.PlanningItemCustom1, dbo.pPlanningItem.PlanningItemCustom2, 
                      ...
                      (SELECT TOP 1 SeasonYearID FROM pPlanningSeasonYear WHERE pPlanningSeasonYear.PlanningID = dbo.pPlanningItem.PlanningID) as SeasonYearID
...
VALUES ('DB_Version', '0.5.0000', '06362', GetDate())
GO
