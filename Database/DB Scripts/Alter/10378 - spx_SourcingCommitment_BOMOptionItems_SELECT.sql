IF OBJECT_ID(N'[dbo].[spx_SourcingCommitment_BOMOptionItems_SELECT]') IS NOT NULL
...
FROM pSourcingQuoteStyleBOM WHERE StyleQuoteItemID = @StyleQuoteItemID
		...
		BEGIN
			...
			SELECT pSourcingCommitmentBOMOptionItems.StyleMaterialID, pSourcingCommitmentBOMOptionItems.AutoColor,pComponentType.ComponentTypeID, pComponentType.ComponentDescription, 
				...
				, 0 AS MaterialDel, 
				dbo.fnx_GetStreamingImageHTML(pSourcingCommitmentBOMOptionItems.MaterialImageID, pSourcingCommitmentBOMOptionItems.MaterialImageVersion, 25, '') AS MaterialImage, 
...
VALUES ('DB_Version', '6.1.0000', '10378', GetUTCDate())
GO
