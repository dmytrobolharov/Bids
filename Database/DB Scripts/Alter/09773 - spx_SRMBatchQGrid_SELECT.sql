/****** Object:  StoredProcedure [dbo].[spx_SRMBatchQGrid_SELECT]    Script Date: 26.02.2015 14:23:18 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_SRMBatchQGrid_SELECT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_SRMBatchQGrid_SELECT]
GO
...
CREATE PROCEDURE [dbo].[spx_SRMBatchQGrid_SELECT]
(
...
VALUES ('DB_Version', '6.1.0000', '09773', GetDate())
GO
