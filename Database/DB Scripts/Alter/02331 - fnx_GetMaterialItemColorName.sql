...
--
--
/****** Object:  UserDefinedFunction [dbo].[fnx_GetMaterialItemColorName]    Script Date: 12/16/2011 12:58:36 ******/
...
BEGIN
	DECLARE @MaterialItemColorName VARCHAR (255)
...
GO
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02331'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '02331', GetDate())
