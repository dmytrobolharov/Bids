/****** Object:  StoredProcedure [dbo].[spx_CostSheetItem_CostingBOL_UPDATE]    Script Date: 12/04/2012 17:23:49 ******/
...
BEGIN
	...
	BEGIN
		...
		UPDATE pStyleCostingBOL SET OperationCode = @NewOperationCode
		WHERE StytleCostingScenarioItemsID = @StyleCostingID AND StyleNBOLItemId = @StyleNBOLItemID
	END
...
VALUES   ('DB_Version', '5.0.0000', '04532', GetDate())
GO
