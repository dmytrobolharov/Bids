/****** Object:  StoredProcedure [dbo].[spx_LinePlanFinancialPlan_Level_SELECT]    Script Date: 06/05/2014 11:28:26 ******/
...
BEGIN
	...
	BEGIN
		...
		FROM pLinePlanAttributeItem a WITH (NOLOCK) 
			...
			INNER JOIN fnx_Permissions_GetGuidProductTypePermissions(@TeamID, 13) access ON CAST(access.ProductTypeID AS nvarchar(40)) = a.LinePlanAttributeValue
...
VALUES ('DB_Version', '0.5.0000', '07910', GetDate())
GO
