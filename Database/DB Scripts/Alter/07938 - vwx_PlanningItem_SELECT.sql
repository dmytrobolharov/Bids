/****** Object:  View [dbo].[vwx_PlanningItem_SELECT]    Script Date: 06/05/2014 14:12:50 ******/
...
INNER JOIN vwx_Permissions_ProductTypes AS c ON dbo.pStyleHeader.StyleType = c.IntProductTypeId AND c.PermissionFolderTypeId = 2
...
VALUES ('DB_Version', '0.5.0000', '07938', GetDate())
GO