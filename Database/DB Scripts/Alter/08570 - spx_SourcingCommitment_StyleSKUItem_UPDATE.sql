...
BEGIN
	...
	FROM pSourcingCommitmentBOMDetails scb
	INNER JOIN pStyleSKUItems skui ON skui.StyleSKUItemID = @StyleSKUItemID
		AND (skui.ItemDim1ID IN (scb.ItemDim1Id, scb.ItemDim2Id, scb.ItemDim3Id) OR skui.ItemDim1ID IS NULL)
		AND (skui.ItemDim2ID IN (scb.ItemDim1Id, scb.ItemDim2Id, scb.ItemDim3Id) OR skui.ItemDim2ID IS NULL)
		AND (skui.ItemDim3ID IN (scb.ItemDim1Id, scb.ItemDim2Id, scb.ItemDim3Id) OR skui.ItemDim3ID IS NULL)
	WHERE scb.SourcingCommitmentItemID = @SourcingCommitmentItemID
...
VALUES ('DB_Version', '0.5.0000', '08570', GetDate())
GO
