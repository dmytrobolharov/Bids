/****** Object:  StoredProcedure [dbo].[spx_MaterialWorkflow_Logic_UPDATE]    Script Date: 08/22/2014 16:08:42 ******/
...
BEGIN
	...
	INSERT INTO pTACalReferenceTask ( 
		TACalReferenceId , TACalTemplateTaskId, 
		TaskActualEnd, TaskActualStart, TaskRevisedEnd, TaskRevisedlStart, 
		TaskAssignedToId, TaskStatusId, Active, 
		MUser, MDate, CUser, CDate)
	select cr.TACalReferenceId, tt.TACalTemplateTaskId, 
		tt.TaskPlanEnd, tt.TaskPlanStart, NULL, NULL, 
		tt.TaskAssignedToId, 100, 1, 
	...
	AND ((tt.New=1 AND ct.SeasonYearId = ISNULL(mt.IntroSeasonYearID, '00000000-0000-0000-0000-000000000000')) 
		OR (tt.CarryOver = 1 AND ct.SeasonYearId <> ISNULL(mt.IntroSeasonYearID, '00000000-0000-0000-0000-000000000000')))  
	AND tw.WorkflowId in (
		SELECT  ti.MaterialTemplatePageID 
	 ...
	 AND tt.TACalTemplateTaskId not in (
		select tempref.TACalTemplateTaskId 
		from pTACalReferenceTask tempref where tempref.TACalReferenceId = cr.TACalReferenceId)
	...
	EXEC spx_TACalendar_MaterialWorkflowReferences_Progress_UPDATE NULL, NULL, NULL
END
GO

INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
VALUES ('DB_Version', '6.0.0000', '08971', GetDate())
GO
