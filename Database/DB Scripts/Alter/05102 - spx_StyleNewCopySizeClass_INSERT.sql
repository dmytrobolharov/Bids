/****** Object:  StoredProcedure [dbo].[spx_StyleNewCopySizeClass_INSERT]    Script Date: 02/22/2013 13:34:57 ******/
...
BEGIN
	...
	EXEC  spx_Style_Marker_Copy @StyleID=@StyleID, @NewStyleID=@NewStyleID, @MUser=@CreatedBy, @MDate=@CreatedDate

	EXEC  spx_Style_Model_Copy @StyleID=@StyleID, @NewStyleID=@NewStyleID, @MUser=@CreatedBy, @MDate=@CreatedDate
...
VALUES ('DB_Version', '5.0.0000', '05102', GetDate())
GO
