...
/****** Object:  StoredProcedure [dbo].[spx_Body_Model_Piece_INSERT]    Script Date: 01/31/2011 10:59:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF EXISTS (SELECT * FROM sysobjects WHERE id = object_id('spx_Body_Model_Piece_INSERT') and sysstat & 0xf = 4)
    DROP PROCEDURE spx_Body_Model_Piece_INSERT
GO
...
,[Piece_Perimeter],[Piece_PreRotation],[Piece_Image_SN],[Piece_Image_Name],[Piece_Comments],[UserDefined1],[UserDefined2]
,[UserDefined3],[UserDefined4],[UserDefined5],[Piece_Size],[Piece_Tilt_CCW],[Piece_CW_Type],[Piece_CCW_Type],[Piece_PreRotationType]
,[PiecePosition],[mPiece_Area],[mPiece_Perimeter] ,null as ImageID 
FROM #tempTblPiece  
...
VALUES     ('DB_Version', '4.0.0000', '01100', GetDate())
GO
