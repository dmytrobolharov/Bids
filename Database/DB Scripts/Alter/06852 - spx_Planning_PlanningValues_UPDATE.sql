		...
		declare @NoOfStyles DECIMAL(18, 5) = 
		   (SELECT PlanningPlanningCh FROM pPlanningBusiness 
			WHERE PlanningID = @PlanningID
				...
				AND ISNULL(PlanningSubCategoryID, '00000000-0000-0000-0000-000000000000') = ISNULL(@PlanningSubCategoryID, '00000000-0000-0000-0000-000000000000')
...
VALUES ('DB_Version', '0.5.0000', '06852', GetDate())
GO
