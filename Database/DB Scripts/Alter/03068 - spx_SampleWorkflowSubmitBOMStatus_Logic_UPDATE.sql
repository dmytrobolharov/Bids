...
/****** Object:  StoredProcedure [dbo].[spx_SampleWorkflowSubmitBOMStatus_Logic_UPDATE]    Script Date: 02/23/2012 00:58:24 ******/
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='03068'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.2.0000', '03068', GetDate())
