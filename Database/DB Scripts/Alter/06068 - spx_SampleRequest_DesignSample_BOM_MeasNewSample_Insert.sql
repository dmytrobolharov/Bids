/****** Object:  StoredProcedure [dbo].[spx_SampleRequest_DesignSample_BOM_MeasNewSample_Insert]    Script Date: 07/19/2013 11:38:24 ******/
...
AS 
    ...
    INSERT INTO pSampleRequestAMLMeasPOM(SampleRequestAMLMeasPOMId, SampleRequestAMLMeasHdrId, PDMPageId, GRPOMCompanyId, POMGuidId, POMAlternatesId, POM_Row, RefCode, Description, 
                      ...
                      MDate, IsLinked, Critical, How2MeasName, FabricType, IsLength, IsWidth, ShrinkX, ShrinkY, CADModelId, BeforeTreat, RevisedSpec) 
	...
	INSERT INTO pSampleRequestAMLMeasIGC(SampleRequestAMLMeasIGCId, SampleRequestAMLMeasHdrId, SampleRequestAMLMeasPOMId, PDMPageId, POM_Row, WSRowId, SizeCol, Grade, Incr, 
                      ConvGrade, CUser, CDate, MUser, MDate) SELECT (NEWID()), @NewSampleRequestAMLHdrID, (SELECT TOP 1 c.SampleRequestAMLMeasPOMId from pSampleRequestAMLMeasPOM c inner join pSampleRequestAMLMeasPOM b on c.POM_Row = b.POM_Row AND c.Description = b.Description AND c.SampleRequestAMLMeasHdrId = @NewsampleRequestAMLHdrID AND b.SampleRequestAMLMeasPOMId = a.SampleRequestAMLMeasPOMId), a.PDMPageId, a.POM_Row, a.WSRowId, a.SizeCol, a.Grade, a.Incr, 
       ...
       UPDATE  pSampleRequestAMLMeasIGC  set pSampleRequestAMLMeasIGC.Incr=b.RevisedSpec
       from pSampleRequestAMLMeasPOM b where b.SampleRequestAMLMeasPOMId = pSampleRequestAMLMeasIGC.SampleRequestAMLMeasPOMId and pSampleRequestAMLMeasIGC.SizeCol in (select SizeCol from pSampleRequestAMLMeasLbl lbl where lbl.IsSample=1 and lbl.SampleRequestAMLMeasHdrId=@NewSampleRequestAMLHdrID) 
       and pSampleRequestAMLMeasIGC.SampleRequestAMLMeasHdrId=@NewSampleRequestAMLHdrID
       
       UPDATE pSampleRequestAMLMeasPOM set RevisedSpec = NULL where SampleRequestAMLMeasHdrId = @NewSampleRequestAMLHdrID
...
VALUES ('DB_Version', '0.5.0000', '06068', GetDate())
GO
