/****** Object:  StoredProcedure [dbo].[spx_StyleColorwaySeasonYear_PIVOT]    Script Date: 04/12/2013 14:51:50 ******/
...
'SELECT SAPCode, PLMCode, SeasonYear, Color, StyleColorNo, StyleColorName,ColorFolderID,ColorPaletteID,Sort FROM #tmpStyleColorSeasonYear',
NULL,
NULL,
'SeasonYear',
'Color',
...
VALUES     ('DB_Version', '0.5.0000', '05559', GetDate())
GO
