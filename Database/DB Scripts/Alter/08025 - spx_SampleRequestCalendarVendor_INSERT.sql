/****** Object:  StoredProcedure [dbo].[spx_SampleRequestCalendarVendor_INSERT]    Script Date: 06/17/2014 14:34:39 ******/
...
IF @TradePartnerId IS NOT NULL
	BEGIN
		...
		FROM dbo.pSampleRequestWorkflow WITH (NOLOCK) INNER JOIN
			...
			fnx_Permissions_GetIntProductType_WorkflowPermissions(@TeamID, 5, NULL) access ON access.WorkflowId = pSampleWorkflow.SampleWorkflowGUID AND pStyleHeader.StyleType = access.ProductTypeID
...
VALUES ('DB_Version', '0.5.0000', '08025', GetDate())
GO
