...
BEGIN
	...
	*/
	...
	BEGIN
		...
		-- Set total cost for calculations in Style categories
	...
	BEGIN
		...
		WHERE PlanningID = @PlanningID AND PlanningDivisionID = @CurrentDivisionID AND PlanningStyleTypeID = @CurrentStyleTypeID
		AND PlanningStyleCategoryID = @CurrentStyleCategoryID AND 
		((PlanningSubCategoryID IS NULL AND @SubCategoriesCount = 0) OR (PlanningSubCategoryID IS NOT NULL AND @SubCategoriesCount > 0))
		AND PlanningFinancialID = '10000000-0000-0000-0000-000000000000'	
		AND SeasonYearID = @SeasonYearID	
		-- Number of Carry Over Styles
		...
		BEGIN
			...
			ELSE
				...
				AND PlanningFinancialID = '10000000-0000-0000-0000-000000000000' -- SUM(Total Cost)/SUM(Total Units)
				AND SeasonYearID = @SeasonYearID			
			-- WHS Cost/Unit
			IF (@WHSUnits = 0)
			...
			ELSE
				...
				WHERE PlanningID = @PlanningID AND PlanningDivisionID = @CurrentDivisionID AND PlanningStyleTypeID = @CurrentStyleTypeID
				AND PlanningStyleCategoryID = @CurrentStyleCategoryID AND PlanningSubCategoryID IS NOT NULL
				AND PlanningFinancialID = '10000000-0000-0000-0000-000000000000' -- SUM(Wholesale Cost)/SUM(WHS Units)	
				AND SeasonYearID = @SeasonYearID		
			-- Retail Cost/Unit
			IF (@RetailUnits = 0)
			...
			ELSE
				...
				WHERE PlanningID = @PlanningID AND PlanningDivisionID = @CurrentDivisionID AND PlanningStyleTypeID = @CurrentStyleTypeID
				AND PlanningStyleCategoryID = @CurrentStyleCategoryID AND PlanningSubCategoryID IS NOT NULL
				AND PlanningFinancialID = '10000000-0000-0000-0000-000000000000' -- SUM(Retail Cost)/SUM(Retail Units)	
				AND SeasonYearID = @SeasonYearID		
		END
...
VALUES ('DB_Version', '0.5.0000', '06854', GetDate())
GO
