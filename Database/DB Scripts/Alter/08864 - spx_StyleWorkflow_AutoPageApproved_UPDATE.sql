/****** Object:  StoredProcedure [dbo].[spx_StyleWorkflow_AutoPageApproved_UPDATE]    Script Date: 08/14/2014 17:50:31 ******/
...
BEGIN
	...
	EXEC spx_TACalendar_StyleWorkflowReferences_Progress_UPDATE @WorkflowID, @StyleID, @SeasonYearID
...
VALUES ('DB_Version', '6.0.0000', '08864', GetDate())
GO
