...
IF NOT EXISTS(SELECT * FROM sSystemPage WHERE MappingPage='Material_List_History.aspx')
	BEGIN
		INSERT INTO [sSystemPage] (MappingPage, CDate, CUser, sSystemFolderID)
		VALUES ('Material_List_History.aspx', GETDATE(), 'Administrator', (SELECT sSystemFolderID from sSystemFolder where sSystemFolder='Material'))
	END
	GO
...
VALUES     ('DB_Version', '5.0.0000', '04255', GetDate())
GO
