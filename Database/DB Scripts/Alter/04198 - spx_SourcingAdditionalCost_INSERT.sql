...
BEGIN
	INSERT INTO pSourcingAdditionalCost 
		(QuoteItemID,SourcingHeaderID,SourcingStyleID, Description, Amount, CUser, CDate, MUser, MDate) 
	VALUES 
		(@QuoteItemID, @SourcingHeaderID,@SourcingStyleID, '', 0, @CUser, @CDate, @Cuser, @CDate)
END

GO

INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
VALUES     ('DB_Version', '5.0.0000', '04198', GetDate())
GO
