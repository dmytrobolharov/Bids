/****** Object:  StoredProcedure [dbo].[spx_StyleColorway_LinePlanColor_INSERT]    Script Date: 02/22/2013 13:19:50 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_StyleColorway_LinePlanColor_INSERT]') AND type in (N'P', N'PC'))
...
VALUES ('DB_Version', '5.0.0000', '05095', GetDate())
GO
