...
BEGIN
	...
	SET @Count_DimItems = (SELECT COUNT(*) FROM pStyleBOMDimensionItems WHERE StyleBOMDimensionID = @StyleBOMDimensionId)
	...
	UPDATE pStyleCosting SET BOMCost = @BOMCosting
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02337'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '02337', GetDate())
