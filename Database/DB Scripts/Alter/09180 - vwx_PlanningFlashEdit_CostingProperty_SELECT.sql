...
FROM pPlanningItem pli
	...
	INNER JOIN pStyleWorkflow sw ON pli.StyleID = sw.StyleID AND pli.StyleSeasonYearID = sw.StyleSeasonYearID AND sw.WorkflowID = '10000000-0000-0000-0000-000000000010' AND sw.StyleSet = sh.StyleSet
...
VALUES ('DB_Version', '6.0.0001', '09180', GetDate())
GO