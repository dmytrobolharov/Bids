...
SELECT     TOP (100) PERCENT dbo.pPlanningMaterial.PlanningMaterialID, dbo.pPlanningMaterial.PlanningID, dbo.pPlanningMaterial.CUser, dbo.pPlanningMaterial.CDate, dbo.pPlanningMaterial.MUser, 
                      ...
                      dbo.pMaterial.MaterialNo AS MaterialNumber, '<a custom="' + dbo.pMaterial.MaterialNo + '" href=''../Material/Material_Frame.aspx?MTID=' + CAST(dbo.pMaterial.MaterialID AS NVARCHAR(50)) 
...
VALUES ('DB_Version', '6.1.0000', '09999', GetUTCDate())
GO