/****** Object:  StoredProcedure [dbo].[spx_StyleLink_MeasurementSize_SeasonYear_INSERT]    Script Date: 06/25/2013 12:29:38 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_StyleLink_MeasurementSize_SeasonYear_INSERT]') AND type in (N'P', N'PC'))
...
END 
	...
	EXEC spx_StyleMeasGRMeasurements_INSERT @POMTempID, @NewStyleID, @WorkflowID, @NewWorkflowItemID, @StyleSet, '1', @NewAmlMeasHdrID, @CDate, @CUser
	
END
GO

INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
VALUES ('DB_Version', '0.5.0.0000', '05925', GetDate())
GO
