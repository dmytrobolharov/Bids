/****** Object:  StoredProcedure [dbo].[spx_SampleRequestBOM_MeasWorkflowSubmit_Logic_UPDATE]    Script Date: 12/21/2011 18:05:06 ******/
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02485'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '02485', GetDate())
