...
IF  EXISTS (SELECT * from INFORMATION_SCHEMA.ROUTINES WHERE SPECIFIC_NAME = N'spx_SampleRequestFitSpec_Logic_UPDATE') 
DROP PROCEDURE spx_SampleRequestFitSpec_Logic_UPDATE
GO
...
VALUES ('DB_Version', '4.0.0000', '01035', GetDate())
GO
