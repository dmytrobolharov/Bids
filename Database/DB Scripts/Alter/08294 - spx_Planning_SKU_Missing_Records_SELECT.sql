IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_Planning_SKU_Missing_Records_SELECT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_Planning_SKU_Missing_Records_SELECT]
GO

CREATE PROCEDURE [dbo].[spx_Planning_SKU_Missing_Records_SELECT]
(
...
VALUES     ('DB_Version', '0.5.0000', '08294', GetDate())
GO
