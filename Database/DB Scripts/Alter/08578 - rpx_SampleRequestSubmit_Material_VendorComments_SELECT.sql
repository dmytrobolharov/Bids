	...
	IF (@Count <> 0)
		BEGIN
			SELECT
				...
				REPLACE(CAST(c.Comment AS NVARCHAR(2000)), 'span', 'u') AS Comments,
				e.Placement,
	...
	ELSE IF (@Count = 0)
		BEGIN
			SELECT
				...
				REPLACE(CAST(b.Comment AS NVARCHAR(2000)), 'span', 'u') AS Comments,
				NULL AS Placement,
...
VALUES ('DB_Version', '0.5.0000', '08578', GetDate())
GO