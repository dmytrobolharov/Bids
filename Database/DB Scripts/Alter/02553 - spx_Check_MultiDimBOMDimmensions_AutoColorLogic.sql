...
/****** Object:  StoredProcedure [dbo].[spx_Check_MultiDimBOMDimmensions_AutoColorLogic]    Script Date: 01/11/2012 15:55:06 ******/
...
BEGIN
	...
	DECLARE 
	@ItemDimId VARCHAR(50),
	@ItemDimName VARCHAR(50)
	...
	BEGIN
		...
		SET @SqlQuery+=' FROM pStyleBOMDimensionItems  A'	 		  						
		SET @SqlQuery+=' LEFT OUTER JOIN pColorPalette B ON A.'+@ItemDimId+'=B.ColorPaletteID  '			
		SET @SqlQuery+=' WHERE'	 		  			
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02553'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.2.0000', '02553', GetDate())
