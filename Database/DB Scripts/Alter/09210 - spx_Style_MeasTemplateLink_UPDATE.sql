IF OBJECT_ID(N'[dbo].[spx_Style_MeasTemplateLink_UPDATE]') IS NOT NULL
...
Begin
	...
	IF @Linked = 1
		BEGIN			
			...
			ImageId=a.ImageId, How2MeasName=a.How2MeasName, How2MeasText=a.How2MeasText, tolplus=a.TolPlus, 
			tolminus=case left(a.TolMinus, 1) when '-' then a.TolMinus else convert(decimal(18, 4), ('-' + cast(a.TolMinus as nvarchar(20)))) end, 
			SortId=a.POMSort, Flag4QA=a.IsOnQA,	critical=a.Critical
...
VALUES ('DB_Version', '6.1.0000', '09210', GetDate())
GO
