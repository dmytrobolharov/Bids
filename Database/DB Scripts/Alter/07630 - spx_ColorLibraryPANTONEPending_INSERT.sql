...
DECLARE @ColorClassID uniqueidentifier

SELECT @ColorClassID = ColorClassID FROM pColorClass WHERE ColorClassDefault = 1
		...
		BEGIN 
			...
			BEGIN
				...
				INSERT INTO ColorLibraryPending (ColorPaletteID, ColorFolderID, ColorCode, ColorName, ColorSource, ColorNotes, 
					HEX, R, G, B, H, S, L, LAB_L, LAB_A, LAB_B, CUser, CDate, MUser, MDate, [Action], ColorImage, SystemServerStorageID, ColorClassID) 
				SELECT @ColorPaletteId, @ColorFolderId, PANTONEColor, PANTONEName, PANTONEType, '' AS ColorNotes, 
					...
					CIELab_D50_2_L, CIELab_D50_2_A, CIELab_D50_2_B, @CUser, @CDate, @MUser, @MDate, 1, @ColorImage, @SystemServerStorageID, @ColorClassID 
		...
		BEGIN 
			...
			BEGIN		
				...
				INSERT INTO ColorLibraryPending (ColorPaletteID, ColorFolderID, ColorCode, ColorName, ColorSource, ColorNotes, 
					...
					,ColorPaletteCustom8,ColorPaletteCustom9,ColorPaletteCustom10, ColorClassID) 
				SELECT a.ColorPaletteID, @ColorFolderID, a.PantoneNumber,  a.PantoneName, a.ColorSource, b.ColorNotes, 
					...
					,b.ColorPaletteCustom8,b.ColorPaletteCustom9,b.ColorPaletteCustom10, @ColorClassID
...
VALUES ('DB_Version', '0.5.0000', '07630', GetDate())
GO