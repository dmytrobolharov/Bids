...
INTO #tempTblPBody
FROM pBodyPatternSheetPiece where Model_Code = @Model_Code  AND StyleID = @StyleID AND StyleSet = @StyleSet
...
Where pBodyPatternSheetPiece.Piece_Code = (select Piece_Code from #tempTblPBody where rownum = @RowCnt) AND StyleID = @StyleID AND StyleSet = @StyleSet
...
VALUES     ('DB_Version', '4.0.0000', '01249', GetDate())
GO
