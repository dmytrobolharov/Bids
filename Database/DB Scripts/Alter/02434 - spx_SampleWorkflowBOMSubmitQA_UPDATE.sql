...
/****** Object:  StoredProcedure [dbo].[spx_SampleWorkflowBOMSubmitQA_UPDATE]    Script Date: 12/18/2011 18:53:17 ******/
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02434'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '02434', GetDate())
