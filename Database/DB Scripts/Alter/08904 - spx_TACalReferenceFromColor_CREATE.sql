/****** Object:  StoredProcedure [dbo].[spx_TACalendar_ColorWorkflowReferences_Progress_UPDATE]    Script Date: 08/20/2014 15:51:37 ******/
...
BEGIN
	...
	INNER JOIN pTACalReferenceTask crt ON crt.TACalTemplateTaskId = tt.TACalTemplateTaskId
	INNER JOIN pTACalReference cr ON cr.TACalReferenceId = crt.TACalReferenceId
	WHERE (cr.TACalTemplateId = @TACalTemplateID OR @TACalTemplateID IS NULL) AND cr.ReferenceId = @ColorFolderID
...
VALUES ('DB_Version', '6.0.0000', '08904', GetDate())
GO
