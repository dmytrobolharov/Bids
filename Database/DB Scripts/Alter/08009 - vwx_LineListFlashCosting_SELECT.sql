/****** Object:  View [dbo].[vwx_LineListFlashCosting_SELECT]    Script Date: 06/16/2014 16:35:55 ******/
...
SELECT     llfc.LineFolderItemID, llfc.MaterialID, llfc.DutyCategory, llfc.MaterialCost, llfc.LaborCost, llfc.AddedCost, llfc.FlashCostFOB, llfc.DutyP, llfc.Duty, llfc.Variance, 
                      ...
                      lfi.LineFolderItemSort, sh.SubCategoryId, st.StyleTypeDescription
FROM         dbo.pLineListFlashCosting AS llfc INNER JOIN
                      ...
                      dbo.pFlashCostDuty AS fcd ON fcd.FlashCostDutyID = llfc.DutyCategory INNER JOIN
                      dbo.pStyleType AS st ON st.StyleTypeId = sh.StyleType 

GO


INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
VALUES ('DB_Version', '0.5.0000', '08009', GetDate())
GO