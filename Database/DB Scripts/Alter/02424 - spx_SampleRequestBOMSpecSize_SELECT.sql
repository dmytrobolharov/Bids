...
/****** Object:  StoredProcedure [dbo].[spx_SampleRequestBOMSpecSize_SELECT]    Script Date: 12/18/2011 18:44:37 ******/
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02424'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '02424', GetDate())
