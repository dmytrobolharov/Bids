IF OBJECT_ID(N'[dbo].[vwx_StyleSample_Search_SEL]') IS NOT NULL
 DROP VIEW [dbo].[vwx_StyleSample_Search_SEL]
GO
...
SELECT sh.StyleID, sh.StyleMasterID, sh.StyleWorkflowID, sh.StyleType, sh.WorkflowType, sh.RefNo, sh.StyleNo, sh.TempID, 
	   ...
	   sh.StyleCategory, sh.SizeClassId, COALESCE(sc.Custom, sh.SizeClass) AS SizeClass, sh.SizeRangeId, 
	   ...
	   sh.CustomField7, sh.CustomField8, sh.CustomField9, sh.CustomField10, sh.CustomField11, sh.CustomField12, 
	   sh.CustomField13, sh.CustomField14, sh.CustomField15, sh.Pc1, sh.Pc2, sh.Pc3, sh.Pc4, sh.CUser, sh.CDate, sh.MUser, 
	   sh.MDate, sh.Active, sh.Change, sh.Action, sh.NoColorCombo, sh.StyleVersion, sh.StyleDetail, sh.StyleDetail1, 
	   sh.StyleDetail2, sh.StyleAttribute, sh.LinePlanID, sh.LinePlanNo, sh.LinePlanSketchID, sh.LinePlanSketchVersion, 
       sh.CustomField16, sh.CustomField17, sh.CustomField18, sh.CustomField19, sh.CustomField20, sh.CustomField21, 
	   sh.CustomField22, sh.CustomField23, sh.CustomField24, sh.CustomField25, sh.CustomField26, sh.CustomField27, 
       sh.CustomField28, sh.CustomField29, sh.CustomField30, sh.PackagingNo, sh.StyleCopyID, sh.LinePlanItemID, 
	   sh.StyleStatusID, sh.BodyID, sh.TradePartnerID, sh.TradePartnerVendorID, sy.Year, sy.Season, sh.HeaderLocked, 
	   ssy.StyleSeasonYearID, ssy.SeasonYearID
FROM pStyleHeader sh
LEFT JOIN pStyleSeasonYear ssy ON sh.StyleID = ssy.StyleID
LEFT JOIN dbo.pSeasonYear sy ON sy.SeasonYearID = ssy.SeasonYearID
...
VALUES ('DB_Version', '6.1.0000', '09493', GetDate())
GO
