...
BEGIN
	...
	BEGIN
		...
		SET @ReportPageName			= 'Artwork Images'							--Name of the new report to show on screen.
		SET @ReportPageDescription	= 'Artwork Images'							--Additional name field, not shown on screen.
		SET @ReportServerType		= 'SQL'										--Report type.  'SQL' for RDLs and 'ASPX' for code-based reports.
		SET @ReportFormName			= 'Style_ArtworkImages_Body_LLT'			--Body RDL name.
...
VALUES ('DB_Version', '5.0.0000', '03494', GetDate())
GO