...
SELECT
	...
	, (CASE pSampleRequestSubmit.StyleSet 
		WHEN 1 THEN ISNULL(pStyleHeader.Pc1, CAST(pSampleRequestSubmit.StyleSet AS nVARCHAR(1)) + 'st Set') 
		WHEN 2 THEN ISNULL(pStyleHeader.Pc2, CAST(pSampleRequestSubmit.StyleSet AS nVARCHAR(1)) + 'nd Set')
		WHEN 3 THEN ISNULL(pStyleHeader.Pc3, CAST(pSampleRequestSubmit.StyleSet AS nVARCHAR(1)) + 'rd Set')
		WHEN 4 THEN ISNULL(pStyleHeader.Pc4, CAST(pSampleRequestSubmit.StyleSet AS nVARCHAR(1)) + 'th Set')
	   END) AS StyleSetName
...
SELECT
	...
	, (CASE pSampleRequestSubmitBOM.StyleSet 
		WHEN 1 THEN ISNULL(pStyleHeader.Pc1, CAST(pSampleRequestSubmitBOM.StyleSet AS nVARCHAR(1)) + 'st Set') 
		WHEN 2 THEN ISNULL(pStyleHeader.Pc2, CAST(pSampleRequestSubmitBOM.StyleSet AS nVARCHAR(1)) + 'nd Set')
		WHEN 3 THEN ISNULL(pStyleHeader.Pc3, CAST(pSampleRequestSubmitBOM.StyleSet AS nVARCHAR(1)) + 'rd Set')
		WHEN 4 THEN ISNULL(pStyleHeader.Pc4, CAST(pSampleRequestSubmitBOM.StyleSet AS nVARCHAR(1)) + 'th Set')
	   END) AS StyleSetName
...
VALUES ('DB_Version', '0.5.0000', '06800', GetDate())
GO