/****** Object:  StoredProcedure [dbo].[spx_StyleDimBOMQuickAddPending_INSERTQE]    Script Date: 08/22/2012 11:00:05 ******/
...
DECLARE @INSERTED TABLE (StyleMaterialID UNIQUEIDENTIFIER) -- is used for change management
...
If @StyleLink='1'
	begin
		...
		MaterialCoreItemID)
		OUTPUT INSERTED.StyleMaterialID INTO @INSERTED
...
SELECT StyleMaterialID FROM @INSERTED

GO


INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
VALUES     ('DB_Version', '5.0.0000', '03834', GetDate())
GO