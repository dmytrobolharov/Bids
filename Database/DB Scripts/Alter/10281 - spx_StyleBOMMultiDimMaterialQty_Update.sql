IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_StyleBOMMultiDimMaterialQty_Update]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_StyleBOMMultiDimMaterialQty_Update]
GO


Create PROCEDURE [dbo].[spx_StyleBOMMultiDimMaterialQty_Update] (
...
VALUES ('DB_Version', '6.1.0000', '10281', GetUTCDate())
GO
