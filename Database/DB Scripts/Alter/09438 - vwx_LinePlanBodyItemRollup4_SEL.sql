IF OBJECT_ID(N'[dbo].[vwx_LinePlanBodyItemRollup4_SEL]') IS NOT NULL
 DROP VIEW [dbo].[vwx_LinePlanBodyItemRollup4_SEL]
GO

CREATE VIEW [dbo].[vwx_LinePlanBodyItemRollup4_SEL]
AS
SELECT b.BodyNo, b.Description, b.StyleCategory, b.SizeClass, b.SizeRange, b.ImageID, 
	   ...
	   lpr.LinePlanAttributeItemID3, lpr.LinePlanAttributeItemID4
FROM pBody b
...
VALUES ('DB_Version', '6.1.0000', '09438', GetDate())
GO
