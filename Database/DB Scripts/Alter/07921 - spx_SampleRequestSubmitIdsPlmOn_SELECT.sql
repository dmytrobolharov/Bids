/****** Object:  StoredProcedure [dbo].[spx_SampleRequestSubmitIdsPlmOn_SELECT]    Script Date: 06/05/2014 12:00:05 ******/
...
INNER JOIN fnx_Permissions_GetStringProductTypePermissions(@TeamID, 5) sampleAccess ON sampleAccess.ProductTypeId = a.SampleWorkflowID
...
VALUES ('DB_Version', '0.5.0000', '07921', GetDate())
GO