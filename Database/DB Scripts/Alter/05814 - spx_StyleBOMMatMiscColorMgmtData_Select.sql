/****** Object:  StoredProcedure [dbo].[spx_StyleBOMMatMiscColorMgmtData_Select]    Script Date: 06/06/2013 15:31:28 ******/
...
WorkflowId, WorkflowItemId, ComponentOrder,MaterialSort,MainMaterial, MaterialImageID, MaterialImageVersion )
...
WorkflowItemId, ComponentOrder, MaterialSort, MainMaterial, MaterialImageID, MaterialImageVersion FROM pStyleBOM 					
...
BEGIN
	...
	b.StyleBOMDimensionId, b.WorkflowId, b.WorkflowItemId, ComponentOrder, MaterialSort, MainMaterial, NULL, 0 from pStyleBOM b					
...
WHILE @Skuloop <= @Skucnt
	...
	StyleBOMDimensionId, WorkflowId, WorkflowItemId, MaterialImageID, MaterialImageVersion, ' + @IncrCols + '
	FROM
		...
		t1.dtl_id, t3.MaterialColorId, t2.MaterialImageID, t2.MaterialImageVersion 	  
...
VALUES     ('DB_Version', '0.5.0000', '05814', GetDate())
GO
