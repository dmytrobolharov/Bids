...
AND Active = 1 
AND (SELECT Active FROM pSeason WHERE pSeason.Custom = pSeasonYear.Season) = 1
AND (SELECT Active FROM pYear WHERE pYear.Custom = pSeasonYear.[Year]) = 1
ORDER BY [Year] DESC , Season
GO


INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
VALUES ('DB_Version', '5.0.0000', '03851', GetDate())
GO
