/****** Object:  StoredProcedure [dbo].[spx_SampleRequestSpecLoad_INSERT]    Script Date: 02/28/2013 15:52:59 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_SampleRequestSpecLoad_INSERT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_SampleRequestSpecLoad_INSERT]
GO
...
CREATE PROCEDURE [dbo].[spx_SampleRequestSpecLoad_INSERT]  
(  
...
IF @SpecPageID = '00000000-0000-0000-0000-000000000000'  
 ...
 BEGIN  
  ...
  INSERT INTO dbo.pSampleRequestSpecItem  
   (SampleRequestWorkflowID, TradePartnerVendorID, SampleWorkflowID, SampleRequestTradeID, StyleColorID, SpecID, StyleID, StyleSet, POM, PointMeasur, TOL, Ask, Spec,   
  ...
  SELECT  @SampleRequestWorkflowID AS SampleRequestWorkflowID, @TradePartnerVendorID AS TradePartnerVendorID, @SampleWorkflowID AS SampleWorkflowID,   
   @SampleRequestTradeID AS SampleRequestTradeID, @StyleColorID AS StyleColorID, SpecID, StyleID, StyleSet, POM, PointMeasur, TOL, Spec AS Ask, 0 AS Spec,   
   Proto0, Proto1, Proto2, Proto3, Proto4, Proto5, Proto6, Proto7, Proto8, Proto9, Proto10, Proto11, Proto12, Proto13, Proto14, Proto15, Proto16, Proto17, Proto18, Proto19,   
   Grade0, Grade1, Grade2, Grade3, Grade4, Grade5, Grade6, Grade7, Grade8, Grade9, Grade10, Grade11, Grade12, Grade13, Grade14, Grade15, Grade16, Grade17, Grade18, Grade19,   
...
ELSE  
 ...
 BEGIN
	 SELECT @NewSubmit = MAX(Submit) FROM pSampleRequestSubmit WITH (NOLOCK)   
	 ...
	 SELECT @NewStatus = Status FROM pSampleRequestSubmit WITH (NOLOCK)   
	 WHERE SampleRequestWorkflowID = @SpecPageID  
	 AND SampleRequestTradeID = @SampleRequestTradeID   
	 AND TradePartnerVendorID = @TradePartnerVendorID  
	 AND StyleColorID = @StyleColorID   
 ...
 IF @NewStatus = 2 OR @NewStatus = 3  
  BEGIN  
   ...
   StyleColorID, StyleSet, POM, PointMeasur, TOL, Ask, Spec, [Var], Rev, Final,   
   Proto0, Proto1, Proto2, Proto3, Proto4, Proto5, Proto6, Proto7, Proto8, Proto9, Proto10, Proto11, Proto12, Proto13, Proto14, Proto15, Proto16, Proto17, Proto18, Proto19,   
    Grade0, Grade1, Grade2, Grade3, Grade4, Grade5, Grade6, Grade7, Grade8, Grade9, Grade10, Grade11, Grade12, Grade13, Grade14, Grade15, Grade16, Grade17, Grade18, Grade19,   
    Size0, Size1, Size2, Size3, Size4, Size5, Size6, Size7, Size8, Size9, Size10, Size11, Size12, Size13, Size14, Size15, Size16, Size17, Size18, Size19,   
  ...
  SELECT     SampleRequestSpecSizeID, SampleRequestTradeID, @SampleRequestWorkflowID AS SampleRequestWorkflowID,   
   @SampleWorkflowID AS SampleWorkflowID, @Submit AS Submit, TradePartnerVendorID, SpecID, StyleID, StyleColorID, StyleSet, POM, PointMeasur,   
...
VALUES ('DB_Version', '5.0.0000', '05195', GetDate())
