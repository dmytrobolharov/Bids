/****** Object:  StoredProcedure [dbo].[spx_TACalendar_MaterialWorkflowReferences_Progress_UPDATE]    Script Date: 08/14/2014 13:34:05 ******/
...
BEGIN
	...
	FROM vwx_TACalTemplateTask_ReferenceFromMaterial_SELECT 
	WHERE WorkflowId=@MaterialTemplatePageID
...
VALUES ('DB_Version', '6.0.0000', '08847', GetDate())
GO
