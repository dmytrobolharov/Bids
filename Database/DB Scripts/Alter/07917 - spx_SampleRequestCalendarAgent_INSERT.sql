/****** Object:  StoredProcedure [dbo].[spx_SampleRequestCalendarAgent_INSERT]    Script Date: 06/05/2014 11:19:51 ******/
...
INNER JOIN fnx_Permissions_GetStringProductTypePermissions(@TeamId, 5) access ON access.ProductTypeId = sw.SampleWorkflowID
WHERE 
...
VALUES ('DB_Version', '0.5.0000', '07917', GetDate())
GO