...
IF EXISTS (select * from sysobjects where id = object_id('spx_StyleMeasGRMeasurementsPOM_Insert') and sysstat & 0xf = 4)
    drop procedure spx_StyleMeasGRMeasurementsPOM_Insert
GO


CREATE PROCEDURE spx_StyleMeasGRMeasurementsPOM_Insert
(
...
VALUES ('DB_Version', '4.2.0000', '03031', GetDate())
GO
