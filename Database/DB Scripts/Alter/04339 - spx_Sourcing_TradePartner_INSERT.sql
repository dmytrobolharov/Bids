/****** Object:  StoredProcedure [dbo].[spx_Sourcing_TradePartner_INSERT]    Script Date: 11/14/2012 10:40:12 ******/
...
BEGIN
	...
	if NOT EXISTS (SELECT * FROM pSourcingTradePartner 
					WHERE SourcingHeaderID = @SourcingHeaderID 
						AND TradePartnerID = @TradePartnerID 
						AND TradePartnerLevelID = @TradePartnerRelationshipID)
	begin
...
VALUES     ('DB_Version', '5.0.0000', '04339', GetDate())
GO