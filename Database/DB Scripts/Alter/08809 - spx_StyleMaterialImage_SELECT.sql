...
SELECT NEWID() AS StyleDetailFormID ,  
        NEWID() as  StyleDetailFormMasterID ,  
          ...
          @MUser ,  
          @MDate ,  
          '70000000-0000-0000-0000-000000000444'  
FROM dbo.pStyleMaterials WHERE StyleID = @StyleID AND StyleSet = @StyleSet AND Artwork = 1
UNION
SELECT NEWID() AS StyleDetailFormID ,  
        NEWID() as  StyleDetailFormMasterID ,  
          StyleMaterialID,
...
WHERE pStyleBOM.StyleID = @StyleID AND pStyleBOM.StyleSet = @StyleSet AND pStyleBOM.Artwork = 1
...
VALUES ('DB_Version', '6.0.0000', '08809', GetDate())
GO
