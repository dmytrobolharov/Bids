/****** Object:  View [dbo].[vwx_LineList_Style_SearchAdd_SEL]    Script Date: 08/14/2013 15:16:05 ******/
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vwx_LineList_Style_SearchAdd_SEL]'))
...
SELECT     dbo.pStyleHeader.StyleID, dbo.pStyleHeader.StyleMasterID, dbo.pStyleHeader.StyleWorkflowID, dbo.pStyleHeader.StyleType, dbo.pStyleHeader.WorkflowType, 
                      ...
                      dbo.pStyleMaterials.F AS FabricType, dbo.pStyleMaterials.H AS FabricContent, dbo.pStyleHeader.IntroSeasonYearID, dbo.pStyleHeader.DivisionID, 
                      dbo.pStyleCategory.StyleCategory AS Category
...
VALUES ('DB_Version', '0.5.0000', '06152', GetDate())
GO
