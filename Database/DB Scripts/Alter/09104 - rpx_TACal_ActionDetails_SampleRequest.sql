IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[rpx_TACal_ActionDetails_SampleRequest]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[rpx_TACal_ActionDetails_SampleRequest]
GO

CREATE PROCEDURE [dbo].[rpx_TACal_ActionDetails_SampleRequest]
(
...
BEGIN
	...
	SELECT
		...
		, ttr.HighlightColor
	FROM
		vwx_TACalTemplateTask_ReferenceFromSampleRequest_SELECT ttr
...
VALUES   ('DB_Version', '6.0.0000', '09104', GetDate())
GO
