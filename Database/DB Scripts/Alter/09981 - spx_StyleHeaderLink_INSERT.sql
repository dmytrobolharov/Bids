...
BEGIN
	INSERT INTO pStyleHeader
		...
		Description, SizeClassId, SizeRangeId, StyleSet, DueDate, RecDate, Designer, StyleStatus, StyleLocation, WashType, Pitch, MaterialID, MaterialImageID, 
	...
	SELECT StyleWorkflowID, @NewStyleID AS NewStyleId, StyleCategory, StyleMasterID, StyleType, WorkflowType, StyleNo, TempID, TempNo, 
	       CustomerNo, DevelopmentID, DevelopmentNo, SpecNo, Description, @SizeClassId, @SizeRangeId, StyleSet, DueDate, RecDate, Designer, StyleStatus, 
...
BEGIN
	...
	(StyleDevelopmentItemID, StyleDevelopmentID, StyleID, SizeRangeId, Variation, CUser, CDate, MUser, MDate, StyleDevelopmentName)
	SELECT newid() AS StyleDevelopmentItemID, StyleDevelopmentID, @NewStyleID, @SizeRangeId, Variation, @CreatedBy AS CUser, @CreatedDate AS CDate, @CreatedBy AS MUser, @CreatedDate AS MDate, StyleDevelopmentName
...
VALUES ('DB_Version', '6.1.0000', '09981', GetUTCDate())
GO
