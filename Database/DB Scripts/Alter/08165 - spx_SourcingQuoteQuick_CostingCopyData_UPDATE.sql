...
BEGIN
    ...
    BEGIN
		...
		BEGIN
			...
			StyleQuoteItem_EcomUnits = scenario.StyleCosting_EcomUnits, -- Ecom Units
			...
			StyleQuoteItem_EcomPriceUnit = scenario.StyleCosting_EcomPriceUnit, -- Ecom Price/Unit
			...
			WHERE scenario.StytleCostingScenarioItemsID = @StyleCostingScenarioItemId
			AND pStyleQuoteItem.StyleQuoteItemID = @StyleQuoteItemID
		END
		ELSE
		BEGIN
			UPDATE pStyleQuoteItem
			...
			StyleQuoteItem_EcomUnits = costing.StyleCosting_EcomUnits, -- Ecom Units
			...
			StyleQuoteItem_EcomPriceUnit = costing.StyleCosting_EcomPriceUnit, -- Ecom Price/Unit
...
VALUES ('DB_Version', '0.5.0000', '08165', GetDate())
GO
