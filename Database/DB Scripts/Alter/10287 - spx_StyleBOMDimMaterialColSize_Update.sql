IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_StyleBOMDimMaterialColSize_Update]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_StyleBOMDimMaterialColSize_Update]
GO
/****** Object:  StoredProcedure [dbo].[spx_StyleBOMDimMaterialColSize_Update]    Script Date: 03/20/2015 18:49:58 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

CREATE PROCEDURE [dbo].[spx_StyleBOMDimMaterialColSize_Update] (
...
VALUES ('DB_Version', '6.1.0000', '10287', GetUTCDate())
GO