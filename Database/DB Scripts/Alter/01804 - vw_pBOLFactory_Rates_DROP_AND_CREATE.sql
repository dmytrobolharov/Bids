...
SELECT     dbo.pBOLFactoryRates.FactoryRateId, dbo.pBOLFactoryRates.FactoryId, dbo.pBOLFactoryRates.BaseRateId, dbo.pBOLFactoryRates.SeasonYearId, 
                      ...
                      dbo.pBOLBaseRateType.RateName
FROM         dbo.pBOLFactoryRates INNER JOIN
                      dbo.pBOLBaseRateType ON dbo.pBOLFactoryRates.BaseRateId = dbo.pBOLBaseRateType.BaseRateTypeId
...
Begin DesignProperties = 
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vw_pBOLFactory_Rates'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vw_pBOLFactory_Rates'
GO

IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='01804'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '01804', GetDate())
END
