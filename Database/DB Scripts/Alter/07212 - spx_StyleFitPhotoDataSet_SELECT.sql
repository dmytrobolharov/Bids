...
AS
	...
	a.FitVideoID AS FitPhotoID, FileName AS FitPhotoDescription, a.CUser AS MUser, 0 AS FrameCount, 0 AS Width, 0 AS Height, a.CUser, Sort, 
	CASE WHEN EXISTS (SELECT * FROM Users u WHERE u.TeamID = a.CTeamID) THEN 0 ELSE 1 END as IsSrmOn,
	1 AS IsVideo
...
VALUES ('DB_Version', '0.5.0000', '07212', GetDate())
GO
