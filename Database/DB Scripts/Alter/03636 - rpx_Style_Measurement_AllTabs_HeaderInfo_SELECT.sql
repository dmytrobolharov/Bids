...
-- ******************************************************************************************** */
-- ******************************************************************************************** */
/****** Object:  StoredProcedure [dbo].[rpx_Style_Measurement_AllTabs_HeaderInfo_SELECT]    Script Date: 06/14/2012 19:17:26 ******/
...
FROM pAMLMeasHdr
	...
	LEFT OUTER JOIN pAMLMeasLbl ON	pAMLMeasHdr.AMLMeasHdrId = pAMLMeasLbl.AMLMeasHdrId
...
VALUES ('DB_Version', '5.0.0000', '03636', GetDate())
