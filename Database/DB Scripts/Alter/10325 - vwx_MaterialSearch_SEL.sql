...
SELECT a.MaterialID, a.TempID, a.TempNo, a.MaterialImageID, a.MaterialImageVersion, a.MaterialImageDetailID, a.MaterialImageDetailVersion, a.NoColorMatch, a.SupplierID, a.MaterialType, a.MaterialNo, 
       ...
       dbo.fnx_GetStreamingImageHTML(a.MaterialImageID, a.MaterialImageVersion, 50, '') AS ImagePath, 
...
INNER JOIN dbo.pComponentType ON a.MaterialType = dbo.pComponentType.ComponentTypeID

GO

INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
VALUES ('DB_Version', '6.1.0000', '10325', GetUTCDate())
GO
