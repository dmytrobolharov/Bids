/****** Object:  StoredProcedure [dbo].[spx_Body_Model_Piece_INSERT]    Script Date: 06/9/2011 19:14:04 ******/
...
CREATE procedure spx_Body_Model_Piece_INSERT
(
@ID UNIQUEIDENTIFIER,
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='01999'))
BEGIN
	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '01999', GetDate())
END
GO
