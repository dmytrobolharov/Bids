...
**************************************************/
	...
	BEGIN
		SELECT pColorPalette.ColorFolderID, pColorPalette.ColorPaletteID, pColorPalette.ColorCode, pColorPalette.ColorName,
				pColorPalette.ColorCode as StyleColorNo, pColorPalette.ColorName as StyleColorName, pStyleColorway.StyleColorID, 
		...
		FROM pStyleBOMDimension
			...
			INNER JOIN pStyleColorway ON 
				pStyleBOMDimensionItem.ItemDim1Id = pStyleColorway.StyleColorID
	...
	BEGIN
		...
		FROM pStyleBOMDimension
			INNER JOIN pStyleBOMDimensionItem ON pStyleBOMDimension.StyleBOMDimensionID = pStyleBOMDimensionItem.StyleBOMDimensionID 
			INNER JOIN pStyleColorway ON 
				(pStyleBOMDimensionItem.ItemDim1Id = pStyleColorway.StyleColorID AND pStyleBOMDimensionItem.ItemDim1Active = 0) 
				OR (pStyleBOMDimensionItem.ItemDim2Id = pStyleColorway.StyleColorID AND pStyleBOMDimensionItem.ItemDim2Active = 0)
				OR (pStyleBOMDimensionItem.ItemDim3Id = pStyleColorway.StyleColorID AND pStyleBOMDimensionItem.ItemDim3Active = 0)
			INNER JOIN pColorPalette ON pStyleColorway.ColorPaletteID = pColorPalette.ColorPaletteID
		WHERE pStyleBOMDimension.StyleBOMDimensionID = @StyleBOMDimensionID
	...
	BEGIN
		...
		FROM pStyleBOMDimension
			INNER JOIN pStyleBOMDimensionItem ON pStyleBOMDimension.StyleBOMDimensionID = pStyleBOMDimensionItem.StyleBOMDimensionID 
			INNER JOIN pStyleColorway ON 
				(pStyleBOMDimensionItem.ItemDim1Id = pStyleColorway.StyleColorID AND pStyleBOMDimensionItem.ItemDim1Active = 1) 
				OR (pStyleBOMDimensionItem.ItemDim2Id = pStyleColorway.StyleColorID AND pStyleBOMDimensionItem.ItemDim2Active = 1)
				OR (pStyleBOMDimensionItem.ItemDim3Id = pStyleColorway.StyleColorID AND pStyleBOMDimensionItem.ItemDim3Active = 1)
			INNER JOIN pColorPalette ON pStyleColorway.ColorPaletteID = pColorPalette.ColorPaletteID
		WHERE pStyleBOMDimension.StyleBOMDimensionID = @StyleBOMDimensionID
		UNION SELECT
		'00000000-0000-0000-0000-000000000000' AS ColorFolderID, '00000000-0000-0000-0000-000000000000' AS ColorPaletteID,
...
VALUES ('DB_Version', '0.5.0000', '07318', GetDate())
GO
