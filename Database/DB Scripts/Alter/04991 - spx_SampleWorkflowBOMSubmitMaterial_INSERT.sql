...
IF (@SampleWorkflowID = '20A') --GCC
	...
	BEGIN
		...
		SELECT  @SampleRequestSubmitNewId, SampleRequestWorkflowID, SampleWorkflowID, SampleRequestTradeID, StyleID, ItemDim1Id,ItemDim2Id,ItemDim3Id, StyleSet, WorkflowID, TradePartnerVendorID, TradePartnerID, @NewSubmit, 0, StartDate, CONVERT(varchar(10), getdate() + ISNULL(@ResubmitDays,1) , 112), 
...
VALUES     ('DB_Version', '5.0.0000', '04991', GetDate())
GO
