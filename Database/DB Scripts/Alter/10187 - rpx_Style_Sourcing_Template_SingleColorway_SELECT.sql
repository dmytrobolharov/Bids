IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[rpx_Style_Sourcing_Template_SingleColorway_SELECT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[rpx_Style_Sourcing_Template_SingleColorway_SELECT]
GO

CREATE PROCEDURE [dbo].[rpx_Style_Sourcing_Template_SingleColorway_SELECT]
(
...
SELECT	pStyleSourcingItem.StyleSet,
	...
	dbo.fnx_GetStreamingImagePath(hImage.ImageID, hImage.[Version], 2000) AS Material_Image_Path,
	...
	dbo.fnx_GetStreamingColorImagePath(pMaterialColor.ColorFolderID, pMaterialColor.ColorPaletteID, '100') AS Color_Image_Path,
...
VALUES ('DB_Version', '6.1.0000', '10187', GetUTCDate())
GO