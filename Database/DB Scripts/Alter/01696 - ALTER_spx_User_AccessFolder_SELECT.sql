...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'spx_User_AccessFolder_SELECT') AND type = N'P' )
	DROP PROCEDURE spx_User_AccessFolder_SELECT
GO


CREATE PROCEDURE spx_User_AccessFolder_SELECT
(
	@nDeskFolderId INT, 
...
VALUES              ('DB_Version', '4.1.0000', '01696', GetDate())
GO
