IF OBJECT_ID(N'[dbo].[vwx_Style_Search_Default_SELECT]') IS NOT NULL
 DROP VIEW [dbo].[vwx_Style_Search_Default_SELECT]
GO

CREATE VIEW [dbo].[vwx_Style_Search_Default_SELECT]
AS
SELECT sh.StyleID, sh.StyleMasterID, sh.StyleWorkflowID, sh.StyleType, sh.WorkflowType, sh.RefNo, sh.StyleNo, sh.TempID, sh.TempNo, 
	   ...
	   sh.CustomField11, sh.CustomField12, sh.CustomField13, sh.CustomField14, sh.CustomField15, /*sh.Size0, sh.Size1, 
	   sh.Size2, sh.Size3, sh.Size4, sh.Size5, sh.Size6, sh.Size7, sh.Size8, sh.Size9, sh.Size10, sh.Size11, sh.Sel0, 
	   sh.Sel1, sh.Sel2, sh.Sel3, sh.Sel4, sh.Sel5, sh.Sel6, sh.Sel7, sh.Sel8, sh.Sel9, sh.Sel10, sh.Sel11,*/ 
	   ...
	   sh.CustomField27, sh.CustomField28, sh.CustomField29, sh.CustomField30, sm.MainMaterial, sm.MaterialName AS StyleMaterialsMaterialName, 
	   sm.J, sm.Q
FROM pStyleMaterials sm
INNER JOIN pStyleHeader sh ON sm.StyleID = sh.StyleID
...
VALUES ('DB_Version', '6.1.0000', '09478', GetDate())
GO
