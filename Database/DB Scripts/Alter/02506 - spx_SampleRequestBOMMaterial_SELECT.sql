...
/****** Object:  StoredProcedure [dbo].[spx_SampleRequestBOMMaterial_SELECT]    Script Date: 12/23/2011 00:07:56 ******/
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02506'))
BEGIN
	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES ('DB_Version', '4.1.0000', '02506', GetDate())
END
