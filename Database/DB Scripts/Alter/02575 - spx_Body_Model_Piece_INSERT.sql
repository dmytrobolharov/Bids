/****** Object:  StoredProcedure [dbo].[spx_Body_Model_Piece_INSERT]    Script Date: 01/13/2012 17:47:23 ******/
...
BEGIN
	SET @strPiece = @strPiece + ',[Rule_Table_Name]'
END
ELSE
BEGIN
	SET @strPiece = @strPiece + ',NULL'
END
/*********************************************************************/

SET @strPiece = @strPiece + '
      ,[Piece_CrOpId]
      ,[Piece_Create]
      ,[Piece_RevOp1]
      ,[Piece_Rev1]
 ...
 +  @CADDB + '.' + @Catalog + 
 '.dbo.Cad_Piece_Details WHERE  Model_Code = ' + Convert(nvarchar(50),@Model_Code)

print @strPiece
Exec (@strPiece) 
       
UPDATE #tempTblPiece
SET Piece_Comments = a.Piece_Comments
 FROM	pBodyPatternSheetPiece AS a	inner join #tempTblPiece as b 
on a.Piece_Code = b.Piece_Code AND a.ModelID = @ID
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02575'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.2.0000', '02575', GetDate())
