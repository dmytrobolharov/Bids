...
SELECT TOP (100) PERCENT pli.PlanningID, ssy.SeasonYearID, sc.StyleCategory AS StyleCategoryName, 
	st.StyleTypeDescription, sy.SeasonYear, d.Custom AS Division, NULL AS AddIDs, sh.*,
...
ORDER BY pli.PlanningItemSort, sh.StyleNo	
GO


INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
VALUES ('DB_Version', '0.5.0000', '07542', GetDate())
GO
