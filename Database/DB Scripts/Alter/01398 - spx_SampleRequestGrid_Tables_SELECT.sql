IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_SampleRequestGrid_Tables_SELECT]') AND type = N'P' )
...
VALUES     ('DB_Version', '4.1.0000', '01398', GETDATE())
GO