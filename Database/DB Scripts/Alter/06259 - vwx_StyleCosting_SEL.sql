...
FROM         dbo.pStyleCosting INNER JOIN
                      ...
                      dbo.pStyleCostingDuty ON dbo.pStyleCosting.StyleCostingHTS = CAST(dbo.pStyleCostingDuty.CustomID as nvarchar(40)) 
...
FROM         dbo.pStyleCostingScenarioItems INNER JOIN
                      ...
                      dbo.pStyleCostingDuty ON dbo.pStyleCostingScenarioItems.StyleCostingHTS = CAST(dbo.pStyleCostingDuty.CustomID as nvarchar(40)) 
...
VALUES ('DB_Version', '0.5.0.0000', '06259', GetDate())
GO
