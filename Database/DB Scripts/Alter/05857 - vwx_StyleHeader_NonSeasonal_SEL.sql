...
SELECT     dbo.pStyleHeader.StyleID, dbo.pStyleHeader.StyleMasterID, dbo.pStyleHeader.StyleWorkflowID, dbo.pStyleHeader.StyleType, dbo.pStyleHeader.WorkflowType, 
                      ...
                      dbo.pStyleHeader.TradePartnerID, dbo.pStyleHeader.TradePartnerVendorID, dbo.pStyleHeader.HeaderLocked, dbo.pStyleHeader.IntroSeasonYearID, dbo.pStyleHeader.StyleLinkID, 
                      ...
                      dbo.pStyleTypeTemplate.IsSilhouette
...
VALUES ('DB_Version', '0.5.0.0000', '05857', GetDate())
GO
