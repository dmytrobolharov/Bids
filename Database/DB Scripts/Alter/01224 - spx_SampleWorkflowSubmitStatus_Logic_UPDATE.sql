IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_SampleWorkflowSubmitStatus_Logic_UPDATE]') AND type = N'P' )
...
VALUES ('DB_Version', '4.0.0000', '01224', GetDate())
GO
