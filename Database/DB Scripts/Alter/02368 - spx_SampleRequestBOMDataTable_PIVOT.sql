...
/****** Object:  StoredProcedure [dbo].[spx_SampleRequestBOMDataTable_PIVOT]    Script Date: 12/18/2011 18:02:19 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_SampleRequestBOMDataTable_PIVOT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_SampleRequestBOMDataTable_PIVOT]
GO
...
CREATE PROCEDURE [dbo].[spx_SampleRequestBOMDataTable_PIVOT](
...
AssignedTo, ItemDim1Id,ItemDim2Id,ItemDim3Id, TechPack, StyleSet, SetNo, Season, Year  )
SELECT 
...
CAST ( a.SampleRequestTradeID AS NVARCHAR(50)) + '&FDIM=1' + '&SWID=' + a.SampleWorkflowID + '&SN='+  CAST(a.StyleSet  as nvarchar(5)) +
''',''' +  
...
Link, StyleNo, Description, SizeClass,Dim1Name,Dim2Name,Dim3Name, ItemDim1Id,ItemDim2Id,ItemDim3Id, TechPack, StyleSet , SetNo, Season, Year  )
...
a.Link , d.StyleNo, d.Description, d.SizeClass ,g.ItemDim1Name,h.ItemDim2Name,j.ItemDim3Name, a.ItemDim1Id,a.ItemDim2Id,a.ItemDim3Id, a.TechPack, a.StyleSet, a.SetNo, a.Season, a.Year
FROM #tmpSample1 a
...
LEFT OUTER JOIN pStyleBOMDimensionItem g ON g.StyleBOMDimensionItemID = a.ItemDim1Id 
LEFT OUTER JOIN pStyleBOMDimensionItem h ON h.StyleBOMDimensionItemID = a.ItemDim2Id
LEFT OUTER JOIN pStyleBOMDimensionItem j ON j.StyleBOMDimensionItemID = a.ItemDim3Id
'
...
VendorName, StyleNo, Description, SizeClass, Dim1Name,Dim2Name,Dim3Name, TechPack, StyleSet, SetNo, Season, Year  
FROM #tmpSample3',
NULL,
NULL,
'SampleWorkflow',
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02368'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '02368', GetDate())
