...
SELECT lf.LineFolderID, lfi.LineFolderItemID, lf.LineFolderDescription, lf.SeasonYearID, lfi.StyleSeasonYearID, lfi.StyleBOMDimensionID, 
	   ...
	   COALESCE(scc.Custom, sh.SizeClass) AS SizeClass, COALESCE(sr.SizeRangeCode, sh.SizeRange) AS SizeRange, sh.StyleSet, sh.TechPackId, sh.TechPackDate, 
...
VALUES ('DB_Version', '6.1.0000', '09448', GetDate())
GO
