IF OBJECT_ID(N'[dbo].[vwx_StyleHeader_SELECT]') IS NOT NULL
...
SELECT sh.StyleID, sh.StyleMasterID, sh.StyleWorkflowID, sh.StyleType, sh.WorkflowType, sh.RefNo, sh.StyleNo, sh.TempID, 
	   ...
	   sh.Change, sh.Action, sh.NoColorCombo, sh.StyleVersion, sh.StyleDetail, sh.StyleDetail1, sh.StyleDetail2, sh.StyleAttribute,
	   sh.LinePlanID, sh.LinePlanNo, sh.LinePlanSketchID, sh.LinePlanSketchVersion, sh.CustomField16, sh.CustomField17, 
	   ...
	   sh.StyleCopyID, sh.LinePlanItemID, sh.StyleStatusID, sh.BodyID, sh.TradePartnerID, sh.TradePartnerVendorID, ssy.StyleSeason, 
	   ssy.StyleYear, sh.StyleLinkID, stt.IsSilhouette, sh.DesignSketchBackID, sh.DesignSketchBackVersion, sh.DivisionID, 
	   sh.PlannedDueDate, sh.PlannedStartDate, sh.StartDate
...
VALUES ('DB_Version', '6.1.0000', '09485', GetDate())
GO
