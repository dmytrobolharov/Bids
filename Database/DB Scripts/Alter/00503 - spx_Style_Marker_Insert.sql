...
/****** Object:  StoredProcedure [dbo].[spx_Style_Marker_Insert]    Script Date: 10/06/2010 12:43:06 ******/
SET ANSI_NULLS ON
GO
...
'   SELECT '+  CHAR(39) + Convert(varchar(36),@ID) + CHAR(39) + ' as ID, null as BodyID ,
' + CHAR(39) + Convert(varchar(36),@StyleID ) + CHAR(39) +' as StyleID
	  ,[Marker_Code]
      ,[Marker_Name]
      ,[Location]
      ,[Last_Updated]
...
VALUES     ('DB_Version', '4.0.0000', '503', GetDate())
GO
