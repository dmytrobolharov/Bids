	...
	BEGIN
		...
		BEGIN
			...
			WHERE wfi.StyleID = @StyleID 
				...
				AND (wfi.WorkflowID != '40000000-0000-0000-0000-000000000080' OR (wfi.WorkflowID = '40000000-0000-0000-0000-000000000080' AND wfi.WorkStatus != 101))
			UNION
			SELECT wfi.WorkFlowItemID, wfi.WorkflowID, wfit.MapId, wfi.WorkflowItemTypeId, wfs.WorkflowStatus as Custom, wfit.ItemTypeLabel, wfi.StyleID, wfi.StyleSet, wfi.WorkFlowItemName, wfil.Sort, 
...
VALUES ('DB_Version', '0.5.0000', '07619', GetDate())
GO
