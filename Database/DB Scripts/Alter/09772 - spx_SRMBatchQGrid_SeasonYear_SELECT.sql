/****** Object:  StoredProcedure [dbo].[spx_SRMBatchQGrid_SeasonYear_SELECT]    Script Date: 26.02.2015 13:57:59 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_SRMBatchQGrid_SeasonYear_SELECT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_SRMBatchQGrid_SeasonYear_SELECT]
GO
...
CREATE PROCEDURE [dbo].[spx_SRMBatchQGrid_SeasonYear_SELECT]
(
...
BEGIN	
	...
	SET @SQLString = 'SELECT DISTINCT SqlBatchQ.* FROM (' + @BatchQueueGridSql + ') AS SqlBatchQ 
...
VALUES ('DB_Version', '6.1.0000', '09772', GetDate())
GO
