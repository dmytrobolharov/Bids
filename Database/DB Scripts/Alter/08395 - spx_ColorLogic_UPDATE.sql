...
UPDATE pMaterialTradePartnerColor SET   ColorCode  = @ColorCode, 
ColorName = @ColorName, 	MUser = @MUser, MDate = @MDate 
WHERE ColorPaletteID = @ColorPaletteID 

UPDATE pLineFolderItemColor SET StyleColorNo = @ColorCode, 
StyleColorName = @ColorName, 	MUser = @MUser, MDate = @MDate 
WHERE ColorPaletteID = @ColorPaletteID 

UPDATE pLinePlanColorItem SET ColorCode = @ColorCode, 
ColorName = @ColorName, 	MUser = @MUser, MDate = @MDate 
WHERE ColorPaletteID = @ColorPaletteID
...
UPDATE pMaterialCoreColor SET ColorCode = @ColorCode, 
ColorName = @ColorName, 	MUser = @MUser, MDate = @MDate 
WHERE ColorPaletteID = @ColorPaletteID
...
VALUES ('DB_Version', '0.5.0000', '08395', GetDate())
GO