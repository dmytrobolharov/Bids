...
/****** Object:  View [dbo].[vwx_Style_Quote_Default_SELECT]    Script Date: 08/19/2011 13:52:04 ******/
...
SELECT DISTINCT  
	 ...
	 dbo.pStyleHeader.StyleNo, dbo.pStyleHeader.SizeClass, dbo.pStyleHeader.MaterialNo,	 
...
Go
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='01773'))
BEGIN
	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '01773', GetDate())
END
GO
