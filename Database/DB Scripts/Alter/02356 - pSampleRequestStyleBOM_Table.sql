...
IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[DF_pSampleRequestStyleBOM_SampleRequestStyleID]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[pSampleRequestStyleBOM] DROP CONSTRAINT [DF_pSampleRequestStyleBOM_SampleRequestStyleID]
END
...
/****** Object:  Table [dbo].[pSampleRequestStyleBOM]    Script Date: 12/18/2011 17:46:24 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[pSampleRequestStyleBOM]') AND type in (N'U'))
DROP TABLE [dbo].[pSampleRequestStyleBOM]
GO



/****** Object:  Table [dbo].[pSampleRequestStyleBOM]    Script Date: 12/18/2011 17:46:25 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[pSampleRequestStyleBOM](
 ...
 CONSTRAINT [PK_pSampleRequestStyleBOM] PRIMARY KEY CLUSTERED 
(
	[SampleRequestStyleID] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
) ON [PRIMARY]

GO

ALTER TABLE [dbo].[pSampleRequestStyleBOM] ADD  CONSTRAINT [DF_pSampleRequestStyleBOM_SampleRequestStyleID]  DEFAULT (newid()) FOR [SampleRequestStyleID]
GO


IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02356'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '02356', GetDate())
