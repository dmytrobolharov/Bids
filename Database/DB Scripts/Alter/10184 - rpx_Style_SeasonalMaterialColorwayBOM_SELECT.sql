...
BEGIN
	...
	FROM pStyleBOM sb
		...
		INNER JOIN pStyleBOMItem sbi ON sb.StyleMaterialID = sbi.StyleMaterialID AND (sbi.ItemDim1Id = sc.StyleColorID OR sbi.ItemDim2Id = sc.StyleColorID OR sbi.ItemDim3Id = sc.StyleColorID)
...
VALUES ('DB_Version', '6.1.0000', '10184', GetUTCDate())
GO