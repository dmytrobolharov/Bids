/****** Object:  View [dbo].[vwx_SourcingStyle_StyleHeader_QuickQuote_SEL]    Script Date: 08/05/2014 17:14:17 ******/
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vwx_SourcingStyle_StyleHeader_QuickQuote_SEL]'))
...
SELECT     dbo.pStyleHeader.StyleID, dbo.pStyleHeader.StyleMasterID, dbo.pStyleHeader.StyleWorkflowID, dbo.pStyleHeader.StyleType, dbo.pStyleHeader.WorkflowType, 
                      ...
                      dbo.pSeasonYear.Year, ISNULL(dbo.pStyleDevelopmentItem.StyleDevelopmentName, 'Variation ' + CAST(dbo.pStyleDevelopmentItem.Variation AS nVarchar(2))) 
                      AS Variation, dbo.pStyleHeader.IntroSeasonYearID, dbo.pStyleHeader.DivisionID, dbo.pStyleCategory.StyleCategory as StyleCategoryName,
                      ...
                      NULL as StyleQuoteItemCustomField16, TaCal.TACalTemplateId AS CalendarID
FROM         dbo.pStyleHeader LEFT OUTER JOIN
                      ...
                      dbo.pStyleDevelopmentItem ON dbo.pStyleDevelopmentItem.StyleID = dbo.pStyleHeader.StyleID LEFT OUTER JOIN
                      ...
                      (   SELECT ct.TACalTemplateId, cr.ReferenceId, ct.SeasonYearId FROM 
						  ...
						  pTACalReference cr ON ct.TACalTemplateId = cr.TACalTemplateId AND cr.TACalReferenceTypeId = 2
					  ) AS TaCal ON TaCal.SeasonYearId = pSeasonYear.SeasonYearID AND TACal.ReferenceId = pStyleHeader.StyleID

GO

INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
VALUES ('DB_Version', '0.5.0000', '08589', GetDate())
GO
