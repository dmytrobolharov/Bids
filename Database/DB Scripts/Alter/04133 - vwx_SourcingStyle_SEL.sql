...
SELECT     dbo.pSourcingStyle.SourcingStyleID, dbo.pSourcingStyle.SourcingHeaderID, dbo.pSourcingStyle.StyleID, dbo.pSourcingStyle.Styleset, dbo.pSourcingStyle.Progress, 
                      ...
                      dbo.pStyleHeader.EnforceDependency, dbo.pStyleHeader.WorkflowTemplateID, dbo.pSeasonYear.SeasonYearID, dbo.pSeasonYear.Year, 
...
FROM         dbo.pSourcingStyle LEFT OUTER JOIN
                      ...
                      dbo.pSeasonYear ON dbo.pSeasonYear.SeasonYearID = dbo.pStyleHeader.IntroSeasonYearID

GO


INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
VALUES     ('DB_Version', '5.0.0000', '04133', GetDate())
GO
