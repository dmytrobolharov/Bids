IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[rpx_SampleRequestSubmit_Fractions_SELECT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[rpx_SampleRequestSubmit_Fractions_SELECT]
GO

CREATE PROCEDURE [dbo].[rpx_SampleRequestSubmit_Fractions_SELECT]
(
...
VALUES ('DB_Version', '0.5.0000', '08577', GetDate())
GO