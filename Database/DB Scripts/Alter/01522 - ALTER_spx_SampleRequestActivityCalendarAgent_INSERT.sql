...
IF EXISTS(SELECT * FROM INFORMATION_SCHEMA.ROUTINES WHERE SPECIFIC_NAME = N'spx_SampleRequestActivityCalendarAgent_INSERT')
   DROP PROCEDURE spx_SampleRequestActivityCalendarAgent_INSERT
GO

CREATE PROCEDURE spx_SampleRequestActivityCalendarAgent_INSERT
(@TeamId varchar(50),
...
VALUES ('DB_Version', '4.1.0000', '01522', GetDate())
GO
