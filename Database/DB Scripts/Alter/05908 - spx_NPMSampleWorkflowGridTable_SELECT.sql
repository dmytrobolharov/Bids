/****** Object:  StoredProcedure [dbo].[spx_SampleWorkflowGridTable_SELECT]    Script Date: 06/25/2013 14:20:50 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_NPMSampleWorkflowGridTable_SELECT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_NPMSampleWorkflowGridTable_SELECT]
GO

CREATE  PROCEDURE [dbo].[spx_NPMSampleWorkflowGridTable_SELECT] (
...
VALUES ('DB_Version', '0.5.0000', '05908', GetDate())
GO
