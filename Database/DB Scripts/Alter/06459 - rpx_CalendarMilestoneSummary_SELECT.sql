...
WHERE ch.CalendarHeaderID = @CalendarHeaderID AND lfi.LineFolderItemDrop LIKE '%No%' AND (wi.StyleSeasonYearID = ssy.StyleSeasonYearID OR wi.StyleSeasonYearID IS NULL)
...
VALUES ('DB_Version', '0.5.0000', '06459', GetDate())
GO
