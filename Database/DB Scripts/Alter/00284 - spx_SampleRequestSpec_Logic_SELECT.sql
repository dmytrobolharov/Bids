IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_SampleRequestSpec_Logic_SELECT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_SampleRequestSpec_Logic_SELECT]
GO


CREATE  PROCEDURE [dbo].[spx_SampleRequestSpec_Logic_SELECT] 
...
*/		
	...
	IF ( SELECT b.ApprovedType
		FROM pSampleRequestSubmit  a INNER JOIN pSampleRequestSubmitStatus b ON a.Status = b.StatusID
