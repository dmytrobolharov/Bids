...
/****** Object:  StoredProcedure [dbo].[spx_SampleWorkflowSubmitBOMStatus_Logic_UPDATE]    Script Date: 02/03/2012 15:29:58 ******/
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='03078'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.2.0000', '03078', GetDate())
