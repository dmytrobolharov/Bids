...
GO
/****** Object:  StoredProcedure [dbo].[spx_StyleNewCopy_ExecuteSelection_INSERT]    Script Date: 12/18/2014 16:49:06 ******/
SET ANSI_NULLS ON
GO
...
BEGIN 
	...
	SELECT NEWID() AS StyleWorkflowID, @NewStyleID AS StyleID, b.StyleSet, b.WorkflowID, b.WorkflowType, b.WorkflowOrder, b.WorkDate, b.WorkStart, 
		...
		CASE WHEN  (SELECT COUNT(*) FROM pStyleCopyTmp WHERE StyleID = @StyleID AND Map = b.WorkflowID) <> 0 THEN CASE WHEN WorkStatus = 1 THEN WorkStatus ELSE 6 END ELSE 1 END,
...
VALUES ('DB_Version', '6.1.0000', '09201', GetDate())
GO