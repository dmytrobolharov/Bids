/****** Object:  StoredProcedure [dbo].[dpx_UserGroup_SampleActivity_ToDoList_SELECT]    Script Date: 08/03/2012 17:35:45 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[dpx_UserGroup_SampleActivity_ToDoList_SELECT]') AND type in (N'P', N'PC'))
...
VALUES     ('DB_Version', '5.0.0000', '03752', GetDate())
GO
