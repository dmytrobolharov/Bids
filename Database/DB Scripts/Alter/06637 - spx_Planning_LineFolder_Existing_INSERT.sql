...
BEGIN
	...
	INSERT INTO @LineFolderItems(StyleID, SeasonYearID, StyleBOMDimensionID)
	SELECT DISTINCT lfi.StyleID, ssy.SeasonYearID, lfi.StyleBOMDimensionID FROM pLineFolderItem lfi
	...
	BEGIN
		...
		SELECT @StyleID = StyleID, @SeasonYearID = SeasonYearID, @StyleBOMDimensionID = StyleBOMDimensionID FROM @LineFolderItems WHERE ROWID = @ROW
...
VALUES     ('DB_Version', '0.5.0000', '06637', GetDate())
GO
