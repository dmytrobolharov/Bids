...
BEGIN
	...
	SELECT meas.AMLMeasHdrId, wi.WorkFlowItemName, wi.WorkStatus, wi.Sort
	FROM pWorkflowItem wi INNER JOIN pAMLMeasHdr meas ON wi.WorkFlowItemID = meas.WorkFlowItemId
	WHERE wi.StyleID = @StyleID
	UNION
	SELECT meas.AMLMeasHdrId, wi.WorkFlowItemName + ' (linked)', wi.WorkStatus, wi.Sort--+ '&nbsp;<img align="absMiddle" src="../System/Icons/icon_link.gif" border="0"/>'
...
VALUES ('DB_Version', '6.1.0000', '10060', GetUTCDate())
GO
