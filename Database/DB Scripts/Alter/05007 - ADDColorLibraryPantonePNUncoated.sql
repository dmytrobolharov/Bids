DECLARE @Cnt int
SELECT @Cnt = COUNT(*) from sys.objects where name =  'ColorLibraryPantonePNUncoated' and type = 'U'
IF @Cnt =  0
BEGIN 

CREATE TABLE [dbo].[ColorLibraryPantonePNUncoated](
 ...
 CONSTRAINT [PK_ColorLibraryPantonePNUncoated] PRIMARY KEY CLUSTERED 
(
	[BookOrder] ASC
...
ALTER TABLE [dbo].[ColorLibraryPantonePNUncoated] ADD  CONSTRAINT [DF_ColorLibraryPantonePNUncoated_PANTONEType]  DEFAULT (N'PANTONE Pastels & Neons UNCOATED') FOR [PANTONEType]
ALTER TABLE [dbo].[ColorLibraryPantonePNUncoated] ADD  CONSTRAINT [DF_ColorLibraryPantonePNUncoated_Active]  DEFAULT ((1)) FOR [Active]
ALTER TABLE [dbo].[ColorLibraryPantonePNUncoated] ADD  CONSTRAINT [DF_ColorLibraryPantonePNUncoated_ColorLibraryTypeID]  DEFAULT ('00000000-0000-0000-0000-0000000000f)') FOR [ColorLibraryTypeID]
...
VALUES ('DB_Version', '5.0.0000', '05007', GetDate())
GO
