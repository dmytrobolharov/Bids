/****** Object:  StoredProcedure [dbo].[spx_TACalendar_ColorWorkflowReferences_Progress_UPDATE]    Script Date: 08/20/2014 15:54:34 ******/
...
BEGIN
	...
	WHERE (cr.TACalTemplateId = @TACalTemplateID OR @TACalTemplateID IS NULL) AND (cr.ReferenceId = @ColorFolderID OR @ColorFolderID IS NULL)
...
VALUES ('DB_Version', '6.0.0000', '08903', GetDate())
GO
