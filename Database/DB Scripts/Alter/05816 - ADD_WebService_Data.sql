...
-- Trade Partner Address
IF (SELECT COUNT(WebServiceItemName)
       FROM sWebServiceItem
       WHERE UPPER(WebServiceItemName) = UPPER('Trade Partner Address')) < 1
BEGIN
       -- Trade Partner Address
       INSERT INTO sWebServiceItem(WebServiceID, WebServiceItemName, WebServiceItemDefaultSchema, Active)
       VALUES ('BE1720B4-8361-4B1B-AFEA-C13BE58B72EA', 'Trade Partner Address', '', 1)
END
GO


INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
VALUES ('DB_Version', '0.5.0000', '05816', GetDate())
GO
