/****** Object:  StoredProcedure [dbo].[spx_StyleCostingHeader_INSERT]    Script Date: 11/22/2012 14:53:22 ******/
...
CREATE PROCEDURE [dbo].[spx_StyleCostingHeader_INSERT](
	...
	,@StyleCostingHeaderID UNIQUEIDENTIFIER = NULL OUTPUT
)
...
VALUES     ('DB_Version', '5.0.0000', '04421', GetDate())
GO
