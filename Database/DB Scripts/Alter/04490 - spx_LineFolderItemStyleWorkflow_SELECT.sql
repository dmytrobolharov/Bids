...
/****** Object:  StoredProcedure [dbo].[spx_LineFolderItemStyleWorkflow_SELECT]    Script Date: 11/29/2012 15:28:35 ******/
...
WHERE     (pStyleWorkflow.StyleID = @StyleID) AND (pStyleWorkflow.StyleSet = 1) AND pWorkflowTemplateItem.WorkflowTemplateID = @StyleWorkflowID and pWorkflowTemplateItem.WorkflowID <> '70000000-0000-0000-0000-000000000001'
...
VALUES     ('DB_Version', '5.0.0000', '04490', GetDate())
GO
