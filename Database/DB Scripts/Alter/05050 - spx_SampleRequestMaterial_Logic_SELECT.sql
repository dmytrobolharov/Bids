...
--+ @delim + convert(varchar(100), tb_pivot) + @delim + ' THEN  CONVERT(NVARCHAR(40),CDate,101) ELSE ''-----''  '  ) + ', '
+ @delim + convert(varchar(100), tb_pivot) + @delim + ' THEN  CDate ELSE NULL  '  ) + ', '
...
VALUES ('DB_Version', '5.0.0000', '05050', GetDate())
GO
