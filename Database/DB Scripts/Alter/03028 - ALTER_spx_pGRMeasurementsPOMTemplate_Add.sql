...
IF EXISTS (select * from sysobjects where id = object_id('spx_pGRMeasurementsPOMTemplate_Add') and sysstat & 0xf = 4)
    drop procedure spx_pGRMeasurementsPOMTemplate_Add
GO


CREATE PROCEDURE spx_pGRMeasurementsPOMTemplate_Add
(
...
VALUES ('DB_Version', '4.2.0000', '03028', GetDate())
GO
