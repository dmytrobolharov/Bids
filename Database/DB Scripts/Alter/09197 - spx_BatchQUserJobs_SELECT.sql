...
GO
/****** Object:  StoredProcedure [dbo].[spx_BatchQUserJobs_SELECT]    Script Date: 12/15/2014 16:00:43 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	SELECT @Amount = COUNT(*) FROM dbo.sPermissionFolder 
	INNER JOIN dbo.uUserGroup AS gr on sPermissionFolder.GroupId = gr.GroupID
	WHERE sPermissionFolder.PermissionFolderTypeId = '18' 
	AND sPermissionFolder.PermissionFolderNotLocked = '1' AND gr.TeamID = @TeamID
...
VALUES ('DB_Version', '6.1.0000', '09197', GetDate())
GO
