IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vwx_Control_CDFeature_SELECT]'))
DROP VIEW [dbo].[vwx_Control_CDFeature_SELECT]
GO
...
SELECT     TOP (100) PERCENT dbo.pConLevel3.Level3ID, dbo.pConLevel3.Level3Desc, dbo.pConLevel3.Detail, dbo.pConLevel3.ImageID, dbo.pConLevel3.ImageVersion, 
                      ...
                      dbo.pConLevel1.Level1Desc, dbo.pConLevel2.Level2Desc, dbo.pConstructTree.SerialNumber, dbo.pConstructTree.Level0ID, dbo.pConLevel0.Level0Desc
FROM         dbo.pConLevel3 INNER JOIN
                      ...
                      dbo.pConLevel2 ON dbo.pConstructTree.Level2ID = dbo.pConLevel2.Level2ID INNER JOIN
                      dbo.pConLevel0 ON dbo.pConstructTree.Level0ID = dbo.pConLevel0.Level0ID

GO

IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02141'))
	BEGIN
		INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
		VALUES     ('DB_Version', '4.1.0000', '02141', GetDate())
	END
GO