/****** Object:  StoredProcedure [dbo].[rpx_Style_Print_Comments_SELECT]    Script Date: 10/11/2012 13:03:08 ******/
...
CREATE PROCEDURE [dbo].[rpx_Style_Print_Comments_SELECT]   
	...
	@WorkflowItemID  VARCHAR(255) = NULL
...
VALUES     ('DB_Version', '5.0.0000', '04150', GetDate())
GO