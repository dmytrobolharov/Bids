DELETE FROM sCurrencyType WHERE CUser IS NULL AND MUser IS NULL
GO
...
INSERT INTO #tmpCurrency (CountryName, Currency, Code) VALUES ('Azerbaijan','Manat','AZN')
...
INSERT INTO #tmpCurrency (CountryName, Currency, Code) VALUES ('Bosnia - Herzegovina','Marka','BAM')
...
INSERT INTO #tmpCurrency (CountryName, Currency, Code) VALUES ('Congo','Franc','CDF')
...
INSERT INTO #tmpCurrency (CountryName, Currency, Code) VALUES ('Cuba (Convertible)','Peso (Conv.)','CUC')
...
INSERT INTO #tmpCurrency (CountryName, Currency, Code) VALUES ('European Union','Euro','EUR')
INSERT INTO #tmpCurrency (CountryName, Currency, Code) VALUES ('Falkland Islands','Pound','FKP')
...
INSERT INTO #tmpCurrency (CountryName, Currency, Code) VALUES ('Maldives ','Rufiyaa','MVR')
...
INSERT INTO #tmpCurrency (CountryName, Currency, Code) VALUES ('Myanmar','Kyat','MMK')
...
INSERT INTO #tmpCurrency (CountryName, Currency, Code) VALUES ('Peru','Sol','PEN')
...
INSERT INTO #tmpCurrency (CountryName, Currency, Code) VALUES ('Romania','Leu','RON')
...
INSERT INTO #tmpCurrency (CountryName, Currency, Code) VALUES ('Sao Tome - Principe','Dobra','STD')
...
INSERT INTO #tmpCurrency (CountryName, Currency, Code) VALUES ('Taiwan','Dollar','TWD')
...
INSERT INTO #tmpCurrency (CountryName, Currency, Code) VALUES ('Trinidad - Tobago','Dollar','TTD')
...
VALUES ('DB_Version', '5.0.0000', '04718', GetDate())
GO
