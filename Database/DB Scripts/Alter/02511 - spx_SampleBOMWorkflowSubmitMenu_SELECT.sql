...
/****** Object:  StoredProcedure [dbo].[spx_SampleBOMWorkflowSubmitMenu_SELECT]    Script Date: 12/23/2011 00:10:20 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_SampleBOMWorkflowSubmitMenu_SELECT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_SampleBOMWorkflowSubmitMenu_SELECT]
GO
...
CREATE PROCEDURE [dbo].[spx_SampleBOMWorkflowSubmitMenu_SELECT]
(@StyleSet int,
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02511'))
BEGIN
	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES ('DB_Version', '4.1.0000', '02511', GetDate())
END
