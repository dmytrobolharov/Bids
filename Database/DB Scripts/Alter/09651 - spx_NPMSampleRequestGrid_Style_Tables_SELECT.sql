IF OBJECT_ID(N'[dbo].[spx_NPMSampleRequestGrid_Style_Tables_SELECT]') IS NOT NULL
...
BEGIN
	...
	ISNULL(e.MainColor,'NA') AS Color ,  c.StyleNo , c.DueDate as TechPack , COALESCE(sc.Custom, c.SizeClass) AS SizeClass , c.TechPackID, 
...
BEGIN
	...
	ORDER BY tpm.AgentName, tpm.VendorName, tpm.FactoryName, c.StyleNo, FOO.StyleSet , Color
...
VALUES ('DB_Version', '6.1.0000', '09651', GetDate())
GO
