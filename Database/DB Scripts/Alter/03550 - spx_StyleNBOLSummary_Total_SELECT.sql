...
SELECT DISTINCT pStyleNBOLItems.OperationTypeID, pNBOLOperationType.Name 
	FROM pStyleNBOLItems INNER JOIN pNBOLOperationType ON pStyleNBOLItems.OperationTypeID = pNBOLOperationType.OperationTypeID
WHERE MacroID IS NULL
...
VALUES     ('DB_Version', '5.0.0000', '03550', GetDate())
GO