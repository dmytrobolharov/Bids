IF OBJECT_ID(N'[dbo].[rpx_CalendarMilestoneSummary_SELECT]') IS NOT NULL
...
INNER JOIN #tmpSizeClass tscl ON COALESCE(sc.Custom, sh.SizeClass) = tscl.SizeClass
...
VALUES ('DB_Version', '6.1.0000', '09586', GetDate())
GO
