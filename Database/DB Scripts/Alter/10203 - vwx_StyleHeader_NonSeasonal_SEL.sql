IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vwx_StyleHeader_NonSeasonal_SEL]'))
...
SELECT sh.StyleID, sh.StyleMasterID, sh.StyleWorkflowID, sh.StyleType, sh.WorkflowType, sh.RefNo, sh.StyleNo, sh.TempID, 
	   ...
	   sh.LinePlanItemID, sh.StyleStatusID, sh.BodyID, sh.TradePartnerID, sh.TradePartnerVendorID, sh.HeaderLocked, sh.IntroSeasonYearID,sy.SeasonYear, 
...
LEFT JOIN vwx_SeasonYear_SEL sy ON sy.SeasonYearID = sh.IntroSeasonYearID   

GO

INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
VALUES ('DB_Version', '6.1.0000', '10203', GetUTCDate())
GO
