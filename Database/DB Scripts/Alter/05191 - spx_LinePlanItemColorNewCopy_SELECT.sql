/****** Object:  StoredProcedure [dbo].[spx_LinePlanItemColorNewCopy_SELECT]    Script Date: 02/28/2013 14:06:48 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_LinePlanItemColorNewCopy_SELECT]') AND type in (N'P', N'PC'))
...
SELECT a.ColorPaletteID, a.ColorFolderID, a.ColorCode, a.ColorName, a.ColorSource, a.ColorNotes, 
	...
	'<img src="../System/Control/ColorStream.ashx?S=20&CFID=' + CAST(a.ColorFolderID AS NVARCHAR(50)) 
	+ '&CPID=' + CAST(a.ColorPaletteID AS NVARCHAR(50)) +  '" border="0" />'
...
VALUES ('DB_Version', '5.0.0000', '05191', GetDate())
