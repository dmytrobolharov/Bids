...
BEGIN
	...
	INSERT INTO #tempUnitStyle (ColumnOrder, ColumnName, ColumnAlias, ColumnDatatype, ColumnEnabled, ColumnVisible, CssClass, DefaultValue)
	VALUES(2, 'StyleCostingCustomField7', 'Duty %', 'percentbox', 1, 1, '', '0.00')
	INSERT INTO #tempUnitStyle (ColumnOrder, ColumnName, ColumnAlias, ColumnDatatype, ColumnEnabled, ColumnVisible, CssClass, DefaultValue)
	VALUES(3, 'StyleCostingCustomField8', 'Duty $', 'numeric', 0, 1, 'Underlined', '0.00')
	INSERT INTO #tempUnitStyle (ColumnOrder, ColumnName, ColumnAlias, ColumnDatatype, ColumnEnabled, ColumnVisible, CssClass, DefaultValue)
	VALUES(4, 'StyleCostingCustomField9', 'Comission %', 'percentbox', 1, 1, '', '0.00')
	INSERT INTO #tempUnitStyle (ColumnOrder, ColumnName, ColumnAlias, ColumnDatatype, ColumnEnabled, ColumnVisible, CssClass, DefaultValue)
	VALUES(5, 'StyleCostingCustomField10', 'Comission $', 'numeric', 0, 1, 'Underlined', '0.00')
	INSERT INTO #tempUnitStyle (ColumnOrder, ColumnName, ColumnAlias, ColumnDatatype, ColumnEnabled, ColumnVisible, CssClass, DefaultValue)
	VALUES(6, 'StyleCostingCustomField11', 'Agent %', 'percentbox', 1, 1, '', '0.00')
	INSERT INTO #tempUnitStyle (ColumnOrder, ColumnName, ColumnAlias, ColumnDatatype, ColumnEnabled, ColumnVisible, CssClass, DefaultValue)
	...
	INSERT INTO #tempUnitStyle (ColumnOrder, ColumnName, ColumnAlias, ColumnDatatype, ColumnEnabled, ColumnVisible, CssClass, DefaultValue)
	VALUES(20, 'StyleCostingCustomField17', 'Wholesale Mark Up %', 'percentbox', 0, 1, 'Underlined', '0.00')
	INSERT INTO #tempUnitStyle (ColumnOrder, ColumnName, ColumnAlias, ColumnDatatype, ColumnEnabled, ColumnVisible, CssClass, DefaultValue)
	...
	INSERT INTO #tempUnitStyle (ColumnOrder, ColumnName, ColumnAlias, ColumnDatatype, ColumnEnabled, ColumnVisible, CssClass, DefaultValue)
	VALUES(25, 'StyleCostingCustomField18', 'Retail Mark Up %', 'percentbox', 0, 1, 'Underlined', '0.00')
	INSERT INTO #tempUnitStyle (ColumnOrder, ColumnName, ColumnAlias, ColumnDatatype, ColumnEnabled, ColumnVisible, CssClass, DefaultValue)
	...
	INSERT INTO #tempUnitStyle (ColumnOrder, ColumnName, ColumnAlias, ColumnDatatype, ColumnEnabled, ColumnVisible, CssClass, DefaultValue)
	VALUES(30, 'StyleCostingCustomField44', 'Weighted Markup %', 'percentbox', 0, 1, 'GridGroupEnd', '0.00')
	INSERT INTO #tempUnitStyle (ColumnOrder, ColumnName, ColumnAlias, ColumnDatatype, ColumnEnabled, ColumnVisible, CssClass, DefaultValue)
...
VALUES     ('DB_Version', '5.0.0000', '03942', GetDate())
GO
