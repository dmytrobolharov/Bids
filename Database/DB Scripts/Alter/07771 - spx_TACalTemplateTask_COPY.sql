/****** Object:  StoredProcedure [dbo].[spx_TACalTemplateTask_COPY]    Script Date: 05/28/2014 16:33:59 ******/
...
CREATE TABLE dbo.#tempTA
	...
	SELECT TACalTemplateTaskNEWID, @TACalTemplateNEWID, TaskAssignedToId, TaskDepId, TaskDepTypeId, TaskDuration, TaskId, TaskName, TaskPlanEnd, TaskPlanStart, TaskProgress, TaskTypeId, TaskWorkflowId, endIsMilestone, level, startIsMilestone, Active, @CDate, @CUser, @CDate, @CUser from pTACalTemplateTask 
...
VALUES ('DB_Version', '0.5.0000', '07771', GetDate())
GO