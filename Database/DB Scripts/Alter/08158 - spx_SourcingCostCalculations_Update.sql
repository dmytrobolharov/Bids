...
--If @StyleBOMDimensionId <> '00000000-0000-0000-0000-000000000000'
	...
	if @DetailsCnt>0 
			AND @StyleCostingTypeID <> 9 -- is not Pre Pack costing type
		begin
		...
		begin
			...
			Declare @StyleQuoteItem_EcomUnits decimal(18,3)    --Ecom Units
			...
			Select @StyleQuoteItemCustomField2 = StyleQuoteItemCustomField2,
					...
					@StyleQuoteItem_EcomUnits = StyleQuoteItem_EcomUnits,
					@StyleQuoteItemCustomField16 = StyleQuoteItemCustomField16
			FROM pStyleQuoteItem
			WHERE StyleQuoteItemID=@StyleQuoteItemID  

			If @StyleQuoteItemCustomField2 is null and @StyleQuoteItemCustomField6 is null and @StyleQuoteItem_EcomUnits is null 
				and @StyleQuoteItemCustomField16 is not null
			Begin
			...
			Begin
				...
				Select @TotalQuantity = ISNULL(StyleQuoteItemCustomField2, '0') + ISNULL(StyleQuoteItemCustomField6, '0') + ISNULL(StyleQuoteItem_EcomUnits, '0') from pStyleQuoteItem
				WHERE StyleQuoteItemID=@StyleQuoteItemID  
			End
...
VALUES ('DB_Version', '0.5.0000', '08158', GetDate())
GO
