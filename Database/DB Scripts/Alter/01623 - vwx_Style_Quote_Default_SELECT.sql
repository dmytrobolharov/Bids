...
AS
SELECT distinct TOP (100) PERCENT dbo.pStyleQuoteItem.StyleQuoteItemID, dbo.pStyleQuoteItem.StyleID, dbo.pStyleQuoteItem.StyleQuoteItemNo, 
...
Go
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='01623'))
BEGIN
	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '01623', GetDate())
END
