/****** Object:  StoredProcedure [dbo].[spx_StyleQuoteHistory_SELECT]    Script Date: 02/12/2013 15:26:01 ******/
...
FROM  pStyleQuoteItem WITH (NOLOCK) INNER JOIN
	  pStyleQuoteItemShare ON pStyleQuoteItemShare.StyleQouteItemID = pStyleQuoteItem.StyleQuoteItemID 
		AND pStyleQuoteItemShare.TradePartnerID = @TeamId INNER JOIN
...
VALUES ('DB_Version', '5.0.0000', '05049', GetDate())
GO