...
AND c.StyleColorID NOT IN (
	SELECT StyleColorID
	FROM pStyleBOMDimensionItem 
		INNER JOIN pStyleColorway ON COALESCE(ItemDim1Id, ItemDim2Id, ItemDim3Id, '00000000-0000-0000-0000-000000000000') = pStyleColorway.StyleColorID 
			AND pStyleBOMDimensionItem.StyleID = pStyleColorway.StyleID
...
VALUES ('DB_Version', '0.5.0000', '07313', GetDate())
GO
