IF OBJECT_ID(N'[dbo].[rpx_Sourcing_SampleRequest_TradePartner_DataTable_PIVOT]') IS NOT NULL
...
VALUES ('DB_Version', '6.1.0000', '09614', GetDate())
GO
