...
AS
SELECT     TOP (100) PERCENT dbo.pStyleQuoteItem.StyleQuoteItemID, dbo.pStyleQuoteItem.StyleID, dbo.pStyleQuoteItem.StyleQuoteItemNo, 
...
FROM         dbo.pStyleQuoteItem INNER JOIN
                      dbo.pStyleSeasonYear ON dbo.pStyleQuoteItem.StyleSeasonYearID = dbo.pStyleSeasonYear.StyleSeasonYearID RIGHT OUTER JOIN
                      ...
                      dbo.pStyleColorway ON dbo.pStyleQuoteItem.StyleColorID = dbo.pStyleColorway.StyleColorID
...
VALUES     ('DB_Version', '4.0.0000', '906', GetDate())
GO
