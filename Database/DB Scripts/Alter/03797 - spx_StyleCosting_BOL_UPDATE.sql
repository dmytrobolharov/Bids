...
CREATE TABLE #tmp_bol_list(
	...
	Comments nvarchar(200) collate database_default NULL,
	ImageID uniqueidentifier NULL,
	ImageType nvarchar(50) collate database_default NULL,
	SAM numeric(10, 2) NULL,
	Coef numeric(10, 2) NULL,
	Adj nvarchar(20) collate database_default NULL,
...
--	StyleColorID uniqueidentifier NULL,
	...
	FactoryCurr nvarchar(5) collate database_default NULL,
	CurrRate numeric(10,2) NULL,
	ConvCurrRate numeric(10,2) NULL,
	ConvCurr nvarchar(5) collate database_default NULL,
	ConvCost numeric(10,2) NULL,
	sTotaltime nvarchar(50) collate database_default NULL,			-- variables
	sCost nvarchar(50) collate database_default NULL,				-- for
	sConvCost nvarchar(50) collate database_default NULL			-- output
	);
...
--	StyleColorID uniqueidentifier NULL,
	Sort int NULL,
	BaseRateId uniqueidentifier NULL,
	BaseRateCode nvarchar(200) collate database_default NULL,
	Totaltime numeric(10,2) NULL,
	ConvCost numeric(10,2) NULL,
	ConvCurr nvarchar(5) collate database_default NULL,
	sTotaltime nvarchar(50) collate database_default NULL,			-- variables
	sConvCost nvarchar(50) collate database_default NULL			-- for output
)
...
SELECT s.*, e.BOLExceptionId, e.BOLExceptionName, b.SourceBOLId, b.TradePartnerId, b.TradeVendorId, b.Adj AS SourcingAdj
		FROM vw_StyleBOL_SELECT s
		INNER JOIN pStyleBOLException e ON s.StyleID = e.StyleId AND s.StyleSet = e.StyleSet
		LEFT JOIN pStyleSourcingBOL b ON s.PageOperationId = b.PageOperationId
		AND ISNULL(s.OpToMacroId, '00000000-0000-0000-0000-000000000000') = ISNULL(b.OpToMacroId, '00000000-0000-0000-0000-000000000000')
		AND b.StyleSourcingId = @StyleSourcingId
...
--print 'Price = ' + @BOLCosting + ' ' + @ConvCurr

-- update data in costing table
UPDATE pStyleCosting 
SET StyleSourcingID = @StyleSourcingId,
	BOLCost = @BOLCosting,
	BOLCurr = @ConvCurr
...
VALUES ('DB_Version', '5.0.0000', '03797', GetDate())
GO
