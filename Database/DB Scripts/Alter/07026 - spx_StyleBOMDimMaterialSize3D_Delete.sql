/****** Object:  StoredProcedure [dbo].[spx_StyleBOMDimMaterialSize3D_Delete]    Script Date: 01/28/2014 16:49:30 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_StyleBOMDimMaterialSize3D_Delete]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_StyleBOMDimMaterialSize3D_Delete]
GO
...
CREATE PROCEDURE [dbo].[spx_StyleBOMDimMaterialSize3D_Delete] (
...
VALUES ('DB_Version', '0.5.0000', '07026', GetDate())
GO
