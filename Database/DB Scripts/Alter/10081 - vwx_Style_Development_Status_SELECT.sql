...
AS
SELECT ISNULL(g.GroupName, '') AS GroupName, dbo.fnx_GetStreamingImagePath(sh.DesignSketchID, sh.DesignSketchVersion, 2000) AS ImagePath, 
...
VALUES ('DB_Version', '6.1.0000', '10081', GetUTCDate())
GO