...
SELECT     dbo.pStyleCosting.StyleCostingID as ScenarioID, dbo.pStyleCosting.StyleCostingID, dbo.pStyleCosting.StyleCostingTypeID, dbo.pStyleCosting.StyleID, dbo.pStyleCosting.StyleCostingFreightTypeID, 
                      ...
                      dbo.pStyleCosting.StyleCostingScenarioNo, dbo.pStyleCosting.StyleCostingCustomField36, dbo.pStyleCosting.StyleCostingScenarioItemsId, 
                      ...
                      BOL_wi.WorkFlowItemName as BOLname, BOM_wi.WorkFlowItemName as BOMname,
...
FROM         dbo.pStyleCosting INNER JOIN
                      ...
                      dbo.pStyleCostingType ON dbo.pStyleCosting.StyleCostingTypeID = pStyleCostingType.StyleCostingTypeID-- LEFT JOIN
...
VALUES     ('DB_Version', '5.0.0000', '03903', GetDate())
GO
