...
-- select BOL list with sourcing data for one BOL page (standard or some exception)
IF @ExceptionId = '00000000-0000-0000-0000-000000000000'  -- standard
BEGIN
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02227'))
	BEGIN
		INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
		VALUES ('DB_Version', '4.1.0000', '02227', GetDate())
	END
GO