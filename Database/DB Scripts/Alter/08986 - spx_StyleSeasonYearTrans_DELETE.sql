/****** Object:  StoredProcedure [dbo].[spx_StyleSeasonYearTrans_DELETE]    Script Date: 08/23/2014 14:24:28 ******/
...
AS 
BEGIN
	IF EXISTS(SELECT * FROM pStyleSeasonYear WHERE StyleID = @StyleID AND SeasonYearID = @SeasonYearID)
	BEGIN
		...
		WHERE ct.SeasonYearId = @SeasonYearID AND cr.ReferenceId = @StyleID AND cr.TACalReferenceTypeId = 2
...
VALUES ('DB_Version', '6.0.0000', '08986', GetDate())
GO