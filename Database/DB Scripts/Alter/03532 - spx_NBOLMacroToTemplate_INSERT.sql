...
INSERT INTO pNBOLTemplateItem
    (TemplateID, ParentID, OperationID, ImageID, Code, Name, MachineID, CUser, CDate, MUser, MDate, Active, Sort, Sort2)
SELECT @TemplateId, @TemplateItemId, o.OperationID, o.ImageID, o.OperationCode, o.OperationName, o.MachineID, @CUser, @CDate, @CUser, @CDate, @Active, @vcCount, otm.Sort
FROM pNBOLOpToMacro otm INNER JOIN pNBOLOperation o
	ON otm.OperationID = o.OperationID
...
VALUES     ('DB_Version', '5.0.0000', '03532', GetDate())
GO
