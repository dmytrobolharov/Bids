IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_NPMSampleWorkflowSilhoBOMGridTable_SELECT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_NPMSampleWorkflowSilhoBOMGridTable_SELECT]
GO

CREATE  PROCEDURE [dbo].[spx_NPMSampleWorkflowSilhoBOMGridTable_SELECT] (
...
VALUES ('DB_Version', '0.5.0000', '06018', GetDate())
GO
