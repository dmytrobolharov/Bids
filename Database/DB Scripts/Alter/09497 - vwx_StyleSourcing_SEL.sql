IF OBJECT_ID(N'[dbo].[vwx_StyleSourcing_SEL]') IS NOT NULL
 DROP VIEW [dbo].[vwx_StyleSourcing_SEL]
GO

CREATE VIEW [dbo].[vwx_StyleSourcing_SEL]
AS
SELECT sh.StyleID, sh.StyleMasterID, sh.StyleWorkflowID, sh.StyleType, sh.WorkflowType, sh.RefNo, sh.StyleNo, 
	   ...
	   sh.CustomField2, sh.CustomField3, sh.CustomField4, sh.CustomField5, sh.CustomField6, sh.CustomField7, 
	   sh.CustomField8, sh.CustomField9, sh.CustomField10, sh.CustomField11, sh.CustomField12, sh.CustomField13, 
       sh.CustomField14, sh.CustomField15, sh.Pc1, sh.Pc2, sh.Pc3, sh.Pc4, sh.NoColorCombo, sh.StyleVersion, sh.StyleDetail, 
	   sh.StyleDetail1, sh.StyleAttribute, sh.StyleDetail2, sh.LinePlanSketchID, sh.LinePlanSketchVersion, sh.LinePlanID, 
       sh.LinePlanNo, sh.CustomField16, sh.CustomField17, sh.CustomField18, sh.CustomField19, sh.CustomField20, sh.CustomField21, 
	   sh.CustomField22, sh.CustomField23, sh.CustomField24, sh.CustomField25, sh.CustomField26, sh.CustomField27, 
	   sh.CustomField28, sh.CustomField29, sh.CustomField30, sh.PackagingNo, sh.StyleCopyID, ss.SourcingName, ss.CDate, 
	   ss.CUser, ss.MDate, ss.MUser, ss.StyleSourcingID, ss.TradePartnerID, ss.TradePartnerVendorID, ss.Custom1, ss.Custom2, 
	   ss.Active
FROM pStyleHeader sh 
INNER JOIN pStyleSourcing ss ON sh.StyleID = ss.StyleID
...
VALUES ('DB_Version', '6.1.0000', '09497', GetDate())
GO
