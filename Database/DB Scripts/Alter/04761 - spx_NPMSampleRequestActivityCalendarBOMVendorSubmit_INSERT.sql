/****** Object:  StoredProcedure [dbo].[spx_NPMSampleRequestActivityCalendarBOMVendorSubmit_INSERT]    Script Date: 01/15/2013 17:38:48 ******/
...
BEGIN
	...
	SELECT @CalendarId AS CalendarId, pSampleRequestSubmit.SampleRequestWorkflowID, pSampleRequestSubmit.SampleRequestTradeId, 
		...
		'<b>A: </b>' + dbo.uTradePartner.TradePartnerCode + ' / <b>V: </b>' + dbo.uTradePartner.TradePartnerName + '<BR>' + dbo.pStyleHeader.StyleNo + 
...
VALUES ('DB_Version', '5.0.0000', '04761', GetDate())
GO
