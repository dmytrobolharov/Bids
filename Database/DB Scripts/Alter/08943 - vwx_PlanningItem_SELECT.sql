/****** Object:  View [dbo].[vwx_PlanningItem_SELECT]    Script Date: 08/21/2014 16:17:16 ******/
...
SELECT     dbo.pPlanningItem.PlanningID, dbo.pPlanningItem.PlanningItemID, dbo.pPlanningItem.PlanningItemDrop, dbo.pPlanningItem.PlanningItemDropUser, 
                      ...
                      dbo.pStyleHeader.Designer, dbo.pStyleHeader.TechnicalDesigner, dbo.pStyleHeader.ProductionManager, dbo.pStyleHeader.WashType, dbo.pStyleDevelopmentItem.Variation,
...
VALUES ('DB_Version', '6.0.0000', '08943', GetDate())
GO
