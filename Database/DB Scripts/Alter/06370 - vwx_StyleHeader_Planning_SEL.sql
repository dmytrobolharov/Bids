IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vwx_StyleHeader_Planning_SEL]'))
...
SELECT     dbo.pStyleHeader.StyleID, dbo.pStyleHeader.WorkflowTemplateID, dbo.pStyleHeader.PlannedDueDate, dbo.pStyleHeader.EnforceDependency, 
                      ...
                      dbo.pPlanningItem.PlanningID, dbo.pPlanningItem.PlanningItemID
FROM         dbo.pStyleHeader LEFT OUTER JOIN
                      ...
                      dbo.pPlanningItem ON dbo.pStyleHeader.StyleID = dbo.pPlanningItem.StyleID
...
VALUES ('DB_Version', '0.5.0000', '06370', GetDate())
GO
