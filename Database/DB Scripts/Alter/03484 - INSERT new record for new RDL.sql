...
BEGIN
	...
	BEGIN
		SET @ReportMapId			= '70000000-0000-0000-0000-000000000999'	--Parent PK id.
		SET @ReportTemplateName		= 'Style_Header_LLT'						--Header RDL name.
		SET @ReportPageName			= 'Design Images'							--Name of the new report to show on screen.
		SET @ReportPageDescription	= 'Design Images'							--Additional name field, not shown on screen.
		SET @ReportServerType		= 'SQL'										--Report type.  'SQL' for RDLs and 'ASPX' for code-based reports.
		SET @ReportFormName			= 'Style_DesignImages_Body_LLT'				--Body RDL name.
...
VALUES ('DB_Version', '5.0.0000', '03484', GetDate())
GO