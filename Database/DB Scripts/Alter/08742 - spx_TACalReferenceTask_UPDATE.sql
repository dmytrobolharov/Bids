/****** Object:  StoredProcedure [dbo].[spx_TACalReferenceTask_UPDATE]    Script Date: 08/11/2014 23:21:32 ******/
...
where tw.WorkflowFolder='MATERIAL' and tt.TACalTemplateId=@TACalTemplateId  and ((tt.New=1 AND @SeasonYearId = mt.IntroSeasonYearID) OR (tt.CarryOver = 1 AND @SeasonYearId <> mt.IntroSeasonYearID))  and tt.TACalTemplateTaskId = @TACalTemplateTaskID 
...
INNER JOIN pTATaskWorkflow tw ON tw.TATaskWorkflowId = tt.TaskWorkflowId
INNER JOIN pTACalReference cr ON cr.TACalTemplateId = tt.TACalTemplateId
where tw.WorkflowFolder='COLOR' and tt.TACalTemplateId=@TACalTemplateId and tt.TACalTemplateTaskId = @TACalTemplateTaskID  
...
where tw.WorkflowFolder='IMAGE' and tt.TACalTemplateId=@TACalTemplateId  and tt.TACalTemplateTaskId = @TACalTemplateTaskID 
...
VALUES ('DB_Version', '0.5.0000', '08742', GetDate())
GO