/****** Object:  StoredProcedure [dbo].[spx_LinePlanStyleCarryColor_SELECT]    Script Date: 02/05/2013 11:00:09 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_LinePlanStyleCarryColor_SELECT]') AND type in (N'P', N'PC'))
...
VALUES ('DB_Version', '5.0.0000', '04968', GetDate())
GO