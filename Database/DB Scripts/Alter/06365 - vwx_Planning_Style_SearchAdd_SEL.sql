...
FROM         dbo.pStyleHeader INNER JOIN
                      dbo.pStyleType ON dbo.pStyleHeader.StyleType = dbo.pStyleType.StyleTypeID INNER JOIN
				...
				(SELECT vw.*, pd.PlanningID FROM vwx_Division_StyleType_StyleCategory_SELECT vw
...
VALUES ('DB_Version', '0.5.0000', '06365', GetDate())
GO
