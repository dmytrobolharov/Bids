/****** Object:  UserDefinedFunction [dbo].[fnx_Permissions_GetGuidProductType_WorkflowPermissions]    Script Date: 12.01.2015 15:46:59 ******/
...
BEGIN
	...
	BEGIN
		...
		AND folders.PermissionFolderNotLocked = 1 AND workflow.Active = 1 AND pt.Active = 1 
	...
	BEGIN
		...
		AND workflow.Active = 1 AND pt.Active = 1 
...
VALUES ('DB_Version', '6.1.0000', '09216', GetDate())
GO
