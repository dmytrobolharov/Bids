IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vwx_BI_Quote_Default_SELECT]'))
...
SELECT DISTINCT 
                      ...
                      dbo.pStyleQuoteItem.StyleQuoteItemNo, dbo.pStyleQuoteItem.StyleQuoteItemStatusId, dbo.pStyleQuoteItem.StyleQuoteVariationId, dbo.pStyleQuoteItem.StyleQuoteID, 
                      dbo.pStyleQuoteItem.StyleQuotaDutyID, dbo.pStyleQuoteItem.StyleDevelopmentID, dbo.pStyleQuoteItem.StyleQuoteTradePartnerID, 
                      dbo.pStyleQuoteItem.StyleCostingID, dbo.pStyleQuoteItem.StyleCostingType, dbo.pStyleQuoteItem.StyleCostingFreightTypeID, dbo.pStyleQuoteItem.TradePartnerID, 
                      ...
                      dbo.pStyleHeader.StyleNo, dbo.pStyleHeader.SizeClass, dbo.pStyleHeader.MaterialNo, dbo.pStyleHeader.Pc1, dbo.pStyleQuoteItem.StyleQuoteItemDueDate, 
                      dbo.pStyleQuoteItem.MDate, dbo.pStyleQuoteItem.StyleColorID, dbo.pStyleQuoteItem.StyleSourcingID, dbo.pStyleColorway.StyleColorID AS Expr1, 
                      dbo.pStyleColorway.StyleColorName, dbo.pStyleQuoteItem.StyleQuoteItemCustomField31, dbo.pStyleQuoteItem.StyleSeasonYearID, 
...
FROM         dbo.pStyleQuoteItem INNER JOIN
                      ...
                      dbo.pStyleColorway ON dbo.pStyleQuoteItem.StyleColorID = dbo.pStyleColorway.StyleColorID LEFT OUTER JOIN
                      dbo.pStyleQuoteItemFreightCost ON dbo.pStyleQuoteItem.StyleQuoteItemID = dbo.pStyleQuoteItemFreightCost.StyleQuoteItemId LEFT OUTER JOIN
                      dbo.pStyleSeasonYear ON dbo.pStyleQuoteItem.StyleSeasonYearID = dbo.pStyleSeasonYear.StyleSeasonYearID LEFT OUTER JOIN
                      dbo.pStyleQuoteItemStatus ON dbo.pStyleQuoteItem.StyleQuoteItemStatusId = dbo.pStyleQuoteItemStatus.CustomKey

GO

IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='01931'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '01931', GetDate())
