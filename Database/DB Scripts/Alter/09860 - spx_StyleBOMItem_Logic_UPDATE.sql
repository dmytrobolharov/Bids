...
BEGIN
	...
	INSERT INTO pStyleBOMItem (
		StyleBOMItemID, StyleBOMDimensionID, StyleBOMDimensionItemID, StyleMaterialID, WorkFlowID, WorkFlowItemID, StyleID, StyleSet
	...
	SELECT
		NEWID(), @StyleBOMDimensionId, sbdi.StyleBOMDimensionItemID, #tmpres.StyleMaterialID, src.WorkFlowID, src.WorkFlowItemID, src.StyleID, src.StyleSet
	...
	FROM #tmpRes
		...
		INNER JOIN pStyleBOMDimensionItems sbdi ON sbdi.StyleBOMDimensionID = @StyleBOMDimensionId
			AND ISNULL(#tmpRes.ItemDim1Id, '00000000-0000-0000-0000-000000000000') = ISNULL(sbdi.ItemDim1Id, '00000000-0000-0000-0000-000000000000')
			AND ISNULL(#tmpRes.ItemDim2Id, '00000000-0000-0000-0000-000000000000') = ISNULL(sbdi.ItemDim2Id, '00000000-0000-0000-0000-000000000000')
			AND ISNULL(#tmpRes.ItemDim3Id, '00000000-0000-0000-0000-000000000000') = ISNULL(sbdi.ItemDim3Id, '00000000-0000-0000-0000-000000000000')		
...
VALUES ('DB_Version', '6.1.0000', '09860', GetDate())
GO
