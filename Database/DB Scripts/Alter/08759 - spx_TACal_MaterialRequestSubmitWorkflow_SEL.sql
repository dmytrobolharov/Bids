...
FROM  pMaterialTradePartner 
			...
			LEFT JOIN pMaterialRequestWorkflowTemplateItem ON pMaterialRequestSubmitWorkflow.MaterialRequestWorkflowTempItemID = pMaterialRequestWorkflowTemplateItem.MaterialRequestWorkflowTempItemID 
...
VALUES ('DB_Version', '0.5.0000', '08759', GetDate())
GO
