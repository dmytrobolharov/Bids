IF OBJECT_ID(N'[dbo].[spx_Sample_WorkFlowItemList_SELECT]') IS NOT NULL
...
DECLARE @IsSeasonal INT = (SELECT IsSeasonal FROM Mapping WHERE Map = @WorkflowID),
		@StyleSeasonYearID uniqueidentifier = (SELECT TOP 1 StyleSeasonYearID FROM pStyleSeasonYear WHERE StyleID = @StyleID AND SeasonYearID = @SeasonYearID)
...
VALUES ('DB_Version', '6.0.0001', '09216', GetDate())
GO
