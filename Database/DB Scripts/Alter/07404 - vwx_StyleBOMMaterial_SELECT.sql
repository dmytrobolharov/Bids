...
CREATE VIEW [dbo].[vwx_StyleBOMMaterial_SELECT]
AS
SELECT DISTINCT 
                      ...
                      dbo.pStyleBOM.UOM, dbo.pStyleBOM.MaterialColorId, dbo.pStyleBOM.Qty, dbo.pStyleBOM.MaterialPrice, dbo.pStyleBOM.Ext, dbo.pMaterialSize.MaterialSize, 
...
FROM         dbo.uTradePartnerVendor RIGHT OUTER JOIN
                      ...
                      dbo.pMaterialSize ON pMaterial.MaterialID = pMaterialSize.MaterialID AND pMaterialSize.MaterialSizeID = pStyleBOM.MaterialSizeID LEFT OUTER JOIN
                      dbo.pStyleHeader ON dbo.pStyleHeader.StyleNo = dbo.pStyleBOM.MaterialNo
GO


INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
VALUES ('DB_Version', '0.5.0000', '07404', GetDate())
GO
