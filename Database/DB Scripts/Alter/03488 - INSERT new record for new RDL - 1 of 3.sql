...
BEGIN
	...
	BEGIN
		...
		SET @ReportPageName			= 'Colorway Images - Details'				--Name of the new report to show on screen.
		SET @ReportPageDescription	= 'Colorway Images - Details'				--Additional name field, not shown on screen.
		SET @ReportServerType		= 'SQL'										--Report type.  'SQL' for RDLs and 'ASPX' for code-based reports.
		SET @ReportFormName			= 'Style_ColorwayImages_Details_Body_LLT'	--Body RDL name.
...
VALUES ('DB_Version', '5.0.0000', '03488', GetDate())
GO