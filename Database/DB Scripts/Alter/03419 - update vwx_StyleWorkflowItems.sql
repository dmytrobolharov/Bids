...
SELECT b.Map, b.MapDetail, b.MapUrl, c.WorkflowStatus, c.WorkflowStatusImage, a.StyleWorkflowID, a.StyleID, a.StyleSet, a.WorkflowID, a.WorkflowType, a.WorkflowOrder, 
       ...
       a.WorkVersion, a.WorkComments, a.WorkSort, a.CUser, a.CDate, a.MUser, a.MDate, d.StyleNo, CAST(e.WorkflowSort as int) WorkflowSort, e.WorkflowTemplateID,
       WorkflowTemplateItemID,
       WorkflowAssignedTo,
       case 
  ...
  FROM pStyleWorkflow AS a WITH (NOLOCK) INNER JOIN
       ...
       pWorkflowTemplateItem AS e WITH (NOLOCK) ON e.WorkflowID = b.Map
...
INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES ('DB_Version', '5.0.0000', '03419', GetDate())
