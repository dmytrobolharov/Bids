...
BEGIN
	...
	SELECT @SampleRequestSubmitNewId, SampleRequestWorkflowID, SampleWorkflowID, SampleRequestTradeID, StyleID, StyleColorID, StyleSet, WorkflowID, TradePartnerVendorID, TradePartnerID, @NewSubmit, 0, StartDate, CONVERT(varchar(10), getdate() + ISNULL(@ResubmitDays,1) , 112), 
...
VALUES     ('DB_Version', '5.0.0000', '04272', GetDate())
GO
