IF OBJECT_ID(N'[dbo].[spx_SampleRequestActivityCalendarAgentShared_INSERT]') IS NOT NULL
 DROP PROCEDURE [dbo].[spx_SampleRequestActivityCalendarAgentShared_INSERT]
GO

CREATE PROCEDURE [dbo].[spx_SampleRequestActivityCalendarAgentShared_INSERT]
...
VALUES ('DB_Version', '6.1.0000', '09680', GetDate())
GO
