/****** Object:  StoredProcedure [dbo].[spx_SampleWorkflowBOMSubmit_Logic_UPDATE]    Script Date: 12/21/2011 17:54:50 ******/
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02482'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '02482', GetDate())
