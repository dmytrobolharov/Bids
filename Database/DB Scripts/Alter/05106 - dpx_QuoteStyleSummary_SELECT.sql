...
IF @QuoteStatusID IS NULL
	SELECT
		...
		, tpm.VendorName
		, tpm.FactoryName
		, CASE WHEN UPPER(tpm.VendorCStatus) = 'FAIL' THEN 1 ELSE 0 END AS isVendorComplianceFailed
		, CASE WHEN UPPER(tpm.FactoryCStatus) = 'FAIL' THEN 1 ELSE 0 END AS isFactoryComplianceFailed
...
VALUES ('DB_Version', '5.0.0000', '05106', GetDate())
GO
