/****** Object:  View [dbo].[vwx_StyleHeader_LineList_SEL]    Script Date: 11/20/2012 16:54:35 ******/
...
/****** Object:  View [dbo].[vwx_StyleHeader_LineList_SEL]    Script Date: 11/20/2012 16:54:36 ******/
SET ANSI_NULLS ON
GO
...
SELECT     dbo.pStyleHeader.StyleID, dbo.pStyleHeader.WorkflowTemplateID, dbo.pStyleHeader.PlannedDueDate, dbo.pStyleHeader.EnforceDependency, 
                      ...
                      dbo.pStyleHeader.StyleType, dbo.pStyleHeader.StyleCategory, dbo.pStyleHeader.SizeClass
FROM         dbo.pStyleHeader LEFT OUTER JOIN
                      ...
                      dbo.vwx_SeasonYear_SEL ON dbo.pStyleHeader.IntroSeasonYearID = dbo.vwx_SeasonYear_SEL.SeasonYearID

GO

INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
VALUES     ('DB_Version', '5.0.0000', '04393', GetDate())
GO
