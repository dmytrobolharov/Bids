IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_StyleBOMMatQtyMgmtHdr_select]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_StyleBOMMatQtyMgmtHdr_select]
GO


CREATE PROCEDURE [dbo].[spx_StyleBOMMatQtyMgmtHdr_select]
(
...
VALUES ('DB_Version', '6.1.0000', '10278', GetUTCDate())
GO
