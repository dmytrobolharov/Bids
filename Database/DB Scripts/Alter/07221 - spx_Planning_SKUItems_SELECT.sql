...
BEGIN
	...
	'NULL AS [' + CAST(pshdt.PlanningSKUHeaderDimTypeID AS NVARCHAR(50)) + ']'
	...
	WHERE psh.PlanningID = @PlanningID AND psh.SeasonYearID = @SeasonYearID ORDER BY Position
	...
	SELECT sh.StyleNo, ssis.*, 
		...
		ssi.ItemDim1TypeID, ssi.ItemDim2TypeID, ssi.ItemDim3TypeID,
...
VALUES ('DB_Version', '0.5.0000', '07221', GetDate())
GO
