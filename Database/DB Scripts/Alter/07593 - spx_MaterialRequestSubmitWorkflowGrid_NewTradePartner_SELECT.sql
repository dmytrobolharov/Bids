...
SELECT uTradePartner.TradePartnerName, ISNULL(pColorPalette.ColorName, pMaterialTradePartnerColor.ColorName) AS ColorName, 
	...
	ISNULL(pSeasonYear.Season,'') + ' ' + ISNULL(pSeasonYear.[Year],'') AS SeasonYear
...
LEFT JOIN vwx_TradePartnerRelationshipLevels_SEL tpm ON tpm.TradePartnerRelationshipLevelID = pMaterialTradePartner.TradePartnerRelationshipLevelID
LEFT JOIN pSeasonYear ON pMaterialTradePartner.SeasonYearID = pSeasonYear.SeasonYearID
...
VALUES ('DB_Version', '0.5.0000', '07593', GetDate())
GO
