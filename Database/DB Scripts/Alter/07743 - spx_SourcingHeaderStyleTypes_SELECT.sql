...
BEGIN
	...
	WHERE DivisionID = @SourcingFolderDivisionID AND st.StyleTypeID IN (SELECT StyleTypeID FROM sAccessStyleFolder WHERE ( AccessRoleId =3 OR AccessView = 1 )  AND TeamId = @TeamID)
...
VALUES ('DB_Version', '0.5.0000', '07743', GetDate())
GO
