...
BEGIN
	...
	BEGIN
		...
		-- gather info new workflowitem and sku page
		;WITH BOMTypes AS (
		...
		BEGIN		
			...
			UPDATE pPlanningItem SET
				StyleSKUHeaderID = (SELECT StyleSKUItemID FROM pStyleSKUItem WHERE WorkflowItemID = @WorkFlowItemId)
...
VALUES ('DB_Version', '0.5.0000', '07192', GetDate())
GO
