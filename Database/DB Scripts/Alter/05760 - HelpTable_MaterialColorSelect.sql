...
IF NOT EXISTS(SELECT * FROM sSystemPage WHERE MappingPage='Material_New_ColorSelect.aspx')
	BEGIN
		INSERT INTO [sSystemPage] (MappingPage, CDate, CUser, sSystemFolderID)
		VALUES ('Material_New_ColorSelect.aspx', GETDATE(), 'Administrator', (SELECT sSystemFolderID from sSystemFolder where sSystemFolder='Material'))
	END
	GO
...
VALUES     ('DB_Version', '0.5.0000', '05760', GetDate())
GO
