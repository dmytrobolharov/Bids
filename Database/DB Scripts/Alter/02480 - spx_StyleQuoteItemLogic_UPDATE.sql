...
/***********************************************************/
/*** Procedure which calculates pStyleQuoteItem fields *****/
...
/****************************************/
 ...
 SET @AirTLC = @DomesticTotalCost + @FreightCost + @AirRate      
 ...
 SET @BoatTLC = @DomesticTotalCost + @FreightCost + @BoatRate  
...
/****************************************/
 ...
 SET @AirTLC = @IndirectTotalCost + @FreightCost + @AirRate      
 ...
 SET @BoatTLC = @IndirectTotalCost + @FreightCost + @BoatRate  
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02480'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '02480', GetDate())
