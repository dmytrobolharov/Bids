/****** Object:  View [dbo].[vwx_LineFolderItem_SELECT]    Script Date: 04/02/2013 17:19:15 ******/
...
/****** Object:  View [dbo].[vwx_LineFolderItem_SELECT]    Script Date: 04/02/2013 17:19:16 ******/
SET ANSI_NULLS ON
GO
...
SELECT     dbo.pLineFolderItem.LineFolderID, dbo.pLineFolderItem.LineFolderItemID, dbo.pLineFolderItem.LineItemFolder1, dbo.pLineFolderItem.LineItemFolder2, 
                      ...
                      dbo.pStyleCategory.StyleCategory AS StyleCategoryName, c.TeamId, c.AccessRoleId, c.AccessModify, dbo.pLineFolderItem.StyleBOMWorkflowItemID
...
VALUES     ('DB_Version', '0.5.0000', '05474', GetDate())
GO
