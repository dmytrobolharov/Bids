/****** Object:  Trigger [tgx_pStyleType_PermissionMapping_UPDATE]    Script Date: 16.02.2015 15:13:37 ******/
...
/****** Object:  Trigger [dbo].[tgx_pStyleType_PermissionMapping_UPDATE]    Script Date: 16.02.2015 15:13:37 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	BEGIN TRY
		UPDATE ppt
		SET Active = st.Active, PermissionProductTypeName = st.StyleTypeDescription
...
VALUES ('DB_Version', '6.1.0000', '09361', GetDate())
GO