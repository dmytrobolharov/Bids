...
BEGIN
	...
	FROM
		...
		INNER JOIN vwx_PlanningSKUHeader_StyleSKU_Matching_SEL vsku ON psh.PlanningSKUHeaderID = vsku.PlanningSKUHeaderID AND pli.StyleID = vsku.StyleID AND vsku.StyleSKUHeaderID IS NULL
	WHERE
...
VALUES     ('DB_Version', '0.5.0000', '08293', GetDate())
GO
