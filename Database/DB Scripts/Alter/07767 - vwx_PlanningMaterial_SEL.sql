...
SELECT     TOP (100) PERCENT dbo.pPlanningMaterial.PlanningMaterialID, dbo.pPlanningMaterial.PlanningID, dbo.pPlanningMaterial.CUser, dbo.pPlanningMaterial.CDate, 
                      ...
                      dbo.pPlanningMaterial.SeasonYearID, dbo.pComponentType.ComponentDescription, pActive.Custom AS ActiveLabel, pMaterial.DueDate,
						(SELECT COUNT(*) FROM pPlanningItem pli
							...
							INNER JOIN pPlanningMaterial pm ON pli.PlanningID = pm.PlanningID AND ssy.SeasonYearID = pm.SeasonYearID AND sb.MaterialID = pm.MaterialID
						WHERE pm.PlanningMaterialID = dbo.pPlanningMaterial.PlanningMaterialID AND pli.PlanningItemDrop = 'No'
...
VALUES              ('DB_Version', '0.5.0000', '07767', GetDate())
GO
