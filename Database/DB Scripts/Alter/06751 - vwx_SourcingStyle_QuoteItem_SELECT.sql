...
SELECT DISTINCT 
                      ...
                      dbo.pStyleHeader.SizeRange, dbo.pStyleCategory.StyleCategoryID, dbo.pStyleHeader.DesignSketchID, dbo.pStyleHeader.DesignSketchVersion, dbo.pStyleHeader.DevelopmentID, 
                      ...
                      'Variation ' + CAST(dbo.pStyleDevelopmentItem.Variation AS nVARCHAR(5))) AS VariationName, CASE WHEN EXISTS
                          (SELECT     *
...
VALUES ('DB_Version', '0.5.0000', '06751', GetDate())
GO
