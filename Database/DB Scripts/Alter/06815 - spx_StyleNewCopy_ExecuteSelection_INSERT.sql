...
BEGIN
	...
	BEGIN
		...
		-- colorways that were added to Seasonal colorway bubble from DimBOM
		INSERT INTO dbo.pStyleColorwaySeasonYear (
			StyleColorwaySeasonYearID, StyleSeasonYearID, StyleColorwayID, ColorPaletteID, StyleID)
		SELECT NEWID(), @StyleSeasonYearID, NULL, a.ColorPaletteID, @NewStyleID 
		FROM dbo.pStyleCopyColorTmp a WITH(NOLOCK)
			INNER JOIN dbo.pStyleColorwaySeasonYear b WITH(NOLOCK) ON a.StyleColorwaySeasonYearID = b.StyleColorwaySeasonYearID
		WHERE a.TransactionID = @TransactionID AND a.StyleColorID IS NULL
	END
...
VALUES ('DB_Version', '0.5.0000', '06815', GetDate())
GO
