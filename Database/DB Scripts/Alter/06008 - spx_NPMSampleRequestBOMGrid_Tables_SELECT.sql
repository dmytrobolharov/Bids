...
SET @SQL  ='  
 ...
 ISNULL(Convert(VARCHAR(50),e.ItemDim1Name),'''') AS Dim1,  
 ISNULL(Convert(VARCHAR(50),f.ItemDim2Name),'''') AS Dim2,  
 ISNULL(Convert(VARCHAR(50),g.ItemDim3Name),'''') AS Dim3,  
...
VALUES ('DB_Version', '0.5.0000', '06008', GetDate())
GO
