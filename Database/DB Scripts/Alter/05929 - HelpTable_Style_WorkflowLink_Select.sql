...
IF NOT EXISTS(SELECT * FROM sSystemPage WHERE MappingPage='Style_WorkflowLink_Select.aspx')
	BEGIN
		INSERT INTO [sSystemPage] (MappingPage, CDate, CUser, sSystemFolderID)
		VALUES ('Style_WorkflowLink_Select.aspx', GETDATE(), 'Administrator', (SELECT sSystemFolderID from sSystemFolder where sSystemFolder='Style'))
	END
GO
...
VALUES ('DB_Version', '0.5.0000', '05929', GetDate())
GO
