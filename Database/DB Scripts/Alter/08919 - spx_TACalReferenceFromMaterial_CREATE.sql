/****** Object:  StoredProcedure [dbo].[spx_TACalReferenceFromMaterial_CREATE]    Script Date: 08/21/2014 14:38:05 ******/
...
SELECT @IntroSeasonYear = ISNULL(IntroSeasonYearID, '00000000-0000-0000-0000-000000000000') 
FROM pMaterial where MaterialID = @MaterialID
...
-- Update progress in related template tasks
EXEC spx_TACalendar_MaterialWorkflowReferences_Progress_UPDATE NULL, @MaterialID, @TACalTemplateID


GO

INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
VALUES ('DB_Version', '6.0.0000', '08919', GetDate())
GO
