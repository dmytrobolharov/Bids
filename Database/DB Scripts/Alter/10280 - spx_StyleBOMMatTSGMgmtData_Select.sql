IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_StyleBOMMatTSGMgmtData_Select]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_StyleBOMMatTSGMgmtData_Select]
GO
...
CREATE PROCEDURE [dbo].[spx_StyleBOMMatTSGMgmtData_Select]
...
SET @query = N'SELECT mat_id, stylematerialId, materialId, materialno, materialname, Placement, UOM, ' +
	...
	(SELECT  t2.mat_id, t2.stylematerialId, t2.materialId, t2.materialno, t2.materialname, t2.Placement, t2.UOM, 
	  t1.dtl_id, t3.MaterialDimension			  
...
VALUES ('DB_Version', '6.1.0000', '10280', GetUTCDate())
GO
