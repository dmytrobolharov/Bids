/****** Object:  StoredProcedure [dbo].[spx_SampleRequestActivityCalendarAgent_INSERT]    Script Date: 06/02/2014 14:55:37 ******/
...
INNER JOIN fnx_Permissions_GetStringProductTypePermissions(@TeamId, 5) access ON sw.SampleWorkflowID = access.ProductTypeId
...
VALUES ('DB_Version', '0.5.0000', '07815', GetDate())
GO
