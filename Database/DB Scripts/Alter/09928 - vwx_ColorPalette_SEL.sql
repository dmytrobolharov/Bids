...
SELECT     '<img src=''' +
  ...
  '00000000-0000-0000-0000-000000000000') AS NVARCHAR(50)) + '&' + CAST(RAND() AS NVARCHAR(50)) + '''  />' AS ColorImagePath, 
  (SELECT     TOP (1) AppSettingValue
        FROM          dbo.sAppSetting
        WHERE      (AppSettingKey = 'ImageServer')) + '/ColorStream.ashx?S=25&CFID=' + CAST(ISNULL(dbo.pColorPalette.ColorFolderID, 
  '00000000-0000-0000-0000-000000000000') AS NVARCHAR(50)) + '&CPID=' + CAST(ISNULL(dbo.pColorPalette.ColorPaletteID, 
  '00000000-0000-0000-0000-000000000000') AS NVARCHAR(50))+ '&' + CAST(RAND() AS NVARCHAR(50)) AS ColorImageUrl,
  dbo.pColorPalette.ColorPaletteID, dbo.pColorPalette.ColorFolderID, 
...
VALUES ('DB_Version', '6.1.0000', '09928', GetDate())
GO
