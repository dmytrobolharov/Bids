...
CREATE PROCEDURE spx_StyleMeasChangeSizeRange_Update
(
...
select @MaxNewSizecnt = count(SizeCount) from pGRSizeRangeDetail where ClassRangeId = @SizeRangeID 
...
Select @OldSampleSizeID = SizeRangeDetailId from pGRSizeRangeDetail where ClassRangeId = @oldSizeRangeID and Sizecount=@oldSampleCol+1
...
VALUES ('DB_Version', '4.2.0000', '03014', GetDate())
GO
