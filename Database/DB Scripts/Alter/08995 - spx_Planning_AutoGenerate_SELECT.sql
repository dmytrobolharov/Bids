...
BEGIN
	...
	SELECT pc.PlanningConfigID, pc.WorkflowTemplateID,
		...
		CAST(((tmp1.PlanningPlanningCh + tmp2.PlanningPlanningCh - tmp3.PlanningPlanningCh) - (tmp1.PlanningDIPCh + tmp1.PlanningActualCh)) as INT) as NoOfStyles
...
VALUES ('DB_Version', '6.0.0000', '08995', GetDate())
GO
