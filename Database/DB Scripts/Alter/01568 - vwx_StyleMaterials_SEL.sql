...
SELECT     dbo.pStyleMaterials.StyleMaterialID, dbo.pStyleMaterials.StyleMaterialMasterID, dbo.pStyleMaterials.CopyStyleMaterialID, dbo.pStyleMaterials.MainMaterial, 
                      ...
                      dbo.pStyleMaterials.MultiMaterialParentID, dbo.pMaterial.MultiDimension
FROM         dbo.pMaterial INNER JOIN
                      dbo.pStyleMaterials ON dbo.pMaterial.MaterialID = dbo.pStyleMaterials.MaterialID


GO

IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='01568'))
BEGIN
	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '01568', GetDate())
END	
GO
