...
IF NOT EXISTS (SELECT * FROM rDashFolderItem WHERE DashFolderItemServerReportName = 'Dash_Commitment_Change_Summary')
BEGIN
	...
	(
		NEWID()
		, @DashStyleFolderID
		, N'Commitment Change Log Summary Report'
		, N'/plmOnDashboards/Dash_Commitment_Change_Summary'
		, N'icon_chart_bar.gif'
		, '009'
		, 1
		, @ReportServer
		, @YuniqueBI
		, N'Dash_Commitment_Change_Summary'
	)
END
GO

INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
VALUES ('DB_Version', '0.5.0000', '06893', GetDate())
GO
