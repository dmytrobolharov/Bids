...
/****** Object:  StoredProcedure [dbo].[spx_Group_AccessUserPermissions_UPDATE]    Script Date: 07/22/2011 21:03:04 ******/
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='01658'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '01658', GetDate())
