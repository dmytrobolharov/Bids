IF OBJECT_ID(N'[dbo].[spx_StyleLink_Set_SeasonYear_INSERT]') IS NOT NULL
...
BEGIN 
	...
	@SizeClassId = @SizeClassId, @SizeRangeId = @SizeRangeId, @CreatedBy = @CUser, @CreatedDate = @CDate
...
--** INSERT pStyleSpec
--***	
EXEC spx_StyleDevelopmentSpecLinkSet_INSERT @StyleID = @StyleID, @NewStyleID = @NewStyleID, @SizeClassId = @SizeClassId,
@SizeRangeId = @SizeRangeId, @CreatedBy = @CUser, @CreatedDate = @CDate, @StyleSet = @StyleSet
...
VALUES ('DB_Version', '6.1.0000', '09985', GetUTCDate())
GO
