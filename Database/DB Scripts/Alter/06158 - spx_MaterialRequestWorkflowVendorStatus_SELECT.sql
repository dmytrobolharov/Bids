...
--	+  CAST(pMaterialRequestSubmitWorkflow.Submit AS VARCHAR(5)) + ')</b></a></TD></TR></TABLE>' AS Link
	...
	+ '''  border=0 ALT=''Open''><TD class=''font'' align=center valign=center nowrap>&nbsp; 
	<a href=''#'' onclick="javascript:window.open(''../Material/Material_RequestSubmitRedirect.aspx?MTPID=' + CAST (pMaterialTradePartner.MaterialTradePartnerId AS VARCHAR(40)) 
...
VALUES ('DB_Version', '0.5.0000', '06158', GetDate())
GO
