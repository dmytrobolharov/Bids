	...
	SET @SQLString = '
        SELECT @pTotal = COUNT(*) FROM (
            SELECT
                ...
                b.Description, b.SizeClass, SUBSTRING(ISNULL(''/'' + tpm.AgentName, '''') + ISNULL(''/'' + tpm.VendorName,'''') + ISNULL (''/'' + tpm.FactoryName, ''''), 2, 1000) as VendorName, a.TradePartnerID,
            ...
            GROUP BY
                ...
                b.StyleNo, b.Description, b.SizeClass, SUBSTRING(ISNULL(''/'' + tpm.AgentName, '''') + ISNULL(''/'' + tpm.VendorName,'''') + ISNULL (''/'' + tpm.FactoryName, ''''), 2, 1000),
...
VALUES ('DB_Version', '5.0.0000', '05216', GetDate())
GO
