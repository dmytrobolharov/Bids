...
BEGIN
	...
	DECLARE @WorkflowTemplateID NVARCHAR(50)
	SELECT @WorkflowTemplateID = ImageWorkflowTemplateID FROM pImage WHERE ImageID = @ImageID
	
	IF ISNULL(@WorkflowTemplateID, '') = ''
		RETURN
...
VALUES ('DB_Version', '0.5.0000', '08723', GetDate())
GO
