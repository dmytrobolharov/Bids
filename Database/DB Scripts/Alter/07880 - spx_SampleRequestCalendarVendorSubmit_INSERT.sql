/****** Object:  StoredProcedure [dbo].[spx_SampleRequestCalendarVendorSubmit_INSERT]    Script Date: 06/04/2014 16:03:15 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_SampleRequestCalendarVendorSubmit_INSERT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_SampleRequestCalendarVendorSubmit_INSERT]
GO
...
CREATE PROCEDURE [dbo].[spx_SampleRequestCalendarVendorSubmit_INSERT]
...
VALUES ('DB_Version', '0.5.0000', '07880', GetDate())
GO