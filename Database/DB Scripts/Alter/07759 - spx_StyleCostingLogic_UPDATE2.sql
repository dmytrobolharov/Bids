IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_StyleCostingLogic_UPDATE2]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_StyleCostingLogic_UPDATE2]
GO



CREATE PROCEDURE [dbo].[spx_StyleCostingLogic_UPDATE2](
...
DECLARE @pStyleCosting_StyleCosting_EcomUnits INT
DECLARE @pStyleCosting_StyleCosting_EcomPriceUnit DECIMAL(18,4)
DECLARE @pStyleCosting_StyleCosting_EcomExtended DECIMAL(18,4)
DECLARE @pStyleCosting_StyleCosting_EcomMarginUnit DECIMAL(18,4)
DECLARE @pStyleCosting_StyleCosting_EcomMarginExtended DECIMAL(18,4)
DECLARE @pStyleCosting_StyleCosting_EcomMargin DECIMAL(18,4)
...
FROM pStyleCostingBOM INNER JOIN
	pStyleCosting ON pStyleCostingBOM.StytleCostingScenarioItemsID = pStyleCosting.StyleCostingScenarioItemsID 
WHERE pStyleCosting.StyleCostingID = @StyleCostingId

SELECT @pStyleCosting_BOLCost = SUM(OperationCost) 
FROM pStyleCostingBOL INNER JOIN
	pStyleCosting ON pStyleCostingBOL.StytleCostingScenarioItemsID = pStyleCosting.StyleCostingScenarioItemsID 
WHERE pStyleCosting.StyleCostingID = @StyleCostingId

SELECT @pStyleCosting_AdditionalCost = SUM(AdditionalItemCost) 
FROM pstyleCostingAdditionalItems INNER JOIN
	pStyleCosting ON pstyleCostingAdditionalItems.StytleCostingScenarioItemsID = pStyleCosting.StyleCostingScenarioItemsID 
WHERE pStyleCosting.StyleCostingID = @StyleCostingId
...
SELECT @pStyleCosting_StyleCostingTypeId = StyleCostingTypeId
 ...
 ,@pStyleCosting_StyleCosting_EcomUnits = ISNULL(StyleCosting_EcomUnits, 0)		  --Ecom UNITS
 ...
 ,@pStyleCosting_StyleCosting_EcomPriceUnit = ISNULL(StyleCosting_EcomPriceUnit, 0) --Ecom / Unit
FROM pStyleCosting
WHERE StyleCostingId = @StyleCostingId
...
SET @pStyleCosting_StyleCostingCustomField19 = @pStyleCosting_StyleCostingCustomField3 + @pStyleCosting_StyleCostingCustomField4 + @pStyleCosting_StyleCosting_EcomUnits
...
/*pStyleCosting.StyleCostingCustomField22 (Retail Extended)*/
...
/*pStyleCosting.StyleCosting_EcomExtended (Ecom Extended)*/
SET @pStyleCosting_StyleCosting_EcomExtended = @pStyleCosting_StyleCosting_EcomPriceUnit * @pStyleCosting_StyleCosting_EcomUnits

/*pStyleCosting.StyleCostingCustomField17 (Wholesale Margin %)*/
...
/*pStyleCosting.StyleCostingCustomField18 (Retail Margin %)*/
...
/*pStyleCosting.StyleCosting_EcomMargin (Ecom Margin %)*/
IF (@pStyleCosting_StyleCosting_EcomExtended = 0 OR @pStyleCosting_StyleCosting_EcomExtended IS NULL) OR (@pStyleCosting_StyleCosting_EcomPriceUnit = 0 OR @pStyleCosting_StyleCosting_EcomPriceUnit IS NULL)
	SET @pStyleCosting_StyleCosting_EcomMargin = 0
ELSE
	SET @pStyleCosting_StyleCosting_EcomMargin = (@pStyleCosting_StyleCosting_EcomPriceUnit - @pStyleCosting_StyleCostingCustomField14) / @pStyleCosting_StyleCosting_EcomPriceUnit
...
/*pStyleCosting.StyleCosting_EcomMarginUnit (Ecom Margin Unit)*/
SET @pStyleCosting_StyleCosting_EcomMarginUnit = @pStyleCosting_StyleCosting_EcomPriceUnit - @pStyleCosting_StyleCostingCustomField14
...
/*pStyleCosting.StyleCosting_EcomMarginExtended (Ecom Margin Extended)*/
SET @pStyleCosting_StyleCosting_EcomMarginExtended = @pStyleCosting_StyleCosting_EcomExtended - (@pStyleCosting_StyleCostingCustomField14 * @pStyleCosting_StyleCosting_EcomUnits)

/*pStyleCosting.StyleCostingCustomField40 (Total Sales $ Extended)*/
SET @pStyleCosting_StyleCostingCustomField40 = @pStyleCosting_StyleCostingCustomField21 + @pStyleCosting_StyleCostingCustomField22 + @pStyleCosting_StyleCosting_EcomExtended

/*pStyleCosting.StyleCostingCustomField41 (Total Margin $ Extended)*/
SET @pStyleCosting_StyleCostingCustomField41 = @pStyleCosting_StyleCostingCustomField38 + @pStyleCosting_StyleCostingCustomField39 + @pStyleCosting_StyleCosting_EcomMarginExtended
...
SET StyleCostingCustomField6 = @pStyleCosting_StyleCostingCustomField6
 ...
 ,StyleCosting_EcomExtended = @pStyleCosting_StyleCosting_EcomExtended
 ,StyleCosting_EcomMargin = @pStyleCosting_StyleCosting_EcomMargin
 ,StyleCosting_EcomMarginUnit = @pStyleCosting_StyleCosting_EcomMarginUnit
 ,StyleCosting_EcomMarginExtended = @pStyleCosting_StyleCosting_EcomMarginExtended
...
VALUES              ('DB_Version', '0.5.0000', '07759', GetDate())
GO
