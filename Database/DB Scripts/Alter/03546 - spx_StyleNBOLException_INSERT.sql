...
INSERT INTO pStyleNBOLException
    (StyleID, StyleSet, WorkflowID, WorkflowItemID, CUser, CDate, MUser, MDate, Active, Sort)
VALUES (@StyleId, @StyleSet, @WorkflowId, @WorkflowItemId, @CUser, @CDate, @CUser, @CDate, @Active, @vcCount)
...
VALUES     ('DB_Version', '5.0.0000', '03546', GetDate())
GO