...
SELECT sh.StyleID, sh.WorkflowTemplateID, sh.PlannedDueDate, sh.EnforceDependency, sh.ScheduleBy, sh.PlannedStartDate, 
	   ...
	   sh.StyleCategory, sh.SizeClassId, COALESCE(scc.Custom, sh.SizeClass) AS SizeClass, sh.DivisionID, sh.StyleThemeID, lfi.LineFolderID, 
	   lfi.LineFolderItemID, lfi.LineFolderItemSort
...
VALUES ('DB_Version', '6.1.0000', '10409', GetUTCDate())
GO
