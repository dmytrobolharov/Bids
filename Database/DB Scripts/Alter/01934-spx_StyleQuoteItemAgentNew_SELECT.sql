...
AND pStyleQuoteItem.AgentView = 0
AND pStyleQuoteItem.StyleQuoteItemShare = 1
ORDER BY uTradePartnerVendor.VendorCode, pStyleQuoteItem.CDate DESC'
...
Go
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='01934'))
BEGIN
	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '01934', GetDate())
END	
