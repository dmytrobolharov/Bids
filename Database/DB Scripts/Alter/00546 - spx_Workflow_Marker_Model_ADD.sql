...
AS
IF NOT EXISTS( SELECT * FROM pWorkflow WHERE WorkflowID = '40000000-0000-0000-0000-000000000023')
BEGIN
...
INSERT INTO [dbo].[pWorkflow]
     ...
     VALUES
           ...
           ,'D')
END
IF NOT EXISTS( SELECT * FROM pWorkflow WHERE WorkflowID = '40000000-0000-0000-0000-000000000037')
BEGIN
...
VALUES     ('DB_Version', '4.0.0000', '546', GetDate())
GO