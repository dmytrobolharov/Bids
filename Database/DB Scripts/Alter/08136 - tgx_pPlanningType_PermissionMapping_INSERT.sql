/****** Object:  Trigger [tgx_pPlanningType_PermissionMapping_INSERT]    Script Date: 06/27/2014 16:10:54 ******/
...
/****** Object:  Trigger [dbo].[tgx_pPlanningType_PermissionMapping_INSERT]    Script Date: 06/27/2014 16:10:54 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
    ...
    BEGIN TRY
		...
		BEGIN
			-- Inserting product type mapping for Planning Folder
		...
		-- Setting "parents" to workflows
		EXEC spx_Permissions_WorkflowsGrouping_UPDATE @PlanningFolderTypeID
...
VALUES ('DB_Version', '0.5.0000', '08136', GetDate())
GO