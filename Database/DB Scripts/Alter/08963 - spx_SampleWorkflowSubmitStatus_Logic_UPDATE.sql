/****** Object:  StoredProcedure [dbo].[spx_SampleWorkflowSubmitStatus_Logic_UPDATE]    Script Date: 08/22/2014 12:23:28 ******/
...
BEGIN
	...
	BEGIN
		...
		---** Submit disapproved
		---***
		UPDATE pSampleRequestSubmit SET EndDate = NULL, EndBy = NULL WHERE SampleRequestSubmitID = @SampleRequestSubmitID
	END
...
VALUES ('DB_Version', '6.0.0000', '08963', GetDate())
GO
