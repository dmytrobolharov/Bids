/****** Object:  StoredProcedure [dbo].[spx_SampleWorkflowGridTable_SELECT]    Script Date: 06/25/2013 17:22:40 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_SampleWorkflowGridTable_SELECT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_SampleWorkflowGridTable_SELECT]
GO

CREATE  PROCEDURE [dbo].[spx_SampleWorkflowGridTable_SELECT] (
...
VALUES ('DB_Version', '0.5.0000', '05907', GetDate())
GO
