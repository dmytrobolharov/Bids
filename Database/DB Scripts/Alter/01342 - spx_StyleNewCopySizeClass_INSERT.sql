IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_StyleNewCopySizeClass_INSERT]') AND type = N'P' )
	DROP PROCEDURE [dbo].[spx_StyleNewCopySizeClass_INSERT]
GO
/****** Object:  StoredProcedure [dbo].[spx_StyleNewCopySizeClass_INSERT]    Script Date: 03/31/2011 08:41:51 ******/
SET ANSI_NULLS ON
GO
...
VALUES ('DB_Version', '4.0.0000', '01342', GetDate())
GO