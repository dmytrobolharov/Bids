...
BEGIN
	...
	WHERE (ItemDim1Id = @ItemDim1Id OR ItemDim1Id IS NULL) AND (ItemDim2Id = @ItemDim2Id OR ItemDim2Id IS NULL) AND (ItemDim3Id = @ItemDim3Id OR ItemDim3Id IS NULL) AND StyleBOMDimensionID = @StyleBOMDimensionID AND StyleID = @StyleID
...
VALUES ('DB_Version', '0.5.0000', '06329', GetDate())
GO
