...
SELECT DISTINCT 
  ...
  ssh.PlanningID, ssh.LineFolderSKUHeaderID, wfi.WorkFlowItemName, ssh.PlanningSKUHeaderID AS StyleSKUHeaderID, psh.PlanningSKUHeaderID, wfi.StyleID
...
VALUES     ('DB_Version', '0.5.0000', '08289', GetDate())
GO
