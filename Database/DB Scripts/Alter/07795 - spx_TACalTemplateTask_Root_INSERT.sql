/****** Object:  StoredProcedure [dbo].[spx_TACalTemplateTask_Root_INSERT]    Script Date: 06/01/2014 22:48:04 ******/
...
@duration int
	...
	insert into pTACalTemplateTask(TACalTemplateId,taskid, TaskName, TaskPlanStart, level,active, TaskTypeId, TaskDuration) values(@templateid,1, @Name,@startDate,0,1,0, @duration)


GO

INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
VALUES ('DB_Version', '0.5.0000', '07795', GetDate())
GO