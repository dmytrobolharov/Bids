...
BEGIN
	...
	begin
		...
		INSERT INTO pSourcingTradePartner(SourcingHeaderID, TradePartnerID, ProductTypes)
		VALUES							 (@SourcingHeaderID, @TradePartnerID, @ProductTypes)
	end
...
VALUES     ('DB_Version', '5.0.0000', '04110', GetDate())
GO
