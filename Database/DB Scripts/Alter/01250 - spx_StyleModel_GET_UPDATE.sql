...
Where pBodyPatternSheetModel.Model_Code = (select Model_Code from #tempTblBody where rownum = @RowCnt)
       AND pBodyPatternSheetModel.StyleID = @StyleID AND StyleSet = @StyleSet
   
   Select @RowCnt = @RowCnt + 1

--EXEC [spx_BodyPatternSheetPiece_GET_UPDATE] @StyleID, @StyleSet, @Model_Code,@CADDB,@Catalog
...
VALUES     ('DB_Version', '4.0.0000', '01250', GetDate())
GO
