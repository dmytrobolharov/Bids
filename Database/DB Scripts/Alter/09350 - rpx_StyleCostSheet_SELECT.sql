...
BEGIN
	...
	IF @StyleCostingId IS NOT NULL AND @StyleCostingId != '00000000-0000-0000-0000-000000000000'
	...
	ELSE IF @StyleCostingComparisonId IS NOT NULL
		SELECT @ListOfCostingScenarios = COALESCE(@ListOfCostingScenarios + ',', '') + 
...
VALUES ('DB_Version', '6.1.0000', '09350', GetDate())
GO
