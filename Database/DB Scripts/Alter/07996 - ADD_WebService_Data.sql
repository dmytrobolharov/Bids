...
IF (SELECT COUNT(WebServiceItemName)
	...
	WHERE UPPER(WebServiceItemName) = UPPER('TACalendarHoliday')) < 1
BEGIN
	
	INSERT INTO sWebServiceItem(WebServiceID, WebServiceItemID, WebServiceItemName, WebServiceItemDefaultSchema, Active)
	VALUES ('56B9ADDB-B6AF-4380-94D7-70588DDDED7B', '5EDFDEC6-E2DF-4CCC-8333-7FB36F651555', 'TACalendarHoliday', '', 1)
END

GO

INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
VALUES ('DB_Version', '0.5.0000', '07996', GetDate())
GO