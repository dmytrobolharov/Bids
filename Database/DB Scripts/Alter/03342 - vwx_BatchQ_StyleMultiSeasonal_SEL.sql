/****** Object:  View [dbo].[vwx_BatchQ_StyleMultiSeasonal_SEL]    Script Date: 04/12/2012 17:01:33 ******/
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='03342'))
BEGIN
	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '5.0.0000', '03342', GetDate())
END
GO