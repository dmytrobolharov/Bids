...
/****** Object:  StoredProcedure [dbo].[spx_SampleWorkflowBOMSubmitSummary_SELECT]    Script Date: 12/18/2011 18:56:21 ******/
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02439'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '02439', GetDate())
