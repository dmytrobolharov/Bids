...
BEGIN
	...
	SELECT '<img src="' + dbo.fnx_GetStreamingImageSmallPath(uTradePartnerInfrastructureImage.ImageID, ImageVersion) + '" />' AS sImage
...
VALUES ('DB_Version', '6.1.0000', '10056', GetUTCDate())
GO