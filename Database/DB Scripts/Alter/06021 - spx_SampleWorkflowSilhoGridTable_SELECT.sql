IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_SampleWorkflowSilhoGridTable_SELECT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_SampleWorkflowSilhoGridTable_SELECT]
GO

CREATE  PROCEDURE [dbo].[spx_SampleWorkflowSilhoGridTable_SELECT] (
...
VALUES ('DB_Version', '0.5.0000', '06021', GetDate())
GO
