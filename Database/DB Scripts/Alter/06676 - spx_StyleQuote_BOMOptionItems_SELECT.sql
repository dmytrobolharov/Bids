...
BEGIN
	...
	BEGIN
		...
		SELECT pSourcingQuotationBOMOptionItems.StyleMaterialID, pSourcingQuotationBOMOptionItems.AutoColor, pComponentType.ComponentTypeID, pComponentType.ComponentDescription, 
			...
			, 0 AS MaterialDel, 
			'<img src=''' + @ImageServer + '/ImageStream.ashx?S=25&V=' + CAST(ISNULL(pSourcingQuotationBOMOptionItems.MaterialImageVersion, 0) AS NVARCHAR(5)) + '&IID=' + CAST(ISNULL(pSourcingQuotationBOMOptionItems.MaterialImageID, '00000000-0000-0000-0000-000000000000') AS NVARCHAR(50)) + ''' />' AS MaterialImage, 
			pStyleHeader.HeaderLocked, pSourcingQuotationBOMOptionItems.Comments, pSourcingQuotationBOMOptionItems.StyleOptionItemID,
			pSourcingQuotationBOMOptionItems.SubstituteForID
...
VALUES     ('DB_Version', '0.5.0000', '06676', GetDate())
GO
