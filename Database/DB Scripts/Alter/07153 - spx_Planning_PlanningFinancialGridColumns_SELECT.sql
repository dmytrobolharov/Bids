...
BEGIN
	...
	SELECT CAST(PlanningFinancialID AS nVARCHAR(100)) AS PlanningFinancialID, 
		PlanningFinancialCssClass, PlanningFinancialText, AllowPercentInput, Editable, PlanningFinancialDataType, PlanningFinancialDataFormat, 
	...
	SELECT 'CMP__' + CAST(PlanningFinancialID AS nVARCHAR(40)) AS PlanningFinancialID, 
		PlanningFinancialCssClass, 'LY ' + PlanningFinancialText, AllowPercentInput, Editable, PlanningFinancialDataType, PlanningFinancialDataFormat, 
...
VALUES ('DB_Version', '0.5.0000', '07153', GetDate())
GO
