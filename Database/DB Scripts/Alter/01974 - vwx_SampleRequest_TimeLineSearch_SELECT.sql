IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].vwx_SampleRequest_TimeLineSearch_SELECT'))
...
/****** Object:  View [dbo].[vwx_SampleRequest_TimeLineSearch_SELECT]    Script Date: 09/28/2011 21:04:00 ******/
SET ANSI_NULLS ON
GO
...
FROM         dbo.pStyleHeader INNER JOIN
                      ...
                      dbo.pSampleRequestWorkflow ON dbo.pSampleRequestTrade.SampleRequestTradeID = dbo.pSampleRequestWorkflow.SampleRequestTradeID LEFT OUTER JOIN
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='01974'))
BEGIN
	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '01974', GetDate())
END	
GO