...
SELECT	CASE WHEN dbo.pTechPack.TechPackID = dbo.pStyleHeader.TechPackId 
		...
		dbo.pTechPack.TechPackRelease, dbo.pSeasonYear.Season, dbo.pSeasonYear.Year, dbo.sSystemCulture.CultureName, 
		dbo.sSystemCulture.CultureLanguage + ' (' + dbo.sSystemCulture.CultureCountry + ')' AS CultureDesc,
		dbo.pTechPack.Active,
		dbo.pSeasonYear.SeasonYearID
FROM	dbo.pTechPack WITH (NOLOCK) 
		INNER JOIN dbo.pStyleHeader WITH (NOLOCK) ON dbo.pTechPack.StyleID = dbo.pStyleHeader.StyleID 
		LEFT OUTER JOIN dbo.pStyleSeasonYear ON dbo.pTechPack.StyleSeasonYearID = dbo.pStyleSeasonYear.StyleSeasonYearID 
		LEFT OUTER JOIN dbo.pSeasonYear ON dbo.pStyleSeasonYear.SeasonYearID = dbo.pSeasonYear.SeasonYearID
...
VALUES     ('DB_Version', '0.5.0000', '06093', GetDate())
GO
