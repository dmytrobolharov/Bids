...
/****** Object:  StoredProcedure [dbo].[spx_Workflow_AccessFolderUserPermissions_UPDATE]    Script Date: 01/04/2012 20:49:02 ******/
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02542'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.2.0000', '02542', GetDate())
