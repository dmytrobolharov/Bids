/****** Object:  StoredProcedure [dbo].[spx_SampleRequest_DesignSample_Meas_Imperial]    Script Date: 07/02/2013 15:43:38 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_SampleRequest_DesignSample_Meas_Imperial]') AND type in (N'P', N'PC'))
...
CREATE  PROCEDURE [dbo].[spx_SampleRequest_DesignSample_Meas_Imperial](
	...
	begin
		if Len(@WhereParam) > 0	
			begin
				...
				@cols +'
				FROM
				(SELECT  t2.SampleRequestamlmeaspomid, t2.pom_row, t3.sortid, t3.refcode, t3.description, 
...
VALUES ('DB_Version', '0.5.0000', '05967', GetDate())
GO
