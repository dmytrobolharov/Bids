/****** Object:  StoredProcedure [dbo].[rpx_SampleRequest_TradePartner_DataTable_PIVOT]    Script Date: 08/22/2013 13:28:33 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[rpx_SampleRequest_TradePartner_DataTable_PIVOT]') AND type in (N'P', N'PC'))
...
AS
	...
	BEGIN
		...
		END AS 'Alert Color',
		c.SampleWorkflowID,
		CONVERT(NVARCHAR(MAX),a.Comment)
...
VALUES ('DB_Version', '0.5.0000', '06207', GetDate())
GO
