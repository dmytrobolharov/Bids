/****** Object:  StoredProcedure [dbo].[spx_NPMStyleQuoteItemAgentNew_SELECT]    Script Date: 02/27/2013 11:30:32 ******/
...
SET @SQLString = @SQLString + ' qi.*, sh.StyleID, sh.StyleNo, sh.Description, sh.SizeClass, 
...
VALUES ('DB_Version', '5.0.0000', '05167', GetDate())
GO