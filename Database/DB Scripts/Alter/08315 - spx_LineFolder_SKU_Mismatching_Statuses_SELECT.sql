IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_LineFolder_SKU_Mismatching_Statuses_SELECT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_LineFolder_SKU_Mismatching_Statuses_SELECT]
GO

CREATE PROCEDURE [dbo].[spx_LineFolder_SKU_Mismatching_Statuses_SELECT]
(
...
BEGIN
	...
	WHERE
		...
		AND wfi.WorkStatus != lfsh.WorkStatus
END

GO

INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
VALUES     ('DB_Version', '0.5.0000', '08315', GetDate())
GO
