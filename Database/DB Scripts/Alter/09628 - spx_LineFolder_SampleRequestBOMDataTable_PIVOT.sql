IF OBJECT_ID(N'[dbo].[spx_LineFolder_SampleRequestBOMDataTable_PIVOT]') IS NOT NULL
...
LEFT JOIN pSizeClass scc ON scc.CustomID = d.SizeClassId
'
...
VALUES ('DB_Version', '6.1.0000', '09628', GetDate())
GO
