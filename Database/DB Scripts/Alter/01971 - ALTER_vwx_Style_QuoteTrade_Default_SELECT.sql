...
AS
SELECT DISTINCT 
                      dbo.pStyleQuoteItem.StyleQuoteItemID, dbo.pStyleQuoteItem.StyleID, dbo.pStyleQuoteItem.StyleQuoteItemNo, dbo.pStyleQuoteItem.StyleQuoteItemStatusId, 
                      ...
                      dbo.pStyleHeader.MaterialNo, dbo.pStyleQuoteItemFreightCost.Margin, dbo.pStyleQuoteItemFreightCost.TotalLandCost, dbo.pStyleHeader.Pc1, 
                      dbo.pStyleQuoteItem.StyleQuoteItemDueDate, dbo.uCountry.CountryName AS FOBCountry, 
                      dbo.pStyleQuoteItemFreightCost.FreightCost, dbo.pStyleQuoteItem.StyleQuoteItemShare
FROM         dbo.pStyleQuoteItem LEFT OUTER JOIN
                      dbo.uCountry ON dbo.pStyleQuoteItem.StyleQuoteItemCustomField1 = dbo.uCountry.CountryCode LEFT OUTER JOIN
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='01971'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '01971', GetDate())
