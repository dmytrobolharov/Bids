IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[rpx_Style_ConstructionDetails2_SELECT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[rpx_Style_ConstructionDetails2_SELECT]
GO
...
CREATE  PROCEDURE [dbo].[rpx_Style_ConstructionDetails2_SELECT]
...
VALUES ('DB_Version', '6.1.0000', '10144', GetUTCDate())
GO