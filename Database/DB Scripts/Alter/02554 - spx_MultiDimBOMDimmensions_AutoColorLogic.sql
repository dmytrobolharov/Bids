...
/****** Object:  StoredProcedure [dbo].[spx_MultiDimBOMDimmensions_AutoColorLogic]    Script Date: 01/11/2012 15:58:39 ******/
...
BEGIN	
	...
	DECLARE @MainMaterial VARCHAR(1) 
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02554'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.2.0000', '02554', GetDate())
