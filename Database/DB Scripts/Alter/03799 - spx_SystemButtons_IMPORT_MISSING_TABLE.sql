...
BEGIN
	...
	BEGIN
		...
		IF NOT EXISTS (SELECT DISTINCT SystembuttonID FROM sSystemButtons WHERE DesignString = @DeskButtonName AND LEN(ButtonType) <> 0)
		BEGIN
...
VALUES ('DB_Version', '5.0.0000', '03799', GetDate())
GO
