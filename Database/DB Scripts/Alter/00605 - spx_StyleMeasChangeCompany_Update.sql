...
CREATE PROCEDURE [dbo].[spx_StyleMeasChangeCompany_Update](	
...
select @IsRelative = IsRelative, @IsNegative = IsNegative, @IsMetric = IsMetric from pGRCompany where CompanyGuidId=@CompanyID
...
VALUES     ('DB_Version', '4.0.0000', '605', GetDate())
GO