IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[vwx_TACalTemplateTask_ReferenceFromSampleRequest_SELECT]') AND type = N'V')
...
VALUES   ('DB_Version', '6.0.0000', '09095', GetDate())
GO
