IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_Style_Model_GetPathCADCategories]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_Style_Model_GetPathCADCategories]
GO
...
CREATE PROCEDURE [dbo].[spx_Style_Model_GetPathCADCategories]
	@CADDB varchar(50),
	@Catalog varchar(50),
	@CADCatId int
AS
...
SELECT @sql = '
	...
	'(' +
		...
		'WHERE A.Level1 = 1 AND A.ParentId = 2 ' +
	'UNION ALL ' +
		'SELECT ' +
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02583'))
BEGIN
	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.2.0000', '02583', GetDate())
END
GO