...
IF EXISTS (select * from sysobjects where id = object_id('spx_PGRMeasurementsPOMSize_SELECT') and sysstat & 0xf = 4)
    drop procedure spx_PGRMeasurementsPOMSize_SELECT
GO


CREATE PROCEDURE spx_PGRMeasurementsPOMSize_SELECT
(
...
VALUES ('DB_Version', '4.2.0000', '03025', GetDate())
GO
