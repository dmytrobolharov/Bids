/****** Object:  View [dbo].[vwx_LineFolderItem_SELECT]    Script Date: 06/04/2014 14:07:53 ******/
...
FROM         dbo.pLineFolderItem INNER JOIN
                      dbo.pStyleHeader ON dbo.pLineFolderItem.StyleID = dbo.pStyleHeader.StyleID INNER JOIN
                          (SELECT ptm.IntProductTypeId, pt.PermissionProductTypeName, u.TeamID, 
								...
								GROUP BY ptm.IntProductTypeId, pt.PermissionProductTypeName, u.TeamID) AS c ON dbo.pStyleHeader.StyleType = c.IntProductTypeId INNER JOIN
...
VALUES ('DB_Version', '0.5.0000', '07888', GetDate())
GO