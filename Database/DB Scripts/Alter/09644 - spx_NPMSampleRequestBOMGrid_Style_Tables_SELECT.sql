IF OBJECT_ID(N'[dbo].[spx_NPMSampleRequestBOMGrid_Style_Tables_SELECT]') IS NOT NULL
...
BEGIN
	...
	c.StyleNo , c.DueDate as TechPack , COALESCE(sc.Custom, c.SizeClass) AS SizeClass , c.TechPackID, 
...
VALUES ('DB_Version', '6.1.0000', '09644', GetDate())
GO
