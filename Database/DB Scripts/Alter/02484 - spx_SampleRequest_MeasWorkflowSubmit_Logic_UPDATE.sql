/****** Object:  StoredProcedure [dbo].[spx_SampleRequest_MeasWorkflowSubmit_Logic_UPDATE]    Script Date: 12/21/2011 18:03:17 ******/
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02484'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '02484', GetDate())
