/****** Object:  StoredProcedure [dbo].[spx_LineFolder_LinePlanningAttribute_Check_INSERT]    Script Date: 03/20/2013 14:52:42 ******/
...
BEGIN
	...
	WHERE NOT EXISTS(
		...
		WHERE ISNULL(lfb.LineFolderDivisionID, '00000000-0000-0000-0000-000000000000') = ISNULL(tal.DivisionID, '00000000-0000-0000-0000-000000000000') AND
			...
			lfb.LineFolderFinancialID = lff.LineFolderFinancialID
	)
...
VALUES ('DB_Version', '0.5.0000', '05363', GetDate())
GO
