...
SET @query = N'select CustomId, SizeRangeCode, SizeRangeKey, Active, sizeid, sizename
 ...
 POMID, POMAlternatesID, POMCode, FitComID, Critical, IsonQA, IsLinked, How2MeasText, How2MeasName, Tolplus, Tolminus, NonWashTolplus, NonWashTolminus,
...
VALUES     ('DB_Version', '0.5.0000', '06083', GetDate())
GO
