/****** Object:  View [dbo].[vwx_SourcingStyle_StyleHeaders_SEL]    Script Date: 11/08/2012 16:11:54 ******/
...
SELECT     dbo.pStyleHeader.StyleID, dbo.pStyleHeader.StyleMasterID, dbo.pStyleHeader.StyleWorkflowID, dbo.pStyleHeader.StyleType, dbo.pStyleHeader.WorkflowType, 
                      ...
                      dbo.pStyleHeader.CustomerNo, dbo.pStyleHeader.TempNo, dbo.pStyleHeader.TempID, dbo.pSeasonYear.SeasonYearID, dbo.pSeasonYear.Season, 
                      dbo.pSeasonYear.Year,
                      ISNULL(pStyleDevelopmentItem.StyleDevelopmentName, 'Variation ' + CAST(pStyleDevelopmentItem.Variation AS Varchar(2))) AS Variation,
					  dbo.pStyleHeader.IntroSeasonYearID
...
VALUES     ('DB_Version', '5.0.0000', '04506', GetDate())
GO
