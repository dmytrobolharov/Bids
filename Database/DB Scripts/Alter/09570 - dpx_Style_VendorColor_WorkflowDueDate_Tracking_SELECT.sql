IF OBJECT_ID(N'[dbo].[dpx_Style_VendorColor_WorkflowDueDate_Tracking_SELECT]') IS NOT NULL
...
/* BOM sample requests */
	...
	FROM
		...
		LEFT OUTER JOIN pStyleColorway sc ON r.ItemDim1Id = sc.StyleColorID OR r.ItemDim2Id = sc.StyleColorID OR r.ItemDim3Id = sc.StyleColorID
	WHERE
		r.SampleRequestWorkflowID = w.SampleRequestWorkflowID
		AND r.DueDate >= @DateFrom
		and r.DueDate <= @DateTo
...
VALUES ('DB_Version', '6.1.0000', '09570', GetDate())
GO
