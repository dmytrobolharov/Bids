/****** Object:  StoredProcedure [dbo].[spx_SampleRequest_DesignSample_IMIncrement_UPDATE]    Script Date: 07/02/2013 15:42:31 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_SampleRequest_DesignSample_IMIncrement_UPDATE]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_SampleRequest_DesignSample_IMIncrement_UPDATE]
GO
...
CREATE PROCEDURE [dbo].[spx_SampleRequest_DesignSample_IMIncrement_UPDATE]
...
if @Metric='0' 
	begin
		...
		where a.SampleRequestamlmeashdrid=''' + cast(@SampleRequestAmlMeasHdrID as nvarchar(50)) + ''' and a.sizecol <= b.sizecol and b.sizecol<=(select sizecol from pSampleRequestamlmeaslbl c where issample=1 and a.SampleRequestamlmeashdrid=c.SampleRequestamlmeashdrid) and a.SampleRequestamlmeaspomid=b.SampleRequestamlmeaspomid
...
VALUES ('DB_Version', '0.5.0000', '05963', GetDate())
GO
