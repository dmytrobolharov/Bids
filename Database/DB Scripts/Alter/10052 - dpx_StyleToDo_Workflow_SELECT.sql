IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[dpx_StyleToDo_Workflow_SELECT]') AND type in (N'P', N'PC'))
...
VALUES ('DB_Version', '6.1.0000', '10052', GetUTCDate())
GO