...
from
(
select wt.WorkflowTemplateID, WorkflowTemplateItemID, WorkflowTemplateItemID DependentOnWorkflowTemplateItemID, Workflow, WorkflowAccessTypeID
       --, RequirementNum
	   , case wti.StartDate
  ...
  from pWorkflowTemplate wt
	   inner join pWorkflowTemplateItem wti on wti.WorkflowTemplateID = wt.WorkflowTemplateID
...
INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES ('DB_Version', '5.0.0000', '03431', GetDate())
