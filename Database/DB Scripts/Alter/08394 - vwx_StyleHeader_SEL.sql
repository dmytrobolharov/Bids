...
SELECT     dbo.pStyleHeader.StyleID, dbo.pStyleHeader.StyleMasterID, dbo.pStyleHeader.StyleWorkflowID, dbo.pStyleHeader.StyleType, dbo.pStyleHeader.WorkflowType, 
                      ...
                      dbo.pStyleHeader.POMTempSizeClass4, dbo.pStyleHeader.StyleMaterialID, dbo.pStyleHeader.DesignSketchID, dbo.pStyleHeader.DesignSketchBackID, dbo.pStyleHeader.TechSketchID, 
                      dbo.pStyleHeader.ConceptSketchID, dbo.pStyleHeader.ColorSketchID, dbo.pStyleHeader.DesignSketchVersion, dbo.pStyleHeader.DesignSketchBackVersion, dbo.pStyleHeader.TechSketchVersion, 
                      ...
                      dbo.pStyleTypeTemplate.IsSilhouette, isy.Season as IntroSeason, isy.Year as IntroYear, dbo.pStyleHeader.SubCategoryId,
                      dbo.pStyleType.StyleTypeDescription, dbo.iCustom1.Custom AS DivisionName, dbo.pStyleCategory.StyleCategory AS StyleCategoryName,
					  dbo.pSubCategory.Custom AS SubCategoryName, ISNULL(isy.Season,'') + ' ' + ISNULL(isy.Year,'') AS IntroSeasonYearName,
...
FROM dbo.pStyleHeader
	LEFT JOIN dbo.pStyleSeasonYear ON dbo.pStyleHeader.StyleID = dbo.pStyleSeasonYear.StyleID
	LEFT JOIN dbo.pSeasonYear ON dbo.pSeasonYear.SeasonYearID = dbo.pStyleSeasonYear.SeasonYearID
	LEFT JOIN dbo.pSeasonYear isy ON isy.SeasonYearID = dbo.pStyleHeader.IntroSeasonYearID
	LEFT JOIN dbo.pStyleType ON dbo.pStyleHeader.StyleType = dbo.pStyleType.StyleTypeID
	LEFT JOIN dbo.pStyleTypeTemplate ON dbo.pStyleType.StyleTypeTemplateID = dbo.pStyleTypeTemplate.StyleTypeTemplateID
	LEFT JOIN dbo.iCustom1 ON pStyleHeader.DivisionID = iCustom1.CustomID
...
VALUES ('DB_Version', '0.5.0000', '08394', GetDate())
GO
