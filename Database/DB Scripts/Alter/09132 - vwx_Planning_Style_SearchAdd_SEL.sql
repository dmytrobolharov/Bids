...
SELECT     dbo.pStyleHeader.StyleID, dbo.pStyleHeader.StyleMasterID, dbo.pStyleHeader.StyleWorkflowID, dbo.pStyleHeader.StyleType, dbo.pStyleHeader.WorkflowType, 
                      ...
                      dbo.pStyleHeader.IntroSeasonYearID, dbo.pStyleHeader.DivisionID, dbo.pStyleType.StyleTypeDescription, dbo.pStyleCategory.StyleCategory AS Category,
                      PlanningAttributes.PlanningID
					  --, bomCnt.BomCnt
...
--) bomCnt ON dbo.pStyleHeader.StyleID = bomCnt.StyleID


GO

INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
VALUES   ('DB_Version', '6.0.0000', '09132', GetDate())
GO
