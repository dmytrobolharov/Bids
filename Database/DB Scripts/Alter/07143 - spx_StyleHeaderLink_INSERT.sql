IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_StyleHeaderLink_INSERT]') AND type in (N'P', N'PC'))
...
VALUES ('DB_Version', '0.5.0000', '07143', GetDate())
GO
