IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_StyleBOMDimTabMaterialSize_Update]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_StyleBOMDimTabMaterialSize_Update]
GO
...
VALUES ('DB_Version', '6.1.0000', '10267', GetUTCDate())
GO
