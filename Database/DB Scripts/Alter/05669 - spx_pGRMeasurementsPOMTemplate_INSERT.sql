IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_pGRMeasurementsPOMTemplate_INSERT]') AND type in (N'P', N'PC'))
...
VALUES     ('DB_Version', '0.5.0.0000', '05669', GetDate())
GO
