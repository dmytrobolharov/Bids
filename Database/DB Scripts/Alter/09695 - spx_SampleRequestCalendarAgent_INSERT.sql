IF OBJECT_ID(N'[dbo].[spx_SampleRequestCalendarAgent_INSERT]') IS NOT NULL
...
SELECT @CalendarId AS CalendarId,
	...
	COALESCE(sr.SizeRangeCode, sh.SizeRange) AS SizeRange, srw.Submit, srw.Status, srw.AssignedTo
INTO #tmpCal
FROM srt
...
VALUES ('DB_Version', '6.1.0000', '09695', GetDate())
GO
