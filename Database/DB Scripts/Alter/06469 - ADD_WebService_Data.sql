...
IF (SELECT COUNT(WebServiceItemName)
	...
	WHERE UPPER(WebServiceItemName) = UPPER('Style Images Artboard')) < 1
BEGIN
	-- Style Design Detail
	INSERT INTO sWebServiceItem(WebServiceID, WebServiceItemID, WebServiceItemName, WebServiceItemDefaultSchema, Active)
	VALUES ('56BDAD9B-B6AF-4380-94D7-70588FD8E66A', '7E4D7816-C76F-426C-8836-FA386E31DEEE', 'Style Images Artboard', '', 1)
END

GO
INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
VALUES ('DB_Version', '0.5.0000', '06469', GetDate())
GO