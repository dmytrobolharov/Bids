...
SELECT     dbo.pStyleCosting.StyleCostingID as ScenarioID, dbo.pStyleCosting.StyleCostingID, dbo.pStyleCosting.StyleCostingTypeID, dbo.pStyleCosting.StyleID, dbo.pStyleCosting.StyleCostingFreightTypeID, 
                      ...
                      dbo.pStyleCostingDuty.Custom as StyleCostingHTSCode,
                      dbo.pStyleCosting.BOMCurrencyType, dbo.pStyleCosting.BOLCurrencyType, 
                      dbo.pStyleCosting.ExchangeRateItemID, dbo.sExchangeRateItem.CurrencyType, 
                      dbo.pStyleCosting.StyleCosting_EcomUnits, dbo.pStyleCosting.StyleCosting_EcomPriceUnit, dbo.pStyleCosting.StyleCosting_EcomExtended,
                      dbo.pStyleCosting.StyleCosting_EcomMarginUnit, dbo.pStyleCosting.StyleCosting_EcomMarginExtended, dbo.pStyleCosting.StyleCosting_EcomMargin,
                      0 as Sort
FROM         dbo.pStyleCosting INNER JOIN
                      ...
                      dbo.pStyleCostingType ON dbo.pStyleCosting.StyleCostingTypeID = dbo.pStyleCostingType.StyleCostingTypeID LEFT JOIN
                      dbo.pStyleCostingDuty ON dbo.pStyleCosting.StyleCostingHTS = CAST(dbo.pStyleCostingDuty.CustomID as nvarchar(40)) LEFT JOIN
                      dbo.sExchangeRateItem ON dbo.pStyleCosting.ExchangeRateItemID = dbo.sExchangeRateItem.ExchangeRateItemID
...
SELECT     dbo.pStyleCostingScenarioItems.StytleCostingScenarioItemsID as ScenarioID, dbo.pStyleCostingScenarioItems.StyleCostingID, dbo.pStyleCostingScenarioItems.StyleCostingTypeID, dbo.pStyleCostingScenarioItems.StyleID, dbo.pStyleCostingScenarioItems.StyleCostingFreightTypeID, 
                      ...
                      dbo.pStyleCostingDuty.Custom as StyleCostingHTSCode, 
                      dbo.pStyleCostingScenarioItems.BOMCurrencyType, dbo.pStyleCostingScenarioItems.BOLCurrencyType, 
                      dbo.pStyleCostingScenarioItems.ExchangeRateItemID, dbo.sExchangeRateItem.CurrencyType, 
                      dbo.pStyleCostingScenarioItems.StyleCosting_EcomUnits, dbo.pStyleCostingScenarioItems.StyleCosting_EcomPriceUnit, dbo.pStyleCostingScenarioItems.StyleCosting_EcomExtended,
                      dbo.pStyleCostingScenarioItems.StyleCosting_EcomMarginUnit, dbo.pStyleCostingScenarioItems.StyleCosting_EcomMarginExtended, dbo.pStyleCostingScenarioItems.StyleCosting_EcomMargin,
                      1 as Sort
FROM         dbo.pStyleCostingScenarioItems INNER JOIN
                      ...
                      dbo.pWorkFlowItem BOM_wi ON dbo.pStyleBOMDimension.WorkFlowItemID = BOM_wi.WorkFlowItemID LEFT JOIN
                      dbo.pStyleCostingType ON dbo.pStyleCostingScenarioItems.StyleCostingTypeID = pStyleCostingType.StyleCostingTypeID LEFT JOIN
                      dbo.pStyleCostingDuty ON dbo.pStyleCostingScenarioItems.StyleCostingHTS = CAST(dbo.pStyleCostingDuty.CustomID as nvarchar(40)) LEFT JOIN
                      dbo.sExchangeRateItem ON dbo.pStyleCostingScenarioItems.ExchangeRateItemID = dbo.sExchangeRateItem.ExchangeRateItemID
...
VALUES              ('DB_Version', '0.5.0000', '07755', GetDate())
GO
