/****** Object:  StoredProcedure [dbo].[spx_Sourcing_SampleRequestTradeBOM_INSERT]    Script Date: 04/29/2013 15:37:53 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_Sourcing_SampleRequestTradeBOM_INSERT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_Sourcing_SampleRequestTradeBOM_INSERT]
GO

CREATE PROCEDURE [dbo].[spx_Sourcing_SampleRequestTradeBOM_INSERT]
(
@SampleRequestGroupID nvarchar(50),
@SourcingTradePartnerID nvarchar(50),
@StyleID nvarchar(50),
...
BEGIN
	...
	SELECT @TradePartnerID= TradePartnerID, @TradePartnerRelationshipLevelID= TradePartnerLevelID FROM pSourcingTradePartner where SourcingTradePartnerID=@SourcingTradePartnerID

	SELECT top 1 @StyleBOMDimensionItemID = COALESCE(StyleBOMDimensionItemID,'00000000-0000-0000-0000-000000000000'), @WorkFlowItemID = COALESCE(WorkflowItemID,'00000000-0000-0000-0000-000000000000')
...
VALUES     ('DB_Version', '0.5.0000', '05625', GetDate())
GO
