/****** Object:  View [dbo].[vwx_PlanningItem_SELECT]    Script Date: 06/04/2014 18:23:08 ******/
...
/****** Object:  View [dbo].[vwx_PlanningItem_SELECT]    Script Date: 06/04/2014 18:23:09 ******/
SET ANSI_NULLS ON
GO
...
INNER JOIN (SELECT ptm.IntProductTypeId, pt.PermissionProductTypeName, u.TeamID, 
			...
			GROUP BY ptm.IntProductTypeId, pt.PermissionProductTypeName, u.TeamID) AS c ON dbo.pStyleHeader.StyleType = c.IntProductTypeId
...
VALUES ('DB_Version', '0.5.0000', '07890', GetDate())
GO