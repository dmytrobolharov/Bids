...
BEGIN
	...
	BEGIN
		DECLARE @WorkflowItemName NVARCHAR(200) = N'BOM ' + CONVERT(varchar, (SELECT count(DISTINCT WorkFlowItemName) FROM pWorkFlowItem WHERE WorkFlowItemName LIKE 'BOM%' ) +1)
...
VALUES ('DB_Version', '0.5.0000', '08406', GetDate())
GO
