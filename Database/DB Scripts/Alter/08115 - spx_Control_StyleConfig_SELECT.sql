...
BEGIN
	...
	LEFT JOIN pControlStyleConfig csc ON t.StyleTypeID = csc.StyleTypeID AND t.StyleCategoryId = csc.StyleCategoryID AND csc.DivisionID = @DivisionID
...
VALUES ('DB_Version', '0.5.0000', '08115', GetDate())
GO