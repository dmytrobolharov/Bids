...
SET [Image] = 
	'<img src="../System/Control/ImageStream.ashx?IT=' + ISNULL(ImageType, 'BOLOP') + '&S=50&ID=' + CAST(ISNULL(ImageID, '00000000-0000-0000-0000-000000000000') AS NVARCHAR(50)) + '" ' +
...
VALUES ('DB_Version', '5.0.0000', '03586', GetDate())
GO