...
/*************************************************************************************************************/
/* The logic for the main Costing page has been moved to spreadsheets and this is not neeeded for that page. */
/* Any changes made here must also be made to the costing spreadsheets.                                      */
/* Since the Flash Edit is running this in batch mode, then it will be used for that purpose only.           */
/*************************************************************************************************************/

IF @FromFlashEdit IS NOT NULL
BEGIN
	...
	IF (@pStyleCosting_StyleCostingTypeId = 1) --Import
	 BEGIN
	  ...
	  IF (@pStyleCosting_StyleCostingCustomField15 IS NULL OR @pStyleCosting_StyleCostingCustomField15 = 0 OR @pStyleCosting_StyleCostingCustomField16 IS NULL OR @pStyleCosting_StyleCostingCustomField16 = 0)
	  ...
	  IF (@pStyleCosting_StyleCostingCustomField14 IS NULL OR @pStyleCosting_StyleCostingCustomField14 = 0 OR @pStyleCosting_StyleCostingCustomField15 IS NULL OR @pStyleCosting_StyleCostingCustomField15 = 0)
...
VALUES     ('DB_Version', '5.0.0000', '03779', GetDate())
GO
