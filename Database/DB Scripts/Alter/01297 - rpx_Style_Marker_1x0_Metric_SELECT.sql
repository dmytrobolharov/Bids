IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[rpx_Style_Marker_1x0_Metric_SELECT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[rpx_Style_Marker_1x0_Metric_SELECT]
GO


CREATE PROCEDURE rpx_Style_Marker_1x0_Metric_SELECT
(
	@StyleId NVARCHAR(50)
)
AS
...
VALUES     ('DB_Version', '4.0.0000', '01297', GetDate())
GO