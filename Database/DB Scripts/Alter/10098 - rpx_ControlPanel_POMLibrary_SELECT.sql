IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[rpx_ControlPanel_POMLibrary_SELECT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[rpx_ControlPanel_POMLibrary_SELECT]
GO
...
VALUES ('DB_Version', '6.1.0000', '10098', GetUTCDate())
GO