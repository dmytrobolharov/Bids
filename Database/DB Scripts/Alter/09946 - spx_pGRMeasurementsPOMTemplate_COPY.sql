...
*    03			03/04/2015			Andrey Dmitrienko			Added class ranges filter WI#30432, remove unused fields
*
*************************************************************************************************/
...
(
	...
	@CUser					NVARCHAR(400),
	@CDate					DATETIME,
	@TargetClassRangesList	NVARCHAR(MAX) = NULL,
...
AS
  ...
  DECLARE @SourceTemplates CURSOR
BEGIN

  IF @TargetClassRangesList IS NULL OR LTRIM(RTRIM(@TargetClassRangesList)) = ''
    SET @SourceTemplates = CURSOR LOCAL FAST_FORWARD READ_ONLY 
	  FOR SELECT t.POMTempID
      FROM pGRMeasurementsPOMTemplate t
      WHERE t.POMTempGroupID = @SourcePOMTempGroupId
  ELSE
    SET @SourceTemplates = CURSOR LOCAL FAST_FORWARD READ_ONLY 
	  FOR SELECT t.POMTempID
      FROM pGRMeasurementsPOMTemplate t
	  INNER JOIN fnx_Split(@TargetClassRangesList, ',') l ON CAST(l.value AS UNIQUEIDENTIFIER) = t.ClassRangeId
      WHERE t.POMTempGroupID = @SourcePOMTempGroupId
  ...
  BEGIN
    ...
    INSERT INTO pGRMeasurementsPOMTemplate(
     POMTempID, POMTempGroupID, POMTempVersion, POMType, POMTypeDescription, SpecSketchID, SpecSketchVersion, 
 	 SizeClassId, SizeRangeId, ClassRangeId, SampleSize, CustomField1, CustomField2, CustomField3, CustomField4, 
	 CustomField5, Size0, Size1, Size2, Size3, Size4, Size5, Size6, Size7, Size8, Size9, Size10, Size11, Size12, 
	 Size13, Size14, Size15, Size16, Size17, Size18, Size19, Size20, Size21, Size22, Size23, Size24, Size25, Size26, 
	 Size27, Size28, Size29, Size30, Size31, Size32, Size33, Size34, Size35, Size36, Size37, Size38, Size39, Size40, 
	 Size41, Size42, Size43, Size44, Size45, Size46, Size47, Size48, Size49, CUser, CDate, MUser, MDate, Sort, Active, Linked)
    SELECT @NewPOMTempID, @TargetPOMTempGroupId, POMTempVersion, @TargetPOMType, @TargetPOMDesc, SpecSketchID, SpecSketchVersion, 
 		   SizeClassId, SizeRangeId, ClassRangeId, SampleSize, CustomField1, CustomField2, CustomField3, CustomField4, 
		   CustomField5, Size0, Size1, Size2, Size3, Size4, Size5, Size6, Size7, Size8, Size9, Size10, Size11, Size12,
		   Size13, Size14, Size15, Size16, Size17, Size18, Size19, Size20, Size21, Size22, Size23, Size24, Size25, Size26, 
		   Size27, Size28, Size29, Size30, Size31, Size32, Size33, Size34, Size35, Size36, Size37, Size38, Size39, Size40, 
		   Size41, Size42, Size43, Size44, Size45, Size46, Size47, Size48, Size49, @CUser, @CDate, @CUser, @CDate, Sort, Active, Linked
	...
	INSERT INTO pGRMeasurementsPOMTemplateGroup(
	  POMTempGroupID, POMTempID, POMType, POMTypeDescription, SizeClassId, SizeRangeId, ClassRangeId, 
	  Relative, Negative, Metric, Active, Sort, CUser, CDate, MUser, MDate)
	SELECT @TargetPOMTempGroupId, @NewPOMTempID, @TargetPOMType, @TargetPOMDesc, SizeClassId, SizeRangeId, ClassRangeId, 
		   Relative, Negative, Metric, Active, Sort, @CUser, @CDate, @CUser, @CDate
...
VALUES ('DB_Version', '6.1.0000', '09946', GetUTCDate())
GO
