...
SET @query = N'SELECT SAPCode, PLMCode, StyleColorNo, StyleColorName, ColorFolderID, ColorPaletteID, '+ @cols +'
		FROM
		...
		PIVOT
		(
			MAX(Color) FOR SeasonYear IN ( '+ @cols +' )
		) AS pvt
...
VALUES ('DB_Version', '0.5.0000', '07082', GetDate())
GO
