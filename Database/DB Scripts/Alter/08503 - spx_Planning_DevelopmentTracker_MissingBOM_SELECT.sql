...
BEGIN
	...
	WHERE
		...
		AND pli.StyleID IN (SELECT StyleID FROM pStyleHeader
							INNER JOIN pWorkflowTemplate ON pStyleHeader.WorkflowTemplateID = pWorkflowTemplate.WorkflowTemplateID
							INNER JOIN pWorkflowTemplateItem ON pWorkflowTemplate.WorkflowTemplateID = pWorkflowTemplateItem.WorkflowTemplateID
...
VALUES ('DB_Version', '0.5.0000', '08503', GetDate())
GO
