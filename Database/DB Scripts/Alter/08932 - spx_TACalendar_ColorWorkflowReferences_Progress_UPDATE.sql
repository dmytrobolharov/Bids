/****** Object:  StoredProcedure [dbo].[spx_TACalendar_ColorWorkflowReferences_Progress_UPDATE]    Script Date: 08/21/2014 19:10:59 ******/
...
BEGIN
	...
	WHERE (tt.TACalTemplateId = @TACalTemplateID OR @TACalTemplateID IS NULL) AND cr.ReferenceId = @ColorFolderID
...
VALUES ('DB_Version', '6.0.0000', '08932', GetDate())
GO
