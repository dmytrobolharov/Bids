...
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'vwx_StyleHeader_SEL'))
DROP VIEW vwx_StyleHeader_SEL
GO


CREATE VIEW vwx_StyleHeader_SEL
AS
	SELECT     dbo.pStyleHeader.StyleID, dbo.pStyleHeader.StyleMasterID, dbo.pStyleHeader.StyleWorkflowID, dbo.pStyleHeader.StyleType, dbo.pStyleHeader.WorkflowType, 
                      ...
                      dbo.pStyleHeader.StyleLinkID,dbo.pStyleHeader.OwnerGroup
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='03205'))
BEGIN
	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '5.0.0000', '03205', GetDate())
END
GO	
