/****** Object:  StoredProcedure [dbo].[spx_StyleQuoteItemSourcingTradePartner_INSERT]    Script Date: 11/16/2012 11:10:21 ******/
...
select @SourcingTradePartnerID = SourcingTradePartnerID from pSourcingTradePartner WITH (NOLOCK) 
WHERE SourcingHeaderID = @SourcingHeaderID AND TradePartnerID = @TradePartnerID
BEGIN
	BEGIN
		IF @iCount = 0 
			BEGIN
...
VALUES     ('DB_Version', '5.0.0000', '04357', GetDate())
GO