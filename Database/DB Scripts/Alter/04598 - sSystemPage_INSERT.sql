...
IF NOT EXISTS(SELECT * FROM sSystemPage WHERE MappingPage='Material_SavedSearch_List.aspx')
	BEGIN
		INSERT INTO [sSystemPage] (MappingPage, CDate, CUser, sSystemFolderID)
		VALUES ('Material_SavedSearch_List.aspx', GETDATE(), 'Administrator', (SELECT sSystemFolderID from sSystemFolder where sSystemFolder='Material'))
	END
...
WHERE sSystemFolderID = (SELECT sSystemFolderID from sSystemFolder where sSystemFolder='Material')
...
VALUES ('DB_Version', '5.0.0000', '04598', GetDate())
GO
