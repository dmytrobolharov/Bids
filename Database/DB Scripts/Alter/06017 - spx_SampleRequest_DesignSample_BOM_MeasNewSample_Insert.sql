/****** Object:  StoredProcedure [dbo].[spx_SampleRequest_DesignSample_BOM_MeasNewSample_Insert]    Script Date: 07/10/2013 13:54:11 ******/
...
AS 
    ...
    INSERT INTO pSampleRequestAMLMeasPOM(SampleRequestAMLMeasPOMId, SampleRequestAMLMeasHdrId, PDMPageId, GRPOMCompanyId, POMGuidId, POMAlternatesId, POM_Row, RefCode, Description, 
                      ...
                      MDate, IsLinked, Critical, How2MeasName, FabricType, IsLength, IsWidth, ShrinkX, ShrinkY, CADModelId, BeforeTreat, SampMeasValue, SampDelta, RevisedSpec) 
...
VALUES ('DB_Version', '0.5.0000', '06017', GetDate())
GO
