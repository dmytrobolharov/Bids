IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'vwx_StyleBOM_SELECT') AND type = N'V')
	DROP VIEW vwx_StyleBOM_SELECT
GO

/****** Object:  View [dbo].[vwx_StyleBOM_SELECT]    Script Date: 09/06/2011 11:52:23 ******/
SET ANSI_NULLS ON
GO
...
AS
SELECT DISTINCT 
                      dbo.pStyleBOM.Artwork, dbo.pStyleBOM.License, dbo.pStyleBOM.Colorway, dbo.uTradePartnerVendor.VendorName, 
                      ...
                      dbo.pStyleBOM.MaterialSize, dbo.pStyleBOM.MaterialID, dbo.pStyleBOM.MaterialPlacement, 
                      ...
                      dbo.pStyleBOM.Dim1TypeSel, dbo.pStyleBOM.Dim2TypeSel, dbo.pStyleBOM.Dim3TypeSel,
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='01863'))
BEGIN
	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '01863', GetDate())
END
