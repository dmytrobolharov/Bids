/****** Object:  View [dbo].[vwx_LineFolderItem_SELECT]    Script Date: 11/29/2012 11:37:44 ******/
...
SELECT     dbo.pLineFolderItem.LineFolderID, dbo.pLineFolderItem.LineFolderItemID, dbo.pLineFolderItem.LineItemFolder1, dbo.pLineFolderItem.LineItemFolder2, 
                      ...
                      dbo.pLineFolderItem.StyleSeasonYearID, dbo.pStyleSeasonYear.SeasonYearID AS ColorwaySeasonYearID, dbo.pStyleCategory.StyleCategory AS StyleCategoryName
...
VALUES     ('DB_Version', '5.0.0000', '04495', GetDate())
GO
