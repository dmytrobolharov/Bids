...
/****** Object:  StoredProcedure [dbo].[spx_Sourcing_StyleBOMCommitmentDimItem_select]    Script Date: 11/22/2012 17:17:13 ******/
		...
		begin											
			...
			if @DimLevel=2
				begin
					...
					and a.SourcingCommitmentItemID=@CommitmentItemId	
...
VALUES     ('DB_Version', '5.0.0000', '04424', GetDate())
GO
