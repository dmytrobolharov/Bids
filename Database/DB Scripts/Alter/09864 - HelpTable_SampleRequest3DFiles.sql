...
IF NOT EXISTS(SELECT * FROM sSystemPage WHERE MappingPage='SampleRequest_3D_Files.aspx')
	BEGIN
		INSERT INTO [sSystemPage] (MappingPage, CDate, CUser, sSystemFolderID)
		VALUES ('SampleRequest_3D_Files.aspx', GETDATE(), 'Administrator', (SELECT sSystemFolderID from sSystemFolder where sSystemFolder='Sample Request'))
	END
GO
IF NOT EXISTS(SELECT * FROM sSystemPage WHERE MappingPage='SampleRequest_3D_Files_Upload.aspx')
	BEGIN
		INSERT INTO [sSystemPage] (MappingPage, CDate, CUser, sSystemFolderID)
		VALUES ('SampleRequest_3D_Files_Upload.aspx', GETDATE(), 'Administrator', (SELECT sSystemFolderID from sSystemFolder where sSystemFolder='Sample Request'))
	END
GO
...
VALUES ('DB_Version', '6.1.0000', '09864', GetDate())
GO