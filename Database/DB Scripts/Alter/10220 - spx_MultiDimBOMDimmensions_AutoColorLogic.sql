...
BEGIN	
	...
	DECLARE @ItemDim1TypeName			NVARCHAR(200)
	DECLARE @ItemDim2TypeName			NVARCHAR(200)
	DECLARE @ItemDim3TypeName			NVARCHAR(200)	
...
VALUES ('DB_Version', '6.1.0000', '10220', GetUTCDate())
GO
