--WI # 24039 : Wrong size class and size range if copy style with variation

IF OBJECT_ID ( 'spx_StyleNewCopy_ExecuteSelection_INSERT', 'P' ) IS NOT NULL
    DROP PROCEDURE spx_StyleNewCopy_ExecuteSelection_INSERT;
GO
...
BEGIN 
	...
	INSERT INTO pStyleWorkflow(
		...
		WorkComments, WorkSort, CUser, CDate, MUser, MDate, WorkDay, StyleSeasonYearID)
	SELECT NEWID() AS StyleWorkflowID, @NewStyleID AS StyleID, b.StyleSet, b.WorkflowID, b.WorkflowType, b.WorkflowOrder, b.WorkDate, b.WorkStart, 
		...
		CASE WHEN m.IsSeasonal = 0 THEN NULL ELSE @StyleSeasonYearID END
...
VALUES ('DB_Version', '0.5.0000', '07451', GetDate())
GO