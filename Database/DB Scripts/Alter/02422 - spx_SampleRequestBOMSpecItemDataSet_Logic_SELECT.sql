...
/****** Object:  StoredProcedure [dbo].[spx_SampleRequestBOMSpecItemDataSet_Logic_SELECT]    Script Date: 12/18/2011 18:43:42 ******/
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02422'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '02422', GetDate())
