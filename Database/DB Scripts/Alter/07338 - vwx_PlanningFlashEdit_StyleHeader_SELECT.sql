...
SELECT TOP (100) PERCENT pli.PlanningID, ssy.SeasonYearID, sc.StyleCategory AS StyleCategoryName, st.StyleTypeDescription, sy.SeasonYear, d.Custom AS Division, NULL AS AddIDs, sh.*
...
VALUES ('DB_Version', '0.5.0000', '07338', GetDate())
GO
