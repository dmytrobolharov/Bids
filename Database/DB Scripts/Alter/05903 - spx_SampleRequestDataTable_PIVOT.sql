/****** Object:  StoredProcedure [dbo].[spx_SampleRequestDataTable_PIVOT]    Script Date: 06/25/2013 13:52:33 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_SampleRequestDataTable_PIVOT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_SampleRequestDataTable_PIVOT]
GO
...
CREATE PROCEDURE [dbo].[spx_SampleRequestDataTable_PIVOT](
...
VALUES ('DB_Version', '0.5.0000', '05903', GetDate())
GO
