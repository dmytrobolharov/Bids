...
IF NOT EXISTS(SELECT * FROM sSystemPage WHERE MappingPage='Style_CostSheet_Copy.aspx')
	BEGIN
		INSERT INTO [sSystemPage] (MappingPage, CDate, CUser, sSystemFolderID)
		VALUES ('Style_CostSheet_Copy.aspx', GETDATE(), 'Administrator', (SELECT sSystemFolderID from sSystemFolder where sSystemFolder='Style'))
	END
	GO
...
VALUES     ('DB_Version', '0.5.0.0000', '05665', GetDate())
GO
