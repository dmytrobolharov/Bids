...
IF EXISTS (select * from sysobjects where id = object_id('spx_SampleRequestTradeBOMAllocation_INSERT') and sysstat & 0xf = 4)
    drop procedure spx_SampleRequestTradeBOMAllocation_INSERT
GO
...
if @StyleBOMDimensionItemID = '00000000-0000-0000-0000-000000000000'
	begin
		SELECT top 1 @StyleBOMDimensionItemID = COALESCE(StyleBOMDimensionItemID,'00000000-0000-0000-0000-000000000000') FROM pStyleBOMDimensionItems WHERE (ItemDim1Id=@ItemDim1Id or ItemDim1Id is null) AND (ItemDim2Id=@ItemDim2Id or ItemDim2Id is null) AND (ItemDim3Id=@ItemDim3Id or ItemDim3Id is null)  AND StyleBOMDimensionID=@StyleBOMDimensionID AND StyleID=@StyleID
	end 
...
VALUES ('DB_Version', '4.2.0000', '03035', GetDate())
GO
