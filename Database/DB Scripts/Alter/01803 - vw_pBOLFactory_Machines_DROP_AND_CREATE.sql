...
SELECT     dbo.pBOLFactoryMachines.FactoryMachinesId, dbo.pBOLFactoryMachines.FactoryId, dbo.pBOLFactoryMachines.MachineId, dbo.pBOLFactoryMachines.CUser, 
                      ...
                      AS NVARCHAR(50)) + ''' />' AS Image, dbo.pBOLFactoryMachines.TradePartnerVendorID
...
Begin DesignProperties = 
   ...
   Begin DiagramPane = 
      ...
      End
      Begin Tables = 
         Begin Table = "pBOLFactoryMachines"
            Begin Extent = 
               Top = 6
               Left = 38
               Bottom = 221
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vw_pBOLFactory_Machines'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vw_pBOLFactory_Machines'
GO

IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='01803'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '01803', GetDate())
END
