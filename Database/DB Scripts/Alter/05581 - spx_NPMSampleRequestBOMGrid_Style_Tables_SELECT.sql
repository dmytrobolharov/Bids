...
ISNULL(Convert(VARCHAR(50),e.ItemDim2Name),'NA') AS Dim2,  
ISNULL(Convert(VARCHAR(50),e.ItemDim3Name),'NA') AS Dim3,  
...
LEFT OUTER JOIN pStyleBOMDimensionItem e ON e.ItemDim1ID=a.ItemDim1ID AND e.ItemDim2ID=a.ItemDim2ID AND e.ItemDim3ID=a.ItemDim3ID
...
VALUES     ('DB_Version', '0.5.0000', '05581', GetDate())
GO
