...
BEGIN
	...
	select @SizeRange = SizeRange from pStyleHeader WITH(NOLOCK)  where StyleID = @StyleID and StyleSet = @StyleSet
...
END
GO
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='03234'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '5.0.0000', '03234', GetDate())
