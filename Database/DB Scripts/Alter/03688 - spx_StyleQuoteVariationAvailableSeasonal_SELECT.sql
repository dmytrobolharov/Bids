...
SELECT pStyleHeader.StyleID, pStyleHeader.StyleMasterID, pStyleHeader.StyleNo, pStyleHeader.SizeClass, pStyleHeader.SizeRange,   
      pStyleHeader.Description, pStyleHeader.DesignSketchID, pStyleHeader.DesignSketchVersion, 
      pStyleDevelopmentItem.StyleDevelopmentName, pStyleDevelopmentItem.Variation,
...
VALUES ('DB_Version', '5.0.0000', '03688', GetDate())
GO