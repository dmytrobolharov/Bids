/****** Object:  StoredProcedure [dbo].[spx_LineFolder_LinePlanningBusiness_ActualLogic_UPDATE]    Script Date: 03/22/2013 11:33:00 ******/
...
BEGIN
	...
	*/
	...
	BEGIN
		...
		-- Avg Cost / Unit
		SELECT @AvgCostUnit = (SUM(sci.StyleQuoteItemCustomField24)/ (SUM(sci.StyleQuoteItemCustomField16))) FROM pSourcingCommitmentItem  sci 
		INNER JOIN @StyleList sl ON sl.StyleID = sci.StyleID
		INNER JOIN pStyleSeasonYear ssy ON sci.StyleSeasonYearID = ssy.StyleSeasonYearID
		WHERE sci.StyleQuoteItemStatusId = 3 AND ssy.SeasonYearID = @SeasonYearID
...
VALUES ('DB_Version', '0.5.0000', '05383', GetDate())
GO
