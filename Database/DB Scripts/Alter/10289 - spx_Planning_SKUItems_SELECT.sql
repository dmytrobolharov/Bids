...
BEGIN
	...
	SELECT sh.StyleID, sh.StyleNo, sh.Description, ssis.*, 
		...
		'<a href="Planning_StyleProperty.aspx?SID=' + CAST(sh.StyleID AS NVARCHAR(50)) + '&SYID=' + LOWER(CAST(ssy.SeasonYearID AS NVARCHAR(50))) + '&PIID=' + CAST(pi.PlanningItemID AS NVARCHAR(50)) + '&SHID=' + CAST(@PlanningSKUHeaderID AS NVARCHAR(50)) + '&RT=SP">' + sh.StyleNo + '</a>' AS StylePropertyLink,
		0 as NegativeDelta
	INTO #tmpItems
...
VALUES ('DB_Version', '6.1.0000', '10289', GetUTCDate())
GO