...
SELECT     dbo.pTechPack.TechPackID, dbo.pTechPack.TechPackNo, dbo.pTechPack.TechPackStatus, dbo.pTechPack.TechPackName, dbo.pTechPack.StyleID,   
                  ...
                  dbo.pStyleHeader.TechPackDate AS FinalTechPackDate, dbo.pTechPackTeam.TechPackDownload, dbo.pTechPackTeam.TeamID, 
...
INNER JOIN  dbo.pTechPackTeam WITH (NOLOCK) ON dbo.pTechPack.TechPackID = dbo.pTechPackTeam.TechPackID  
...
VALUES     ('DB_Version', '4.0.0000', '653', GetDate())
