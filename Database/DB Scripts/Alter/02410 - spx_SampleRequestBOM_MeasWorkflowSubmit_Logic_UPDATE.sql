...
/****** Object:  StoredProcedure [dbo].[spx_SampleRequestBOM_MeasWorkflowSubmit_Logic_UPDATE]    Script Date: 12/18/2011 18:37:03 ******/
...
GO
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02410'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '02410', GetDate())
