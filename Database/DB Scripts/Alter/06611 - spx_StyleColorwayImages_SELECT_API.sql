/****** Object:  StoredProcedure [dbo].[spx_StyleColorwayImages_SELECT_API]    Script Date: 11/15/2013 17:00:10 ******/
...
BEGIN
	...
	select COUNT(*) as amount from pstyleheader 
...
VALUES     ('DB_Version', '0.5.0000', '06611', GetDate())
GO