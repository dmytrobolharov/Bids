...
SET @DVTableName = 'ComponentTypeCode'
SET @ControlPanelName = 'Component Type Code'
...
BEGIN
	...
	-- Add records.
    INSERT INTO dvtComponentTypeCode (ItemValue, ItemKey, Active, CUser, CDate, MUser, MDate, ItemSort)
    VALUES ('F', 'F', 1, 'administrator', getutcdate(), 'administrator', getutcdate(), '00001')

    INSERT INTO dvtComponentTypeCode (ItemValue, ItemKey, Active, CUser, CDate, MUser, MDate, ItemSort)
    VALUES ('I', 'I', 1, 'administrator', getutcdate(), 'administrator', getutcdate(), '00002')

    INSERT INTO dvtComponentTypeCode (ItemValue, ItemKey, Active, CUser, CDate, MUser, MDate, ItemSort)
    VALUES ('P', 'P', 1, 'administrator', getutcdate(), 'administrator', getutcdate(), '00003')

    INSERT INTO dvtComponentTypeCode (ItemValue, ItemKey, Active, CUser, CDate, MUser, MDate, ItemSort)
    VALUES ('T', 'T', 1, 'administrator', getutcdate(), 'administrator', getutcdate(), '00004')
...
VALUES              ('DB_Version', '6.0.0000', '09015', GetDate())
GO
