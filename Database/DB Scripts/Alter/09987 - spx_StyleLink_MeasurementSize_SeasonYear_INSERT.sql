...
BEGIN 
	...
	--***
	EXEC spx_StyleHeaderLink_INSERT 
	 @StyleID = @StyleID, @NewStyleID = @NewStyleID, @SizeClassId = @SizeClassId, 
	 @SizeRangeId = @SizeRangeId, @CreatedBy = @CUser, @CreatedDate = @CDate, 
...
VALUES ('DB_Version', '6.1.0000', '09987', GetUTCDate())
GO
