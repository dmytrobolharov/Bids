...
CREATE PROCEDURE spx_StyleMeasChangeProduct_Update
(
						...
						begin
							if @OverrideDesc=1 
								begin
									...
									and p.POM_Row=t.POM_Row	and p.refcode=t.refcode where  p.amlmeashdrid=@AMLMeasHdrId  and p.pom_row <= @MaxPOMRow											
								end						
...
VALUES ('DB_Version', '4.2.0000', '03015', GetDate())
GO
