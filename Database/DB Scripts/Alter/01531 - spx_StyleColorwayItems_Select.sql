IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_StyleColorwayITEMS_SELECT]') AND type = N'P' )
	DROP PROCEDURE [dbo].[spx_StyleColorwayITEMS_SELECT]
GO

/****** Object:  StoredProcedure [dbo].[spx_StyleColorwayITEMS_SELECT]    Script Date: 06/15/2011 17:18:32 ******/
SET ANSI_NULLS ON
GO
...
VALUES ('DB_Version', '4.1.0000', '01531', GetDate())
GO