IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_Group_AccessFolderUserPermissions_UPDATE]') AND type = N'P' )
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='01549'))
BEGIN
	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '01549', GetDate())
END	
