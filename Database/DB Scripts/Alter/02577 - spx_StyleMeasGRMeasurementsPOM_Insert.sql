...
IF EXISTS(SELECT * FROM INFORMATION_SCHEMA.ROUTINES WHERE SPECIFIC_NAME = N'spx_StyleMeasGRMeasurementsPOM_Insert')
   DROP PROCEDURE spx_StyleMeasGRMeasurementsPOM_Insert
GO
...
INSERT INTO pamlmeaspom(AMLMeasHdrId, GRPOMCompanyId, POMGuidId, POMAlternatesId,  Refcode, Description, 
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02577'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.2.0000', '02577', GetDate())
