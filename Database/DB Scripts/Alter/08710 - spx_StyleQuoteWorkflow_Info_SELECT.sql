/****** Object:  StoredProcedure [dbo].[spx_StyleQuoteWorkflow_Info_SELECT]    Script Date: 08/10/2014 13:19:05 ******/
...
BEGIN
	...
	SELECT @TACalTemplateID = cr.TACalTemplateId 
...
VALUES ('DB_Version', '0.5.0000', '08710', GetDate())
GO
