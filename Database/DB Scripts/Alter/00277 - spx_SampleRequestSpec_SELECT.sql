IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_SampleRequestSpec_SELECT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_SampleRequestSpec_SELECT]
GO


CREATE  PROCEDURE [dbo].[spx_SampleRequestSpec_SELECT] 
