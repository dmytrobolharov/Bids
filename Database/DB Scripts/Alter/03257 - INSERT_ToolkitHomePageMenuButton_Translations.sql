...
IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE UPPER(COLUMN_NAME) = 'DESKBUTTONNAME' AND UPPER(TABLE_NAME) = UPPER('sYuniFaceDeskTop'))
BEGIN
	ALTER TABLE sYuniFaceDeskTop ADD DeskButtonName NVARCHAR(200)
END
ELSE
BEGIN
	PRINT 'Column already exists for table sYuniFaceDeskTop'
END
GO
...
VALUES ('DB_Version', '5.0.0000', '03257', GetDate())
GO
