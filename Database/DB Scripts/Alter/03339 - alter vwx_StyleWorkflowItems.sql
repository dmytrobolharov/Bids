...
FROM         dbo.pStyleWorkflow AS a WITH (NOLOCK) INNER JOIN
                      ...
                      dbo.pWorkflowStatus AS c WITH (NOLOCK) ON a.WorkStatus = c.WorkflowStatusID and e.WorkflowTemplateID = c.WorkflowTemplateID

go


IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='03339'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '5.0.0000', '03339', GetDate())
