/****** Object:  View [dbo].[vwx_SourcingStyle_StyleHeader_QuickQuote_SEL]    Script Date: 08/06/2014 17:58:54 ******/
...
SELECT     dbo.pStyleHeader.StyleID, dbo.pStyleHeader.StyleMasterID, dbo.pStyleHeader.StyleWorkflowID, dbo.pStyleHeader.StyleType, dbo.pStyleHeader.WorkflowType, 
                      ...
                      AS Variation, dbo.pStyleHeader.IntroSeasonYearID, ISNULL(dbo.pStyleHeader.DivisionID, '00000000-0000-0000-0000-000000000000') AS DivisionID, dbo.pStyleCategory.StyleCategory as StyleCategoryName,
...
VALUES ('DB_Version', '0.5.0000', '08600', GetDate())
GO
