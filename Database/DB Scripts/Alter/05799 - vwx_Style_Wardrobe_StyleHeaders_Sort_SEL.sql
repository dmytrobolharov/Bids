/****** Object:  View [dbo].[vwx_Style_Wardrobe_StyleHeaders_Sort_SEL]    Script Date: 06/04/2013 14:00:55 ******/
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vwx_Style_Wardrobe_StyleHeaders_Sort_SEL]'))
...
SELECT     dbo.pStyleHeader.StyleID, dbo.pStyleHeader.StyleMasterID, dbo.pStyleHeader.StyleWorkflowID, dbo.pStyleHeader.StyleType, dbo.pStyleHeader.WorkflowType, 
                      ...
                      AS Variation, dbo.pStyleHeader.IntroSeasonYearID, dbo.pStyleHeader.DivisionID, dbo.pStyleWardrobeRelation.StyleRelationID, 
                      dbo.pStyleWardrobeRelation.StyleID AS MasterStyleID, dbo.pStyleWardrobeRelation.Sort, dbo.pStyleWardrobeRelation.SeasonYearID AS RelationSeasonYear
FROM         dbo.pStyleHeader LEFT OUTER JOIN
                      ...
                      dbo.pStyleWardrobeRelation ON dbo.pStyleHeader.StyleID = dbo.pStyleWardrobeRelation.StyleRelationID AND 
                      dbo.pStyleSeasonYear.SeasonYearID = dbo.pStyleWardrobeRelation.SeasonYearID

GO

INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
VALUES ('DB_Version', '0.5.0.0000', '05799', GetDate())
GO