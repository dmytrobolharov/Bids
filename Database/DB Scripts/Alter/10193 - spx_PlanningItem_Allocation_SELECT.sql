...
AS
BEGIN
	SELECT ppi.PlanningItemID, sh.*, dbo.fnx_GetStreamingImagePath(DesignSketchID, DesignSketchVersion, 500) as designImage
...
VALUES ('DB_Version', '6.1.0000', '10193', GetUTCDate())
GO