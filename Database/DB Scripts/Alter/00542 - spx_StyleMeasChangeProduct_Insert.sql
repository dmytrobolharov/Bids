...
create PROCEDURE [dbo].[spx_StyleMeasChangeProduct_Insert](	
...
(SizeRangeGuidId = @SizeRangeID) AND (GarmentGuidID = @OldProductTypeID))))
...
Update pamlmeashdr set ProductTypeID=@ProductTypeID, MeasRowCnt=(select max(pom_row) from pamlmeaspom where AMLMeasHdrId = @AMLMeasHdrId) 
...
VALUES     ('DB_Version', '4.0.0000', '542', GetDate())
GO
