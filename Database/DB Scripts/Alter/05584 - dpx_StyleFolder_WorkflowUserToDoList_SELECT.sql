...
BEGIN  
  SELECT    
   ...
   pStyleHeader.*, pStyleSeasonYear.SeasonYearID,
   pStyleWorkflow.WorkStatus, pWorkflowStatus.WorkflowStatus, pStyleWorkflow.WorkflowID,   
      DATEDIFF(day, pStyleWorkflow.WorkDue, GETDATE()) AS DaysLate  
      , DATEDIFF(day, pStyleWorkflow.WorkStart, GETDATE()) AS DaysWork 
...
VALUES     ('DB_Version', '0.5.0000', '05584', GetDate())
GO
