...
BEGIN
	...
	SET	 
		  ...
		  ,Location = (SELECT REPLACE(Location, '#', '\') from  #tempTBLCAD )
	...
	--      ,MUser = (SELECT MUser from  #tempTBLCAD )
		  ...
		  ,Marker_Plac_Bndl = (SELECT Marker_Plac_Bndl from  #tempTBLCAD )
...
VALUES ('DB_Version', '0.5.0.0000', '05861', GetDate())
GO
