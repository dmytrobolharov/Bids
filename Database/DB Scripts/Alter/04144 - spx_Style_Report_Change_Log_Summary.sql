/****** Object:  StoredProcedure [dbo].[spx_Style_Report_Change_Log_Summary]    Script Date: 10/10/2012 18:14:01 ******/
...
CREATE PROCEDURE [dbo].[spx_Style_Report_Change_Log_Summary]
...
SELECT 
	...
	, sh.SizeClass
	, (SELECT TOP 1 dbo.fnx_GetStreamingImagePath(hImage.ImageID, hImage.[Version])) AS FilePath
	, (CASE sh.StyleSet
...
VALUES     ('DB_Version', '5.0.0000', '04144', GetDate())
GO