...
BEGIN
	...
	(StyleNBOLHeaderID, WorkflowID, WorkFlowItemID, StyleID, StyleSet, TemplateID, TemplateName, ImageID, 
	CUser, CDate, MUser, MDate, CustomField1, CustomField2, CustomField3, CustomField4, CustomField5)
	SELECT NEWID(), WorkflowID, @NewWorkFlowItemId, @NewStyleID, @NewStyleSet, TemplateID, TemplateName, ImageID,
...
VALUES     ('DB_Version', '5.0.0000', '03561', GetDate())
GO 