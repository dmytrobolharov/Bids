...
GO
/****** Object:  StoredProcedure [dbo].[spx_Planning_FinancialPlan_SELECT]    Script Date: 03/17/2015 15:44:22 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	DECLARE @sql NVARCHAR(MAX) = 
		...
		INTO ##tmpPlanValues
		FROM (SELECT Active, PlanningPlanningCh, PlanningDivisionID, PlanningStyleTypeID, PlanningStyleCategoryID, PlanningFinancialID, PlanningStyleCategory
...
VALUES ('DB_Version', '6.1.0000', '10059', GetUTCDate())
GO