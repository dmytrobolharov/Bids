/****** Object:  StoredProcedure [dbo].[spx_StyleBOM_SeasonalColor_EXECUTE]    Script Date: 08/28/2013 11:06:47 ******/
...
BEGIN
	...
	begin -- copy colors from seasonal colorway
		...
		SELECT sc.ColorPaletteID FROM pStyleColorwaySeasonYear scsy
...
VALUES ('DB_Version', '0.5.0.0000', '06248', GetDate())
GO
