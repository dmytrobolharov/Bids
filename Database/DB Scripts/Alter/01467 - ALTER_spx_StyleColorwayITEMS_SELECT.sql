...
IF EXISTS (select * from sysobjects where id = object_id('spx_StyleColorwayITEMS_SELECT') and sysstat & 0xf = 4)
    drop procedure spx_StyleColorwayITEMS_SELECT
GO


CREATE PROCEDURE spx_StyleColorwayITEMS_SELECT (
...
VALUES     ('DB_Version', '4.1.0000', '01467', GetDate())
GO
