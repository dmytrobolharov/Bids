...
/****** Object:  StoredProcedure [dbo].[spx_SampleRequestTradeBOMAllocation_INSERT]    Script Date: 12/18/2011 18:01:46 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_SampleRequestTradeBOMAllocation_INSERT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_SampleRequestTradeBOMAllocation_INSERT]
GO
...
CREATE PROCEDURE [dbo].[spx_SampleRequestTradeBOMAllocation_INSERT]
	...
	BEGIN
		...
		BEGIN	
			...
			INSERT INTO pSampleRequestBOMTrade
				...
				ItemDim1Id,ItemDim2Id,ItemDim3Id, TechPackID, CUser, CDate, MUser, MDate, MessageSent, SampleRequestShare, StyleSourcingID , StyleSeasonYearID   )
			VALUES (@SampleRequestTradeID, @TradePartnerVendorID, @TradePartnerID, @StyleID, 
				@ItemDim1Id,@ItemDim2Id,@ItemDim3Id, @TechPackID, @CreatedBy, @CreatedDate, @CreatedBy, @CreatedDate, 0, @SampleRequestShare  , @StyleSourcingID , @StyleSeasonYearID )	
			...
			VALUES  (@SampleRequestTradeId, @TradePartnerId, @TradepartnerVendorId, @StyleId, @ItemDim1Id,@ItemDim2Id,@ItemDim3Id, @TechPackId, @CreatedBy, @CreatedDate, N'New Sample Request', 'N')					
...
set @ISet_Max = 1
							...
							SELECT @SampleRequestWorkflowID = SampleRequestWorkflowID FROM ##SampleRequestWorkflowBOMTemp WHERE ID_Num = @I
								BEGIN
									...
									INSERT INTO pSampleRequestWorkflowBOM
										...
										ItemDim1Id,ItemDim2Id,ItemDim3Id, StyleSet, Status, Submit, SubmitDays, ResubmitDays, AssignedTo, TechPackID, StartDate, DueDate, FinalDate, EndDate, CUser, CDate, MUser, MDate , SampleWorkflowFinalDate )
								...
								BEGIN
									...
									SELECT @TradePartnerVendorID, @TradePartnerID, @SampleRequestTradeID AS SampleRequestTradeID, @NewSampleRequestWorkflowID AS SampleRequestWorkflowID, SampleWorkflowID, StyleID,@ItemDim1Id as 'ItemDim1Id',@ItemDim2Id as 'ItemDim2Id',@ItemDim3Id as 'ItemDim3Id', StyleSet, WorkflowID, 
		...
		BEGIN
			...
			SELECT @SampleRequestTradeID AS SampleRequestTradeID, @TradePartnerVendorID AS TradePartnerVendorID, @ItemDim1Id,@ItemDim2Id,@ItemDim3Id, ItemDim1Name,ItemDim2Name,ItemDim3Name, StyleID, StyleSet, 
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02367'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '02367', GetDate())
