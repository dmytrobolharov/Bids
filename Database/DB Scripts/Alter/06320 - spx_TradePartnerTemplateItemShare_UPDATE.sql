...
INSERT INTO uTradePartnerTemplateItemShare 
SELECT @TradePartnerID, tpti.TradePartnerTemplateItemID, tpti.Shared
FROM uTradePartner tp INNER JOIN uTradePartnerTemplateItem tpti ON tp.TradePartnerTemplateID = tpti.TradePartnerTemplateID
WHERE tp.TradePartnerID = @TradePartnerID

GO

INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
VALUES ('DB_Version', '0.5.0000', '06320', GetDate())
GO
