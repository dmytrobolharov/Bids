/****** Object:  View [dbo].[vwx_LineList_SampleStyle_SEL]    Script Date: 07/15/2013 12:01:34 ******/
...
SELECT     dbo.pStyleHeader.StyleID, dbo.pStyleHeader.WorkflowTemplateID, dbo.pStyleHeader.PlannedDueDate, dbo.pStyleHeader.EnforceDependency, 
                      ...
                      dbo.pLineFolderItem.LineFolderID, dbo.pLineFolderItem.LineFolderItemID, ISNULL(dbo.pStyleDevelopmentItem.StyleDevelopmentName, 
                      'Variation ' + CAST(dbo.pStyleDevelopmentItem.Variation AS Varchar(2))) AS Variation,
...
VALUES ('DB_Version', '0.5.0000', '06053', GetDate())
GO
