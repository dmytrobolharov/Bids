...
SELECT pMaterialRequestSubmitWorkflow.MaterialRequestSubmitWorkflowID, pMaterialTradePartnerColor.MaterialTradePartnerColorID,  
  ...
  pMaterialRequestSubmitWorkflow.DueDate, pMaterialRequestSubmitWorkflow.EndDate, pMaterialRequestSubmitItemStatus.ApprovedType,
	...
	+
	CASE 
		WHEN pMaterialRequestSubmitItemStatus.ApprovedType = 1 Or pMaterialRequestSubmitItemStatus.StatusID = 4 THEN ISNULL(CONVERT(nVARCHAR(12), pMaterialRequestSubmitWorkflow.EndDate , 107),'NODATE')
		ELSE ISNULL(CONVERT(nVARCHAR(12), pMaterialRequestSubmitWorkflow.DueDate , 107),'NODATE') --CONVERT(nVARCHAR(20), pMaterialRequestSubmitWorkflow.DueDate , 101)
	END 
	+ '&nbsp;<b>(' 
...
FROM  pMaterialTradePartnerColor
	...
	INNER JOIN pMaterialRequestSubmitWorkflowShare ON pMaterialRequestSubmitWorkflow.TradePartnerID = pMaterialRequestSubmitWorkflowShare.TradePartnerID
...
VALUES     ('DB_Version', '0.5.0000', '06603', GetDate())
GO
