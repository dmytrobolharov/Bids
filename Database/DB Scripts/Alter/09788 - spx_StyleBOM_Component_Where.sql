IF OBJECT_ID(N'[dbo].[spx_StyleBOM_Component_Where]') IS NOT NULL
...
SELECT DISTINCT ssy.StyleSeasonYearID , a.StyleID ,c.StyleNo ,c.DesignSketchVersion, c.DesignSketchID,
	COALESCE(sc.Custom, c.SizeClass) AS SizeClass, COALESCE(sr.SizeRangeCode, c.SizeRange) AS SizeRange,
	c.Description,c.MaterialName, c.CustomField2,c.CustomField4, ssy.SeasonYearID
FROM pStyleBOM a 
...
VALUES ('DB_Version', '6.1.0000', '09788', GetDate())
GO
