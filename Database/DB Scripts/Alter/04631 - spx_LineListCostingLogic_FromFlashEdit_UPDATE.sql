/****** Object:  StoredProcedure [dbo].[spx_LineListCostingLogic_FromFlashEdit_UPDATE]    Script Date: 12/13/2012 19:56:20 ******/
...
BEGIN
	...
	DECLARE @WMarkup NUMERIC(18,4)
	DECLARE @RMarkup NUMERIC(18,4)
	...
	SET
		...
		WholesalePrice=@FlashCostLDP/(1-@WMarkup/100),
		RetailPrice=@FlashCostLDP/(1-@RMarkup/100),
...
VALUES ('DB_Version', '5.0.0000', '04631', GetDate())
GO
