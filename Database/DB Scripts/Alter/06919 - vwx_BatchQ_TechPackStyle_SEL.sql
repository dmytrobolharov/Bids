IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vwx_BatchQ_TechPackStyle_SEL]'))
...
SELECT dbo.pStyleHeader.StyleID, dbo.pStyleHeader.StyleMasterID, dbo.pStyleHeader.StyleWorkflowID, dbo.pStyleHeader.StyleType, dbo.pStyleHeader.WorkflowType, 
      ...
      dbo.pStyleHeader.TradePartnerID, dbo.pStyleHeader.TradePartnerVendorID, dbo.pStyleHeader.HeaderLocked, dbo.pStyleHeader.IntroSeasonYearID, 
      dbo.pStyleHeader.StyleLinkID, dbo.pStyleType.StyleTypeDescription
...
VALUES              ('DB_Version', '0.5.0000', '06919', GetDate())
GO
