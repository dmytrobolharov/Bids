IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_SampleWorkflowSilhoBOMGridTable_SELECT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_SampleWorkflowSilhoBOMGridTable_SELECT]
GO

CREATE  PROCEDURE [dbo].[spx_SampleWorkflowSilhoBOMGridTable_SELECT] (
...
VALUES ('DB_Version', '0.5.0000', '06020', GetDate())
GO
