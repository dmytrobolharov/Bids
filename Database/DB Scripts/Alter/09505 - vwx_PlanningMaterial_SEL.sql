...
SELECT     TOP (100) PERCENT dbo.pPlanningMaterial.PlanningMaterialID, dbo.pPlanningMaterial.PlanningID, dbo.pPlanningMaterial.CUser, dbo.pPlanningMaterial.CDate, 
                      dbo.pPlanningMaterial.MUser, dbo.pPlanningMaterial.MDate, dbo.pPlanningMaterial.MaterialID, dbo.pPlanningMaterial.Sort, dbo.pMaterial.MaterialType, 
                      '<a href=''../Material/Material_Frame.aspx?MTID=' + CAST(dbo.pMaterial.MaterialID AS NVARCHAR(50)) 
                      ...
                      dbo.pMaterial.MaterialImageID, dbo.pMaterial.MaterialImageVersion, dbo.pMaterial.Active, dbo.pPlanningMaterial.PlanningMaterialDrop, 
                      dbo.pPlanningMaterial.PlanningMaterialDropUser, dbo.pPlanningMaterial.PlanningMaterialDropDate, 
                      ...
                      + '&V=' + CAST(ISNULL(dbo.pMaterial.MaterialImageVersion, '0') AS NVARCHAR(50)) AS MaterialImageUrl, '<img src=''' +
                          (SELECT     TOP (1) AppSettingValue
                            FROM          dbo.sAppSetting
                            WHERE      (AppSettingKey = 'ImageServer')) + '/ImageStream.ashx?S=25&IID=' + CAST(ISNULL(dbo.pMaterial.MaterialImageID, '00000000-0000-0000-0000-000000000000') 
                      AS NVARCHAR(50)) + '&V=' + CAST(ISNULL(dbo.pMaterial.MaterialImageVersion, '0') AS NVARCHAR(50)) + '''  />' AS MaterialImagePath, 
                      dbo.pPlanningMaterial.SeasonYearID, dbo.pComponentType.ComponentDescription, dbo.pActive.Custom AS ActiveLabel, dbo.pMaterial.DueDate,
...
VALUES ('DB_Version', '6.1.0000', '09505', GetDate())
GO
