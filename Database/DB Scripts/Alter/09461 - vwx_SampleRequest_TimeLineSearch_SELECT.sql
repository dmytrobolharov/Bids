IF OBJECT_ID(N'[dbo].[vwx_SampleRequest_TimeLineSearch_SELECT]') IS NOT NULL
...
INNER JOIN pSampleRequestTrade srt ON sh.StyleID = srt.StyleID 
...
VALUES ('DB_Version', '6.1.0000', '09461', GetDate())
GO
