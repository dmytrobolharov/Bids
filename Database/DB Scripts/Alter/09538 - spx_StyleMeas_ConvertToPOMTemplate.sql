IF OBJECT_ID(N'[dbo].[spx_StyleMeas_ConvertToPOMTemplate]') IS NOT NULL
 DROP PROCEDURE [dbo].[spx_StyleMeas_ConvertToPOMTemplate]
GO

CREATE PROCEDURE [dbo].[spx_StyleMeas_ConvertToPOMTemplate]
(
...
VALUES ('DB_Version', '6.1.0000', '09538', GetDate())
GO
