IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_Planning_SKU_Mismatching_BOM_SELECT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_Planning_SKU_Mismatching_BOM_SELECT]
GO

CREATE PROCEDURE [dbo].[spx_Planning_SKU_Mismatching_BOM_SELECT]
(
...
BEGIN
	...
	WHERE
		...
		AND pli.StyleBOMDimensionID != ssh.StyleBOMDimensionID
END

GO

INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
VALUES     ('DB_Version', '0.5.0000', '08291', GetDate())
GO
