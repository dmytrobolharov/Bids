...
IF EXISTS(SELECT * FROM INFORMATION_SCHEMA.ROUTINES WHERE SPECIFIC_NAME = N'spx_SampleRequest_TradePartner_DataTable_PIVOT')
...
SET @SQL = 'INSERT INTO #tmpWorkflow (SampleWorkflow,  SampleWorkflowSort) 
SELECT b.SampleWorkflow, b.SampleWorkflowSort 
...
IF @TradepartnerID IS NOT NULL
	BEGIN
		SET @SQL = @SQL + ' WHERE TradePartnerID = ''' + CAST (@TradepartnerID AS NVARCHAR(50)) + ''' '
	END
...
VALUES ('DB_Version', '4.1.0000', '01517', GetDate())
GO
