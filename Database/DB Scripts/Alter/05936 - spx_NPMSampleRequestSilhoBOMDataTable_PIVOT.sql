/****** Object:  StoredProcedure [dbo].[spx_NPMSampleRequestSilhoBOMDataTable_PIVOT]    Script Date: 07/01/2013 11:32:57 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_NPMSampleRequestSilhoBOMDataTable_PIVOT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_NPMSampleRequestSilhoBOMDataTable_PIVOT]
GO
...
CREATE PROCEDURE [dbo].[spx_NPMSampleRequestSilhoBOMDataTable_PIVOT](
...
TradePartnerID , Link, 
AssignedTo, ItemDim1Id,ItemDim2Id,ItemDim3Id, TechPack, StyleSet, SetNo, Season, Year,WorkFlowItemID,StyleBOMDimensionID,StyleBOMDimensionItemID, TradePartnerRelationshipLevelID )
SELECT 
...
a.Link , d.StyleNo, d.Description, d.SizeClass ,g.ItemDim1Name,h.ItemDim2Name,j.ItemDim3Name, a.ItemDim1Id,a.ItemDim2Id,a.ItemDim3Id, a.TechPack, a.StyleSet, a.SetNo, a.Season, a.Year,a.WorkFlowItemID,a.StyleBOMDimensionID,a.StyleBOMDimensionItemID
FROM #tmpSample1 a
...
VALUES ('DB_Version', '0.5.0000', '05936', GetDate())
GO
