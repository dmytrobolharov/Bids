...
SELECT sh.StyleID, sh.StyleMasterID, sh.StyleWorkflowID, sh.StyleType, sh.WorkflowType, sh.RefNo, sh.StyleNo, 
	   ...
	   ssy.SeasonYearID,sy.Season,sy.Year,ISNULL(sdi.StyleDevelopmentName, sdi.Variation) AS Variation, sh.UserCID, 
	   sh.UserMID, sh.DivisionID, sh.StyleThemeID
...
VALUES ('DB_Version', '6.1.0000', '09494', GetDate())
GO
