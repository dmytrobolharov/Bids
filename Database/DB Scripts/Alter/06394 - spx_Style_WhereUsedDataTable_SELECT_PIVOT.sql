/****** Object:  StoredProcedure [dbo].[spx_Style_WhereUsedDataTable_SELECT_PIVOT]    Script Date: 10/02/2013 14:15:14 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_Style_WhereUsedDataTable_SELECT_PIVOT]') AND type in (N'P', N'PC'))
...
select sh.StyleNo,sh.Description,sh.SizeClass,wl.StyleID,wl.StyleSet,
...
VALUES ('DB_Version', '0.5.0000', '06394', GetDate())
GO