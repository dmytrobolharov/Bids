...
SELECT	t.TemplateEntryId, t.MacroId, t.TemplateID, o.OperationID, o.OperationCode AS Code, o.OperationName AS Name, 
		o.CUser AS OpM_CUser, o.MUser AS OpM_MUser, o.CDate AS OpM_CDate, o.MDate AS OpM_MDate, 
...
SELECT	t.TemplateEntryId, t.MacroId, t.TemplateID, NULL AS OperationID, m.MacroCode AS Code, m.MacroName AS Name, 
		m.CUser AS OpM_CUser, m.MUser AS OpM_MUser, m.CDate AS OpM_CDate, m.MDate AS OpM_MDate, 
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='03237'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '5.0.0000', '03237', GetDate())
