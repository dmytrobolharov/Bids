...
SELECT     TOP (100) PERCENT dbo.pPlanningColor.PlanningColorID, dbo.pPlanningColor.PlanningID, dbo.pPlanningColor.CUser, dbo.pPlanningColor.CDate, 
                      ...
                      dbo.pColorPalette.Sort, dbo.pColorFolder.ColorTypeID, dbo.pPlanningColor.PlanningColorDrop, dbo.pPlanningColor.PlanningColorDropUser, dbo.pPlanningColor.PlanningColorDropDate,
...
FROM         dbo.pColorPalette INNER JOIN
                      ...
                      dbo.pColorType ON dbo.pColorFolder.ColorTypeID = dbo.pColorType.ColorTypeID
...
VALUES     ('DB_Version', '0.5.0000', '06584', GetDate())
GO
