/****** Object:  StoredProcedure [dbo].[spx_SourcingTradePartners_SELECT]    Script Date: 02/01/2013 16:22:37 ******/
...
BEGIN
	...
	SELECT 
		...
		(
			SELECT COUNT(*) FROM pStyleQuoteItem 
			WHERE SourcingHeaderID = @SourcingHeaderID AND StyleQuoteTradePartnerID = stp.SourcingTradePartnerID
		) as QuoteCount,
...
VALUES ('DB_Version', '5.0.0000', '04959', GetDate())
GO