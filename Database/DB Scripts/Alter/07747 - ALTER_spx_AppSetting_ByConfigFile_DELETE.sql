...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'spx_AppSetting_ByConfigFile_DELETE') AND type = N'P' )
	DROP PROCEDURE spx_AppSetting_ByConfigFile_DELETE
GO

CREATE PROCEDURE spx_AppSetting_ByConfigFile_DELETE
(
...
VALUES              ('DB_Version', '0.5.0000', '07747', GetDate())
GO
