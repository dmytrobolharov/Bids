/****** Object:  StoredProcedure [dbo].[spx_BatchQJob_AddBOMMaterialGroup_EXECUTE]    Script Date: 12/18/2012 14:00:18 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_BatchQJob_AddBOMMaterialGroup_EXECUTE]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_BatchQJob_AddBOMMaterialGroup_EXECUTE]
GO
...
Create PROCEDURE [dbo].[spx_BatchQJob_AddBOMMaterialGroup_EXECUTE](
...
SET @ServiceQueueSql1 = 'dbo.spx_BatchQJob_AddBOMMaterialGroup_EXECUTE_QUEUE ' + 
@pBatchQueueJobID  + ',' + 
@pMDate 
...
VALUES     ('DB_Version', '5.0.0000', '04649', GetDate())
GO
