...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[vwx_Style_Quote_Default_SELECT]') AND type in (N'V'))
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02959'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.2.0000', '02959', GetDate())
