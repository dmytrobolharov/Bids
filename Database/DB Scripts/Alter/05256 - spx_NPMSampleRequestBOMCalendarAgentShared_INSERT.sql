/****** Object:  StoredProcedure [dbo].[spx_NPMSampleRequestBOMCalendarAgentShared_INSERT]    Script Date: 03/06/2013 17:48:10 ******/
...
WHERE     (pSampleRequestWorkflow.DueDate BETWEEN @StartDate AND @EndDate) AND 
		pSampleRequestWorkflow.Status IN (0,1)
...
VALUES ('DB_Version', '0.5.0000', '05256', GetDate())
GO
