/****** Object:  StoredProcedure [dbo].[spx_MaterialRequestSubmitColor_NewTradePartner_PIVOT]    Script Date: 01/18/2013 11:28:20 ******/
...
LEFT JOIN vwx_TradePartnerMgmt_SEL tpm ON tpm.RelationshipLevelID = b.TradePartnerRelationshipLevelID
...
VALUES     ('DB_Version', '5.0.0000', '04806', GetDate())
GO
