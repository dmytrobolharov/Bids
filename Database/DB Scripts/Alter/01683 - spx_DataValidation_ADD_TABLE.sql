...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'spx_DataValidation_ADD_TABLE') AND type = N'P' )
	DROP PROCEDURE spx_DataValidation_ADD_TABLE
GO


CREATE PROCEDURE spx_DataValidation_ADD_TABLE
(
...
BEGIN
    ...
    SET @Task = @Task + ' [ItemKey] [nvarchar](10) NOT NULL,'
    ...
    SET @Task = @Task + ' ' + CHAR(39) + @ControlPanelName + CHAR(39) + ','
    SET @Task = @Task + ' ' + CHAR(39) + @DVDescription + CHAR(39) + ','
...
VALUES              ('DB_Version', '4.1.0000', '01683', GetDate())
GO
