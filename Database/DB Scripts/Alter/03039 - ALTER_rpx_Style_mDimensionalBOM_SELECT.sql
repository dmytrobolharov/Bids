...
IF EXISTS (select * from sysobjects where id = object_id('rpx_Style_mDimensionalBOM_SELECT') and sysstat & 0xf = 4)
    drop procedure rpx_Style_mDimensionalBOM_SELECT
GO


CREATE PROCEDURE rpx_Style_mDimensionalBOM_SELECT
(
	@StyleID VARCHAR(50)
	,@StyleSet INT
...
BEGIN
	...
	BEGIN
		...
		BEGIN
			...
			,Comments,UOM,StyleSet,WorkFlowID,Dimension1,Dimension2,Dimension3,WorkFlowItemID,ItemDim1Sort,ItemDim2Sort,ItemDim3Sort
...
VALUES ('DB_Version', '4.2.0000', '03039', GetDate())
GO
