...
ELSE
	...
	ELSE IF @ColorLibraryTypeID = '00000000-0000-0000-0000-00000000000d' --PANTONE UNCOATED
		...
		BEGIN
			...
			END
		END  -- COATED / UNCOTED*/
	ELSE IF @ColorLibraryTypeID = '00000000-0000-0000-0000-000000000018' --PANTONE Pastels & Neons UNCOATED
			OR @ColorLibraryTypeID = '00000000-0000-0000-0000-000000000019' --PANTONE Pastels & Neons COATED
		BEGIN

			DECLARE @iCount INT 
			IF @ColorLibraryTypeID = '00000000-0000-0000-0000-000000000018' 
				SELECT @iCount = COUNT(*) FROM ColorLibraryPantonePNUncoated WHERE  sRGB_D65_2_R BETWEEN @RedLow AND @RedMax 
				AND sRGB_D65_2_G BETWEEN @GreenLow AND @GreenMax AND sRGB_D65_2_B BETWEEN @BlueLow AND @BlueMax
			ELSE 
				SELECT @iCount = COUNT(*) FROM ColorLibraryPantonePNCoated WHERE  sRGB_D65_2_R BETWEEN @RedLow AND @RedMax 
				AND sRGB_D65_2_G BETWEEN @GreenLow AND @GreenMax AND sRGB_D65_2_B BETWEEN @BlueLow AND @BlueMax
			...
			END
		END  -- Pastels & Neons COATED / Pastels & Neons UNCOTED*/
END --  @Red = 0 AND @Green = 0 AND @Blue = 0

GO

INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
VALUES ('DB_Version', '5.0.0000', '05013', GetDate())
GO