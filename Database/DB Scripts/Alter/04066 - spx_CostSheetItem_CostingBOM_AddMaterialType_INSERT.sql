...
CREATE PROCEDURE [dbo].[spx_CostSheetItem_CostingBOM_AddMaterialType_INSERT]
...
BEGIN
	...
	BEGIN
		...
		SELECT DISTINCT StytleCostingScenarioItemsID, StyleID, StyleBOMDimensionID,
						...
						@CUser, @CDate, @CUser, @CDate FROM pStyleCostingBOM
...
VALUES     ('DB_Version', '5.0.0000', '04066', GetDate())
