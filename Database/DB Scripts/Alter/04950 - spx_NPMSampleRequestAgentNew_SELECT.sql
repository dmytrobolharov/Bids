	...
	SET @SQLString = '
        SELECT @pTotal = COUNT(*) FROM (
            ...
            FROM dbo.pStyleHeader b WITH (NOLOCK)
                ...
                INNER JOIN dbo.vwx_TradePartnerMgmt_SEL tpm  WITH (NOLOCK) ON a.TradePartnerRelationshipLevelID = tpm.RelationshipLevelID
...
VALUES ('DB_Version', '5.0.0000', '04950', GetDate())
GO
