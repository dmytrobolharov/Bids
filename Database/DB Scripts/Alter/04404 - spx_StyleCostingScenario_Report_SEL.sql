IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_StyleCostingScenario_Report_SEL]') AND type in (N'P', N'PC'))
...
VALUES     ('DB_Version', '5.0.0000', '04404', GetDate())
GO
