...
BEGIN
    ...
    (SELECT pStyleHeader.SizeClass FROM  pStyleHeader WITH (NOLOCK) INNER JOIN
    pStyleDevelopmentItem WITH (NOLOCK) ON pStyleHeader.StyleID = pStyleDevelopmentItem.StyleID
...
VALUES ('DB_Version', '0.5.0.0000', '08452', GetDate())
GO
