/****** Object:  StoredProcedure [dbo].[spx_SampleRequest_DesignSample_GRMeasurements_INSERT]    Script Date: 07/02/2013 15:41:54 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_SampleRequest_DesignSample_GRMeasurements_INSERT]') AND type in (N'P', N'PC'))
...
VALUES ('DB_Version', '0.5.0000', '05961', GetDate())
GO