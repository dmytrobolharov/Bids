...
IF NOT EXISTS(SELECT * FROM sSystemPage WHERE MappingPage='Style_Whereused_Silho.aspx')
	BEGIN
		INSERT INTO [sSystemPage] (MappingPage, CDate, CUser, sSystemFolderID)
		VALUES ('Style_Whereused_Silho.aspx', GETDATE(), 'Administrator', (SELECT sSystemFolderID from sSystemFolder where sSystemFolder='Style'))
	END
	GO
...
VALUES     ('DB_Version', '0.5.0000', '06444', GetDate())
GO
