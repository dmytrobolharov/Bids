...
/****** Object:  StoredProcedure [dbo].[spx_SourcingStyle_Commitment_SELECT]    Script Date: 11/21/2012 17:22:14 ******/
...
BEGIN
    ...
    EXEC spx_SourcingTradePartner_SELECT @SourcingHeaderID
	...
	INNER JOIN @Partners p ON p.SourcingTradePartnerID = pSourcingCommitmentItem.StyleQuoteTradePartnerID
	...
	EXEC('SELECT * FROM #tmpQuotes ' + @SearchCond)
...
VALUES     ('DB_Version', '5.0.0000', '04406', GetDate())
GO
