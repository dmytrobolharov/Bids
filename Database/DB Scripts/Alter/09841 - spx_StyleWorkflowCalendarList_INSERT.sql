IF OBJECT_ID(N'[dbo].[spx_StyleWorkflowCalendarList_INSERT]') IS NOT NULL
 DROP PROCEDURE [dbo].[spx_StyleWorkflowCalendarList_INSERT]
GO

CREATE PROCEDURE [dbo].[spx_StyleWorkflowCalendarList_INSERT](@CalendarId nvarchar(50),
@StartDate datetime,
@EndDate datetime,
@StyleType int)
...
WHERE (sh.Active = 1) AND (dbo.pStyleWorkflow.WorkDue BETWEEN @StartDate AND @EndDate) AND 
      (sh.StyleType = @StyleType)

GO

INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
VALUES ('DB_Version', '6.1.0000', '09841', GetDate())
GO
