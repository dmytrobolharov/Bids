...
BEGIN
	...
	WHERE (Active = 1) AND (TechPackDate BETWEEN @StartDate AND @EndDate) AND (TechPackID IS NOT NULL) AND (StyleType = @StyleType)
END 
...
VALUES ('DB_Version', '3.0.0000', '162', GetDate())
GO
