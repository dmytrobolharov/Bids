/****** Object:  View [dbo].[vwx_LineFolderStyle_SELECT]    Script Date: 12/28/2012 11:09:24 ******/
...
/****** Object:  View [dbo].[vwx_LineFolderStyle_SELECT]    Script Date: 12/28/2012 11:09:25 ******/
SET ANSI_NULLS ON
GO
...
AS
SELECT DISTINCT 
                      dbo.pLineFolderItem.LineFolderID, dbo.pLineFolderItem.LineFolderItemDrop, dbo.pStyleHeader.StyleID, 
                      ...
                      c.AccessModify, dbo.pLineFolderItem.LineFolderImageID, dbo.pLineFolderItem.LineFolderImageVersion
...
VALUES ('DB_Version', '5.0.0000', '04699', GetDate())
GO
