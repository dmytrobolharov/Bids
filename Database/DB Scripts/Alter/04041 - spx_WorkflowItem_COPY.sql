 ...
 IF @@Error <> 0 OR @@RowCount <> 1 GOTO Error  
  ...
  Else If @WorkFlowId = '40000000-0000-0000-0000-000000000050'   
   ...
   Else If @WorkFlowId = '40000000-0000-0000-0000-000000000080' 
			...
			INSERT INTO pStyleBOMDimension (StyleBOMDimensionID, Workflowid, WorkFlowItemID, StyleId, StyleSet, ItemDim1TypeId, ItemDim2TypeId, ItemDim3TypeId,
			ItemDim1TypeName, ItemDim2TypeName, ItemDim3TypeName, Comments, ImageId, CUser, CDate, MUser, MDate)			
			select @NewBOMId, @WorkflowID, @NewWorkFlowItemId, @StyleID, @StyleSet, ItemDim1TypeId, ItemDim2TypeId, ItemDim3TypeId,
		    ...
		    SELECT StyleMaterialMasterID,CopyStyleMaterialID,MainMaterial,Development,MiscColor,@StyleSet
...
VALUES     ('DB_Version', '5.0.0000', '04041', GetDate())
GO
