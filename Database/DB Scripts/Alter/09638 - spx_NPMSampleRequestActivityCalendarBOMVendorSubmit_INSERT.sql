IF OBJECT_ID(N'[dbo].[spx_NPMSampleRequestActivityCalendarBOMVendorSubmit_INSERT]') IS NOT NULL
...
BEGIN
	...
	SELECT @CalendarId AS CalendarId, pSampleRequestSubmit.SampleRequestWorkflowID, pSampleRequestSubmit.SampleRequestTradeId, 
		...
		'<b>TP: </b>' + dbo.uTradePartner.TradePartnerName + '<BR>' + sh.StyleNo + 
...
VALUES ('DB_Version', '6.1.0000', '09638', GetDate())
GO
