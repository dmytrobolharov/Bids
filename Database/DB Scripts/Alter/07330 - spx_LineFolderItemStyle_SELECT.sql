...
--				SELECT @SQLString
		...
		SELECT
			pStyleColorway.StyleColorName AS ColorNameIndividual
		...
		INNER JOIN pStyleColorway ON pStyleBOMDimensionItem.ItemDim1Id = pStyleColorway.StyleColorID OR pStyleBOMDimensionItem.ItemDim2Id = pStyleColorway.StyleColorID OR pStyleBOMDimensionItem.ItemDim3Id = pStyleColorway.StyleColorID
...
VALUES ('DB_Version', '0.5.0000', '07330', GetDate())
GO
