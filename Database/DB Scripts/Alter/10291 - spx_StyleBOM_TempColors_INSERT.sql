/****** Object:  StoredProcedure [dbo].[spx_StyleBOM_TempColors_INSERT]    Script Date: 21.03.2015 11:23:34 ******/
...
BEGIN
	...
	ELSE IF EXISTS (SELECT 1 FROM pPlanning 
				...
				INNER JOIN pStyleSeasonYear ON pStyleSeasonYear.SeasonYearID = pPlanningColor.SeasonYearID
...
VALUES ('DB_Version', '6.1.0000', '10291', GetUTCDate())
GO
