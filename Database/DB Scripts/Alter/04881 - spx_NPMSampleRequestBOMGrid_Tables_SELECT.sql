...
INNER JOIN vwx_TradePartnerMgmt_SEL tpm ON c.TradePartnerRelationshipLevelID = tpm.RelationshipLevelID 
WHERE 1=1   
'  
...
SET @SQL  ='  
 ...
 INNER JOIN vwx_TradePartnerMgmt_SEL tpm ON a.TradePartnerRelationshipLevelID = tpm.RelationshipLevelID
...
VALUES     ('DB_Version', '5.0.0000', '04881', GetDate())
GO
