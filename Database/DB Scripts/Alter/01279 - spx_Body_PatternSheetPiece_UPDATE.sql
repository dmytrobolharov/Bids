...
IF EXISTS (SELECT * FROM sysobjects WHERE id = object_id('spx_Body_PatternSheetPiece_UPDATE') and sysstat & 0xf = 4)
    DROP PROCEDURE spx_Body_PatternSheetPiece_UPDATE
GO
...
VALUES     ('DB_Version', '4.0.0000', '01279', GetDate())
GO
