...
SELECT OwnerGroup  FROM pStyleHeader WITH (NOLOCK) where StyleID=@StyleID --and StyleSet=@StyleSet 

GO


IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='03305'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '5.0.0000', '03305', GetDate())
