...
/****** Object:  StoredProcedure [dbo].[spx_SampleRequestStyleBOMTemp_INSERT]    Script Date: 12/18/2011 17:59:04 ******/
...
IF(NOT EXISTS(SELECT * FROM sVersion WHERE LastScriptRun='02362'))
BEGIN

	INSERT INTO sVersion(AppName, Version, LastScriptRun, TimeStamp)
	VALUES     ('DB_Version', '4.1.0000', '02362', GetDate())
