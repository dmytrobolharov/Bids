/****** Object:  StoredProcedure [dbo].[spx_BatchQGrid_StyleMaterialColor_Review_SELECT]    Script Date: 24.02.2015 13:28:48 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_BatchQGrid_StyleMaterialColor_Review_SELECT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_BatchQGrid_StyleMaterialColor_Review_SELECT]
GO
...
CREATE PROCEDURE [dbo].[spx_BatchQGrid_StyleMaterialColor_Review_SELECT](
...
VALUES ('DB_Version', '6.1.0000', '09743', GetDate())
GO
