IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_PlanningSKUHeader_StyleSKU_DELETE]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_PlanningSKUHeader_StyleSKU_DELETE]
GO

CREATE PROCEDURE [dbo].[spx_PlanningSKUHeader_StyleSKU_DELETE]
...
VALUES ('DB_Version', '0.5.0000', '07979', GetDate())
GO
