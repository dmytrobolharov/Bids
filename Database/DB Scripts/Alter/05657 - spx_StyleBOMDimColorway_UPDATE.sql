/****** Object:  StoredProcedure [dbo].[spx_StyleBOMDimColorway_UPDATE]    Script Date: 04/30/2013 17:58:14 ******/
...
ItemDim2Id, ItemDim2Name, ItemDim3Id, ItemDim3Name from pStyleBOMDimensionItem
	...
	begin
		if @DimColor='1'
			begin
				...
				distinct(ItemDim1Id) from pStyleBOMDimensionItem where StyleBOMDimensionId=@StyleBOMDimensionId
			...
			begin
				...
				distinct(ItemDim2Id) from pStyleBOMDimensionItem where StyleBOMDimensionId=@StyleBOMDimensionId
			...
			begin
				...
				distinct(ItemDim3Id) from pStyleBOMDimensionItem where StyleBOMDimensionId=@StyleBOMDimensionId
...
VALUES     ('DB_Version', '0.5.0.0000', '05657', GetDate())
GO
