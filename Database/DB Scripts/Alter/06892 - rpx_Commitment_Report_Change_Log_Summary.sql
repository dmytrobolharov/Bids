IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[rpx_Commitment_Report_Change_Log_Summary]') AND type in (N'P', N'PC'))
...
BEGIN
	...
	FROM pSourcingCommitmentItem sci
		INNER JOIN vwx_ChangeLogItem_SEL cli ON sci.StyleQuoteItemID = cli.ChangeTablePKID AND cli.ChangeTableID = '9038A3FD-0580-422F-A3A6-895CA0223A81'
...
VALUES ('DB_Version', '0.5.0000', '06892', GetDate())
GO
