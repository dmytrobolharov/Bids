...
/****** Object:  StoredProcedure [dbo].[spx_Dash_Quote_Summary_COO_SEL]    Script Date: 12/05/2012 11:23:41 ******/
...
--		, ISNULL((sqi.StyleQuoteItemCustomField18 * sqi.StyleQuoteItemCustomField16),0) AS Extended_LDP
		...
		, ISNULL((sqi.StyleCostingCustomField1 * sqi.StyleQuoteItemCustomField2),0) AS Extended_WHSE
		, (ISNULL((sqi.StyleCostingCustomField1 * sqi.StyleQuoteItemCustomField2),0) - ISNULL((sqi.StyleQuoteItemCustomField18),0)) AS Extended_Gross_Margin -- Extended_WHSE - Extended_LDP
	FROM
		pStyleQuoteItem sqi
...
VALUES ('DB_Version', '5.0.0000', '04563', GetDate())
GO
