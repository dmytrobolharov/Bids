...
CREATE PROCEDURE [dbo].[spx_Planning_SKUPlan_Items_SELECT]
	...
	@SelectedDimensions VARCHAR(MAX),
...
BEGIN	
	...
	SELECT DISTINCT pli.PlanningID, pli.PlanningItemID, pli.PlanningItemDrop, 
		pli.PlanningItemDropUser, pli.PlanningItemDropDate, pli.PlanningImageID, 
		pli.PlanningImageVersion, pli.CUser, pli.CDate, pli.MUser, pli.MDate, 
		pli.MChange, pli.StyleID, pli.ConceptNo, pli.DevelopmentNo, pli.StyleNo, pli.CustomField1, pli.PatternRef, 
		pli.Description, pli.DMCStyleType, pli.FabricYarnType, 
		pli.MainMaterial, pli.[Content], pli.FabricWeight, pli.SizeRange, 
		pli.SizeClass, pli.DesignSketchID, 
		pli.DesignSketchVersion, pli.PlanningItemSort, pli.StyleCategoryId, pli.StyleType, 
		pli.WorkflowType, pli.DueDate, pli.RecDate, pli.TradePartnerID, pli.IntroSeasonYearID, 
		pli.StyleSeasonYearID, pli.ColorwaySeasonYearID, pli.DivisionID,
		pli.StyleCategory, pli.TeamId, pli.AccessRoleId, pli.AccessModify, pli.CustomField3,
		pli.SeasonYearID, pli.StyleBOMDimensionID,
		pli.SubCategoryId, 
		pli.[Image],
		pli.DivisionName, pli.StyleTypeDescription, pli.StyleCategoryName, 
		pli.IntroSeasonYear,
	'<a href="Planning_StyleProperty.aspx?SID=' + CAST(pli.StyleID AS NVARCHAR(50)) + '&SYID=' + CAST(pli.SeasonYearID AS NVARCHAR(50)) + '&PIID=' + CAST(pli.PlanningItemID AS NVARCHAR(50)) + '&SHID=' + CAST(@PlanningSKUHeaderID AS NVARCHAR(50)) + '&RT=SKUP">' + pli.StyleNo + '</a>' AS StylePropertyLink,
		pli.SubCategoryName, pli.DevelopmentID, 
		wfi.WorkFlowItemName AS BOMName, ssh.StyleSKUItemID, ssh.Dimensions, psh.PlanningSKUHeaderID,
		...
		<a href="../Style/Style_Frame.aspx?P=40000000-0000-0000-0000-000000000090&WFIID=' + CAST(ssh.WorkFlowItemID AS VARCHAR(50)) + '&SID=' + CAST(pli.StyleID AS VARCHAR(50)) + '&SYID=' + CAST(ssy.SeasonYearID AS VARCHAR(50)) + '" target="_blank">' + ssh.WorkflowStatus + '</a>' AS StatusLink,
	...
	LEFT JOIN pStyleWorkflow sw ON pli.StyleID = sw.StyleID AND sw.WorkflowID = '40000000-0000-0000-0000-000000000090' AND sw.StyleSet = 1
...
VALUES ('DB_Version', '0.5.0000', '08037', GetDate())
GO
