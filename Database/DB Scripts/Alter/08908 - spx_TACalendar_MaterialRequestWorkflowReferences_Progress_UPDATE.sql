/****** Object:  StoredProcedure [dbo].[spx_TACalendar_MaterialRequestWorkflowReferences_Progress_UPDATE]    Script Date: 08/20/2014 16:44:56 ******/
...
CREATE PROCEDURE [dbo].[spx_TACalendar_MaterialRequestWorkflowReferences_Progress_UPDATE]
	...
	@MaterialRequestWorkflowID NVARCHAR(10) = NULL,
...
BEGIN
	...
	INNER JOIN pTATaskWorkflow tw ON tw.TATaskWorkflowId = tt.TaskWorkflowId AND UPPER(tw.WorkflowFolder) = 'MATERIAL REQUEST'
	...
	AND (cr.ReferenceId = @MaterialTradePartnerID OR @MaterialTradePartnerID IS NULL)
	AND (tw.WorkflowId = @MaterialRequestWorkflowGUID OR @MaterialRequestWorkflowGUID IS NULL)
...
VALUES ('DB_Version', '6.0.0000', '08908', GetDate())
GO
