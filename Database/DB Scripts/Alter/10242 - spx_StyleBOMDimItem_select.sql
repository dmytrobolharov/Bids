IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_StyleBOMDimItem_select]') AND type in (N'P', N'PC'))
...
VALUES ('DB_Version', '6.1.0000', '10242', GetUTCDate())
GO
