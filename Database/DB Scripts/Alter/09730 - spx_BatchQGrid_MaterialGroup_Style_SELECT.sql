/****** Object:  StoredProcedure [dbo].[spx_BatchQGrid_MaterialGroup_Style_SELECT]    Script Date: 23.02.2015 16:47:29 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_BatchQGrid_MaterialGroup_Style_SELECT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_BatchQGrid_MaterialGroup_Style_SELECT]
GO
...
CREATE PROCEDURE [dbo].[spx_BatchQGrid_MaterialGroup_Style_SELECT] (
...
VALUES ('DB_Version', '6.1.0000', '09730', GetDate())
GO
