...
INSERT INTO pSampleRequestSubmitFitVideo
	(FitVideoID, FileName, SampleRequestSubmitID, CUser, CDate, CTeamID)
VALUES (@FitVideoID, @FileName, @SampleRequestSubmitID, @CUser, @CDate, @CTeamID)
...
VALUES ('DB_Version', '0.5.0000', '07211', GetDate())
GO
