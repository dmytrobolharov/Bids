...
BEGIN
	...
	LEFT JOIN (select TradePartnerId, COUNT(StatusId) as StatusCount from uTradePartnerCompliance where StatusId='00000000-0000-0000-0000-000000000001' GROUP BY TradePartnerId) vci ON vci.TRadePartnerID = p.VendorID
	LEFT JOIN (select TradePartnerId, COUNT(StatusId) as StatusCount from uTradePartnerCompliance where StatusId='00000000-0000-0000-0000-000000000001' GROUP BY TradePartnerId) fci ON fci.TRadePartnerID = p.FactoryID
...
VALUES     ('DB_Version', '5.0.0000', '04592', GetDate())
GO
