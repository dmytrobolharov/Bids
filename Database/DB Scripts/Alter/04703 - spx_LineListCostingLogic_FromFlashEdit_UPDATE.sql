/****** Object:  StoredProcedure [dbo].[spx_LineListCostingLogic_FromFlashEdit_UPDATE]    Script Date: 12/28/2012 18:01:17 ******/
...
BEGIN
	...
	SELECT @DutyCategoryID = ISNULL(DutyCategoryID, '00000000-0000-0000-0000-000000000000') from pMaterial inner join pLineListFlashCosting on pMaterial.MaterialID=pLineListFlashCosting.MaterialID where pLineListFlashCosting.LineFolderItemId=@LineFolderItemId
...
VALUES ('DB_Version', '5.0.0000', '04703', GetDate())
GO
