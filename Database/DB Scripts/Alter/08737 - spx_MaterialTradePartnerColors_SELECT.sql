...
Case  
	WHEN a.MaterialColorImageID IS NULL  THEN 
		...
		<IMG src=''' + '../System/Control/ColorStream.ashx?S=16&CFID=' + CAST(a.ColorFolderID AS nVARCHAR(40)) + 
		'&CPID=' + CAST(a.ColorPaletteID AS nVARCHAR(40)) + ''' border=0 ALT=''Open''></TD></TR></TABLE>'
	 ELSE  
		'<TABLE cellSpacing=''0'' cellPadding=''0'' width=''100%'' border=''0''><TR><TD width=''18''> 
		<IMG src=''' + '../System/Control/ImageStream.ashx?S=16&V=' + CAST(a.MaterialColorImageVersion AS nVARCHAR(40)) + 
		'&IID=' + CAST(a.MaterialColorImageID AS nVARCHAR(40)) + ''' border=0 ALT=''Open''></TD></TR></TABLE>'
...
VALUES ('DB_Version', '0.5.0000', '08737', GetDate())
GO
