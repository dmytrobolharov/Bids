...
SELECT     '<img src=''' +
                      ...
                      dbo.pColorPalette.ColorPaletteCustom7, dbo.pColorPalette.Status, dbo.xCustom8.Custom AS ColorStatus
FROM         dbo.pColorPalette INNER JOIN
                      ...
                      dbo.xCustom8 ON dbo.pColorPalette.Status = dbo.xCustom8.CustomKey
...
VALUES ('DB_Version', '0.5.0000', '06902', GetDate())
GO
