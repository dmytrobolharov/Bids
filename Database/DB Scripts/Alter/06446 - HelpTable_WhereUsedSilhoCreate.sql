...
IF NOT EXISTS(SELECT * FROM sSystemPage WHERE MappingPage='Style_New_Copy_Silhouette.aspx')
	BEGIN
		INSERT INTO [sSystemPage] (MappingPage, CDate, CUser, sSystemFolderID)
		VALUES ('Style_New_Copy_Silhouette.aspx', GETDATE(), 'Administrator', (SELECT sSystemFolderID from sSystemFolder where sSystemFolder='Style'))
	END
	GO
...
VALUES     ('DB_Version', '0.5.0000', '06446', GetDate())
GO
