/****** Object:  StoredProcedure [dbo].[spx_SampleRequestSilhoDataTable_PIVOT]    Script Date: 07/01/2013 12:23:53 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_SampleRequestSilhoDataTable_PIVOT]') AND type in (N'P', N'PC'))
...
VALUES ('DB_Version', '0.5.0000', '05934', GetDate())
GO
