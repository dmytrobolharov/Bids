/****** Object:  StoredProcedure [dbo].[spx_SampleWorkflowSubmit_UPDATE]    Script Date: 05/21/2013 18:03:55 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spx_SampleWorkflowSubmit_UPDATE]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spx_SampleWorkflowSubmit_UPDATE]
GO

CREATE PROCEDURE [dbo].[spx_SampleWorkflowSubmit_UPDATE]
(@Status nvarchar(50),
@RevDate nvarchar(50),
@RevBy nvarchar(200),
@RecDate nvarchar(50),
...
VALUES     ('DB_Version', '0.5.0000', '05763', GetDate())
GO
