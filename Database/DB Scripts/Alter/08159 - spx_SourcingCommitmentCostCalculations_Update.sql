...
SELECT @StyleCostingTypeID = StyleCostingType FROM pSourcingCommitmentItem WHERE SourcingCommitmentItemID = @SourcingCommitmentItemID
...
--If @StyleBOMDimensionId <> '00000000-0000-0000-0000-000000000000'
	...
	if @DetailsCnt>0
		...
		begin
			...
			Select @TotalQuantity = ISNULL(StyleQuoteItemCustomField2, '0') + ISNULL(StyleQuoteItemCustomField6, '0') + ISNULL(StyleQuoteItem_EcomUnits, '0') from pSourcingCommitmentItem
...
VALUES ('DB_Version', '0.5.0000', '08159', GetDate())
GO
