...
BEGIN
    ...
    SELECT sysCol.StyleAdditionalItemID, sysCol.AdditionalItemNo, sysCol.StytleCostingScenarioItemsID, sysCol.AdditionalItemName, sysCol.AdditionalItemNo, 
	...
	ON sysCol.StyleAdditionalItemID = firstCol.StyleAdditionalItemID
	LEFT JOIN pstyleCostingAdditionalItems AS secondCol
	ON sysCol.StyleAdditionalItemID = secondCol.StyleAdditionalItemID
	LEFT JOIN pstyleCostingAdditionalItems AS thirdCol
	ON sysCol.StyleAdditionalItemID = thirdCol.StyleAdditionalItemID
	...
	ORDER BY sysCol.CDate, sysCol.AdditionalItemNo
...
VALUES     ('DB_Version', '5.0.0000', '03958', GetDate())
GO
