...
IF EXISTS (select * from sysobjects where id = object_id('rpx_Desktop_Agent_Sample_SharedComments_SELECT') and sysstat & 0xf = 4)
    drop procedure rpx_Desktop_Agent_Sample_SharedComments_SELECT
GO
...
CREATE PROCEDURE rpx_Desktop_Agent_Sample_SharedComments_SELECT
(
...
VALUES ('DB_Version', '4.2.0000', '02988', GetDate())
GO
