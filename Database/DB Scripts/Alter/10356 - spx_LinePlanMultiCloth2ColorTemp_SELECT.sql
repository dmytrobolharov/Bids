IF OBJECT_ID(N'[dbo].[spx_LinePlanMultiCloth2ColorTemp_SELECT]') IS NOT NULL
...
BEGIN
	...
	WHERE lpmcct.LinePlanColorGroupID = @LinePlanColorGroupID AND lpmcct.MaterialID = @MaterialID
...
VALUES ('DB_Version', '6.1.0000', '10356', GetUTCDate())
GO
