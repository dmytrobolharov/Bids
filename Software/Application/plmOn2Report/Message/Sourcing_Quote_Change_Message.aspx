<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Sourcing_Quote_Change_Message.aspx.vb" Inherits="plmOn2Report.Sourcing_Quote_Change_Message" %>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<table style="BORDER-BOTTOM: orange thin solid; BORDER-LEFT-STYLE: none; BACKGROUND-COLOR: white"
				...
				<tr>
					<td><asp:Label ID="lblStyleChange" runat="server">Quotation Change Notification</asp:Label>
					</td>
			...
			<table cellspacing="0" cellpadding="0" width="800" border="0">
				<tr>
					<td bgColor="#ffffff"><br />&nbsp;<img src="../System/Icons/icon_link.gif"><asp:hyperlink id="hlReturn" runat="server" Font-Underline="true" Font-Size="12px" ForeColor="Blue"
							CssClass="fonthead">Click here to view the quote...</asp:hyperlink><BR />&nbsp;</td>
				</tr>
			</table>
			<table cellspacing="0" cellpadding="0" width="800" border="0">
				<tr>
					<td>
					    <asp:DataGrid id="DataGrid1" runat="server" BorderColor="#E0E0E0" BorderStyle="Solid" BorderWidth="1px"
				            AutoGenerateColumns="False" DataKeyField="StyleQuoteItemChangeID" AllowPaging="false" AllowSorting="false">
