...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Style_Status_Message.aspx.vb" Inherits="plmOn2Report.Style_Status_Message" %>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			&nbsp;<IMG src="../System/Icons/icon_link.gif"><asp:hyperlink id="hlReturn" runat="server" CssClass="fonthead" ForeColor="Blue" Font-Size="12px"
				Font-Underline="true">Click here to view style...</asp:hyperlink>
		</form>
	</body>
</html>
