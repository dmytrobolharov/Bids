<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Image_Change_Message.aspx.vb" Inherits="plmOn2Report.Image_Change_Message" %>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<table style="BORDER-BOTTOM: orange thin solid; BORDER-LEFT-STYLE: none; BACKGROUND-COLOR: white"
				...
				<tr>
					<td><asp:Label ID="lblStyleChange" runat="server">Image Change Notification</asp:Label>
					</td>
			...
			<table cellspacing="0" cellpadding="0" width="800" border="0">
				<tr>
					<td bgColor="#ffffff"><uc1:Image_Header id="Image_Header1" runat="server"></uc1:Image_Header></td>
				</tr>
			</table>
			<table cellspacing="0" cellpadding="0" width="800" border="0">
				<tr>
					<td bgColor="#ffffff"><br />&nbsp;<img src="../System/Icons/icon_link.gif"><asp:hyperlink id="hlReturn" runat="server" Font-Underline="true" Font-Size="12px" ForeColor="Blue"
							CssClass="fonthead">Click here to view image...</asp:hyperlink><BR />&nbsp;</td>
				</tr>
			</table>
			<table cellspacing="0" cellpadding="0" width="800" border="0">
				<tr>
					<td>
					    <asp:DataGrid id="DataGrid1" runat="server" BorderColor="#E0E0E0" BorderStyle="Solid" BorderWidth="1px"
				            AutoGenerateColumns="False" DataKeyField="ImageChangeID" AllowPaging="false" AllowSorting="false">
