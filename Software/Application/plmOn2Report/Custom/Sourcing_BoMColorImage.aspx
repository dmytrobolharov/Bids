<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Sourcing_BoMColorImage.aspx.vb" Inherits="plmOn2Report.Sourcing_BoMColorImage" %>
    ...
    <form id="form1" runat="server">
			<asp:datagrid id="DataGrid1" runat="server" BorderColor="#999999" 
				...
				PageSize="100" AutoGenerateColumns="False" DataKeyField="ComponentTypeID" 
                    ShowHeader="false" CellPadding="1" CellSpacing="1" BackColor="White">
				...
				<Columns>
				    <asp:TemplateColumn>
					    ...
					    <td> <TABLE cellSpacing="0" cellPadding="0" border="0"  runat="server" id ="tbHeader">
						    ...
						    <asp:DataGrid runat="server" ID="dgComponenType" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="0">
						            ...
						            <asp:TemplateColumn>
						                <ItemTemplate>
						                    <asp:Image runat="server" ID="imgDesign"  
						                        ImageUrl='<%#  string.Concat("Image/ImageStream.ashx?S=50&V=" &amp; Convert.ToString(Container.DataItem("MaterialImageVersion")) &amp; "&IID=" &amp; Convert.ToString(Container.DataItem("MaterialImageID"))      )  %>' />
						                </ItemTemplate>
						            </asp:TemplateColumn>
