...
<asp:Panel id="Panel3" runat="server">
 <TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
	    <TR>
		    ...
		    <TD bgColor="white"><FONT face="Tahoma" size="1"><asp:label ID="lblComments"  runat ="server" ></asp:label> </FONT></TD>
	    </TR>
    </TABLE>
</asp:Panel>
<asp:datagrid id="DataGrid2" PageSize="200" AutoGenerateColumns="False" GridLines="Horizontal"
