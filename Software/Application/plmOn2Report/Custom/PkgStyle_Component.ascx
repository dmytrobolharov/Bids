<%@ Control Language="vb" AutoEventWireup="false" Codebehind="PkgStyle_Component.ascx.vb" Inherits="plmOn2Report.PkgStyle_Component2" targetSchema="http://schemas.microsoft.com/mobile/html32template" enableViewState="False" %>
