<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Quote_Comment.ascx.vb" Inherits="srmOnApp.Quote_Comment" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<asp:panel id="Panel2" runat="server" CssClass="font" BorderWidth="1" Width="100%" BorderColor="Silver"
	...
	<asp:datalist id="DataList1" runat="server" BackColor="White" BorderStyle="Solid" BorderColor="WhiteSmoke"
		Width="100%" BorderWidth="0px" DataKeyField="StyleQuoteCommentID">
		<HeaderTemplate>
			<!--
