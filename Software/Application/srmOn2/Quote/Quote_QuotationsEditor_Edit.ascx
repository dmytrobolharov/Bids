<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Quote_QuotationsEditor_Edit.ascx.vb" Inherits="srmOnApp.Quote_QuotationsEditor_Edit" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
