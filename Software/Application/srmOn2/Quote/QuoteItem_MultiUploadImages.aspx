<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="QuoteItem_MultiUploadImages.aspx.vb" Inherits="srmOnApp.QuoteItem_MultiUploadImages" %>
        ...
        <tr valign="middle">
            ...
            <td>
             <asp:ImageButton runat="server" ID="btnSave" OnClick="btnSave_Click" OnClientClick="return btnSave_Click()" Visible="False"  />
                ...
                <img  runat="server"  id='Img1' style="display: none;" onclick="Upload_Click();return false;" /> 
    ...
    <asp:Panel ID="pnlMulti" runat="server">
        <div>
            ...
            <CuteWebUI:UploadAttachments runat="server" ID="UploadAttachments1" ManualStartUpload="False" AutoUseSystemTempFolder="False"
                ...
                NumFilesShowCancelAll="1000" InsertText='<%#GetSystemText("Add files")%>' TableHeaderTemplate="<td nowrap='nowrap'></td><td>Files</td><td>Description</td>" InsertButtonID="btnAdd">
                <ItemTemplate>
                    <table>
                        <tr valign="middle">
                            <td>
