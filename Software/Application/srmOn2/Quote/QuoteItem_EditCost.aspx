   ...
   <!-- <asp:PlaceHolder ID="phSeasonYearColor" runat="server"></asp:PlaceHolder>-->
                            ...
                            <tr>
                                ...
                                <td valign="middle" class="fonthead" style="padding: 0 10px;">
                                    <table cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td class="fonthead">
                                                <asp:Label id="lblMinQNT" runat="server" Text=""><%= GetSystemText("Minimum Quantity")%></asp:Label>:&nbsp;&nbsp;
                                            </td>
                                            <td width="65px">
                                                <asp:TextBox ID="txtMinQNT" runat="server" Width="40"></asp:TextBox>
                                                <asp:CustomValidator id="validatorMinQNT" runat="server" ControlToValidate="txtMinQNT" ValidationGroup="groupMinQNT"
                                                    ClientValidationFunction="ValidateDecimal" Display="Dynamic" ToolTip="Invalid data format!" 
                                                    ErrorMessage="<img style=&quot;vertical-align:middle&quot; class=&quot;ValidationMessage&quot; src=&quot;../System/Icons/icon_warning.gif&quot; />" 
                                                />
                                            </td>
                                            <td>
                                                <cc1:confirmedimagebutton id="btnMinQNT" runat="server" CausesValidation="True" ValidationGroup="groupMinQNT" Message="NONE"></cc1:confirmedimagebutton>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td valign="middle" class="fonthead" style="padding: 0 10px;">
                                    <table cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td class="fonthead">
                                                <asp:Label id="lblMaxQNT" runat="server" text=""><%= GetSystemText("Maximum Quantity")%></asp:Label>:&nbsp;&nbsp;
                                            </td>
                                            <td width="65px">
                                                <asp:TextBox ID="txtMaxQNT" runat="server" Width="40"></asp:TextBox>
                                                <asp:CustomValidator id="validatorMaxQNT" runat="server" ControlToValidate="txtMaxQNT" ValidationGroup="groupMaxQNT"
                                                    ClientValidationFunction="ValidateDecimal" Display="Dynamic" ToolTip="Invalid data format!" 
                                                    ErrorMessage="<img style=&quot;vertical-align:middle&quot; class=&quot;ValidationMessage&quot; src=&quot;../System/Icons/icon_warning.gif&quot; />" 
                                                />
                                            </td>
                                            <td>
                                                <cc1:confirmedimagebutton id="btnMaxQNT" runat="server" CausesValidation="True" ValidationGroup="groupMaxQNT" Message="NONE"></cc1:confirmedimagebutton>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td valign="middle" class="fonthead" style="padding: 0 10px;">
                                    <table cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td class="fonthead">
                                                <asp:Label id="lblCostQNT" runat="server" Text=""><%= GetSystemText("Partner Cost/Quantity")%></asp:Label>:&nbsp;&nbsp;
                                            </td>
                                            <td width="65px">
                                                <asp:TextBox ID="txtCostQNT" runat="server" Width="40"></asp:TextBox>
                                                <asp:CustomValidator id="validatorCostQNT" runat="server" ControlToValidate="txtCostQNT" ValidationGroup="groupCostQNT"
                                                    ClientValidationFunction="ValidateDecimal" Display="Dynamic" ToolTip="Invalid data format!" 
                                                    ErrorMessage="<img style=&quot;vertical-align:middle&quot; class=&quot;ValidationMessage&quot; src=&quot;../System/Icons/icon_warning.gif&quot; />" 
                                                />
                                            </td>
                                            <td>
                                                <cc1:confirmedimagebutton id="btnCostQNT" runat="server" CausesValidation="True" ValidationGroup="groupCostQNT" Message="NONE"></cc1:confirmedimagebutton>
                                            </td>
                                        </tr>
                                   </table>
                                </td>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ValidateDecimal(sender, args) {
            var value = document.getElementById(sender.controltovalidate).value;
            var regex = /<%= strRegExp %>/
            if (regex.test(value)) {
                args.IsValid = true;
            } else {
