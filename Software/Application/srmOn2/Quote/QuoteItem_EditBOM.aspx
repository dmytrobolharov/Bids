...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="QuoteItem_EditBOM.aspx.vb"
    Inherits="srmOnApp.QuoteItem_EditBOM" %>
                        ...
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td valign="middle" align="center" class="fonthead" style="padding: 0 10px;">
                                    <asp:Label ID="lblBOMOptions" runat="server" ><%= GetSystemText("BOM & Options")%></asp:Label>
                                </td>
                                <td>
