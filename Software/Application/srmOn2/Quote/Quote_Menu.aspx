...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Quote_Menu.aspx.vb" Inherits="srmOnApp.Quote_Menu" %>
		...
		<TABLE class="TableHeader" height="27" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TBODY>
					<TR>
						...
						<TD class="fontHead">
							<DIV align="center"><asp:label id="lblQuote" runat="server">Quote</asp:label>
							</DIV>
						</TD>
					</TR>
				</TBODY>
