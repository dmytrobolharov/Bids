<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="QuoteItem_QuotationEdit_Menu.aspx.vb" Inherits="srmOnApp.QuoteItem_QuotationEdit_Menu" %>
    ...
    <table class="TableHeader" height="25" cellspacing="0" cellpadding="0" width="100%" border="0">
        <tr>
            ...
            <td valign="middle" align="left">
                <div>
                    &nbsp;
                    <asp:ImageButton ID="btnSearch" runat="server" ImageUrl="../System/icons/icon_search.gif" OnClientClick="window.parent.location.href = 'Quote_Grid.aspx?CL=H'; return false;"></asp:ImageButton>
                    &nbsp;
