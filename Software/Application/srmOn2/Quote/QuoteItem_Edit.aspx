...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="QuoteItem_Edit.aspx.vb"
    Inherits="srmOnApp.QuoteItem_Edit" %>
                                                                            ...
                                                                            <td height="30">
                                                                                <table id="TbTrim" cellspacing="0" cellpadding="0" width="250" border="0" runat="server">
                                                                                    <tr class="fontHead">
                                                                                        ...
                                                                                        <td nowrap width="85">
                                                                                            <asp:Label ID="lblNoofRow" runat="server" Text=""> <%= GetSystemText("No. of Row(s)")%>:</asp:Label>
                                                                                        </td>
                                                                                        <td width="35">
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:TemplateColumn>
                                                                                ...
                                                                                <ItemTemplate>
                                                                                    ...
                                                                                    <asp:CustomValidator id="AmountValidator" runat="server"
                                                                                                         ControlToValidate="txtAmount" ClientValidationFunction="ValidateDecimal" 
                                                                                                         Display="Dynamic"  ToolTip="Invalid data format!" 
                                                                                                         ErrorMessage="<img class=&quot;ValidationMessage&quot; src=&quot;../System/Icons/icon_warning.gif&quot; />" />
                                                                                </ItemTemplate>
                                                                            </asp:TemplateColumn>
                                                                        </Columns>
                                                                    </asp:DataGrid>
                ...
                <asp:Panel ID="DimInfo" runat="server">
                    <table class="TableHeader" height="25" cellspacing="0" cellpadding="0" width="100%"
                        ...
                        <tr>
                            ...
                            <td width="100%">
                                <asp:Label ID="lblQuotationDetails" runat="server"><%= GetSystemText("Quotation Details") %></asp:Label>
                            </td>
                        </tr>
                    </table>
                    <asp:DataGrid ID="DataGrid2" runat="server" DataKeyField="SourcingQuotationBOMDetailsID"
