...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="QuoteItem_Edit_Old.aspx.vb" Inherits="srmOnApp.QuoteItem_Edit_Old" %>
				...
				<tr>
					<td width="50%">
						...
						<TABLE class="TableHeader" id="Table1" height="25" cellSpacing="0" cellPadding="0" width="100%"
							...
							<TR vAlign="middle">
								<TD vAlign="middle" align="center" width="10"><IMG height="15" src="../System/Images/bbTbSCnr.gif" width="3"></TD>
								<TD>&nbsp;<asp:label id="lblMainMaterial" runat="server">Main Material</asp:label></TD>
							</TR>
						</TABLE>
