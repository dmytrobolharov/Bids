<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Downloads_Edit_Search.aspx.vb" Inherits="srmOnApp.Downloads_Edit_Search" %>
			...
			<table class="TableHeader" id="toolbar" cellSpacing="0" cellPadding="0" width="100%" border="0"
				...
				<tr vAlign="middle">
					...
					<td>
					    ...
					    <cc1:confirmedimagebutton id="btnClose" runat="server" Message="NONE"  OnClientClick="return btnClose_Click()" CausesValidation="False"></cc1:confirmedimagebutton>
					</td>
				</tr>
			</table>
