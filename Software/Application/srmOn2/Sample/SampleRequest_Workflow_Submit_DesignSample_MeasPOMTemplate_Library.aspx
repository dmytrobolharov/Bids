<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SampleRequest_Workflow_Submit_DesignSample_MeasPOMTemplate_Library.aspx.vb" Inherits="srmOnApp.SampleRequest_Workflow_Submit_DesignSample_MeasPOMTemplate_Library" %>
			...
			<TABLE class="TableHeader" id="TableHeader" cellSpacing="0" cellPadding="0" width="100%"
				...
				<TR vAlign="middle">
					...
					<TD>
                        ...
                        <cc1:confirmedimagebutton id="btnClose" runat="server" ToolTip="" Message="NONE" OnClientClick="return btnClose_Click()"></cc1:confirmedimagebutton>
                    </TD>
				</TR>
			</TABLE>
