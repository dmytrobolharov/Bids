...
<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="SampleRequest_Workflow_Submit_MeasEval.ascx.vb" Inherits="srmOnApp.SampleRequest_Workflow_Submit_MeasEval" %>
