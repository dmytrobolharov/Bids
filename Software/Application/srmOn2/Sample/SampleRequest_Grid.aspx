<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SampleRequest_Grid.aspx.vb"
    Inherits="srmOnApp.SampleRequest_Grid" %>
...
<body ms_positioning="GridLayout">
    ...
    <table class="TableHeader" id="toolbar" cellspacing="0" cellpadding="0" width="100%"
        ...
        <tr valign="middle">
            ...
            <td width="80">
                <cc1:ConfirmedImageButton ID="btnEditColorList" runat="server" Message="Are you sure you want to edit material list?">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
        <tr>
            <td>
                &nbsp;<asp:Label ID="lblMaterialHeader" runat="server" Font-Names="Tahoma,Verdana"
                    Font-Size="X-Large" ForeColor="#E0E0E0">Sample Request</asp:Label>
            </td>
        </tr>
    </table>
    ...
    <table cellspacing="0" cellpadding="0" width="100%" border="0">
        <tr valign="top">
            <td>
                ...
                <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="SampleRequestID">
