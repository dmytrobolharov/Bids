...
<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="SampleRequest_Workflow_Submit_MeasQA.ascx.vb" Inherits="srmOnApp.SampleRequest_Workflow_Submit_MeasQA" %>
