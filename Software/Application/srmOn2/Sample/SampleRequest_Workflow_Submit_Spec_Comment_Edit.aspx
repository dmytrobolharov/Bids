<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SampleRequest_Workflow_Submit_Spec_Comment_Edit.aspx.vb" Inherits="srmOnApp.SampleRequest_Workflow_Submit_Spec_Comment_Edit" %>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<asp:textbox id="txtFitComment" runat="server" TextMode="MultiLine" MaxLength="4000" Width="790px"
				Height="550px"></asp:textbox><INPUT id="txtNoTOL" type="hidden" name="txtTOL" runat="server"></form>
	</body>
</HTML>
