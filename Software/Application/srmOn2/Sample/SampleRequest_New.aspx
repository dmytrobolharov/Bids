<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SampleRequest_New.aspx.vb" Inherits="srmOnApp.SampleRequest_New1" %>
...
<body>
    ...
    <div>
		...
		<TABLE class="TableHeader" id="Table1" cellSpacing="1" cellPadding="1" width="100%" border="0">
			<TR>
				<TD width="20" height="20"><IMG src="../System/Icons/icon_ball_blue.gif"></TD>
				<TD><asp:label id="lblNewSample" runat="server">New Sample</asp:label></TD>
			</TR>
		</TABLE>    
...
<asp:DataGrid id="dgQuote" runat="server" DataKeyField="SampleRequestTradeID" BorderColor="Silver"
	...
	<Columns>
		...
		<asp:TemplateColumn>
			<HeaderTemplate>
				<asp:Label id="lblQuoteVendorHeader" runat="server"><%#GetSystemText("Trade Partner")%></asp:Label>
			</HeaderTemplate>
			<ItemTemplate>
