<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SampleRequest_Workflow_Submit_GoTo.aspx.vb" Inherits="srmOnApp.SampleRequest_Workflow_Submit_GoTo" %>
<%@ Register TagPrefix="cc1" Namespace="Yunique.WebControls" Assembly="YSWebControls" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title runat="server" id="PageTitle">Select Page...</title>
		...
		<form id="Form1" method="post" runat="server">
			...
			<asp:datagrid id="DataGrid1" runat="server" BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px"
				...
				<Columns>
					...
					<asp:TemplateColumn>
						<HeaderTemplate>
							<asp:Label runat="server" CssClass="fontHead" ID="label1"><%#GetSystemText("Select Style Page")%>...</asp:Label>
						</HeaderTemplate>
						<ItemTemplate>
