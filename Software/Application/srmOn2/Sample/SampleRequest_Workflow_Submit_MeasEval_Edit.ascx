...
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SampleRequest_Workflow_Submit_MeasEval_Edit.ascx.vb" Inherits="srmOnApp.SampleRequest_Workflow_Submit_MeasEval_Edit" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
								...
								<TABLE height="30" cellSpacing="0" cellPadding="0" border="0">
									<TR>
										...
										<TD>
											...
											</asp:ImageButton>											<asp:HiddenField ID="HFSubmitForm" runat="server" Value="0" />
