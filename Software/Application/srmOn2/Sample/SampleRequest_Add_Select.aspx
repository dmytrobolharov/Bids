<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SampleRequest_Add_Select.aspx.vb" Inherits="srmOnApp.SampleRequest_Add_Select" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
				<tr>
					<td>&nbsp;<asp:Label id="lblHeader" runat="server" Font-Names="Tahoma,Verdana" Font-Size="X-Large" ForeColor="#E0E0E0">Available Styles...</asp:Label></td>
				</tr>
			</table>
					...
					<TD>
						<TABLE class="TableHeader" width="100%" height="25" border="0" cellPadding="0" cellSpacing="0"
							...
							<TR vAlign="middle">
								...
								<TD width="100" class="fontHead"><asp:label id="lblThumbnail" runat="server">Thumbnail?</asp:label></TD>
