<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SampleRequest_Workflow_Submit_Calendar.aspx.vb" Inherits="srmOnApp.SampleRequest_Workflow_Submit_Calendar" %>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<table style="BORDER-BOTTOM: orange thin solid; BORDER-LEFT-STYLE: none; BACKGROUND-COLOR: white"
				...
				<tr>
					<td>&nbsp;<asp:label id="lblHeader" runat="server" Font-Names="Tahoma,Verdana" Font-Size="X-Large" ForeColor="#E0E0E0">Sample Submit Calendar</asp:label></td>
				</tr>
			</table>
				...
				<TR>
					...
					<TD vAlign="top" width="180">
						<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<TR>
								<TD>
									<asp:calendar id="CalendarRight02" runat="server" Width="180px" BorderColor="White" DayNameFormat="FirstLetter"
										PrevMonthText=" " NextMonthText=" " CssClass="font" SelectWeekText=" ">
										<DayHeaderStyle Font-Bold="True" Height="25px" BorderStyle="None" CssClass="TableHeaderYellow" BackColor="#E0E0E0"></DayHeaderStyle>
										<SelectedDayStyle BackColor="Silver"></SelectedDayStyle>
										<WeekendDayStyle BackColor="#FFFFC0"></WeekendDayStyle>
										<OtherMonthDayStyle ForeColor="#E0E0E0"></OtherMonthDayStyle>
							...
							<TR>
								<TD>
									<asp:calendar id="CalendarRight03" runat="server" Width="180px" BorderColor="White" DayNameFormat="FirstLetter"
										PrevMonthText=" " NextMonthText=" " CssClass="font" SelectWeekText=" ">
										<DayHeaderStyle Font-Bold="True" Height="25px" BorderStyle="None" CssClass="TableHeaderYellow" BackColor="#E0E0E0"></DayHeaderStyle>
										<SelectedDayStyle BackColor="Silver"></SelectedDayStyle>
										<WeekendDayStyle BackColor="#FFFFC0"></WeekendDayStyle>
