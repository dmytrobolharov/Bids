<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="MaterialRequest_RequestSubmit_MultipleAttachment.aspx.vb" Inherits="srmOnApp.MaterialRequest_RequestSubmit_MultipleAttachment" %>
    ...
    <table class="TableHeader" id="toolbar" cellspacing="0" cellpadding="0" width="100%"
        ...
        <tr valign="middle">
            ...
            <td>
                ...
                <%--<img runat="server" alt="" src="" id='btnUpload' style="display: none;" onclick="Upload_Click();return false;" /> --%>
     ...
     <asp:Panel ID="pnlMulti" runat="server">
        <div>
            ...
            <CuteWebUI:UploadAttachments runat="server" ID="UploadAttachments1" ManualStartUpload="False" AutoUseSystemTempFolder="False"
                ...
                NumFilesShowCancelAll="1000" TableHeaderTemplate="<td nowrap='nowrap'></td><td>Files</td><td>Description</td>" 
...
<script type="text/javascript">
    var btnUpload = document.getElementById("<%=btnAdd.ClientID %>");
