<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Material_RequestSubmitVendor.aspx.vb" Inherits="srmOnApp.Material_RequestSubmitVendor" %>
...
<HTML>
	<HEAD>
		<title runat="server" id="PageTitle">SampleRequest_Workflow_Submit_Vendor</title>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table1" runat="server" cellSpacing="1" cellPadding="1" width="100%" border="0" bgColor="#ffffff">
				<TR>
					<TD width="400" vAlign="top">
						...
						<TABLE id="Table3" borderColor="#ffffff" cellSpacing="2" cellPadding="2" border="0" width="100%">
							...
							<TR>
								<TD></TD>
								<TD>
									<asp:CheckBox id="cbShareAgent" runat="server" ForeColor="Red" CssClass="fontHead" Enabled="false"></asp:CheckBox></TD>
							</TR>
						</TABLE>
					</TD>
					<TD width="400" vAlign="top">
