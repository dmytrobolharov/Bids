<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Material_Request_New.aspx.vb" Inherits="srmOnApp.Material_Request_New1" %>
    ...
    <div>
		...
		<TABLE class="TableHeader" id="Table1" cellSpacing="1" cellPadding="1" width="100%" border="0">
			<TR>
				...
				<TD><asp:label id="lblNewMaterial" runat="server">New Material</asp:label></TD>
			</TR>
		</TABLE>    
