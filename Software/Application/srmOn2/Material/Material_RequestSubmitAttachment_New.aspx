<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Material_RequestSubmitAttachment_New.aspx.vb" Inherits="srmOnApp.Material_RequestSubmitAttachment_New" %>
...
<head runat="server">
    <title runat="server" id="PageTitle">New</title>
    ...
    <div>
		...
		<asp:panel id="pnlUpload" runat="server">
			<BLOCKQUOTE dir="ltr" style="MARGIN-RIGHT: 0px"> <BLOCKQUOTE dir="ltr" style="MARGIN-RIGHT: 0px">
					<P><BR>
						<SPAN class="fontHead"><asp:label id="lblSelectFileToUpload" runat="server">Select File to Upload...</asp:label></SPAN>
						<BR>
						<BR>
					...
					<P><SPAN class="fontHead"><asp:label id="lblDescription" runat="server">Description...</asp:label></SPAN>&nbsp;
