<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Material_RequestSubmitRedirect.aspx.vb" Inherits="srmOnApp.Material_RequestSubmitRedirect" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title runat="server" id="PageTitle">Please Wait...</title>
    ...
    <div id="BusyBoxDiv" style="BORDER-RIGHT: gainsboro 0px solid; PADDING-RIGHT: 5px; BORDER-TOP: gainsboro 0px solid; PADDING-LEFT: 5px; PADDING-BOTTOM: 5px; BORDER-LEFT: gainsboro 0px solid; PADDING-TOP: 5px; BORDER-BOTTOM: gainsboro 0px solid; POSITION: absolute; BACKGROUND-COLOR: transparent; TEXT-ALIGN: center">
	    ...
	    <TABLE WIDTH="100%" BORDER="0" CELLSPACING="1" CELLPADDING="1">
		    <TR>
			    ...
			    <TD class="fontHead"><asp:label id="lblPleaseWait" runat="server">Please Wait...</asp:label><br><asp:label id="lblPageLoading" runat="server">Page Loading</asp:label></TD>
		    </TR>
	    </TABLE>
	    </p>
    </div>
