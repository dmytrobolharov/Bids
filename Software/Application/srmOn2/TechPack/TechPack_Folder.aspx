<%@ Page Language="vb" AutoEventWireup="false" Codebehind="TechPack_Folder.aspx.vb" Inherits="srmOnApp.TechPack_Folder" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<TITLE id="htmlHeader"></TITLE>
		...
		function reloadPage() {
			parent.opener.location = parent.opener.location.reload();
		}
		//--></script>
	</HEAD>
