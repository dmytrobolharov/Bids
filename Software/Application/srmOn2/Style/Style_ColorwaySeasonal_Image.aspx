<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Style_ColorwaySeasonal_Image.aspx.vb" Inherits="srmOnApp.Style_ColorwaySeasonal_Image" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<table class="TableHeader" id="toolbar" cellspacing="0" cellpadding="0" width="100%" border="0" runat="server">
				<tr valign="middle">
                    ...
                    <td width="40">
                        <asp:dropdownlist id="dpStyleSet" runat="server" CssClass="font" DataTextField="Value" DataValueField="ID" AutoPostBack="true"></asp:dropdownlist>
                    </td>
					<td>
                        <asp:imagebutton id="imgBtnGo" runat="server" ImageUrl="../System/Icons/icon_go.gif"></asp:imagebutton>
                    </td>
				</tr>
			</table>
