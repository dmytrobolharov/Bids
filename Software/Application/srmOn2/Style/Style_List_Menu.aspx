...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Style_List_Menu.aspx.vb" Inherits="srmOnApp.Style_List_Menu" %>
			...
			<TABLE class="TableHeader" height="27" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TBODY>
					<TR>
						...
						<TD class="fontHead">
							<DIV align="center">
								<asp:Label Runat="server" ID="lblMenuHeader">Style</asp:Label>
							</DIV>
						</TD>
					</TR>
				</TBODY>
