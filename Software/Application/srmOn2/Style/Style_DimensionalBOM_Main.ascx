<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Style_DimensionalBOM_Main.ascx.vb" Inherits="srmOnApp.Style_DimensionalBOM_Main" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
