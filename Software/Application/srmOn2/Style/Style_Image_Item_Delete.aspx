...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Style_Image_Item_Delete.aspx.vb" Inherits="srmOnApp.Style_Image_Item_Delete" %>
		...
		<form id="Form1" method="post" runat="server">
			<table class="TableHeader" id="toolbar" cellSpacing="0" cellpadding="0" width="100%" border="0"
				...
				<tr valign="middle">
					...
					<td><cc1:confirmedimagebutton id="btnDelete" runat="server"  Message="Are you sure you want to remove image(s) ?"></cc1:confirmedimagebutton>
