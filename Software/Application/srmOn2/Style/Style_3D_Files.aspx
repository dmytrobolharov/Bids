<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Style_3D_Files.aspx.vb" Inherits="srmOnApp.Style_3D_Files" %>
...
<body>
    ...
    <asp:DataList ID="DataList1" runat="server" RepeatLayout="Flow" RepeatDirection="Horizontal" DataKeyField="Style3DFileID"
        ...
        <ItemTemplate>
            ...
            <table>                     
                <tr>   
                    ...
                    <td class="font"><%#Container.DataItem("Style3DFileName")%></td>
                    <td class="fontHead"><%=GetSystemText("File Description")%>:</td>
                    <td class="font"><%#Container.DataItem("Style3DFileDescription").Replace(vbCrLf, "<BR>").ToString%></td>
                </tr>
                <tr> 
                    <td class="fontHead"><%=GetSystemText("File Size")%>:</td> 
                    <td class="font"><%#Container.DataItem("Style3DFileSize")%></td>
                    <td class="fontHead"><%=GetSystemText("Shared")%>:</td> 
                    <td class="font"><%#IIf(Container.DataItem("Style3DFileShared") = 1, GetSystemText("YES"), GetSystemText("NO"))%></td>
                </tr>
            </table>
        </ItemTemplate>        
        <EditItemTemplate>
            <table class="TableHeader" cellspacing="0" cellpadding="0" width="100%" border="0">
                <tr>
                    ...
                    <td>
                        <cc1:ConfirmedImageButton ID="btnEditSave" runat="server" Message="NONE" CommandName="update"></cc1:ConfirmedImageButton>
                        <cc1:ConfirmedLinkButton ID="btnEditDelete" runat="Server" Message='<%#GetSystemText("Are you sure you want to Delete this file?")%>' CommandName="delete"></cc1:ConfirmedLinkButton>
                        <asp:LinkButton ID="btnEditDownload" runat="Server" CommandName="download" OnClientClick="dont_show_wait_twice();hide_wait_text();"></asp:LinkButton>
            ...
            <asp:HiddenField runat="server" ID="hdnFileName" Value='<%# DataBinder.Eval(Container.DataItem, "Style3DFileName").ToString  %>' />
            <asp:HiddenField runat="server" ID="hdnFileDescription" Value='<%# DataBinder.Eval(Container.DataItem, "Style3DFileDescription").ToString  %>' />
            <asp:HiddenField runat="server" ID="hdnFileSize" Value='<%# DataBinder.Eval(Container.DataItem, "Style3DFileSize").ToString %>' />
            <table>
                <tr>                    
                ...
                <tr>
                    <td class="fontHead"><%=GetSystemText("File Description")%>:</td>
                    <td class="font">
                        <asp:TextBox ID="txtFileDescription" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Style3DFileDescription").ToString  %>'
