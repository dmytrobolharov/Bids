<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Style_3D_File.aspx.vb" Inherits="srmOnApp.Style_3D_File" %>
...
<body>
    ...
    <table class="TableHeader" height="27" cellSpacing="0" cellpadding="0" width="100%" border="0">
	    <tr valign="middle">
		    <td valign="middle" align="left"><cc1:ConfirmedImageButton ID="btnClose" runat="server" CausesValidation="false" Message="NONE" OnClientClick="return btnClose_Click()"/></td>
            <td></td>
	    </tr>
    </table>
