<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Style_DesignDetailForm_Edit.aspx.vb" Inherits="srmOnApp.Style_DesignDetailForm_Edit" %>
					...
					<table style="border-color:silver" cellspacing="2" cellpadding="2" width="100%" border="0">
						<tr>
							<td align="left" valign="top">
								...
								<cc1:confirmedimagebutton id="btnImageBreak" runat="server" Message='<%# GetSystemText("Break image link from all size class?") %>' Visible="false"
