<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Style_Wardrobe_Style_List_Image.ascx.vb" Inherits="srmOnApp.Style_Wardrobe_Style_List_Image" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
