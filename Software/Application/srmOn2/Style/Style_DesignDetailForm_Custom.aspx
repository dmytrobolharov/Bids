<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Style_DesignDetailForm_Custom.aspx.vb" Inherits="srmOnApp.Style_DesignDetailForm_Custom" %>
...
<html>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<asp:datalist id="DataList1" runat="server" DataKeyField="ImageID" RepeatColumns="1" RepeatDirection="Horizontal" EnableViewState="True" Width="100%">
