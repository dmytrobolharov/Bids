<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Style_DesignDetail_Custom.aspx.vb" Inherits="srmOnApp.Style_DesignDetail_Custom" %>
	...
	<body>
		<form id="Form1" method="post" runat="server" style="margin:0px;">
			...
			<table cellspacing="0" cellpadding="0" border="0">
				<tr>
					<td valign="top">
                        <asp:datagrid id="DataGrid1" runat="server" DataKeyField="StyleDetailGridId" EnableViewState="False" BorderColor="#E0E0E0">
		...
		<%--	<asp:datagrid id="DataGrid1" runat="server" BorderColor="Silver" Width="800px" BorderStyle="Solid"
            ...
            <asp:datalist id="DataList1" runat="server" DataKeyField="ImageID" RepeatColumns="4" RepeatDirection="Horizontal" EnableViewState="True" Width="100%">
				<ItemStyle HorizontalAlign="Left" BorderWidth="1px" BorderStyle="Solid" BorderColor="LightGray" VerticalAlign="Top" BackColor="White"></ItemStyle>
				<ItemTemplate>
            ...
            <table id="Table5" height="24" cellspacing="0" cellpadding="0" width="100%" border="0" runat="server">
				<tr valign="middle">
