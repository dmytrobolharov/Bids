		...
		<form id="Form1" method="post" encType="multipart/form-data" runat="server">
			...
			<table height="25" cellSpacing="0" cellpadding="1" width="100%" border="0">
				<tr class="TableHeader" bgColor="whitesmoke">
					...
					<cc1:confirmedimagebutton id="imgBtnFolderImage" runat="server" ToolTip="Edit Image ..." visible="false"
							Message="NONE"></cc1:confirmedimagebutton><cc1:confirmedimagebutton id="imgBtnEditImage" runat="server" ToolTip="Edit Image File..." visible="false"
