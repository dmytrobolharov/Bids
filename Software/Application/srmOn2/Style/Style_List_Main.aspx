...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Style_List_Main.aspx.vb" Inherits="srmOnApp.Style_List_Main" %>
					...
					<TD vAlign="top">
						<asp:panel id="pnlWeek" runat="server">
							<cc2:ysxdayscalendar id="YSXDaysCalendar1" runat="server" PreviousWeek='<img src="../System/Icons/arrow_left.gif"  border="0" />'
								...
								TableHeaderCssClass="CalendarHeader" TableBodyCssClass="CalendarBody" NextFormat="MMM dd" PreviousFormat="MMM dd">
								<ItemTemplate>
