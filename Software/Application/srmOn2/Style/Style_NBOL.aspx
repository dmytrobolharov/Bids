<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Style_NBOL.aspx.vb" Inherits="srmOnApp.Style_NBOL" %>
...
<body>
    ...
    <form id="form1" runat="server" defaultbutton="imgBtnSearch" style="margin:0px;">
                ...
                <td width="350">
                    <table id="tblBOLTemplate" visible="false"  height="24" cellspacing="0" cellpadding="0" width="100%" border="0"
		                ...
		                <tr valign="middle">
			                ...
			                <td class="TableBar">
                                <%--<cc1:bwhyperlink id="lnkBolTemplate" visible="true" runat="server" WindowName="PomTemplate"></cc1:bwhyperlink>--%>
                                <asp:Label ID="lblBolTemplate" visible="true" runat="server"></asp:Label>
                            </td>
