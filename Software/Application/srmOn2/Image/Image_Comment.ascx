<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Image_Comment.ascx.vb" Inherits="srmOnApp.Image_Comment" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
				...
				<TR>
					<TD width="20" height="20">
						<asp:linkbutton id="Linkbutton1" runat="Server" Text='<IMG border="0" alt="edit" src="../System/Icons/icon_edit.gif">'
							CommandName="edit" Visible="true"></asp:linkbutton></TD>
...
<asp:panel id="Panel2" runat="server" BorderWidth="1" CssClass="font"  Width="100%"
	...
	<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
		...
		<TR bgColor="#ffffff">
			<TD style="WIDTH: 18px" width="19" height="20">&nbsp;</TD>
			<TD>&nbsp;
				<cc1:ConfirmedImageButton id="imgBtnInsert" runat="server"  Message="NONE" Visible="true"></cc1:ConfirmedImageButton>
