<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Vendor_Folder_Main.aspx.vb" Inherits="srmOnApp.Vendor_Folder_Main" %>
...
<body>
    ...
    <table class="TableHeader" height="27" cellspacing="0" cellpadding="0" width="100%"
        ...
        <tr>
            ...
            <td width="100%">
                <cc2:ConfirmedImageButton ID="btnSave" runat="server"  Message="NONE"></cc2:ConfirmedImageButton>
                <cc2:ConfirmedImageButton ID="btnClose" runat="server" Message="NONE" OnClientClick="top.dbody.location = '../Desktop/DesktopHome.aspx?CL=H'; return false;"></cc2:ConfirmedImageButton>
            </td>
            <td>
                &nbsp;
            </td>
