<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Vendor_FolderPage_Comment.ascx.vb" Inherits="srmOnApp.Vendor_FolderPage_Comment" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
