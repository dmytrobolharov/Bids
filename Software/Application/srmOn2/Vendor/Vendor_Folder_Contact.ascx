<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="Vendor_Folder_Contact.ascx.vb" Inherits="srmOnApp.Vendor_Folder_Contact" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
