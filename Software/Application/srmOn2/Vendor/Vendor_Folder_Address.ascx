<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="Vendor_Folder_Address.ascx.vb" Inherits="srmOnApp.Vendor_Folder_Address" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
