<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Vendor_FolderPage_ShippingInfo.aspx.vb" Inherits="srmOnApp.Vendor_FolderPage_ShippingInfo" %>
    ...
    <table cellspacing="0" cellpadding="0" width="100%" border="0">
        <tr>
			...
			<table style="BORDER-BOTTOM: orange thin solid; BORDER-LEFT-STYLE: none; BACKGROUND-COLOR: white"
				...
				<tr>
					<td>&nbsp;<asp:label id="lblTradeName" runat="server" ForeColor="#E0E0E0" Font-Size="X-Large" Font-Names="Tahoma,Verdana"></asp:label></td>
				</tr>
			</table>
