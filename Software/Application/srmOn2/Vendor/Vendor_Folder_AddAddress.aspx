<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Vendor_Folder_AddAddress.aspx.vb" Inherits="srmOnApp.Vendor_Folder_AddAddress" %>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE class="TableHeader" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<cc2:confirmedimagebutton id="btnClose" runat="server" Message="NONE" CausesValidation="false"></cc2:confirmedimagebutton>
					</TD>
					<TD>&nbsp;</TD>
				</TR>
			</TABLE>
			<TABLE height="25" cellSpacing="0" cellPadding="0" width="100%" bgColor="gray" border="0">
				<TR>
					<TD width="10">&nbsp;</TD>
					<TD class="fontHead"><FONT color="white">&nbsp;<asp:Label ID="lblNewAddress" runat="server"></asp:Label> </FONT></TD>
				</TR>
			</TABLE>
