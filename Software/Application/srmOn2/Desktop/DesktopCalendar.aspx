<%@ Page Language="vb" AutoEventWireup="false" Codebehind="DesktopCalendar.aspx.vb" Inherits="srmOnApp.DesktopCalendar" %>
...
<HTML>
	<HEAD>
		<title runat="server" id="PageTitle">Profile</title>
					...
					<TD vAlign="top">
						<asp:panel id="pnlWeek" runat="server">
							<cc2:ysxdayscalendar id="YSXDaysCalendar1" runat="server" TableBodyCssClass="CalendarBody" TableHeaderCssClass="CalendarHeader"
								...
								PreviousWeek='<img src="../System/Icons/arrow_left.gif"  border="0" />' PreviousFormat="MMM dd" NextFormat="MMM dd">
								<ItemTemplate>
									<%# GetCalendarLink(Container.DataItem("PKeyId").ToString, Container.DataItem("CalendarLinkId").ToString, Container.DataItem("CalendarLinkSubId").ToString, Container.DataItem("CalendarDate").ToString, Container.DataItem("CalendarType").ToString, Container.DataItem("CalendarStatus").ToString, Container.DataItem("CalendarDescription").ToString, Container.DataItem("CalendarView").ToString ,  Container.DataItem("CalendarSN").ToString,Container.DataItem("StyleID").ToString )  %>
								</ItemTemplate>
							</cc2:ysxdayscalendar>
						</asp:panel>
