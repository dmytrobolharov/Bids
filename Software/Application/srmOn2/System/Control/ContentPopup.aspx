<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ContentPopup.aspx.vb" Inherits="srmOnApp.ContentPopup" %>
<%@ Register TagPrefix="cc1" Namespace="Yunique.WebControls" Assembly="YSWebControls" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title runat="server" id="PageTitle">Select</title>
			...
			<asp:datagrid id="dgContent" runat="server" Width="500px" AutoGenerateColumns="False" PageSize="100"
				...
				<Columns>
					...
					<asp:TemplateColumn>
						...
						<HeaderTemplate>
							<asp:Label runat="server" CssClass="fontHead" ID="label1">Content %</asp:Label>
						</HeaderTemplate>
						<ItemTemplate>
					...
					<asp:TemplateColumn>
						<HeaderTemplate>
							<asp:Label runat="server" CssClass="fontHead" ID="label1">Content Type</asp:Label>
						</HeaderTemplate>
						<ItemTemplate>
