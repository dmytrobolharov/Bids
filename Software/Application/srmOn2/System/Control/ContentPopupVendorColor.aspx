				...
				<Columns>
					...
					<asp:TemplateColumn HeaderText="Content %">
						...
						<ItemTemplate>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txtContentPerc" Display="Static" ErrorMessage="*" tooltip="Numbers only" ValidationExpression="^\d+$" runat="server" ValidationGroup="Group1" />
