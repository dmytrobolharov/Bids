<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="QuotaPopup.aspx.vb" Inherits="srmOnApp.QuotaPopup" %>
					...
					<TD>
						<table class="TableHeader">
							<tr>
								...
								<TD width="20"><asp:imagebutton id="btnImgPrevious" runat="server" ImageUrl="../Icons/icon_Previous.gif"></asp:imagebutton></TD>
								<TD noWrap align="center" width="100"><asp:label id="lblPageCount" runat="server" CssClass="fontHead"></asp:label></TD>
								<TD width="20"><asp:imagebutton id="btnImgNext" runat="server" ImageUrl="../Icons/icon_next.gif"></asp:imagebutton></TD>
								<TD width="20"><asp:imagebutton id="btnImgLast" runat="server" ImageUrl="../Icons/icon_last.gif"></asp:imagebutton></TD>
								<TD width="10">&nbsp;</TD>
