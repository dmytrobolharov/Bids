...
function calendarGrid(sTxtBoxName, sTxtData) {
    ...
    if (o == null) {
        var strReplace = '$';
        var strID = sTxtBoxName.replace(/\$/gi, '_');
        o = document.getElementById(strID);
    }    
    ...
    windowDatePicker = window.open("../System/Control/CalendarPopup.aspx?txtdata=" + sTxtData + "&txtbox=" + sTxtBoxName, "dp", "toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=0,resizable=0,width=170px,height=170px,screenX=" + this.x + ",left=" + this.x + ",screenY=" + this.y + ",top=" + this.y + "");
    windowDatePicker.focus();
}
