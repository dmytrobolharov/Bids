<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report_Sample_Print.aspx.vb" Inherits="srmOnApp.Report_Sample_Print" %>
				...
				<p style="WIDTH: 220px; TEXT-ALIGN: center">
					<TABLE WIDTH="100%" BORDER="0" CELLSPACING="1" CELLPADDING="1">
						<TR>
							...
							<TD class="fontHead"><asp:label id="lblPleaseWait" runat="server">Please Wait...</asp:label><br>
								<asp:label id="lblReportLoading" runat="server">Report Loading</asp:label></TD>
						</TR>
					</TABLE>
				</p>
			</div>
