...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Report_MaterialRequest_Print.aspx.vb" Inherits="srmOnApp.Report_MaterialRequest_Print" %>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE class="TableHeader" id="toolbar" cellSpacing="0" cellPadding="0" width="100%" border="0"
				...
				<TR vAlign="middle">
					...
					<TD width="80"><cc1:confirmedimagebutton id="btnSave" runat="server" ImageUrl="../System/Button/btn_preview_pdf.gif" Message="NONE"></cc1:confirmedimagebutton></TD>
					<TD><cc1:confirmedimagebutton id="btnClose" runat="server" ImageUrl="../System/Button/btn_close.gif" Message="NONE"></cc1:confirmedimagebutton></TD>
				</TR>
			</TABLE>
