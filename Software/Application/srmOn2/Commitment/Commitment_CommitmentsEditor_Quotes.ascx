<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Commitment_CommitmentsEditor_Quotes.ascx.vb" Inherits="srmOnApp.Commitment_CommitmentsEditor_Quotes" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
