<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CommitmentItem_New.aspx.vb" Inherits="srmOnApp.CommitmentItem_New1" %>
...
<body>
    ...
    <div>
        <TABLE class="TableHeader" cellSpacing="1" cellPadding="1" width="100%" border="0">
			<TR>
				<TD width="20" height="20"><IMG src="../System/Icons/icon_quote.gif"></TD>
				<TD><asp:label id="lblNewQuote" runat="server">New Quote</asp:label></TD>
			</TR>
		</TABLE>    
