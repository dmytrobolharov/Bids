...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CommitmentItem_Edit.aspx.vb"
    Inherits="srmOnApp.CommitmentItem_Edit" %>
...
<%@ Register TagPrefix="uc2" TagName="Commitment_Comment" Src="Commitment_Comment.ascx" %>
<%@ Register TagPrefix="uc3" TagName="Sourcing_Partner_Header" Src="../Sourcing/Sourcing_Partner_Header.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title runat="server" id="PageTitle">Commitment</title>
    ...
    <table class="TableHeader" id="toolbar" height="24" cellspacing="0" cellpadding="0"
        ...
        <tr valign="middle">
            ...
            <td>
                ...
                <cc1:bwimagebutton id="btnGoTo" runat="server" Message="NONE"></cc1:bwimagebutton>
            </td>
        </tr>
    </table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
        <tr>
            <td>&nbsp;<asp:Label id="lblHeader" runat="server" Font-Names="Tahoma,Verdana" Font-Size="X-Large" ForeColor="#E0E0E0">Quote</asp:Label></td>
        </tr>
    </table>
            ...
            <td width="50%">
                ...
                <tr>
                    ...
                    <tr valign="top">
                        ...
                        <asp:Panel runat="server" ID='pnladdcost'>
                            <td valign="top">
                                <table class="TableHeader" height="25" cellspacing="0" cellpadding="0" width="100%"
                                    border="0">
                                    <tr height="25">
                                                                            ...
                                                                            <td height="30">
                                                                                <table id="TbTrim" cellspacing="0" cellpadding="0" width="250" border="0" runat="server">
                                                                                    <tr class="fontHead">
                                                                                        ...
                                                                                        <td nowrap width="85">
                                                                                            <asp:Label ID="lblNoofRow" runat="server" ><%= GetSystemText("No. of Row(s)")%>:</asp:Label>
                                                                                        </td>
                                                                                        <td width="35">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <asp:DataGrid ID="Datagrid1" runat="server" OnItemDataBound="Datagrid1_ItemEventHandler"
                                                                        DataKeyField="CommitmentAdditionalCostID" Width="250" AutoGenerateColumns="False"
                ...
                <td valign="top" width="50%">
                    ...
                    <asp:Panel ID="pnlComments" runat="server">
                        <uc2:Commitment_Comment ID="Commitment_Comment1" runat="server"></uc2:Commitment_Comment>
                    </asp:Panel>
                ...
                <asp:Panel ID="DimInfo" runat="server">
                    <table class="TableHeader" height="25" cellspacing="0" cellpadding="0" width="100%"
                        ...
                        <tr>
                            ...
                            <td width="100%">
                                <asp:Label ID="lblQuotationDetails" runat="server"><%= GetSystemText("Commitment Details")%></asp:Label>
                            </td>
                        </tr>
                    </table>
                    <asp:DataGrid ID="DataGrid2" runat="server" DataKeyField="SourcingCommitmentBOMDetailsID"
