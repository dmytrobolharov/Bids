...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CommitmentItem_EditCost.aspx.vb" Inherits="srmOnApp.CommitmentItem_EditCost" %>
...
<%@ Register TagPrefix="uc2" TagName="Quote_Comment" Src="Commitment_Comment.ascx" %>
    ...
    <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff" border="0"
        ...
        <tr>
                    ...
                    <td>
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <table cellspacing="0" cellpadding="0" id="tblMinQNT" runat="server">
            <tr>
             <td class="fonthead">  <asp:Label id="lblMinQNT" runat="server" ><%= GetSystemText("Minimum Quantity")%></asp:Label>:&nbsp;&nbsp;</td>
             ...
             <td>  <cc1:confirmedimagebutton id="btnMinQNT" runat="server"  Message="NONE"></cc1:confirmedimagebutton></td>
               ...
               <td valign="middle" class="fonthead" style="padding: 0 10px;">
                  <table cellspacing="0" cellpadding="0" id="tblMaxQNT" runat="server">
            <tr>
             <td class="fonthead">  <asp:Label id="lblMaxQNT" runat="server" ><%= GetSystemText("Maximum Quantity")%></asp:Label>:&nbsp;&nbsp;</td>
             ...
             <td>  <cc1:confirmedimagebutton id="btnMaxQNT" runat="server"  Message="NONE"></cc1:confirmedimagebutton></td>
               ...
               <td valign="middle" class="fonthead" style="padding: 0 10px;">
                  <table cellspacing="0" cellpadding="0" id="tblCostQNT" runat="server">
            <tr>
             <td class="fonthead">  <asp:Label id="lblCostQNT" runat="server" ><%= GetSystemText("Partner Cost/Quantity")%></asp:Label>:&nbsp;&nbsp;</td>
            ...
            <asp:Panel ID="CostDetail" runat="server">
                ...
                <asp:DataGrid ID="DataGrid2" runat="server" DataKeyField="SourcingCommitmentCostOptionDetailID"
