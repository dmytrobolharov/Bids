...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CommitmentItem_EditBOM.aspx.vb"
    Inherits="srmOnApp.CommitmentItem_EditBOM" %>
                ...
                <asp:Panel ID="DimInfo" runat="server">
                    <table class="TableHeader" height="25" cellspacing="0" cellpadding="0" width="100%"
                        ...
                        <tr>
                            ...
                            <td width="100%">
                                <asp:Label ID="lblQuotationDetails" runat="server">Commitment Details</asp:Label>
                            </td>
                        </tr>
                    </table>
                        ...
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td valign="middle" align="center" class="fonthead" style="padding: 0 10px;">
                                    <asp:Label ID="lblBOMOptions" runat="server" Text=""><%= GetSystemText("BOM & Options")%></asp:Label>
                                </td>
                                <td>
