<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Commitment_CommitmentsEditor.aspx.vb" Inherits="srmOnApp.Commitment_CommitmentsEditor" %>
...
<div id="FloatDG" runat="server" style="width:715px; background-color:White; z-index:500; position: absolute; left:0px; cursor:pointer;" >
    <div style="float:left; background-color:White; width:695px; height:100%;"><asp:PlaceHolder ID="plhQuoteGrid" runat="server" EnableViewState="False"></asp:PlaceHolder></div>
