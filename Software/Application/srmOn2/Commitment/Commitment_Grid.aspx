<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Commitment_Grid.aspx.vb" Inherits="srmOnApp.Commitment_Grid" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server" defaultbutton="imgBtnSearch">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
				<tr>
					<td>&nbsp;<asp:Label id="lblHeader" runat="server" Font-Names="Tahoma,Verdana" Font-Size="X-Large" ForeColor="#E0E0E0">Commitment Folder...</asp:Label></td>
				</tr>
			</table>
						...
						<asp:datagrid id="DataGrid1" runat="server" DataKeyField="SourcingCommitmentItemID">
				            ...
				            <Columns>
				                <asp:TemplateColumn Visible="False">
				                    ...
				                    <ItemTemplate>
				                        <asp:CheckBox ID="chbCommitmentItem" name="chbCommitmentItem" runat="server"></asp:CheckBox>				            
				                    </ItemTemplate>
				                </asp:TemplateColumn>
				            </Columns> 						
        ...
        <script type="text/javascript">
            ...
            function CheckAll(checkAllBox) {
                ...
                for (i = 0; i < frm.length; i++) {
                    e = frm.elements[i];
                    if (e.type == 'checkbox' && e.name.indexOf('chbCommitmentItem') != -1) {
