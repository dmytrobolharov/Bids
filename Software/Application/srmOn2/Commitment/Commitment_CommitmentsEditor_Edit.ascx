<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Commitment_CommitmentsEditor_Edit.ascx.vb" Inherits="srmOnApp.Commitment_CommitmentsEditor_Edit" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<script type="text/javascript">
    $(":text[id^=ctrCommitmentEdit_DataList1]").change(function () { $(this).css("color", "red"); });
