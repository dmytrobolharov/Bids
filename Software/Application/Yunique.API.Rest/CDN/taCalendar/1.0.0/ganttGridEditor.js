...
//        options.calendarHeight = options.calendarHeight ? options.calendarHeight : $(window).width() - 20;
//        options.calendarWidth = options.calendarWidth ? options.calendarWidth : $(window).height() - 20;
