<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="Style_Comment.ascx.vb" Inherits="plmOnCustomControls.Style_Comment" %>
<%@ Register TagPrefix="cc1" Namespace="Yunique.WebControls" Assembly="YSWebControls" %>
<%@ Register TagPrefix="ycl" Namespace="Yunique.Core.Library" Assembly="Yunique.Core" %>
<table height="25" cellspacing="0" cellPadding="0" width="100%" border="0">
	<tr class="TableHeader">
		<td vAlign="middle" align="center" width="10"><img id="imgTbSCnr" height="15" src="<%=GetSystemImagePath("bbTbSCnr.gif", "")%>" width="3" /></td>
		<td width="20">
		    
		    <img id="imbBtnExpand" onclick="return ShowCommentContent(this)"  src="<%=GetIconPath("icon_Next.gif", "")%>"  />
		    <img id="imgBtnCollapse" onclick="return HideCommentContent(this)" style="display:none;"  src="<%=GetIconPath("icon_Down.gif", "")%>" />
		</td>
		<td class="fontHead">&nbsp;
			...
			<TABLE width="100%">
				<TR>
					<TD width="20" height="20">
						<asp:linkbutton id="Linkbutton1" CausesValidation="False" runat="Server" Visible='<%# ShowAddComment(Container.DataItem("CTeamID").ToString) %>' CommandName="edit" Text='<%# GetEditButtonDefinition() %>'></asp:linkbutton>
                    </TD>
					<TD class="font">
		...
		<EditItemTemplate>
			...
			<TABLE cellspacing="0" cellPadding="0" width="100%" border="0">
				...
				<TR>
					<TD width="20">&nbsp;</TD>
					<TD width="100"><BR>
						<asp:linkbutton id="Linkbutton2" CausesValidation="False" runat="Server" NAME="Linkbutton2" CommandName="update" Text='<%# GetSaveButtonDefinition() %>'></asp:linkbutton>
						<cc1:ConfirmedLinkButton id="Linkbutton4"  CausesValidation="False"  runat="Server" NAME="Linkbutton4" CommandName="delete" Text='<%# GetDeleteButtonDefinition() %>'
							Visible="TRUE" Message='<%#GetSystemtext("Are you sure you want to Delete this comment?")%>'>
		...
		<TABLE>
			<TR>
				...
				<TD width="100" height="16">
					<asp:linkbutton id="btnNew" CausesValidation="False" runat="Server" CssClass="fonthead" Text='<IMG border="0" alt="New" src=""><%=Getsystemtext("Add New")%>...' CommandName="new">
                        <img id="imgAddComment" border="0" alt="New" src='<%=GetIconPath("icon_add.gif", "")%>' /><%=Getsystemtext("Add New")%>...
                    </asp:linkbutton>
                </TD>
				<TD>&nbsp;</TD>
			</TR>
