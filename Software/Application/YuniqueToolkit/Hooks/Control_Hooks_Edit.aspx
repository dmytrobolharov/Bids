<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_Hooks_Edit.aspx.vb" Inherits="YuniFace.Control_Hooks_Edit" ValidateRequest="false" %>
<%@ Register TagPrefix="cc1" Namespace="Yunique.WebControls" Assembly="YSWebControls" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
    <head>
        <title runat="server" id="PageTitle">Edit API Plugin</title>
            ...
            <table cellspacing="0" cellpadding="0" width="100%" border="0" bgcolor="#ffffff">
	            ...
	            <tr valign='top' align="left">
		            <td width='98%'>
            	        ...
            	        <asp:Label ID="lblRadGridFilterHeader" runat="server">Parameters</asp:Label></b></font>
		            </td>
	            </tr>
			    <tr class="fontHead">
				    <td>
				        <cc1:confirmedimagebutton id="btnAddFilter" runat="server" ImageUrl="" Message="NONE" EnableViewState="False" />&nbsp;
				        <cc1:confirmedimagebutton id="btnDeleteFilter" runat="server" ImageUrl="" Message="NONE" EnableViewState="False" CausesValidation="False" />
				    </td>
			    </tr>
	            <tr valign='top' align="left">
		            <td width='98%'>
                        <asp:PlaceHolder ID="plhFilterControlsHolder" runat="server"></asp:PlaceHolder>
		            </td>
	            </tr>
			</table>
			<br />
