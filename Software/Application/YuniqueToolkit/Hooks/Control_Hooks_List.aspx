<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_Hooks_List.aspx.vb" Inherits="YuniFace.Control_Hooks_List" %>
...
<html>
    <head>
        <title runat="server" id="PageTitle">API Plugins</title>
