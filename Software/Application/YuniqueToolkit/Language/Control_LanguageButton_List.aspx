...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Control_LanguageButton_List.aspx.vb" Inherits="YuniFace.Control_LanguageButton_List" %>
		...
		<div id="TheWholeForm" runat="server">
            ...
            <script type="text/javascript">
                ...
                function ShowGenerateButtonsForm() {
                    window.radopen("Control_LanguageButton_GenerateButton.aspx", "GenerateButtonDialog");
                }
                //]]>
            </script>
