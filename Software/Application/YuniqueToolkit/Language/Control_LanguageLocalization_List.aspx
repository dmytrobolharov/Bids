...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Control_LanguageLocalization_List.aspx.vb" Inherits="YuniFace.Control_LanguageLocalization_List" %>
            ...
            <TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR vAlign="top">
					<TD>
						...
						<asp:datagrid id="DataGrid1" runat="server" AllowSorting="True" AllowPaging="true">
							...
							<Columns>
								<asp:TemplateColumn ItemStyle-BorderWidth="0">
									...
									<ItemTemplate>
                                        <cc1:BWHyperLink ID="btnWhereLink" runat="server" Visible="false"></cc1:BWHyperLink>
									</ItemTemplate>
								</asp:TemplateColumn>
                            </Columns>
