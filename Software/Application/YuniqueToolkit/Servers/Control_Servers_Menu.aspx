<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_Servers_Menu.aspx.vb" Inherits="YuniFace.Control_Servers_Menu" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<table width="100%" height="27" border="0" cellpadding="0" cellspacing="0" class="TableHeader">
				<tr>
					<td width="100%">&nbsp;
					    <cc2:confirmedimagebutton id="btnAdd" runat="server" ImageUrl="" Message="NONE" />
					</td>
				</tr>
			</table>
