<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_Override_Custom_VWX_Edit.aspx.vb" Inherits="YuniFace.Control_Override_Custom_VWX_Edit" %>
		    ...
		    <table style="BORDER-BOTTOM: orange thin solid; BORDER-LEFT-STYLE: none; BACKGROUND-COLOR: white" cellSpacing="2" cellPadding="0" width="100%" border="0">
				<tr>
					<td height='25' class='fonthead' nowrap>
					    <asp:label id="lblViewName" runat="server">View Name</asp:label>
					</td>
					<td width='10px' class='font'>
						&nbsp;
					</td>
					<td width='100%' class='font'>
                        <telerik:RadComboBox ID="cboViewName" runat="server" Width="400px" Height="150px"
                            EmptyMessage="" EnableLoadOnDemand="True" ShowMoreResultsBox="true"
                            EnableVirtualScrolling="true" OnItemsRequested="cboViewName_ItemsRequested"
			...
			<table cellSpacing="0" cellPadding="0" width="100%" bgColor="white" border="0">
                ...
                <tr>
                    <td width="100%" valign="top">
                        <asp:TextBox ID="txtVWX" runat="server" Height="600" TextMode="MultiLine" 
