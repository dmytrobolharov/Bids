...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Control_Override_SPX_Main.aspx.vb" Inherits="YuniFace.Control_Override_SPX_Main" %>
	...
	<body>
		<form id="Form1" method="post" runat="server" defaultbutton="btnSave" >
			...
			<table  cellSpacing="0" cellPadding="0" width="100%" bgColor="white" border="0">
				<tr>
					<td width="100%" valign="top">	
					    <asp:TextBox ID="txtOrigHdr" runat="server" Height="100" TextMode="MultiLine" 
                                        Width="100%" ReadOnly="true" Wrap="False"></asp:TextBox>
                    </td>  
                </tr>
                <tr>                 
                    <td>
                ...
                <tr>
                    <td width="100%" valign="top">	
                        <asp:TextBox ID="txtOvrSPX" runat="server" Height="600" TextMode="MultiLine" 
