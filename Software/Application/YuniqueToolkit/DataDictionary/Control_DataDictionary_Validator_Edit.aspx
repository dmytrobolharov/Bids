<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_DataDictionary_Validator_Edit.aspx.vb" Inherits="YuniFace.Control_DataDictionary_Validator_Edit" %>
<%@ Register TagPrefix="cc1" Namespace="Yunique.WebControls" Assembly="YSWebControls" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
    <head>
        <title runat="server" id="PageTitle">Edit Data Dictionary Entry</title>
