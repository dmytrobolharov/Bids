<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_SpreadsheetEditor_New.aspx.vb" Inherits="YuniFace.Control_SpreadsheetEditor_New" %>
<%@ Register TagPrefix="cc1" Namespace="Yunique.WebControls" Assembly="YSWebControls" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
    <head>
        <title runat="server" id="PageTitle">New Spreadsheet</title>
												...
												<table width='100%' bordercolor='#CCCCCC'  border='0' cellspacing='0' cellpadding='0'>
													<tr>
														<td width='125' height='25' class='fontHead' nowrap="nowrap">
															<asp:label id="lblSpreadsheetName" runat="server">Spreadsheet Name</asp:label>
														</td>
														<td class='font'>
                                                            <telerik:RadComboBox ID="cboSpreadsheetName" runat="server" Width="500px" Height="150px"
                                                                EmptyMessage="" EnableLoadOnDemand="True" ShowMoreResultsBox="true"
                                                                EnableVirtualScrolling="true" OnItemsRequested="cboSpreadsheetName_ItemsRequested"
