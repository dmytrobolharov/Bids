<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_SpreadsheetEditor_Menu.aspx.vb" Inherits="YuniFace.Control_SpreadsheetEditor_Menu" %>
			...
			<table width="100%" height="27" border="0" cellpadding="0" cellspacing="0" class="TableHeader">
				<tr>
					<td width="100%">&nbsp;
					    ...
					    <cc2:confirmedimagebutton id="btnRestore" runat="server" Message="NONE" />
					</td>
				</tr>
			</table>
