<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_WSClient_New.aspx.vb" Inherits="YuniFace.Control_WSClient_New" %>
				...
				<tr>
					<td vAlign="top" bgColor="#ffffff">
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr>
								<td>
									<div align="right"><asp:label id="lblHeader" runat="server" ForeColor="#E0E0E0" Font-Size="XX-Large" Font-Names="Tahoma,Verdana">Web Service Client</asp:label></div>
								</td>
							</tr>
						</table>
