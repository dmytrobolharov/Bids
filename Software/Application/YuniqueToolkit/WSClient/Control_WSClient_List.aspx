<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_WSClient_List.aspx.vb" Inherits="YuniFace.Control_WSClient_List" %>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<table style="BORDER-BOTTOM: orange thin solid; BORDER-LEFT-STYLE: none; BACKGROUND-COLOR: white"
				...
				<tr>
					<td>&nbsp;<asp:label id="lblHeader" runat="server" ForeColor="#E0E0E0" Font-Size="X-Large" Font-Names="Tahoma,Verdana">Web Service Client</asp:label></td>
				</tr>
			</table>
			<table cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr vAlign="top">
					<td>
						...
						<asp:datagrid id="DataGrid1" runat="server" DataKeyField="WSClientID" AllowSorting="True">
