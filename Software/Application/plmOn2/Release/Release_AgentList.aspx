<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Release_AgentList.aspx.vb" Inherits="plmOnApp.Release_AgentList" %>
				...
				<TR vAlign="middle">
					...
					<TD>
						<asp:imagebutton id="btnInvSearch" runat="server" ImageUrl="../System/icons/1x1.gif" Width="0px"
							Height="0px" />
						<cc1:confirmedimagebutton id="btnNew" runat="server" Message="NONE"></cc1:confirmedimagebutton></TD>
					<td>&nbsp;</td>
				</TR>
			</TABLE>
