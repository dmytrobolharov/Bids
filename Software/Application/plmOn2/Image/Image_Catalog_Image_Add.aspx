<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Image_Catalog_Image_Add.aspx.vb" Inherits="plmOnApp.Image_Catalog_Image_Add" %>
			...
			<TABLE class="TableHeader" id="toolbar" cellSpacing="0" cellPadding="0" width="100%" border="0"
				...
				<tr vAlign="middle">
					...
					<td><asp:imagebutton id="btnInvSearch" runat="server" ImageUrl="../System/icons/1x1.gif" Width="0px"
						...
						<cc1:confirmedimagebutton id="btnNew" runat="server" Message="NONE" Visible="False" >
