<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Image_WorkflowPage_Edit.aspx.vb" Inherits="plmOnApp.Image_WorkflowPage_Edit" %>
...
<html>
    ...
    <div id="fixed_icons"><a href="../Help/Help_Folder.aspx?Folder=<%= Folder %>&HID=<%= HelpID %>" title="Help" target="_blank" id="yHelp"></a></div>
		<form id="Form1" method="post" runat="server">
			...
			<uc1:Image_Header id="Image_Header1" runat="server" IsCollapsible="true" IsCollapsed="true"></uc1:Image_Header>
			...
			<table width="100%" height="300" border="1" cellpadding="0" cellspacing="0" bordercolor="#cccccc">
				<tr>
					...
					<td valign="top"><table class="TableHeaderOver" height="24" cellspacing="0" cellpadding="0" width="100%"
						...
						<asp:DataGrid id="DataGrid1" runat="server" DataKeyField="ImageChangeID" BorderColor="#E0E0E0"
