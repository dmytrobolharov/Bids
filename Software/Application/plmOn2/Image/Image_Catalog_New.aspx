...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Image_Catalog_New.aspx.vb" Inherits="plmOnApp.Image_Catalog_New" %>
				...
				<tr>
					<td valign="top" bgcolor="#ffffff">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td><div align="right">
										<asp:Label id="lblHeader" runat="server" Font-Names="Tahoma,Verdana" Font-Size="XX-Large" ForeColor="#E0E0E0">New Image Catalog</asp:Label></div>
								</td>
							</tr>
						</table>
