<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Image_Catalog_Image_Comment.ascx.vb" Inherits="plmOnApp.Image_Catalog_Image_Comment" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<table cellSpacing="0" cellPadding="0" width="100%" border="0" height="25">
	<tr class="TableHeaderOver">
		...
		<td class="fontHead"><asp:Label id="lblNoComments" runat="server">Label</asp:Label></td>
	</tr>
</table>
<asp:panel id="Panel1" runat="server" BorderWidth="1" CssClass="font" Width="100%" BorderColor="DodgerBlue"
	...
	<asp:datalist id="DataList1" runat="server" BackColor="White" BorderStyle="Solid" BorderColor="WhiteSmoke"
		Width="100%" BorderWidth="1px" DataKeyField="ImageCommentID" OnEditCommand="DataList_EditCommand"
	...
	<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
		<TR class="TableHeader">
			...
			<TD class="fontHead" style="FONT-WEIGHT: bold; COLOR: black; TEXT-DECORATION: none">
				<asp:Label id="lblNewComment" runat="server" ForeColor="Red" Visible="False">New Comment:</asp:Label></TD>
