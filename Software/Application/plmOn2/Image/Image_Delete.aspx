...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Image_Delete.aspx.vb" Inherits="plmOnApp.Image_Delete"%>
		...
		<form id="Form1" method="post" runat="server">
			...
			<asp:datagrid id="DataGrid1" runat="server" BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px"
				...
				<Columns>
					...
					<asp:TemplateColumn >
					<HeaderTemplate>
                        <asp:Label ID="lblImage" runat="server" ><%#GetSystemText("Image")%></asp:Label> </HeaderTemplate>
						<ItemTemplate>
					...
					<asp:TemplateColumn >
					<HeaderTemplate >
                        <asp:Label ID="lblVersion" runat="server" ><%#GetSystemText("Version")%></asp:Label></HeaderTemplate>
						<ItemTemplate>
