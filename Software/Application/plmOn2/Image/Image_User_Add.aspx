...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Image_User_Add.aspx.vb" Inherits="plmOnApp.Image_User_Add" %>
						...
						<TABLE width="100%" align="center">
							<TR>
								<TD align="center" width="40%"><FONT face="Microsoft Sans Serif" color="#000000" size="2"><B class="fonthead"><asp:Label 
                                        ID="lblAvailable" runat="server" Text="Available"></asp:Label></B>
                                    </FONT></TD>
								<TD width="10%"></TD>
								<TD align="center" width="40%"><FONT face="Microsoft Sans Serif" color="#000000" size="2"><B class="fonthead"><asp:Label 
                                        ID="lblSelected" runat="server" Text="Selected"></asp:Label>
&nbsp;</B></FONT></TD>
								<TD width="10%"></TD>
							</TR>
							<TR>
