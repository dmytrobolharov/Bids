<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="Image_List_View.ascx.vb"
    Inherits="plmOnApp.Image_List_View" %>
...
<table cellspacing="0" cellpadding="0" width="100%" border="0">
    <tr valign="top">
        <td>
            ...
            <asp:Label ID="SortOrder" runat="server" Visible="False" Text="MDate"></asp:Label>
        </td>
    </tr>
</table>
