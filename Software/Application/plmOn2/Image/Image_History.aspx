	...
	<body>
		<form id="Form1" method="post" runat="server" autocomplete="on">
			...
			<TABLE id="Table1" cellSpacing="1" cellPadding="0" width="100%" border="0">
				<TR>
					<TD vAlign="top">
						<TABLE class="ToolbarShort" id="Table2" height="20" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<TR class="fontHead">
								...
								<TD>
									<DIV align="left"><B><asp:Label ID="lblRecordsFound" runat="server" Text="Records Found"></asp:Label></B></DIV>
                                    </TD>
							</TR>
						</TABLE>
								...
								<TABLE borderColor="silver" cellSpacing="0" cellPadding="0" width="100%" bgColor="#ffffff"
									...
									<TR>
										<TD>
											...
											<cc1:ConfirmedImageButton id="imgBtnLinkImage" runat="server" Message="NONE" CommandName="Link" ></cc1:ConfirmedImageButton>
										</TD>
									</TR>
									<TR>
