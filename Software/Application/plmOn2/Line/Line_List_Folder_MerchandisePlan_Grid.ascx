<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="Line_List_Folder_MerchandisePlan_Grid.ascx.vb" Inherits="plmOnApp.Line_List_Folder_MerchandisePlan_Grid" %>
...
<asp:datagrid id="DataGrid1" runat="server" PageSize="1000" OnItemDataBound="DataGrid1_ItemDataBound"
		...
		<Columns>
            ...
            <asp:TemplateColumn>
                <HeaderStyle CssClass="TableHeaderGreen" Height="30"  Width="100" HorizontalAlign="Center" />
                <HeaderTemplate>
            ...
            <asp:TemplateColumn>
                <HeaderStyle CssClass="TableHeaderRed" Height="30"  Width="100" HorizontalAlign="Center" />
				<HeaderTemplate>
            ...
            <asp:TemplateColumn>
                <HeaderStyle CssClass="TableHeaderBlue" Height="30"  Width="100" HorizontalAlign="Center" />
				<HeaderTemplate>
