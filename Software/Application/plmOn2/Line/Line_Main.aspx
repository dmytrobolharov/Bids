<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Line_Main.aspx.vb" Inherits="plmOnApp.Line_Main" %>
				...
				<tr>
					<td valign="top" bgcolor="#ffffff"><table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td><div align="right">
										<DIV align="right">
											<asp:Label id="lblHeader" runat="server" Font-Size="XX-Large" ForeColor="Silver">Line List</asp:Label></DIV>
									</div>
								</td>
							</tr>
						</table>
