<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Line_Folder_SKUPlan_New.aspx.vb" Inherits="plmOnApp.Line_Folder_SKUPlan_New" %>
...
<body>
    ...
    <asp:Panel runat="server" ID="pnlWarning" Visible="false">
        <div style="background-color: #a00; padding: 10px;">
            <asp:Label ID="lblPerm" runat="server" Text="Line Folder should have styles with asoosiated Bill of Material that have at least one dimension selected"
