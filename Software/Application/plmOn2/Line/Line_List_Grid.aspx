...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Line_List_Grid.aspx.vb" Inherits="plmOnApp.Line_List_Grid" %>
...
<HTML>
	...
	<body>
		...
		<asp:Panel runat="server" ID="pnlPerm" Visible=false>
            ...
            <script>
                $("#drlLineFolderTypeID").change(function () { __doPostBack('imgBtnSearch', 'onClick') })
            </script>
		</form>
	</body>
</HTML>
