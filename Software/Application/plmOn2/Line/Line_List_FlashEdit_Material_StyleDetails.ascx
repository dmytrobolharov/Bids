<%@ Control Language="vb" EnableViewState="true" AutoEventWireup="false" CodeBehind="Line_List_FlashEdit_Material_StyleDetails.ascx.vb" Inherits="plmOnApp.Line_List_FlashEdit_Material_StyleDetails" %>
