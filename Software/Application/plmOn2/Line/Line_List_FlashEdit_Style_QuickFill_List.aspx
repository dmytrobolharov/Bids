<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Line_List_FlashEdit_Style_QuickFill_List.aspx.vb" Inherits="plmOnApp.Line_List_FlashEdit_Style_QuickFill_List" %>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR vAlign="top">
					<TD>
						...
						<asp:datagrid id="DataGrid1" runat="server" AllowSorting="True" DataKeyField="QuickFillID">
