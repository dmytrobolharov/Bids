 ...
 <table class="TableHeader" id="toolbar" cellspacing="0" cellpadding="0" width="100%"
        ...
        <tr>
            ...
            <td width="100%">
                ...
                <cc1:confirmedimagebutton id="btnShare" runat="server" Message="NONE"></cc1:confirmedimagebutton>
                <cc1:confirmedimagebutton id="btnBatchUpdate" runat="server" Message="NONE" ValidationGroup="BATCH"></cc1:confirmedimagebutton>
                            ...
                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                <tr valign="top">
                                    <td>
                                        ...
                                        <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="TradePartnerID" BorderStyle="Solid" BorderWidth="1px">
                                            ...
                                            <Columns>
                                                <asp:TemplateColumn>
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:HiddenField ID="hdnRelationshipLevelID" runat="server" Value='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "RelationshipLevelID")) %>' />
                                                        <asp:HiddenField ID="hdnTradePartnerIDChain" runat="server" Value='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "TradePartnerIDChain")) %>' />
                                                    </ItemTemplate>
                                                </asp:TemplateColumn>
                                            </Columns>
    ...
    <script type="text/javascript" language="javascript">
        ...
        $(".slider-container").height($(document).height() - $(".slider-container").offset().top + 20);
        $("#FloatDG, #FloatDGMain").height($(document).height() - $(".slider-container").offset().top + 20);
