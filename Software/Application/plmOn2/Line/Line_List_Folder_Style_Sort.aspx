	...
	<script type="text/javascript">
	    ...
	    function sortRows2(txtSort) {
	       ...
	       // var allRows = currentTable.get(0).rows;
	        ...
	        var lastRowVal = parseInt(currentTable.find('li:last').find('input[name*="txtLineFolderItemSort"]').val(), 10);
	        ...
	        if (!wasInserted) {
	            ...
	            $('li.ui-state-default').each(function () {
	                if (!wasInserted) {
	                    ...
	                    var txtCurrentSort = $(this).find('input[name*="txtLineFolderItemSort"]');
	       ...
	       // processRowDrop($("#DataGrid1").get(0), draggingRow);
	        ...
	        $('li').each(function () {
	            ...
	            $(this).find('table').find('input[id*="LineFolderItemSort"]').val(newSort);
	    ...
	    $(window).load(function () {
	        ...
	        //hide id field
	        $('li').each(function () {
	            $(this).find('table').find('input[id*="LineFolderItemID"]').closest('tr').hide();
	            ...
	            $('<input type="hidden" name="hdnsort" value="' + $(this).find('table').find('input[id*="LineFolderItemSort"]').val() + '"/>').insertAfter($(this).find('table').find('input[id*="LineFolderItemSort"]'));
	        ...
	        $('li').each(function () {
	            ...
	            $(this).find('table').find('input[id*="LineFolderItemSort"]').bind('blur', function () {
	                sortRows2(this);
	            });
	        });
	        ...
	        $('li').each(function () {
	            ...
	            $(this).find('table').find('input[id*="LineFolderItemSort"]').css("width", "50px");
	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<TABLE class="TableHeader" height="27" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TBODY>
					<TR vAlign="middle">
                        ...
                        </cc1:confirmedimagebutton><cc1:confirmedimagebutton id="Confirmedimagebutton1" runat="server" 
			...
			<asp:datagrid id="DataGrid1" runat="server" Width="300px" BorderColor="#E0E0E0" BorderStyle="Solid"
				BorderWidth="1px" PageSize="100" AutoGenerateColumns="False" DataKeyField="LineFolderItemID">
                ...
                <asp:TemplateColumn ItemStyle-CssClass="dropimage">
					...
					<asp:TemplateColumn HeaderText="Sort">						
						<ItemTemplate>
							<asp:TextBox Runat="server" ID="txtSort" Text='<%#DataBinder.Eval(Container.DataItem,"LineFolderItemSort").tostring%>' Width="40" MaxLength="4">
							</asp:TextBox>
                             <asp:HiddenField runat="server" ID="hdnSort" Value='<%#DataBinder.Eval(Container.DataItem,"LineFolderItemSort").tostring%>' />
						</ItemTemplate>
					</asp:TemplateColumn>
				</Columns>
			</asp:datagrid>
