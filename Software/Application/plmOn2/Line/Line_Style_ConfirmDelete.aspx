<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Line_Style_ConfirmDelete.aspx.vb" Inherits="plmOnApp.Line_Style_ConfirmDelete"%>
		...
		<form id="Form1" method="post" runat="server">
			<table cellspacing="0" cellpadding="0" width="100%" border="0" bgcolor="#ffffff">
				<tr>
					...
					<td>
						<asp:Label id="lblHeader" runat="server" CssClass="fontHead">You are about to delete selected styles</asp:Label></td>
				</tr>
			</table>
            <div id="deleteBox" style="padding-left: 55px;">
                ...
                <div id="buttonPanel" style="padding-left: 55px;">
			        ...
			        <cc1:confirmedimagebutton id="ntnClose" runat="server" Message="NONE" CausesValidation="false"></cc1:confirmedimagebutton>
                </div>
            </div>
		</form>
	</body>
