<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Line_List_FlashEdit_Image.aspx.vb"
                                    ...
                                    <tr>
                                        <td valign="top">
                                            <asp:DataList ID="Datalist2" runat="server" EnableViewState="true" RepeatDirection="Horizontal"
                                                ...
                                                <ItemTemplate>
                                                    <table id="tbItem" runat="server" bordercolor='#CCCCCC' border="1" cellpadding="0" style="table-layout:fixed"
                                                        width="300px" cellspacing="0">
...
//            });
        ...
        function removeImage(obj) {
            ...
            imageSrc = imageSrc.replace("&S=200", "&S=200")
            ...
            $(function () {
                ...
                $(".droppable").droppable({
                    ...
                    drop: function (event, ui) {
                        ...
                        $(this).find('*[id*="lblAlias0"]').css("color", "red");
