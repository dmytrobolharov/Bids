<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="Line_List_Folder_FinancialRange_Grid.ascx.vb" Inherits="plmOnApp.Line_List_Folder_FinancialRange_Grid" %>
...
<asp:datagrid id="DataGrid1" runat="server" PageSize="1000" OnItemDataBound="DataGrid1_ItemDataBound"
		DataKeyField="LineFolderBusinessID" CellPadding="0" CellSpacing="2" BorderWidth="0" CssClass="fontHead" BackColor="#DFDFDF"
