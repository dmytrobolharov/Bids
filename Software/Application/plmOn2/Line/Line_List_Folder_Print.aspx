<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Line_List_Folder_Print.aspx.vb" Inherits="plmOnApp.Line_List_Folder_Print" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<asp:datagrid id="DataGrid1" runat="server" Width="100%" AutoGenerateColumns="False" PageSize="100"
				...
				<Columns>
					...
					<asp:TemplateColumn HeaderText="Select Line List...">
						<ItemTemplate>
