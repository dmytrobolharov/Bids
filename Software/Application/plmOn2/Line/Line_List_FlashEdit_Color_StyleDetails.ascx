<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="Line_List_FlashEdit_Color_StyleDetails.ascx.vb" Inherits="plmOnApp.Line_List_FlashEdit_Color_StyleDetails" %>
