<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Sourcing_StylePage_QuotationsEditor.aspx.vb" Inherits="plmOnApp.Sourcing_StylePage_QuotationsEditor" %>
...
<div id="FloatDG" runat="server" style="z-index:500; width:620px; position: absolute; left:0px; background-color:White;" >
    <div style="float:left; width:600px; height:100%;"><asp:PlaceHolder ID="plhQuoteGrid" runat="server" EnableViewState="False"></asp:PlaceHolder></div>
...
<div id="DimBOMEdit" style="padding-left:20px; background-color:White;"><asp:PlaceHolder ID="plhEdit" runat="server" EnableViewState="False"></asp:PlaceHolder></div>
</form>
<script type="text/javascript">
    function resizeGrid() {
