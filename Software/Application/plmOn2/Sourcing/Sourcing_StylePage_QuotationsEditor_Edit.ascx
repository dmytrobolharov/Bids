<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Sourcing_StylePage_QuotationsEditor_Edit.ascx.vb" Inherits="plmOnApp.Sourcing_StylePage_QuotationsEditor_Edit" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<asp:DataList ID="DataList1" runat="server" DataKeyField="StyleQuoteItemID" Width="100%">
    <ItemTemplate>
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
            <tr style="height:20px; vertical-align:middle;">
                <td colspan="2">
                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td>
                                <asp:PlaceHolder ID="plhQuoteDetailsForm" runat="server"></asp:PlaceHolder>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr style="background-color: White;">
                ...
                <td align="left" style="vertical-align:top;">
        	        <asp:datagrid id="DataGrid1" runat="server" DataKeyField="SourcingQuotationBOMDetailsID">
...
<script type="text/javascript">
    $(":text[id^=ctrQuoteEdit_DataList1]").change(function () { $(this).css("color", "red"); });
