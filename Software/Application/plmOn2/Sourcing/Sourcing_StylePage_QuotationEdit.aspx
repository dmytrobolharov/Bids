<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Sourcing_StylePage_QuotationEdit.aspx.vb" Inherits="plmOnApp.Sourcing_StylePage_QuotationEdit" %>
...
<body>
    ...
    <telerik:RadAjaxManager runat="server" ID="RadAjaxManager1" />
        ...
        <tr>
            ...
            <td width="100%">
                ...
                <cc1:BWImageButton ID="btnCopyQuote" runat="server" disabled="disabled"></cc1:BWImageButton>
										                            ...
										                            <tr>
											                            ...
											                            <td height="30">
												                            <table id="TbTrim" cellspacing="0" cellpadding="0" width="250" border="0" runat="server">
													                            <tr class="fontHead">
														                            <td>&nbsp;</td>
														                            <td noWrap width="85"><asp:Label ID="lblNoofRow" runat="server" ><%= GetSystemText("No. of Row(s)")%>:</asp:Label></td>
   ...
   <br />
        ...
        <tr>
            ...
            <table cellspacing="0" cellpadding="0" id="tblFlashQuantity" runat="server">
            <tr>
...
//                    parent.menu.showImage("<%= getStyleImageID()%>", "<%= getStyleName() %>");
                ...
                function validateBOM(source, args) {
                alert(sourse);
        ...
        <div id="sku-sync-confirm" style="display:none;">
            <%= GetSystemText("Are you sure you want to sync quantities with the Style SKU page? Any modifications made to these quantities in the quote will be lost.")%>
        </div>
		...
		<script language="javascript" type="text/javascript">
		    ...
		    function SelectAllDimension(sender, dimensionTableId) {
		        ...
		        $("#" + dimensionTableId + " :input[id*='chbDim']:enabled").each(function () {
