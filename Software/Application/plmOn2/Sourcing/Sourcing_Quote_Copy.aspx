<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Sourcing_Quote_Copy.aspx.vb" Inherits="plmOnApp.Sourcing_Quote_Copy" %>
...
<head runat="server">
    <title runat="server" id="pgTitle">Quote Copy</title>
    ...
    <table class="TableHeader" height="25" cellspacing="0" cellpadding="0" width="100%" border="0">
        <tr>
            ...
            <td width="100%">
                ...
                <cc1:confirmedimagebutton id="btnClose" runat="server" message="NONE" CausesValidation="false" OnClientClick="window.close();"></cc1:confirmedimagebutton>
            </td>
            <td>
                &nbsp;
            </td>
