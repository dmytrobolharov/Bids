<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Sourcing_CommitmentCalendar.aspx.vb" Inherits="plmOnApp.Sourcing_CommitmentCalendar" %>
    ...
    <div id="fixed_icons"><a href="../Help/Help_Folder.aspx?Folder=<%= Folder %>&HID=<%= HelpID %>" title="Help" target="_blank" id="yHelp"></a></div>
        ...
        <wc1:Color_Wait ID="Color_Wait" runat="server" />
			...
			<asp:panel id="Panel1" runat="server">
				...
				<asp:datagrid id="dgWorkflowSet1" runat="server" DataKeyField="SourcingCommitmentItemID" AllowSorting="False">
