<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Sourcing_PageQuote_Style_List_View.ascx.vb" Inherits="plmOnApp.Sourcing_PageQuote_Style_List_View" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<%@ Register TagPrefix="cc1" Namespace="Yunique.WebControls" Assembly="YSWebControls" %>

<script type="text/javascript" language="javascript" src="../System/Jscript/jquery-1.6.2.min.js"></script>
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $("select[id*=drlBOM]").each(function () {
...
<table class="TableHeader" height="25" cellspacing="0" cellpadding="0" width="100%" border="0" runat="server" style="vertical-align:middle;">
...
<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
	<TR vAlign="top">
		<TD>
			...
			<asp:datagrid id="DataGrid1" runat="server" DataKeyField="StyleID" EnableViewState="False" AllowSorting="true">
