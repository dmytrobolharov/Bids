...
<HEAD>
	<title runat="server" id="pgTitle">Commitment Editor</title>
...
<div id="FloatDG" runat="server" style="width:650px; z-index:500; position: absolute; left:0px;" >
    <div style="float:left; background-color:White; width:630px; height:100%;"><asp:PlaceHolder ID="plhQuoteGrid" runat="server" EnableViewState="False"></asp:PlaceHolder></div>
    <div id="FloatDGControl" style="float:right; cursor:pointer; width:20px; background-color:#6699FF; height:100%;"><span id="SliderHead" runat="server" style="-moz-transform: rotate(90deg); -webkit-transform: rotate(90deg); -o-transform: rotate(90deg); writing-mode: tb-rl; white-space:nowrap; padding: 4px 4px 0px 3px; font-size:12px; font-family:Arial; font-weight:bold; color:White; display:block;"></span></div>
</div>
