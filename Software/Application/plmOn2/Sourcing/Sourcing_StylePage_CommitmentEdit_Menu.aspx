<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Sourcing_StylePage_CommitmentEdit_Menu.aspx.vb" Inherits="plmOnApp.Sourcing_StylePage_CommitmentEdit_Menu" %>
        ...
        <table class="TableHeader" height="25" cellspacing="0" cellpadding="0" width="100%" border="0">
            <tr>
                ...
                <td valign="middle" align="left">
                    <div>
                        &nbsp;
                        <asp:ImageButton ID="btnSearch" runat="server" ImageUrl="../System/icons/icon_search.gif" OnClientClick="window.parent.location.href = 'Sourcing_Page_Folder.aspx'; return false;">
                        </asp:ImageButton>
                        &nbsp;
