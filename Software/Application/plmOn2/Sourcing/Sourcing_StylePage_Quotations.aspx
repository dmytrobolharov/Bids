...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Sourcing_StylePage_Quotations.aspx.vb" Inherits="plmOnApp.Sourcing_StylePage_Quotations" %>
        ...
        <table class="TableHeader" id="toolbar" cellspacing="0" cellpadding="0" width="100%"
            ...
            <tr valign="middle">
                ...
                <td width="700">
                    ...
                    <cc1:BWImageButton ID="btnQuick" runat="server" message="NONE"></cc1:BWImageButton>
                    ...
                    <cc1:BWImageButton ID="btnDelete" runat="server" message="NONE"></cc1:BWImageButton>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR vAlign="top">
					<TD>
                        ...
                        <td style="display: none"><asp:PlaceHolder runat="server" ID="plhQuotationsGrid"></asp:PlaceHolder></td>
				</TR>
			</TABLE>
		</form>
