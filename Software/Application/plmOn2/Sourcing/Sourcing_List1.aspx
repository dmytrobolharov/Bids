<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Sourcing_List1.aspx.vb" Inherits="plmOnApp.Sourcing_List1" %>
    ...
    <form id="form1" runat="server">
			...
			<TABLE id="TABLE1" class="TableHeader" cellSpacing="0" cellPadding="0" width="100%" border="0" runat="server">
				<TR vAlign="middle">
					...
					id="btnNewSourcing" runat="server"  ToolTip="Click here to add a new Sourcing..." Message="NONE"></cc1:confirmedimagebutton><cc1:confirmedimagebutton 
