<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Sourcing_Page_TradePartner_Remove.aspx.vb" Inherits="plmOnApp.Sourcing_Page_TradePartner_Remove" %>
    ...
    <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="SourcingTradePartnerID" BorderStyle="Solid"
        ...
        <Columns>
            <asp:TemplateColumn>
                ...
                <ItemTemplate>
                    <asp:CheckBox ID="chkSelected" runat="server" Enabled='<%# Convert.ToInt32(Eval("QuoteCount")) = 0 %>'></asp:CheckBox>
                </ItemTemplate>
            </asp:TemplateColumn>
        </Columns>
    </asp:DataGrid>
    ...
    <script type="text/javascript">
        ...
        function CheckAll(checkAllBox) {
            ...
            for (var i = 0; i < frm.length; i++) {
                ...
                if (e.type == 'checkbox' && e.name.indexOf("chkSelected") != -1 && !e.disabled)
                    e.checked = actVar;
            }
        }        
    </script>
