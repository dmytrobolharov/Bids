<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Sourcing_Page_TradePartner_Add.aspx.vb" Inherits="plmOnApp.Sourcing_Page_TradePartner_Add" %>
        ...
        <Columns>
            <asp:TemplateColumn>
                ...
                <ItemTemplate>
                    ...
                    <asp:HiddenField ID="hdnTradePartnerIDChain" runat="server" Value='<%# Eval("TradePartnerIDChain").ToString %>' />
                    <asp:HiddenField ID="hdnRelationshipLevelID" runat="server" Value='<%# Eval("RelationshipLevelID").ToString %>' />
                </ItemTemplate>
            </asp:TemplateColumn>
        </Columns>
    </asp:DataGrid>
