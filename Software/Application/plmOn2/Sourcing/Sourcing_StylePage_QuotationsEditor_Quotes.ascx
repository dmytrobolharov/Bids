<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Sourcing_StylePage_QuotationsEditor_Quotes.ascx.vb" Inherits="plmOnApp.Sourcing_StylePage_QuotationsEditor_Quotes" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<%@ Register TagPrefix="cc1" Namespace="Yunique.WebControls" Assembly="YSWebControls" %>

<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0" background-color:White;">
	<TR vAlign="top">
		<TD>
