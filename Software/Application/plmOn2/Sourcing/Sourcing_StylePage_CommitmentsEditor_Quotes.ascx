<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Sourcing_StylePage_CommitmentsEditor_Quotes.ascx.vb" Inherits="plmOnApp.Sourcing_StylePage_CommitmentsEditor_Quotes" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
	<TR vAlign="top">
		<TD>
			...
			<asp:datagrid id="DataGrid1" runat="server" DataKeyField="SourcingCommitmentItemID" width="100%">
...
<script type="text/javascript">
    ...
    function addScrollToTable() {
        ...
        var tableHeight = $("#FloatDG").height() - $("#tButtons").height() -$("#tNavigate").height() - $("#tPlh").height() - $(head).height();
