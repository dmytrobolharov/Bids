<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Sourcing_PageSample_Style_List_View.ascx.vb" Inherits="plmOnApp.Sourcing_PageSample_Style_List_View" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
