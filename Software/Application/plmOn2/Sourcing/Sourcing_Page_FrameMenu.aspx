<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Sourcing_Page_FrameMenu.aspx.vb" Inherits="plmOnApp.Sourcing_Page_FrameMenu" %>
...
<head runat="server">
    ...
    .footer {position:relative;margin-top:-290px;height:230px;}
   ...
   <table class="TableHeader" height="25" cellspacing="0" cellpadding="0" width="100%"
        ...
        <tr>
            ...
            <td width="100%" align="center">
               <asp:Label id="lblImage" runat="server">Style</asp:Label>&nbsp;&nbsp;
            </td>
        </tr>
        </table>
        <div align="center">
