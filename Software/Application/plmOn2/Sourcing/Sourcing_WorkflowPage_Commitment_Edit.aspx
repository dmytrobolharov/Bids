<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Sourcing_WorkflowPage_Commitment_Edit.aspx.vb" Inherits="plmOnApp.Sourcing_WorkflowPage_Commitment_Edit" %>
<%@ Register TagPrefix="cc1" Namespace="Yunique.WebControls.YSTab" Assembly="YSTab" %>
<%@ Register TagPrefix="uc1" TagName="Sourcing_Header" Src="~/Sourcing/Sourcing_Header.ascx" %>
    ...
    <div id="fixed_icons"><a href="../Help/Help_Folder.aspx?Folder=<%= Folder %>&HID=<%= HelpID %>" title="Help" target="_blank" id="yHelp"></a></div>
		<form id="Form1" method="post" runat="server">
            ...
            <table style="border-bottom: orange thin solid; border-left-style: none; height: 24px; background-color: white"
				...
				<tr>
					<td height="24">&nbsp;<asp:label id="lbHeader" runat="server" Font-Names="Tahoma,Verdana" Font-Size="X-Large" ForeColor="#E0E0E0"><%= GetSystemText("Commitment") %>&nbsp;<%= GetSystemText("Status") %></asp:label></td>
				</tr>
			</table>
			<uc1:Sourcing_Header id="Sourcing_Header1" runat="server" IsCollapsible="true" IsCollapsed="true"></uc1:Sourcing_Header>
			...
			<table width="100%" height="300" border="1" cellpadding="0" cellspacing="0" bordercolor="#cccccc">
				<tr>
					...
					<td valign="top"><table class="TableHeaderOver" height="24" cellspacing="0" cellpadding="0" width="100%"
						...
						<asp:DataGrid id="DataGrid1" runat="server" DataKeyField="SourcingCommitmentItemChangeID" BorderColor="#E0E0E0"
