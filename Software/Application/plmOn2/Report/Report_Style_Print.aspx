<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report_Style_Print.aspx.vb" Inherits="plmOnApp.Report_Style_Print" %>
		...
		<form id="Form1" method="post" runat="server">
		    ...
		    <TABLE cellSpacing="0" cellPadding="0" width="500" border="0">
			    <TR>
				    ...
				    <TD width="100">
					    <asp:Label id="lblTechPackLanguage" Runat="server" CssClass="fontHead"><%# GetSystemText("Language") & ":"%></asp:Label>
					</TD>
				    <TD width="400">
