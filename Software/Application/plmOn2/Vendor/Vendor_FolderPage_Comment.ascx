<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Vendor_FolderPage_Comment.ascx.vb" Inherits="plmOnApp.Vendor_FolderPage_Comment" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<asp:panel id="Panel1" runat="server" BackColor="#ffffff" Width="400" CssClass="font" BorderWidth="0">
	...
	<asp:datalist id="DataList1" runat="server" BorderWidth="0px" Width="100%" BorderColor="WhiteSmoke"
		...
		OnUpdateCommand="DataList_UpdateCommand" OnEditCommand="DataList_EditCommand" DataKeyField="TradePartnerCommentID">
		<HeaderTemplate>
		</HeaderTemplate>
		<FooterTemplate>
		</FooterTemplate>       
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<TR>
					<TD class="font" colSpan="2">
						<asp:Label id="lblTradePartnerComment" Runat="server">
							<%#Container.DataItem("TradePartnerComment")%>
						</asp:Label></TD>
				</TR>
			</TABLE>
			<BR>                  
				...
				<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
					...
					<TR>
						...
						<TD class="font" vAlign="top">
							<asp:TextBox id=txtComments runat="server" Width="350" Text='<%# DataBinder.Eval(Container.DataItem, "TradePartnerComment").ToString  %>' TextMode="MultiLine" ToolTip='<%#GetSystemText("Enter your comments here") & "..." %>' Height="150">
							</asp:TextBox></TD>
					<TR>
						<TD width="20">&nbsp;</TD>
						<TD class="font">
