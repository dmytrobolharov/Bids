<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Vendor_FolderPage_Capacity.aspx.vb" Inherits="plmOnApp.Vendor_FolderPage_Capacity" %>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR vAlign="top">
					<TD>
						...
						<asp:datagrid id="DataGrid1" runat="server" DataKeyField="TradePartnerCapacityId" AllowSorting="True">
