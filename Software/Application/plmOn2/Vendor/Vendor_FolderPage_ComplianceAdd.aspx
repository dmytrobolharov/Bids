<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Vendor_FolderPage_ComplianceAdd.aspx.vb" Inherits="plmOnApp.Vendor_FolderPage_ComplianceAdd" %>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE class="TableHeader" id="toolbar" cellSpacing="0" cellPadding="0" width="100%" border="0"
				...
				<TR vAlign="middle">
					...
					<TD><cc1:confirmedimagebutton id="btnClose" runat="server" Message="NONE"  CausesValidation="False" OnClientClick="return btnClose_Click()"></cc1:confirmedimagebutton>
					</TD>
				</TR>
			</TABLE>
