<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Vendor_Folder_New.aspx.vb"
    Inherits="plmOnApp.Vendor_Folder_New" %>
...
<body ms_positioning="GridLayout">
    ...
    <table class="TableHeader" id="toolbar" cellspacing="0" cellpadding="0" width="100%"
        ...
        <tr valign="middle">
            ...
            <td>
                <cc1:ConfirmedImageButton ID="btnClose" visible="false" runat="server" Message="NONE" CausesValidation="False" OnClientClick="return btnClose_Click()"></cc1:ConfirmedImageButton>
            </td>
        </tr>
    </table>
