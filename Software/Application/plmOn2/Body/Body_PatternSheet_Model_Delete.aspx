<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Body_PatternSheet_Model_Delete.aspx.vb" Inherits="plmOnApp.Body_PatternSheet_Model_Delete" %>
...
<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<table style="BORDER-BOTTOM: orange thin solid; BORDER-LEFT-STYLE: none; BACKGROUND-COLOR: white"
				...
				<tr>
					<td>&nbsp;<asp:label id="lblHeader" runat="server" Font-Size="Large" Font-Names="Tahoma,Verdana">Delete Model</asp:label></td>
				</tr>
			</table>
