<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Body_POMTemplate.aspx.vb" Inherits="plmOnApp.Body_POMTemplate" %>
						...
						<asp:datagrid id="DataGrid1" runat="server" DataKeyField="POMTempID" AutoGenerateColumns="False">
							...
							<Columns>
								<asp:TemplateColumn>
									...
									<ItemTemplate>
										<cc1:confirmedimagebutton id="imgBtnCopy" runat="server"  Message="Are you sure you want to copy this POM?"
											ToolTip="Click here to copy POM..."  CommandName="Copy"></cc1:confirmedimagebutton>
