<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Body_PatternSheet_Marker_Add.aspx.vb" Inherits="plmOnApp.Body_PatternSheet_Marker_Add" %>
...
<HEAD>
		<title runat="server" id="PageTitle">Body Marker</title>
...
<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<table style="BORDER-BOTTOM: orange thin solid; BORDER-LEFT-STYLE: none; BACKGROUND-COLOR: white"
				...
				<tr>
					<td>&nbsp;<asp:label id="lblHeader" runat="server" ForeColor="#E0E0E0" Font-Size="Medium" Font-Names="Tahoma,Verdana">Select Marker</asp:label></td>
				</tr>
			</table>
