<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Body_PatternSheet_Model_Select.aspx.vb"
    Inherits="plmOnApp.Body_PatternSheet_Model_Select" %>
...
<HEAD>
		<title runat="server" id="PageTitle">Body PatternSheet</title>
...
<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<table style="BORDER-BOTTOM: orange thin solid; BORDER-LEFT-STYLE: none; BACKGROUND-COLOR: white"
				...
				<tr>
					<td>&nbsp;<asp:label id="lblHeader" runat="server" Font-Size="Medium" Font-Names="Tahoma,Verdana">Select Model</asp:label></td>
				</tr>
			</table>
