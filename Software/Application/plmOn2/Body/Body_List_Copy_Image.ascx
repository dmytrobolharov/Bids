<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="Body_List_Copy_Image.ascx.vb" Inherits="plmOnApp.Body_List_Copy_Image" %>
	...
	<TR class="fontHead">
		...
		<TD width="20" height="25">
			<div align="center">
			    ...
			    <%--<a id="Previous" href="pagingdatalist.aspx#BookMark" OnServerClick="ShowPreviousPage"
