<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="Body_List_Copy_View.ascx.vb" Inherits="plmOnApp.Body_List_Copy_View" %>
		...
		<TD>
			...
			<asp:datagrid id="DataGrid1" runat="server" DataKeyField="BodyID" EnableViewState="False">
				...
				<Columns>
				    <asp:TemplateColumn>
				        <ItemTemplate>
				            <asp:Image runat="server" ID="imgBody"  /> 
				        </ItemTemplate>
				    </asp:TemplateColumn>
				</Columns>
			</asp:datagrid>
