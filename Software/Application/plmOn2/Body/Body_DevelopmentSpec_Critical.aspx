<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Body_DevelopmentSpec_Critical.aspx.vb" Inherits="plmOnApp.Body_DevelopmentSpec_Critical" %>
...
<head runat="server">
    <title id="titleCritical" runat="server">Critical POM</title>
