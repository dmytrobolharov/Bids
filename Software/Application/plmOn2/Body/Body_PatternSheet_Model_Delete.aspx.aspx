<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Body_PatternSheet_Model_Delete.aspx.aspx.vb" Inherits="plmOnApp.Body_PatternSheet_Model_Delete_aspx" %>
...
<HEAD>
		<title runat="server" id="PageTitle">Delete Model</title>
		...
		<form id="Form1" method="post" runat="server">
			<table class="TableHeader" id="toolbar" cellSpacing="0" cellPadding="0" width="100%" border="0"
				...
				<tr vAlign="middle">
					...
					<td><cc1:confirmedimagebutton id="btnDelete" runat="server" Message="NONE" ImageUrl="../System/Button/ButtonStream.ashx?BN=btn_delete.gif"></cc1:confirmedimagebutton><cc1:confirmedimagebutton id="btnClose" runat="server" Message="NONE" ImageUrl="../System/Button/ButtonStream.ashx?BN=btn_close.gif"></cc1:confirmedimagebutton></td>
					<td width="40"></td>
					<td></td>
				</tr>
			</table>
			<table style="BORDER-BOTTOM: orange thin solid; BORDER-LEFT-STYLE: none; BACKGROUND-COLOR: white"
				...
				<tr>
					<td>&nbsp;<asp:label id="lblHeader" runat="server" ForeColor="#E0E0E0" Font-Size="Medium" Font-Names="Tahoma,Verdana">Delete Model</asp:label></td>
				</tr>
			</table>
		...
		<SCRIPT language="javascript">
		    ...
		    function CheckAll(checkAllBox) {
		        ...
		        for (i = 0; i < frm.length; i++) {
		            e = frm.elements[i];
		            if (e.type == 'checkbox' && e.name.indexOf("chbModel_Code") != -1)
		                e.checked = actVar;
		        }
		    }
