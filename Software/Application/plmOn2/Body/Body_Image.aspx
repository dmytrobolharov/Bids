<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Body_Image.aspx.vb" Inherits="plmOnApp.Body_Image" %>
    ...
    <form id="form1" runat="server">
        ...
        <table height="25" cellSpacing="0" cellPadding="1" width="100%" border="0">
				<tr class="TableHeader" bgColor="whitesmoke">
					...
					<td class="fonthead"><cc1:confirmedimagebutton id="imgBtnFolderImage" runat="server" Message="NONE"></cc1:confirmedimagebutton>
					<cc1:confirmedimagebutton id="imgBtnEditImage" runat="server" Message="NONE"></cc1:confirmedimagebutton>
					...
					<cc1:confirmedimagebutton id="imgBtnCopyImage" runat="server" DESIGNTIMEDRAGDROP="18"></cc1:confirmedimagebutton>
					<cc1:confirmedimagebutton id="imgBtnDeleteImage" runat="server" CausesValidation="False"></cc1:confirmedimagebutton>
						...
						<table cellSpacing="0" cellPadding="0" width="100%" >
							<tr><td colspan="3"><table height="25" cellSpacing="0" cellPadding="0" width="100%" bgColor="whitesmoke" border="0">
								<tr class="TableHeader">
									<td style="WIDTH: 11px" vAlign="middle" align="center" width="11"><IMG height="15" src="../System/Images/bbTbSCnr.gif" width="3"></td>
									<td>&nbsp;<asp:Label id="lblImage" runat="server" Text="Image..." /></td>
								</tr>
								</table>
							</td>
							</tr>
					...
					<td vAlign="top" bgColor="#ffffff"><asp:panel id="pnlProperty" runat="server">
							<TABLE height="25" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR class="TableHeader" bgColor="whitesmoke">
									...
									<TD class="fonthead"><asp:Label id="lblImageProperty" runat="server" Text="Image Property..." /></TD>
								</TR>
							</TABLE>
							...
							<TABLE height="75" cellSpacing="0" cellPadding="1" width="100%" border="0">
								<TR bgColor="#ffffff">
									...
									<TD class="fontHead" width="125">&nbsp;<asp:Label id="lblImageFile" runat="server" Text="Image File" /></TD>
						...
						<table height="25" cellSpacing="0" cellPadding="1" width="100%" border="0">
							<tr class="TableHeader" bgColor="whitesmoke">
								<td width="10">&nbsp;</td>
								<td class="fonthead"><asp:Label id="lblImageHistory" runat="server" Text="Image History..." /></td>
							</tr>
						</table>
						<table cellSpacing="0" cellPadding="1" width="100%" border="0">
							<tr>
								<td vAlign="top"><asp:datalist id="DataList1" runat="server" ShowHeader="False" ShowFooter="False" RepeatDirection="Horizontal"
										...
										<ItemTemplate>
											<TABLE cellSpacing="0" cellPadding="1" width="125" border='<%# SelectHTMLImageCurrentVersion(DataBinder.Eval(Container.DataItem,"Version")) %>' bordercolor=CornflowerBlue>
												...
												<TR bgColor="#ffffff">
													<TD class="font" vAlign="middle" align="center">Last Modified:<%# SystemHandler.GetLocalTime(DataBinder.Eval(Container.DataItem,"MDate"))%></TD>
												</TR>
											</TABLE>
										</ItemTemplate>
									</asp:datalist></td>
