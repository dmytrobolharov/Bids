<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Color_PaletteMultipleAttachment.aspx.vb"
    Inherits="plmOnApp.Color_PaletteMultipleAttachment" %>
...
<body ms_positioning="GridLayout">
    ...
    <table class="TableHeader" id="toolbar" cellspacing="0" cellpadding="0" width="100%"
        ...
        <tr valign="middle">
            ...
            <img alt= ""  runat="server"   id='imgAttachFile' style="display: none;" onclick="Upload_Click();return false;" /> 
...
//        btnAdd.style.display = files.length > 0 ? "" : "none";
