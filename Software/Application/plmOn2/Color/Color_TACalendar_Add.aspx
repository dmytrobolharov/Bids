...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Color_TACalendar_Add.aspx.vb" Inherits="plmOnApp.Color_TACalendar_Add" %>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR vAlign="top">
					<TD>
						...
						<asp:datagrid id="dgWorkflowSet1" runat="server" DataKeyField="TACalTemplateId" AllowSorting="true">
