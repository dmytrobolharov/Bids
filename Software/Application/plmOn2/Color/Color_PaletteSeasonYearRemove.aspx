...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Color_PaletteSeasonYearRemove.aspx.vb" Inherits="plmOnApp.Color_PaletteSeasonYearRemove" %>
    ...
    <div id="fixed_icons"><a href="../Help/Help_Folder.aspx?Folder=<%= Folder %>&HID=<%= HelpID %>" title="Help" target="_blank" id="yHelp"></a></div>
		<form id="Form1" method="post" runat="server" defaultbutton="imgBtnSearch">
            ...
            <table class="TableHeader" cellspacing="0" cellpadding="0" width="100%" border="0">
	            <tr>
		            <td align="center" width="10"><IMG height="15" src="../System/Images/bbTbSCnr.gif" width="3"></td>
		            <td class="fonthead" height="20"><asp:label id="lblColorHeader" runat="server" CssClass="fontHead" Text="Color List..."></asp:label></td>
	            </tr>
            </table>			
			            ...
			            <tr>
			                <td>
			                    <%--<cc1:ScrollingGrid ID="sgColorPaletteGrid" runat="server" Width="800" ScrollBars="Auto" Height="600">--%>
                                    <asp:datagrid id="DataGrid1" runat="server"  EnableViewState="true" DataKeyField="ColorPaletteID">
