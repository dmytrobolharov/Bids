...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Color_PaletteSeasonYearAdd.aspx.vb" Inherits="plmOnApp.Color_PaletteSeasonYearAdd" %>
			...
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				<tr valign="top">
					<td>
						...
						<tr>
							<td>
								<%--<cc1:ScrollingGrid ID="sgColorPaletteGrid" runat="server" Width="800" ScrollBars="Both" Height="600">--%>
