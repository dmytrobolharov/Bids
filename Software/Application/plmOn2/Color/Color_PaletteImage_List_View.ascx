<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="Color_PaletteImage_List_View.ascx.vb"
    Inherits="plmOnApp.Color_PaletteImage_List_View" %>
        ...
        <td>
            <table class="TableHeader" height="25" cellspacing="0" cellpadding="0" width="100%"
                ...
                <tr valign="middle">
                    ...
                    <td width="10">
                        <asp:Button ID="Button1" runat="server" CssClass="fontHead" Text="GO">
                        </asp:Button>
                    </td>
                </tr>
            </table>
            <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="ImageID" AllowSorting="True"
                ...
                <Columns>
                    <asp:TemplateColumn>
                        ...
                        <ItemTemplate>
                            <div align="center">
                                <input type="checkbox" id="chkSelect" name="chkSelect" runat="server" onclick="CheckSelect(this);" />
                                <input type="radio" id="rbSelect" name="rbSelect" runat="server" onclick="javascript:RadioSelect(this.id)"/>
                                <input type="hidden" id="ImageVersion" runat="server" /></div>
                        </ItemTemplate>
                    </asp:TemplateColumn>
                    <asp:TemplateColumn>
                        <HeaderTemplate>
