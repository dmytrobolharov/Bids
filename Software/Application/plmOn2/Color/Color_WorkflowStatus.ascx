<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="Color_WorkflowStatus.ascx.vb" Inherits="plmOnApp.Color_WorkflowStatus" %>
...
<table class="TableHeader" height="25" cellSpacing="0" cellpadding="0" width="100%" border="0">
	<tr>
		...
		<td class="fontHead" valign="middle">
            <asp:label id="lblHeader" runat="server"><%= GetSystemText("Color Palette")%></asp:label>&nbsp;
