<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CalendarPopup.aspx.vb" Inherits="plmOnApp.CalendarPopup" %>
...
<HTML>
	...
	<body>
			...
			<div align="center" >
                    ...
                    <asp:CheckBox ID="chkForceParentPostback" runat="server" Visible="false" />
			</form>
	</body>
</HTML>
