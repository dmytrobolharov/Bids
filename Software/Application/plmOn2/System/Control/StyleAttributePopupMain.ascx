<%@ Control Language="vb" AutoEventWireup="false" Codebehind="StyleAttributePopupMain.ascx.vb" Inherits="plmOnApp.StyleAttributePopupMain" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<table style="BORDER-BOTTOM: orange thin solid; BORDER-LEFT-STYLE: none; BACKGROUND-COLOR: white"
	...
	<tr>
		...
		<td class="fonthead">
			&nbsp;<asp:Label ID="lblSelSt" runat="server" Text="Please select style attributes..."></asp:Label></td>
	</tr>
</table>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" align="center" bgColor="#ffffff" border="0">
				<TR>
					...
					<TD align="center" width="200"><FONT face="Microsoft Sans Serif" color="#000000" size="2"><B class="fonthead">
								<asp:Label ID="lblAttribute" runat="server" Text="Attribute"></asp:Label>&nbsp;<asp:Label ID="lblAvailable" runat="server" Text="Available"></asp:Label></B></FONT></TD>
					<TD width="50"></TD>
					<TD align="center" width="200"><FONT face="Microsoft Sans Serif" color="#000000" size="2"><B class="fonthead">
								<asp:Label ID="lblAttribute1" runat="server" Text="Attribute"></asp:Label>&nbsp;<asp:Label ID="lblSelected" runat="server" Text="Selected"></asp:Label> </B></FONT>
					</TD>
					<TD>&nbsp;</TD>
					<TD>&nbsp;</TD>
				</TR>
