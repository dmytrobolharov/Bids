<%@ Page Language="vb" AutoEventWireup="false" Codebehind="_QuotaPopup.aspx.vb" Inherits="plmOnApp.ctrlQuotaPopup"   %>
...
<HTML>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<table height="15" cellSpacing="0" cellPadding="0" width="100%" bgColor="orange" border="0">
				<tr>
					<td></td>
				</tr>
			</table>
					...
					<TD>
						...
						<table>
							<tr>
								...
								<TD width="10"><asp:imagebutton id="btnImgSearch" runat="server" ImageUrl="../Icons/icon_search.gif"></asp:imagebutton></TD>
								<TD width="10">&nbsp;</TD>
								...
								<TD width="50">&nbsp;</TD>
								<TD class="fontHead" noWrap>Rec per page:</TD>
