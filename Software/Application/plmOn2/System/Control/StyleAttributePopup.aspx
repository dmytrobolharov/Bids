...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="StyleAttributePopup.aspx.vb" Inherits="plmOnApp.StyleAttributePopup" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
	    <title runat="server" id="PageTitle">Style Attribute</title>		
