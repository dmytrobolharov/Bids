<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="IntellimasPopup.aspx.vb" Inherits="plmOnApp.IntellimasPopup" %>
...
<body>
    ...
    <ul class="intellimas-links">
        <li><asp:HyperLink runat="server" ID="hypIntellimasClient" Text="Client" Target="_blank"></asp:HyperLink></li>
        <li><asp:HyperLink runat="server" ID="hypIntellimasAdmin" Text="Administration" Target="_blank"></asp:HyperLink></li>
        <li><asp:HyperLink runat="server" ID="hypIntellimasLicense" Text="Apply License" Target="_blank"></asp:HyperLink></li>
    </ul>
    </form>
</body>
</html>
