<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CustomPopup_NewCosting.aspx.vb" Inherits="plmOnApp.CustomPopup_NewCosting"   %>
...
<html xmlns="http://www.w3.org/1999/xhtml" >
	<HEAD>
	    ...
	    <script language="javascript" type="text/javascript" src="../jscript/FillDRL.js"></script>
		...
		<script language="javascript">
		    function SelectWindowCustom(sValue, sTxtBox) {
		        if (window.opener.document.Form1[sTxtBox] != null) {
		            ...
		            window.opener.CopyValuesFromWindowboxes();
		        }
		    }

		    function SelectWindowCustomNoCopy(sValue, sTxtBox) {
		        if (window.opener.document.Form1[sTxtBox] != null) {
		            window.opener.document.Form1[sTxtBox].value = sValue;
		        }
		    }
