<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Planning_Folder_ViewStyle2Flash.ascx.vb" Inherits="plmOnApp.Planning_Folder_ViewStyle2Flash" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<TABLE borderColor="gainsboro" cellSpacing="1" cellPadding="0" border="0">
	<TR>
		<TD vAlign="top" id="style-list-container"><asp:datalist id="Datalist1" runat="server" DataKeyField="PlanningItemID" RepeatLayout="Flow" 
