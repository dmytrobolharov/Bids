...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Planning_Folder_Material_Plan.aspx.vb" Inherits="plmOnApp.Planning_Folder_Material_Plan" %>
		...
		<form id="Form1" method="post" runat="server">
			<table class="TableHeader" id="toolbar" cellspacing="0" cellpadding="0" width="100%" border="0"
				...
				<tr valign="middle">
					...
					<td valign="top">
                        <cc1:BWImageButton id="btnMaterialAdd" runat="server" CausesValidation="false" Visible="false"></cc1:BWImageButton>
                        <cc1:confirmedimagebutton id="btnMaterialDrop" runat="server" Message="NONE" Visible="false"></cc1:confirmedimagebutton>
                        <cc1:ConfirmedImageButton ID="btnMaterialRemove" runat="server" Visible="false"></cc1:ConfirmedImageButton>
