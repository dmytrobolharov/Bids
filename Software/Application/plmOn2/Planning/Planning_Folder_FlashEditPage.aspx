<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Planning_Folder_FlashEditPage.aspx.vb" Inherits="plmOnApp.Planning_Folder_FlashEditPage" %>
...
<html>
    ...
    <div id="fixed_icons"><a href="../Help/Help_Folder.aspx?Folder=<%= Folder %>&HID=<%= HelpID %>" title="Help" target="_blank" id="yHelp"></a></div>
        ...
        <telerik:RadAjaxManager runat="server" ID="RadAjaxManager1" />
            ...
            <asp:PlaceHolder runat="server" ID="plhRadGrid" EnableViewState="false"></asp:PlaceHolder>
    </form>
