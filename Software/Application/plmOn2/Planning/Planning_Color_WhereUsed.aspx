<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Planning_Color_WhereUsed.aspx.vb" Inherits="plmOnApp.Planning_Color_WhereUsed" %>
...
<div id="fixed_icons"><a href="../Help/Help_Folder.aspx?Folder=<%= Folder %>&HID=<%= HelpID %>" title="Help" target="_blank" id="yHelp"></a></div>
    ...
    <table class="TableHeader" id="toolbar" cellspacing="0" cellpadding="0" width="100%" border="0" runat="server">
        <tr valign="middle">
            ...
            <td valign="top">
                <cc1:confirmedimagebutton id="btnColorReplace" runat="server" message="NONE" OnClientClick="return ReplaceButtonClick();"></cc1:confirmedimagebutton>
    ...
    <table class="TableHeader" cellpadding="0" cellspacing="" width="100%">
        <tr>
            ...
            <td><%= GetSystemText("Selected Colors")%></td>
            <td>
                <asp:RadioButtonList ID="rbColorOption" RepeatLayout="Flow" RepeatDirection="Horizontal" runat="server"></asp:RadioButtonList>
            </td>
        </tr>
    </table>
    ...
    <div class="slider-container">
                    ...
                    <table style="border-bottom: orange thin solid; border-left-style: none; background-color: white" height="45"
                        ...
                        <tr>
                            <td class="droppable" width="100%">
                                <asp:DataList ID="dlColors" runat="server" DataKeyField="PlanningColorID" RepeatLayout="Flow" RepeatDirection="Horizontal">
                                    ...
                                    <ItemTemplate>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td style="padding: 2px;"><%# Eval("ColorCode")%><br /><%# Eval("ColorName")%></td>
                                            </tr>
                                        </table>
                                    </ItemTemplate>
                                </asp:DataList>&nbsp;
                                <asp:Panel ID="DnDWatermark" runat="server"><%= GetSystemText("Drag & Drop Colors Here")%></asp:Panel>
                            </td>
                        </tr>
                    </table>
        ...
        <div id="FloatDG" runat="server">
            <div id="FloatDGControl">
                <span id="SliderHead"><%= GetSystemText("Select Color")%></span>
            </div>
            <div id="FloatDGMain">
                        ...
                        <table cellspacing="0" cellpadding="0" width="100%" border="0">
                            <tr valign="top">
                                <td>
                                    ...
                                    <asp:DataGrid ID="dgColors" runat="server" DataKeyField="PlanningColorID" BorderStyle="Solid" BorderWidth="1px" Width="100%" AllowPaging="true" EnableViewState="true">
                                        ...
                                        <Columns>
                                            <asp:TemplateColumn ItemStyle-BorderWidth="1" ItemStyle-BorderColor="Gainsboro" HeaderStyle-Width="20px">
                                                ...
                                                <ItemTemplate>                                            
                                                    ...
                                                    <asp:HiddenField ID="hdnPlanningColorID" runat="server" Value='<%# Eval("PlanningColorID") %>' />
                                                    <img class="drag-helper" src='<%# GetColorStreamPath("50", Eval("ColorFolderID").ToString, Eval("ColorPaletteID").ToString)%>' alt="" />
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
                                            <asp:TemplateColumn ItemStyle-BorderWidth="1" ItemStyle-BorderColor="Gainsboro" HeaderStyle-Width="20px">
                                                <HeaderTemplate>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Image ImageUrl="../System/Icons/icon_drop.gif" AlternateText="Dropped" Visible='<%# Eval("PlanningColorDrop") %>'
    ...
    <div id="dialog-message" style="display: none;"><p><%= GetSystemText("Please select colors and styles before clicking the replace color button")%></p></div>
    ...
    <script type="text/javascript">
        ...
        function WireEvents() {
            ...
            $(".droppable").droppable({
                ...
                drop: function (event, ui) {
                    var PlanninColorID = ui.draggable.find("[id*='hdnPlanningColorID']").val();
                    <%= GetPostBackEventReference(btnColorSelect, "PlanninColorID").Replace("'PlanninColorID'", "PlanninColorID") %>;
                }
            });
            ...
            $(".color-item").droppable({
                ...
                tolerance: 'intersect',
                drop: function (event, ui) {
                    var PlanninColorID = ui.draggable.find("[id*='hdnPlanningColorID']").val() + ',' + $(this).find("[id*='hdnPlanningColorID']").val();
                    <%= GetPostBackEventReference(btnColorSelect, "PlanninColorID").Replace("'PlanninColorID'", "PlanninColorID") %>;
                }
            });
        ...
        function RadGridMaterials_ColumnHidden(sender, eventArgs) {
            ...
            var strHiddenColumns = hiddenColumns.join();
            PageMethods.SaveHiddenColumns('RadGridMaterials', '<%= aspxPageName & "?PLID=" & _PlanningID %>', strHiddenColumns, '<%= UserProperties.TeamID %>', '<%= UserProperties.Username %>');
        }
