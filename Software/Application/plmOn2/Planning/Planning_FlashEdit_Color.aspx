<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Planning_FlashEdit_Color.aspx.vb" Inherits="plmOnApp.Planning_FlashEdit_Color" %>
	...
	<body style="background-color: White;">
        ...
        <telerik:RadWindowManager ID="RadWindowManager1" runat="server">
            <Windows>            
                <telerik:RadWindow ID="DroppedColorways" runat="server" Title="Dropped Colorways" Height="300px" Width="600px"
                    ReloadOnShow="true" ShowContentDuringLoad="false" NavigateUrl="Planning_FlashEdit_Color_Dropped.aspx"
        ...
        <script type="text/javascript" language="javascript">
            ...
            $(document).ready(function () {
                ...
                $("#resizableTable").height($(window).height() - 18);
            ...
            */
            function addColorForSaving(styleCheckbox, colorInfo) {
                var $styleCheckbox = $(styleCheckbox);
                ...
                $(function () {
                    ...
                    $(".droppable").droppable({
                        ...
                        drop: function (event, ui) {
                            var chkSelectStyle = $(this).find("input[id*='chkSelectStyle']")[0];
                            chkSelectStyle.checked = true;
                            var colorInfo = getColorInfo($(ui.draggable).find("input[id*='chkSelectColor']"));
                            addColorToStyles(colorInfo);
                            chkSelectStyle.checked = false;
                        }
                    });
