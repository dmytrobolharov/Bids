<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Planning_Callendar_Add.aspx.vb" Inherits="plmOnApp.Planning_Callendar_Add" %>
					...
					<TD>
						...
						<asp:datagrid id="dgCalendars" runat="server" DataKeyField="TACalTemplateId" AllowSorting="False">
                            ...
                            <Columns>
                                <asp:TemplateColumn>
                                    <HeaderTemplate>
                                        <asp:CheckBox ID="chkSelectAll" runat="server" onclick="SelectAll(this)" Visible='<%# Not IsCopy %>' />
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <asp:Panel runat="server" Wrap="false" Visible='<%# IsCopy %>'>
                                            <input type="radio" name="rbSelect" value='<%# Eval("TACalTemplateId").ToString %>' />
                                        </asp:Panel>
                                        <asp:CheckBox ID="chkSelect" runat="server" Visible='<%# Not IsCopy %>' />                                        
                                    </ItemTemplate>
                                 </asp:TemplateColumn>
				            </Columns>
