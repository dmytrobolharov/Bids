<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Planning_Folder_Calendars_Edit.aspx.vb" Inherits="plmOnApp.Planning_Folder_Calendars_Edit" %>
            ...
            <td>
                <asp:DataGrid ID="DataGrid1" runat="server" AllowSorting="False" DataKeyField="PlanningTACalendarID">
                    ...
                    <Columns>
                        <asp:TemplateColumn>
                            <ItemTemplate>
                                <asp:HiddenField ID="hdnChangeLogHeader" runat="server" Value='<%# eval("TACalTemplateName") %>' />
                            </ItemTemplate>
                        </asp:TemplateColumn>
                    </Columns>                   
                </asp:DataGrid>
