...
<div id="fixed_icons"><a href="../Help/Help_Folder.aspx?Folder=<%= Folder %>&HID=<%= HelpID %>" title="Help" target="_blank" id="yHelp"></a></div>
    <form id="form1" runat="server" defaultbutton="imgBtnSearch">
        ...
        <asp:DataList ID="dlColors" runat="server" DataKeyField="ColorPaletteID" RepeatLayout="Flow" RepeatDirection="Horizontal" BackColor="White">
		...
		<table cellspacing="0" cellpadding="0" width="100%" border="0">
			<tr valign="top">
				<td>
                <asp:UpdatePanel ID="pnlColor" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
					<table class="TableHeader" height="25" cellspacing="0" cellpadding="0" width="100%" bgColor="#ffffff"
						border="0">
						<tr valign="middle">
							<td valign="middle" align="center" width="10"><IMG height="15" src="../System/Images/bbTbSCnr.gif" width="3"></td>
                            <td width="100" runat="server" id="tdThumbnail" visible="true"><asp:CheckBox runat="server" id="chbThumbnail" AutoPostBack="true" Checked="true"/></td>
					...
					<asp:datagrid id="DataGrid1" runat="server" AllowSorting="True" AllowPaging="true" DataKeyField="PlanningColorID">
        ...
        <script type="text/javascript">
            ...
            if ($("#dlColors [id*='chkSelect']").length == 1)
            {
                ...
                $("#dlColors [id*='chkSelect']").click(function (e) { e.preventDefault(); })
            }

            function ReplaceButtonClick() {
                if ($("#dlColors [id*='chkSelect']:checked").length > 0 & $("#DataGrid1 [name*='rdbPlanningColorID']:checked").length > 0) {
                    return true;
                }
                else {
                    ShowReplaceMessage();
