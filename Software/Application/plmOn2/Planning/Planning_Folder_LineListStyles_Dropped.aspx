<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Planning_Folder_LineListStyles_Dropped.aspx.vb" Inherits="plmOnApp.Planning_Folder_LineListStyles_Dropped" %>
...
<div id="fixed_icons"><a href="../Help/Help_Folder.aspx?Folder=<%= Folder %>&HID=<%= HelpID %>" title="Help" target="_blank" id="yHelp"></a></div>
    ...
    <table class="TableHeader" id="toolbar" cellspacing="0" cellpadding="0" width="100%" border="0" runat="server">
        <tr valign="middle">
            ...
            <td>                
                <cc1:ConfirmedImageButton ID="btnActive" runat="server" Message="NONE"></cc1:ConfirmedImageButton>
    ...
    <table bordercolor="gainsboro" cellspacing="1" cellpadding="0" border="0">
        <tr>
            <td valign="top">
                <asp:DataList ID="Datalist1" runat="server" DataKeyField="LineFolderItemID" RepeatLayout="Table" RepeatColumns="1" RepeatDirection="Horizontal" EnableViewState="false">
