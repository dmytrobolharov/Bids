	...
	<script type="text/javascript">
	    ...
	    function sortRows2(txtSort) {
	       ...
	       // var allRows = currentTable.get(0).rows;
	        ...
	        var lastRowVal = parseInt(currentTable.find('li:last').find('input[name*="txtPlanningItemSort"]').val(), 10);
	        ...
	        if (!wasInserted) {
	            ...
	            $('li.ui-state-default').each(function () {
	                if (!wasInserted) {
	                    ...
	                    var txtCurrentSort = $(this).find('input[name*="txtPlanningItemSort"]');
	       ...
	       // processRowDrop($("#DataGrid1").get(0), draggingRow);
	        ...
	        $('li').each(function () {
	            ...
	            $(this).find('table').find('input[id*="PlanningItemSort"]').val(newSort);
	    ...
	    $(window).load(function () {
	        ...
	        //hide id field
	        $('li').each(function () {
	            $(this).find('table').find('input[id*="PlanningItemID"]').closest('tr').hide();
	            ...
	            $('<input type="hidden" name="hdnsort" value="' + $(this).find('table').find('input[id*="PlanningItemSort"]').val() + '"/>').insertAfter($(this).find('table').find('input[id*="PlanningItemSort"]'));
	        ...
	        $('li').each(function () {
	            ...
	            $(this).find('table').find('input[id*="PlanningItemSort"]').bind('blur', function () {
	                sortRows2(this);
	            });
	        });
	        ...
	        $('li').each(function () {
	            ...
	            $(this).find('table').find('input[id*="PlanningItemSort"]').css("width", "50px");
		...
		<form id="Form1" method="post" runat="server">
            ...
            <table class="TableHeader" height="25" cellSpacing="0" cellPadding="0" width="100%" bgColor="#ffffff"
				...
				<tr vAlign="middle">
					...
					<td><asp:checkbox id="cbThumbnail" AutoPostBack="True" runat="server" Checked="True"></asp:checkbox> <asp:Label ID="lblQryThumbnail" runat="server" 
			...
			<asp:datagrid id="DataGrid1" runat="server" Width="300px" BorderColor="#E0E0E0" BorderStyle="Solid"
				BorderWidth="1px" PageSize="100" AutoGenerateColumns="False" DataKeyField="PlanningItemID">
                ...
                <asp:TemplateColumn ItemStyle-CssClass="dropimage">
                    ...
                    <asp:TemplateColumn HeaderText="Design Image">						
						<ItemTemplate>
                        <img src="../../plmOnImageServer/ImageStream.ashx?S=50&V= <%# DataBinder.Eval(Container.DataItem, "DesignSketchVersion").ToString%>&IID=<%# DataBinder.Eval(Container.DataItem, "DesignSketchID").ToString%>" />
						</ItemTemplate>
					</asp:TemplateColumn>
					<asp:TemplateColumn HeaderText="Style No">						
						<ItemTemplate>
							<%#DataBinder.Eval(Container.DataItem,"StyleNo").tostring%>
						</ItemTemplate>
					</asp:TemplateColumn>
					...
					<asp:TemplateColumn HeaderText="Dropped">
						<ItemTemplate>
							<%# DataBinder.Eval(Container.DataItem, "PlanningItemDrop").ToString%>
						</ItemTemplate>
					</asp:TemplateColumn>
					<asp:TemplateColumn HeaderText="Sort">						
						<ItemTemplate>
							<asp:TextBox Runat="server" ID="txtSort" Text='<%#DataBinder.Eval(Container.DataItem,"PlanningItemSort").tostring%>' Width="40" MaxLength="4">
							</asp:TextBox>
                             <asp:HiddenField runat="server" ID="hdnSort" Value='<%#DataBinder.Eval(Container.DataItem,"PlanningItemSort").tostring%>' />
						</ItemTemplate>
					</asp:TemplateColumn>
				</Columns>
			</asp:datagrid>
         ...
         <script type="text/javascript">
             ...
             $(document).ready(function () {
                 ...
                 $('#repeater1 span[id*=lbl]').css("white-space", "nowrap");
             });
