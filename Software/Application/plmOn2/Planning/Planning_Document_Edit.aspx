<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Planning_Document_Edit.aspx.vb" Inherits="plmOnApp.Planning_Document_Edit"%>
						...
						<TD vAlign="top">
							<TABLE cellSpacing="0" cellPadding="0" width="400" border="0">
								<TR>
									...
									<TD class="font"><INPUT class="font" id="txtNewPlanningDocumentPath" type="file" name="txtPlanningDocumentPath"
											runat="server">
										<asp:RequiredFieldValidator id="rvNewFileRquired" runat="server" CssClass="fontHead" ControlToValidate="txtNewPlanningDocumentPath"
...
<%--									<TD class="fontHead" colSpan="2" height="35">&nbsp;&nbsp;
        ...
        <table bordercolor="#999999" cellspacing="0" cellpadding="0" width="100%" border="0">
			<asp:datalist id="DataList1" runat="server" Width="100%" OnDeleteCommand="DataList_DeleteCommand"
				...
				DataKeyField="PlanningDocumentID" BackColor="White" BorderColor="WhiteSmoke" BorderStyle="Solid" BorderWidth="1px">
				<HeaderTemplate>
						<tr class="Toolbar">
...
<%--							<td class="fontHead" width="100"><%=GetSystemText("File Shared")%></td>--%>
                            <td class="fontHead" width="100"><%= GetSystemText("File Attached By")%></td>
                            <td class="fontHead" width="125"><%= GetSystemText("File Attached Date")%></td>
				...
				<ItemTemplate>
						<TR>
							...
							<TD class="font" width="200"><%# Container.DataItem("PlanningDocumentName")%></TD>
							<TD class="font" width="200"><%# Container.DataItem("PlanningDocumentDescription").Replace(vbCrLf, "<BR>").ToString%></TD>
							<TD class="font" width="100"><%# Container.DataItem("PlanningDocumentSize")%></TD>
							...
							<TD vAlign="top" width="400">
								<TABLE cellSpacing="0" cellPadding="0" width="400" border="0">
									<TR>
										...
										<TD class="font">
											<asp:Label id=lblFileName runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "PlanningDocumentName").ToString  %>'>
											</asp:Label>
                                            <asp:HiddenField runat="server" ID="hdnlblFileName" Value='<%# DataBinder.Eval(Container.DataItem, "PlanningDocumentName").ToString  %>' />
                                            </TD>
									</TR>
									<TR>
										<TD width="10">&nbsp;</TD>
										...
										<TD class="font">
											<asp:TextBox id=txtFileDescription runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "PlanningDocumentDescription").ToString  %>' Width="250" Columns="50" Wrap="false" ToolTip='<%#GetSystemText("Enter file description here") & "..."%>' TextMode="MultiLine" Rows="5">
											</asp:TextBox>
                                            <asp:HiddenField runat="server" ID="hdnFileDescription" Value='<%# DataBinder.Eval(Container.DataItem, "PlanningDocumentDescription").ToString  %>' />
                                            </TD>
									</TR>
								</TABLE>
							</TD>
							<TD vAlign="top">
								<TABLE cellSpacing="0" cellPadding="0" width="400" border="0">
									...
									<TR>
										...
										<TD class="font">
											<asp:Label id=lblFileSize runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "PlanningDocumentSize").ToString  %>'>
											</asp:Label></TD>
									</TR>
									<TR>
										<TD width="10" height="35">&nbsp;</TD>
