		...
		<form id="Form1" method="post" runat="server" defaultbutton="imgBtnSearch">
            ...
            <table class="TableHeaderBlue" height="25" width="100%" border="0" cellspacing="0" cellpadding="0" >
				<tr valign="middle">
					...
					<td align="left">
                        ...
                        <asp:DropDownList style="margin-left:50px; font-weight:bold;" ID="ConfigLevel" runat="server" AutoPostBack="true"></asp:DropDownList>
                    </td>
				</tr>
			</table>
			<table cellspacing="0" cellpadding="0" width="100%" bgcolor="white" border="0">
				<tr>
					...
					<td width="100%">
						<table><tr><td><asp:imagebutton id="imgBtnSearch" runat="server" CausesValidation="false"></asp:imagebutton></td></tr></table>
					</td>
				</tr>
			</table>
