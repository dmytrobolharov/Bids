<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Planning_FlashEdit_Style.aspx.vb" Inherits="plmOnApp.Planning_FlashEdit_Style" %>
<%@ Register TagPrefix="cc1" Namespace="Yunique.WebControls" Assembly="YSWebControls" %>
<%@ Register TagPrefix="uc1" TagName="GridEdit" Src="Planning_FlashEdit_Style_GridEdit.ascx" %>
...
<html>
    ...
    <div id="fixed_icons"><a href="../Help/Help_Folder.aspx?Folder=<%= Folder %>&HID=<%= HelpID %>" title="Help" target="_blank" id="yHelp"></a></div>
		<form id="Form1" method="post" runat="server">
            ...
            <telerik:RadWindowManager ID="RadWindowManager1" runat="server">
                <Windows>
                    <telerik:RadWindow ID="QuickFill" runat="server" Title="Quick Fill" Height="600px" Width="800px" ReloadOnShow="true"
                        ShowContentDuringLoad="false" NavigateUrl="Planning_FlashEdit_Style_QuickFill_New.aspx" Behaviors="Close"
			...
			<%--<asp:PlaceHolder id="phStyleGrid" runat="server" EnableViewState="True"></asp:PlaceHolder>		--%>
