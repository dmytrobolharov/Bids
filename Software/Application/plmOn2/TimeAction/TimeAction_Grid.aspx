...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="TimeAction_Grid.aspx.vb" Inherits="plmOnApp.TimeAction_Grid" %>
			...
			<TABLE class="TableHeader" id="toolbar" cellSpacing="0" cellPadding="0" width="100%" border="0"
				...
				<TR vAlign="middle">
					...
					<TD>
					    ...
					    <cc1:bwimagebutton id="btnNew" runat="server"  CausesValidation="False"></cc1:bwimagebutton>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR vAlign="top">
					<TD>
						...
						<asp:datagrid id="DataGrid1" runat="server" AllowSorting="True" DataKeyField="TACalTemplateID">
