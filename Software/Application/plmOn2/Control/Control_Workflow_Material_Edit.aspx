<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_Workflow_Material_Edit.aspx.vb" Inherits="plmOnApp.Control_Workflow_Material_Edit" %>
...
<body ms_positioning="GridLayout">
    ...
    <table cellspacing="0" width="100%" cellpadding="0" border="0">
        <tr>
            <td valign="top">
                <asp:DataGrid ID="DataGrid1" runat="server" AllowSorting="True" DataKeyField="MaterialTemplateItemID">
