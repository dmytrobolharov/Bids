<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_User_ProductAttributeList.aspx.vb" Inherits="plmOnApp.Control_User_ProductAttributeList" %>
...
<body>
    ...
    <div>
			...
			<tr vAlign="middle">
				...
				<td>
					<asp:imagebutton id="btnInvSearch" runat="server" ImageUrl="../System/icons/1x1.gif" Width="0px"
						Height="0px" />
					<cc1:confirmedimagebutton id="btnNew" runat="server" ImageUrl="../System/Button/ButtonStream.ashx?BN=btn_new.gif" Message="NONE" CausesValidation="false" ></cc1:confirmedimagebutton>
		...
		<table style="BORDER-BOTTOM: orange thin solid; BORDER-LEFT-STYLE: none; BACKGROUND-COLOR: white"
			...
			<tr>
				<td>&nbsp;<asp:label id="lblHeader" runat="server" ForeColor="#999999" Font-Size="X-Large" Font-Names="Tahoma,Verdana"></asp:label></td>
			</tr>
		</table>
