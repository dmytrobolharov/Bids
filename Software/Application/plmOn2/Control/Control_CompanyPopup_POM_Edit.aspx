<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_CompanyPopup_POM_Edit.aspx.vb" Inherits="plmOnApp.Control_CompanyPopup_POM_Edit" %>
...
<body>
		<form id="Form1" method="post" runat="server">
           ...
           <table cellspacing="0" cellpadding="0" width="100%" border="0">
            ...
            <asp:datagrid id="DataGrid1" runat="server" DataKeyField="POMCompanyID" 
				    ...
				    <headerStyle Height="25px" CssClass="TableHeaderRed"></headerStyle>
                       <Columns>
                        ...
                        <asp:TemplateColumn>
                           <HeaderStyle Width="100px" CssClass="TableHeader"></HeaderStyle>
                           <HeaderTemplate>
								<DIV align="center">
                        ...
                        <asp:TemplateColumn>
                           ...
                           <HeaderTemplate>
								<DIV align="center">
									<asp:Label id="lblDeleteImage" runat="server" CssClass="fontHead"><%#GetSystemText("D")%></asp:Label></DIV>
							</HeaderTemplate>
                            <ItemTemplate>
                                    <cc1:confirmedimagebutton id="btnDeleteImage" OnCommand="DeleteImage" runat="server" ImageUrl="../System/Icons/icon_image_delete.gif" Visible="false" />
                            </ItemTemplate>
                        </asp:TemplateColumn>                          
                        ...
                        <asp:TemplateColumn>
                           ...
                           <HeaderTemplate>
								<DIV align="center">
									<asp:Label id="lblUpload" runat="server" CssClass="fontHead"><%#GetSystemText("U")%></asp:Label></DIV>
							</HeaderTemplate>
                            <ItemTemplate>
                                    <cc1:BWImageButton id="ImgUpload" runat="server" ImageUrl="../System/Icons/icon_panelup.gif" MenuBar="False"  Status="False" ToolBar="False" Location="False" />
                            </ItemTemplate>
                        </asp:TemplateColumn>                         
