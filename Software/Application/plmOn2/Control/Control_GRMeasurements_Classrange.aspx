...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_GRMeasurements_Classrange.aspx.vb" Inherits="plmOnApp.Control_GRMeasurements_Classrange" %>
...
<body>
   ...
   <table class="TableHeader" id="toolbar" cellspacing="0" cellpadding="0" width="100%"
        ...
        <tr valign="middle">
            ...
            <td><cc1:ConfirmedImageButton ID="btnSave" runat="server" 
        ...
        <tr>
          ...
          <table class="TableHeader" cellspacing="0" cellpadding="0" width="100%" border="0">
               <tr valign="middle">
                    ...
                    <td width="600">
                            <asp:Label ID="lblSizeClass" runat="server" Text=""></asp:Label>
                            <asp:dropdownlist id="ddlSizeClass" runat="server"
