...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Control_TradePartner_Add.aspx.vb" Inherits="plmOnApp.Control_TradePartner_Add" %>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE class="TableHeader" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<cc2:confirmedimagebutton id="btnClose" runat="server" Message="NONE"></cc2:confirmedimagebutton>
					</TD>
					<TD>&nbsp;</TD>
				</TR>
			</TABLE>
