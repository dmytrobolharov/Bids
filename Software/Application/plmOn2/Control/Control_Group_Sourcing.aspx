<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_Group_Sourcing.aspx.vb" Inherits="plmOnApp.Control_Group_Sourcing" %>
				...
				<ItemTemplate>
					<TABLE width="100%">
						<TR>
							...
							<TD class="fontHead" width="200"><%#Container.DataItem("SourcingFolder")%></TD>
							<TD width="125">
