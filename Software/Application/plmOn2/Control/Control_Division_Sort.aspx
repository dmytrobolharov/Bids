...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_Division_Sort.aspx.vb" Inherits="plmOnApp.Control_Division_Sort" %>
								...
								<td><asp:datagrid id="datagrid1" runat="server" EnableViewState="true" AutoGenerateColumns="False"
										...
										<Columns>
											<asp:TemplateColumn>
												...
												<HeaderTemplate>
													<asp:Label runat="server" CssClass="fontHead" ID="label3"><%# GetSystemText("ID")%></asp:Label>
												</HeaderTemplate>
												<ItemTemplate>
