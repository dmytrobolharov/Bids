<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_Measurement_Menu.aspx.vb" Inherits="plmOnApp.Control_Measurement_Menu" %>
		...
		<table cellspacing="0" cellpadding="0" width="100%" border="0">
				<tr>
					<td colspan="2" align="center" style="color:#E0E0E0;font-family:Tahoma,Verdana;font-size:medium;">
					    <asp:Label ID="lblHeader" runat="server">Measurements</asp:Label>
					</td>
				</tr>
				<tr>
					<td>
