...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Control_Consumption_Labor_Tables_List.aspx.vb" Inherits="plmOnApp.Control_Consumption_Labor_Tables_List" %>
            ...
            <TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR vAlign="top">
					<TD>
						...
						</asp:datagrid><asp:label id="SortOrder" runat="server" Text="CustomKey" Visible="False"></asp:label></TD>
				</TR>
			</TABLE>
		</form>
	</body>
