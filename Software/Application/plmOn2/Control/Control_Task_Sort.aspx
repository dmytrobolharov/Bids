...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_Task_Sort.aspx.vb" Inherits="plmOnApp.Control_Task_Sort" %>
				...
				<tr>
					...
					<td>
						<table border="0">
							...
							<tr>
								<td><asp:datagrid id="datagrid1" runat="server" EnableViewState="true" AutoGenerateColumns="False" DataKeyField="TaskID"
										...
										<Columns>
											<asp:TemplateColumn>
												...
												<HeaderTemplate>
													<asp:Label runat="server" CssClass="fontHead" ID="label3"><%# GetSystemText("TaskCode")%></asp:Label>
												</HeaderTemplate>
												<ItemTemplate>
													<asp:Label runat="server" ID="lblTaskCode"></asp:Label>
												</ItemTemplate>
											</asp:TemplateColumn>
											<asp:TemplateColumn>
												<ItemStyle Width="200px"></ItemStyle>
												<HeaderTemplate>
													<asp:Label runat="server" CssClass="fontHead" ID="label1"><%#GetSystemText("TaskName")%></asp:Label>
												</HeaderTemplate>
												<ItemTemplate>
