		...
		<form id="Form1" method="post" runat="server">
			<TABLE class="TableHeader" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD width="500"><cc2:confirmedimagebutton id="btnAdd" runat="server" Message="NONE" ></cc2:confirmedimagebutton><cc2:confirmedimagebutton id="btnClose" runat="server" Message="NONE" ></cc2:confirmedimagebutton></TD>
					<TD>&nbsp;</TD>
				</TR>
			</TABLE>
