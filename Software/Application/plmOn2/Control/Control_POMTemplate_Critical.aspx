...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Control_POMTemplate_Critical.aspx.vb" Inherits="plmOnApp.Control_POMTemplate_Critical" %>
					...
					<td vAlign="top" width="600"><asp:datagrid id="DataGrid1" runat="server" BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px"
							...
							<Columns>
								...
								<asp:TemplateColumn>
									<HeaderTemplate>
										<div align="center">
											<asp:Label id="lblSampleSize" runat="server"><%#GetSystemText("Spec")%></asp:Label></div>
									</HeaderTemplate>
									<ItemTemplate>
										<div align="center">
