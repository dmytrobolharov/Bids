<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_BOL_Macro_View.aspx.vb"
    Inherits="plmOnApp.Control_BOL_Macro_View" %>
...
<body>
    ...
    <div>
        ...
        <table id="TableEdit" style="border-bottom: orange thin solid" runat="server" cellspacing="2"
            cellpadding="0" width="100%" border="0">
            <tr>
                <td>
