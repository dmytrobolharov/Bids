<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_ExchangeRate_List.aspx.vb" Inherits="plmOnApp.Control_ExchangeRate_List" %>
    ...
    <form id="form1" runat="server">
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR vAlign="top">
					<TD>
						...
						<asp:datagrid id="DataGrid1" runat="server" AllowSorting="True" DataKeyField="ExchangeRateID">
        ...
        <script type="text/javascript">
            ...
            jQuery(document).ready(function ($) {
                ...
                // Adding magical pixel
                table.closest(".tablescroll_wrapper").width(table.closest(".tablescroll_wrapper").width() + 1);
