...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Control_Group_ComplianceFolder.aspx.vb" Inherits="plmOnApp.Control_Group_ComplianceFolder" %>
...
<HTML>
	...
	<body>
		<form onkeypress="if(event.keyCode==13) {document.getElementById('btnImgSearch').click(); return false}"
            ...
            <ContentTemplate>
			<asp:datalist id="dlComplianceFolder" runat="server" Width="100%" BorderColor="Silver" BorderStyle="Solid"
				BorderWidth="1px">
				...
				<ItemTemplate>
					<TABLE width="100%">
						<TR>
							...
							<TD class="fontHead" width="200"><%#Container.DataItem("ComplianceType")%></TD>
							<TD width="125">
