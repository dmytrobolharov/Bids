<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_BOL_Operations_FixedCostAdd_Popup_New.aspx.vb" Inherits="plmOnApp.Control_BOL_Operations_FixedCostAdd_Popup_New" %>
    ...
    <div>
			...
			<table class="TableHeader" id="toolbar" cellSpacing="0" cellPadding="0" width="100%" border="0"
				...
				<tr vAlign="middle">
					...
					<td><cc1:confirmedimagebutton id="btnAddClose" runat="server" Message="NONE"></cc1:confirmedimagebutton>
					<cc1:confirmedimagebutton id="btnAddNew" runat="server" Message="NONE"></cc1:confirmedimagebutton>
