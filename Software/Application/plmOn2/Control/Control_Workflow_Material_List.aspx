<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_Workflow_Material_List.aspx.vb" Inherits="plmOnApp.Control_Workflow_Material_List" %>

<%@ Register TagPrefix="cc1" Namespace="Yunique.WebControls" Assembly="YSWebControls" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html>
<head>
    <title>Material workflow template</title>
    ...
    <table cellspacing="0" cellpadding="0" width="100%" border="0">
        <tr valign="top">
            <td>
                ...
                <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="MaterialTemplateID" AllowSorting="True">
