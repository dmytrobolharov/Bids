...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_Group_PlanningFolder_Item.aspx.vb" Inherits="plmOnApp.Control_Group_PlanningFolder_Item" %>
...
<HTML>
	...
	<body>
		<form onkeypress="if(event.keyCode==13) {document.getElementById('btnImgSearch').click(); return false}"
			...
			<asp:datalist id="dlPlanningType" runat="server" Width="100%" BorderColor="Silver" BorderStyle="Solid"
				BorderWidth="1px">
				...
				<ItemTemplate>
					<TABLE width="100%">
						<TR>
							...
							<TD class="fontHead" width="200"><%# Container.DataItem("PlanningItemName")%></TD>
							<TD width="125">
