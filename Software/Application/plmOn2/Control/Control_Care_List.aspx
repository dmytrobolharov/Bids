...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Control_Care_List.aspx.vb" Inherits="plmOnApp.Control_Care_List" %>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR vAlign="top">
					<TD>
						...
						<asp:datagrid id="DataGrid1" runat="server" AllowSorting="True" DataKeyField="TemplateCareID">
