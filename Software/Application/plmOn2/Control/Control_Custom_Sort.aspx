...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Control_Custom_Sort.aspx.vb" Inherits="plmOnApp.Control_Custom_Sort" %>
...
<HTML>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<TABLE class="TableHeader" id="toolbar" height="27" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TBODY>
					<TR vAlign="middle">
						<TD vAlign="middle" align="center" width="10"><IMG height="15" src="../System/Images/bbTbSCnr.gif" width="3"></TD>
						<TD vAlign="middle" align="left" width="400">
                            <cc1:confirmedimagebutton id="btnSave" runat="server" disabled="disabled" Message="NONE"></cc1:confirmedimagebutton>
                            <cc1:confirmedimagebutton id="Confirmedimagebutton1" runat="server" disabled="disabled" Message="NONE"></cc1:confirmedimagebutton>
                        </TD>
						<TD></TD>
					</TR>
				</TBODY>
