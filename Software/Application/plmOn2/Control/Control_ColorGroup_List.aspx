<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_ColorGroup_List.aspx.vb" Inherits="plmOnApp.Control_ColorGroup_List" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">		
			...
			<table style="BORDER-BOTTOM: orange thin solid; BORDER-LEFT-STYLE: none; BACKGROUND-COLOR: white"
				...
				<tr>
					<td>&nbsp;<asp:label id="lblHeader" runat="server" ForeColor="#E0E0E0" Font-Size="X-Large" Font-Names="Tahoma,Verdana">Color Group</asp:label></td>
				</tr>
			</table>
...
<asp:Label ID="lblRecordsPerPage" runat="server" ></asp:Label></TD>
						...
						<asp:datagrid id="DataGrid1" runat="server" AllowSorting="True" DataKeyField="CustomID">
