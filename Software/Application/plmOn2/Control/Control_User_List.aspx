...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Control_User_List.aspx.vb" Inherits="plmOnApp.Control_User_List" %>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR vAlign="top">
					<TD>
						...
						<asp:datagrid id="DataGrid1" runat="server" DataKeyField="TeamId" AllowSorting="True">
