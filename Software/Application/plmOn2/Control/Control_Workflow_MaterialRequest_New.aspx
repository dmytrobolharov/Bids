<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Control_Workflow_MaterialRequest_New.aspx.vb" Inherits="plmOnApp.Control_Workflow_MaterialRequest_New" %>
							...
							<tr>
								<td><div align="right">
										<asp:Label id="lblMaterialNew" runat="server" Font-Names="Tahoma,Verdana" Font-Size="XX-Large"
											ForeColor="#E0E0E0">New Workflow...</asp:Label></div>
								</td>
							</tr>
						</table>
