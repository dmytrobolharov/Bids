...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Control_SourcingTypes_Sort.aspx.vb" Inherits="plmOnApp.Control_LineListType_Sort" %>
			...
			<table border="0">
				...
				<tr>
					<td><asp:datagrid id="DataGrid1" runat="server" EnableViewState="true" AutoGenerateColumns="False"
							BorderColor="#E0E0E0" BorderStyle="Solid" BorderWidth="1px" DataKeyField="SourcingTypeID">
							...
							<Columns>
								...
								<asp:TemplateColumn>
									...
									<HeaderTemplate>
										<asp:Label runat="server" CssClass="fontHead" ID="label3"><%# GetSystemText("Sourcing Code")%></asp:Label>
									</HeaderTemplate>
									<ItemTemplate>
								...
								<asp:TemplateColumn>
									...
									<HeaderTemplate>
										<asp:Label runat="server" CssClass="fontHead" ID="label1"><%# GetSystemText("Sourcing Type")%></asp:Label>
									</HeaderTemplate>
									<ItemTemplate>
