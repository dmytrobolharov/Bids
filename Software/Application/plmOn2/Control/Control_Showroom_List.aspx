<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_Showroom_List.aspx.vb" Inherits="plmOnApp.Control_Showroom_List" %>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR vAlign="top">
					<TD>
						...
						<asp:datagrid id="DataGrid1" runat="server" DataKeyField="ShowroomID" AllowSorting="True">
