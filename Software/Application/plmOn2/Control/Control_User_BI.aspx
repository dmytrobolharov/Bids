...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_User_BI.aspx.vb" Inherits="plmOnApp.Control_User_BI" %>
	...
	<body>
		<form onkeypress="if(event.keyCode==13) {document.getElementById('btnImgSearch').click(); return false}"
			...
			<table class="TableHeader" id="toolbar" cellSpacing="0" cellPadding="0" width="100%" border="0"
				...
				<tr vAlign="middle">
					...
					<td><cc1:confirmedimagebutton id="btnSave" runat="server"  Message="NONE"></cc1:confirmedimagebutton>
						<cc1:BWImageButton id="btnLockFolder" visible="false" runat="server"></cc1:BWImageButton>
			...
			<asp:datalist id="dlBIType" runat="server" Width="100%" BorderColor="Silver" BorderStyle="Solid"
				...
				<ItemTemplate>
                    <table width="100%" id="ReportGroupName" runat="server" visible="false" style="font-size:large; font-weight:bold; border-top: 1px Solid LightGray; border-bottom: 1px Solid LightGray; background-color:White;">
                        <TR><TD><%#Container.DataItem("FolderName")%></TD></TR>
                    </table>
					<TABLE width="100%">
						<TR>
							<TD width="20">
								<asp:Image id="iconStatus" runat="server"></asp:Image></TD>
							<%--<TD class="fontHead" width="200"><%#Container.DataItem("Workflow")%></TD>--%>
							<TD class="fontHead" width="200"><%#Container.DataItem("Description")%></TD>
							<TD width="125">
