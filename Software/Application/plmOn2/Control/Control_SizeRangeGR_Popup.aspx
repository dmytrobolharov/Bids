<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_SizeRangeGR_Popup.aspx.vb" Inherits="plmOnApp.Control_SizeRangeGR_Popup" %>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE class="TableHeader" id="TableHeader" cellSpacing="0" cellPadding="0" width="100%"
				...
				<TR vAlign="middle">
					...
					<TD><cc1:confirmedimagebutton id="btnDelete" runat="server" ToolTip="Save..." 
           ...
           <table cellspacing="0" cellpadding="0" width="100%" border="0">
            ...
            <asp:datagrid id="DataGrid1" runat="server" DataKeyField="SizeRangeGuidID" 
