<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_SeasonCalendar_List.aspx.vb" Inherits="plmOnApp.Control_SeasonCalendar_List" %>
<%@ Register TagPrefix="cc1" Namespace="Yunique.WebControls" Assembly="YSWebControls" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head>
		<title>Season Calendar</title>
			...
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				<tr valign="top">
					<td align="left">
						...
						<asp:datagrid id="DataGrid1" runat="server" AllowSorting="True" DataKeyField="SeasonCalendarID">
