<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_NBOL_TemplateAddOperation_Popup.aspx.vb"
    Inherits="plmOnApp.Control_NBOL_TemplateAddOperation_Popup" %>
...
<body>
    ...
    <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="OperationId" Width="100%"
        AllowSorting="true">
        ...
        <Columns>
            <asp:TemplateColumn HeaderStyle-Width="20" HeaderStyle-BorderWidth="0" ItemStyle-BorderWidth="1" ItemStyle-BorderColor="Gainsboro">
                <HeaderTemplate>
