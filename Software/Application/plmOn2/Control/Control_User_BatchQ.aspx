...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_User_BatchQ.aspx.vb" Inherits="plmOnApp.Control_User_BatchQ" %>
			...
			<table class="TableHeader" id="toolbar" cellSpacing="0" cellPadding="0" width="100%" border="0"
				...
				<tr vAlign="middle">
					...
					<td><cc1:confirmedimagebutton id="btnSave" runat="server" ImageUrl="../System/Button/ButtonStream.ashx?BN=btn_save.gif" Message="NONE"></cc1:confirmedimagebutton>
						<cc1:BWImageButton id="btnLockFolder" visible="false" runat="server" ImageUrl="../System/Button/ButtonStream.ashx?BN=btn_lockfolder.gif"></cc1:BWImageButton>
				...
				<ItemTemplate>
					<TABLE width="100%">
						<TR>
							...
							<TD class="fontHead" width="200"><%#Container.DataItem("BatchQueueDesc")%></TD>
							<TD width="125">
