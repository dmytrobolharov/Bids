<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Control_Group_LinePlanTemplateList.aspx.vb" Inherits="plmOnApp.Control_Group_LinePlanTemplateList" %>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR vAlign="top">
					<TD>
						...
						<asp:datagrid id="DataGrid1" runat="server" DataKeyField="LinePlanTemplateID" AllowSorting="True">
