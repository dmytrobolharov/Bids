...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Control_GRMeasurements_Template_UnLink.aspx.vb" Inherits="plmOnApp.Control_GRMeasurements_Template_UnLink" %>
		...
		<form id="Form1" method="post" runat="server">
			<table class="TableHeader" id="toolbar" cellSpacing="0" cellPadding="0" width="100%" border="0"
				...
				<tr vAlign="middle">
					...
					<td>
						<cc1:confirmedimagebutton id="btnSave" runat="server" ></cc1:confirmedimagebutton>
