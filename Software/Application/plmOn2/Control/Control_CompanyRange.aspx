...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_CompanyRange.aspx.vb" Inherits="plmOnApp.Control_CompanyRange" %>
...
<body MS_POSITIONING="GridLayout">
   <form id="Form1" method="post" runat="server">
			...
			<table style="BORDER-BOTTOM: orange thin solid; BORDER-LEFT-STYLE: none; BACKGROUND-COLOR: white"
				...
				<tr>
					<td>&nbsp;<asp:label id="lblCompany" runat="server" ForeColor="#E0E0E0" Font-Size="X-Large" Font-Names="Tahoma,Verdana"></asp:label></td>
				</tr>
			</table>
