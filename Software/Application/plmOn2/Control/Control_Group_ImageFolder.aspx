<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Control_Group_ImageFolder.aspx.vb" Inherits="plmOnApp.Control_Group_ImageFolder" %>
				...
				<ItemTemplate>
					<TABLE width="100%">
						<TR>
							...
							<TD class="fontHead" width="200"><%#Container.DataItem("ImageType")%></TD>
							<TD width="125">
