<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_Group_SubFolder.aspx.vb" Inherits="plmOnApp.Control_Group_SubFolder" %>
			...
			<table class="TableHeader" id="toolbar" cellSpacing="0" cellPadding="0" width="100%" border="0"
				...
				<tr vAlign="middle">
					...
					<td><cc1:confirmedimagebutton id="btnSave" runat="server"  Message="NONE"></cc1:confirmedimagebutton>
						...
						<cc1:confirmedimagebutton id="btnClose" runat="server" OnClientClick="return btnClose_Click()" Message="NONE"></cc1:confirmedimagebutton></td>
