<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_NBOL_Macro_Sort.aspx.vb" Inherits="plmOnApp.Control_NBOL_Macro_Sort" %>
...
<%--			            <TABLE class="TableHeader" height="25" cellSpacing="0" cellPadding="0" width="100%" bgColor="#ffffff"
			            ...
			            <asp:datagrid id="DataGrid1" runat="server" EnableViewState="true" AutoGenerateColumns="False"
										BorderColor="#E0E0E0" BorderStyle="Solid" BorderWidth="1px" DataKeyField="OpToMacroID"> 
...
<%--				            <Columns >
				                <asp:TemplateColumn >
				                    ...
				                    <ItemTemplate>
				                        <asp:TextBox  runat="server" ID="txtSort" Width="40px"></asp:TextBox>
				                    </ItemTemplate>
				                </asp:TemplateColumn>
				            </Columns>--%>
			            </asp:datagrid>
