<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_BOL_Template_Edit.aspx.vb"
    Inherits="plmOnApp.Control_BOL_Template_Edit" %>
...
<%--        <cc2:YSTabView ID="YSTabView2" runat="server"></cc2:YSTabView>--%>
        ...
        <table id="Table2" class="TableHeader TableFloatHeader" visible="true" runat="server" cellspacing="0"
        ...
        <table id="Table3" class="TableHeader" runat="server" visible="true" height="25"
        ...
        <asp:DataGrid ID="DataGrid1" runat="server" AllowSorting="True" DataKeyField="TemplateEntryId">
            ...
            <Columns>
                <asp:TemplateColumn ItemStyle-BorderWidth="1" ItemStyle-BorderColor="Gainsboro">
                    <HeaderStyle Width="35px" CssClass="TableHeaderRed"></HeaderStyle>
