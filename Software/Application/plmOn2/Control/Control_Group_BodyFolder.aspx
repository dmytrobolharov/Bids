...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_Group_BodyFolder.aspx.vb" Inherits="plmOnApp.Control_Group_BodyFolder" %>
...
<HTML xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form onkeypress="if(event.keyCode==13) {document.getElementById('btnImgSearch').click(); return false}"
            ...
            <ContentTemplate>
			<asp:datalist id="dlBodyType" runat="server" Width="100%" BorderColor="Silver" BorderStyle="Solid"
				BorderWidth="1px">
				...
				<ItemTemplate>
					<TABLE width="100%">
						<TR>
							...
							<TD class="fontHead" width="200"><%#Container.DataItem("BodyTypeDescription")%></TD>
							<TD width="125">
