...
<%@ Page Language="vb" AutoEventWireup="false" MaintainScrollPositionOnPostback="true" CodeBehind="Control_POMLibrary_Edit.aspx.vb"
    Inherits="plmOnApp.Control_POMLibrary_Edit" %>
...
<body>
        ...
        <tr>
            <td valign="middle">
                &nbsp;<asp:Label ID="lblHeader" runat="server" Font-Names="Tahoma,Verdana" Font-Size="X-Large"
                    ForeColor="#E0E0E0">POM Library</asp:Label>
            </td>
        </tr>
    </table>
            ...
            <tr>
                ...
                <td width="500">
                    <asp:LinkButton ID="btnAddPOM" runat="Server" >
								<IMG border="0" ID="imgpom" runat="Server" alt="Save" width="85" height="24"></asp:LinkButton>
                    <asp:LinkButton ID="btnAddClose" runat="Server" CausesValidation="False" >
								<IMG border="0" ID="imgclo" runat="Server" alt="Cancel"  width="85" height="24"></asp:LinkButton>
                </td>
                <td>
                    &nbsp;
                </td>
                    ...
                    <table cellspacing="0" cellpadding="0" width="400" border="0">
                        <tr>
                            ...
                            <td class="fontHead" valign="top" width="100">
                                <asp:Label ID="lblPOMCode" runat="server"></asp:Label>
                            </td>
                            <td class="font">
                                <asp:TextBox ID="txtPOMCode" runat="server" MaxLength="3"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="rvPOMCode" runat="server" CssClass="fontHead" ControlToValidate="txtPOMCode"
                            ...
                            <tr>
                                ...
                                <td class="fontHead" width="100">
                                    <asp:Label ID="lblPtMeasure" runat="server"></asp:Label>
                                </td>
                                <td class="font">
                                    <asp:TextBox ID="txtPointMeasur" runat="server" Width="250px" MaxLength="200"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="rvPointOfMeasurment" runat="server" CssClass="fontHead"
                                        ControlToValidate="txtPointMeasur" Display="Dynamic" ErrorMessage="*" ></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td width="10">
                                ...
                                <td class="font">
                                    <asp:TextBox ID="txtHowToMeasureText" runat="server" Width="250" 
                                        Rows="5" TextMode="MultiLine" Wrap="false" Columns="50"></asp:TextBox>
                                </td>
                            </tr>
                    </table>
                </td>
    ...
    <asp:DataList ID="DataList1" runat="server" Width="100%" BorderWidth="1px" BorderStyle="Solid"
        BorderColor="WhiteSmoke" BackColor="White" DataKeyField="POMLibraryID" OnEditCommand="DataList_EditCommand"
                    ...
                    <td valign="top" width="400">
                        <table cellspacing="0" cellpadding="0" width="400" border="0">
                            <tr>
                                ...
                                <td class="font">
                                    <asp:TextBox ID="txtPOM" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "POM").ToString  %>'
                                        MaxLength="3" ReadOnly="true">
                                    </asp:TextBox>
                                    <asp:RequiredFieldValidator ID="rvPOMCodeEdit" runat="server" CssClass="fontHead" ToolTip ="POM Code Required"
                                        ErrorMessage="*" Display="Dynamic" ControlToValidate="txtPOM"></asp:RequiredFieldValidator>
                                </td>
                                <tr>
                                    <td style="height: 22px" width="10">
                                        &nbsp;
                                    ...
                                    <td class="fontHead" width="100">
                                        <asp:Label ID="lblPtMeasur" runat="server"><%#GetSystemText("Point of Measure")%>:</asp:Label>
                                    </td>
                                    <td class="font">
                                        <asp:TextBox ID="txtPointMeasure" runat="server" Width="250px" Text='<%# DataBinder.Eval(Container.DataItem, "PointMeasur").ToString  %>'>
                                        </asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rvPointMeasurEdit" runat="server" CssClass="fontHead" ToolTip = "Point Of Measurement Required..."
                                            ...
                                            ControlToValidate="txtPointMeasure"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="10">
                                    ...
                                    <td class="font">
                                        <asp:TextBox ID="txtHowToMeasure" runat="server" Width="250" Text='<%# DataBinder.Eval(Container.DataItem, "HowToMeasurText").ToString  %>'
                        ...
                        <table cellspacing="0" cellpadding="0" width="400" border="0">
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <asp:Image ID="imgHowToImage" runat="server" ImageUrl='<%# GetImageThumbnail(DataBinder.Eval(Container.DataItem, "POMLibraryID").ToString,"200","jpg") %>'>
                                        </asp:Image>
                                    </td>
                                </tr>
                        </table>
