<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Control_SourcingTypes_Edit.aspx.vb" Inherits="plmOnApp.Control_SourcingTypes_Edit" %>
			...
			<table class="TableHeader" id="toolbar" cellSpacing="0" cellPadding="0" width="100%" border="0"
				...
				<tr vAlign="middle">
					...
					<td><cc1:confirmedimagebutton id="btnSave" runat="server"  Message="NONE"></cc1:confirmedimagebutton>
                        ...
                        <cc1:confirmedimagebutton id="btnDelete" runat="server"  CausesValidation="false" visible="false"></cc1:confirmedimagebutton>
