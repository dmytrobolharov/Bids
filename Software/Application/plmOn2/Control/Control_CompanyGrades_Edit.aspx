<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Control_CompanyGrades_Edit.aspx.vb" Inherits="plmOnApp.Control_CompanyGrades_Edit" %>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE class="TableHeader" id="TableHeader" cellSpacing="0" cellPadding="0" width="100%"
				...
				<TR vAlign="middle">
					...
					<TD>
						<cc1:confirmedimagebutton id="btnSave" runat="server" ToolTip="Edit..." 
			...
			<table cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<TR class="fontHead">
					<TD width="50" align ="left">
						<cc1:confirmedimagebutton id="btnAdd" runat="server" Message="NONE" ></cc1:confirmedimagebutton></td>
					</TR>
			</table>
