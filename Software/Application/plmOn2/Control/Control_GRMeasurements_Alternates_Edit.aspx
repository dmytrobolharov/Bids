<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_GRMeasurements_Alternates_Edit.aspx.vb" Inherits="plmOnApp.Control_GRMeasurements_Alternates_Edit" %>
...
<body>
    ...
    <table cellspacing="0" cellpadding="0" width="100%" border="0" style="border-bottom: orange thin solid;" >
        ...
        <tr>
            <td class="style1">&nbsp;</td>           
            <td>    
                <asp:Label ID="lblAlternates" runat="server" width="100px" CssClass="fontHead"></asp:Label>                               
