...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Control_LineListType_Sort.aspx.vb" Inherits="plmOnApp.Control_LineListType_Sort" %>
			...
			<table border="0">
				...
				<tr>
					<td><asp:datagrid id="DataGrid1" runat="server" EnableViewState="true" AutoGenerateColumns="False"
							BorderColor="#E0E0E0" BorderStyle="Solid" BorderWidth="1px" DataKeyField="LineListTypeID">
