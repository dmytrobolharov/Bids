<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_Group_Partner.aspx.vb" Inherits="plmOnApp.Control_Group_Partner" %>
				...
				<ItemTemplate>
					<TABLE width="100%">
						<TR>
							...
							<TD class="fontHead" width="200"><%#Container.DataItem("PartnerFolder")%></TD>
							<TD width="125">
