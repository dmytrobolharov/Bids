<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Control_Group_LineFolder.aspx.vb" Inherits="plmOnApp.Control_Group_LineFolder" %>
					...
					<TABLE width="100%">
						<TR>
							<TD width="20">
                                ...
                                <asp:HiddenField ID="hdnLineType" runat="server" Value='<%# Container.DataItem("LineTypeID").ToString() %>' />    
                            </TD>
							<TD class="fontHead" width="200"><%#Container.DataItem("LineListType")%></TD>
							<TD width="125">
