<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Control_Workflow_MaterialRequest_List.aspx.vb" Inherits="plmOnApp.Control_Workflow_MaterialRequest_List" %>
<%@ Register TagPrefix="cc1" Namespace="Yunique.WebControls" Assembly="YSWebControls" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Material Request Template</title>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR vAlign="top">
					<TD>
						...
						<asp:datagrid id="DataGrid1" runat="server" AllowSorting="True" DataKeyField="MaterialRequestWorkflowTempID">
