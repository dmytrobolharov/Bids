...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_SizeRange_GR.aspx.vb" Inherits="plmOnApp.Control_SizeRange_GR" %>
   ...
   <form id="Form1" method="post" runat="server">
			<TABLE class="TableHeader" id="toolbar" cellSpacing="0" cellPadding="0" width="100%" border="0"
				...
				<TR vAlign="middle">
					...
					<TD>
						<cc1:confirmedimagebutton id="btnNew" runat="server" ToolTip="Edit..." 
							Message="NONE"></cc1:confirmedimagebutton>	
						<cc1:confirmedimagebutton id="btnDelete" runat="server" ToolTip="Delete..." 
							Message="NONE"></cc1:confirmedimagebutton>						
