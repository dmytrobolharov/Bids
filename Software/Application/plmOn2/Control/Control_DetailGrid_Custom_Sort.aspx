<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_DetailGrid_Custom_Sort.aspx.vb" Inherits="plmOnApp.Control_DetailGrid_Custom_Sort" %>
    ...
    <form id="form1" runat="server">
			...
			<asp:datagrid id="DataGrid1" runat="server" Width="300px" BorderColor="#E0E0E0" BorderStyle="Solid"
				...
				<Columns>
					<asp:TemplateColumn>
						<HeaderTemplate>
							<asp:Label id="lblSize" runat="server"><%#GetSystemText("Property")%></asp:Label>
						</HeaderTemplate>
						<ItemTemplate>
