...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_Group_BatchQ.aspx.vb" Inherits="plmOnApp.Control_Group_BatchQ" %>
...
<HTML>
	...
	<body>
		<form onkeypress="if(event.keyCode==13) {document.getElementById('btnImgSearch').click(); return false}"
			...
			<table class="TableHeader" id="toolbar" cellSpacing="0" cellPadding="0" width="100%" border="0"
				...
				<tr vAlign="middle">
					...
					<td><cc1:confirmedimagebutton id="btnSave" runat="server" ImageUrl="../System/Button/ButtonStream.ashx?BN=btn_save.gif" Message="NONE"></cc1:confirmedimagebutton>
						<cc1:BWImageButton id="btnLockFolder" runat="server" ImageUrl="../System/Button/ButtonStream.ashx?BN=btn_lockfolder.gif"></cc1:BWImageButton>
						...
						<cc1:confirmedimagebutton id="btnSaveAll" runat="server" ImageUrl="../System/Button/ButtonStream.ashx?BN=btn_save_all.gif" Message="NONE"></cc1:confirmedimagebutton>
						</td>
            ...
            <ContentTemplate>
			<asp:datalist id="dlBatchQType" runat="server" Width="100%" BorderColor="Silver" BorderStyle="Solid"
				BorderWidth="1px">
				...
				<ItemTemplate>
					<TABLE width="100%">
						<TR>
							...
							<TD class="fontHead" width="200"><%#Container.DataItem("BatchQueueTypeName")%></TD>
							<TD width="125">
