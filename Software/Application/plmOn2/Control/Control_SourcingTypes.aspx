...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Control_SourcingTypes.aspx.vb" Inherits="plmOnApp.Control_SourcingTypes" %>
			...
			<TABLE class="TableHeader" id="toolbar" cellSpacing="0" cellPadding="0" width="100%" border="0"
				...
				<TR vAlign="middle">
					...
					<TD ><asp:imagebutton id="btnInvSearch" runat="server" ImageUrl="../System/icons/1x1.gif" Width="0px"
							Height="0px"></asp:imagebutton><cc1:confirmedimagebutton id="btnNewPOM" runat="server"  Message="NONE"></cc1:confirmedimagebutton>
                            <cc1:BWImageButton id="btnSort" Visible="false" runat="server" WindowHeight="400px"
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR vAlign="top">
					<TD>
						...
						<asp:datagrid id="DataGrid1" runat="server" AllowSorting="True" DataKeyField="SourcingTypeId">
