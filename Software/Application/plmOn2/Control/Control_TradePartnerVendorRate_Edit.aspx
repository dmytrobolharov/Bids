<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_TradePartnerVendorRate_Edit.aspx.vb" Inherits="plmOnApp.Control_TradePartnerVendorRate_Edit" %>
...
<body>
    <form id="form1" runat="server">
        <div class="FreezePane">
			<table class="TableHeader" id="toolbar" cellSpacing="0" cellPadding="0" width="100%" border="0"
				...
				<tr vAlign="middle">
					...
					<td><cc1:confirmedimagebutton id="btnSave" runat="server"  Message="NONE"></cc1:confirmedimagebutton>
						...
						<cc1:confirmedimagebutton id="btnClose" CausesValidation="False" runat="server"  Message="NONE" OnClientClick="return btnClose_Click()"></cc1:confirmedimagebutton>
        	...
        	<asp:datagrid id="dgCategoryRate" runat="server" DataKeyField="TradePartnerVendorRateItemID" AllowSorting="True">
