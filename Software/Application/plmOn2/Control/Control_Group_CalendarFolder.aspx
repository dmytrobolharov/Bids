<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_Group_CalendarFolder.aspx.vb" Inherits="plmOnApp.Control_Group_CalendarFolder" %>
				...
				<ItemTemplate>
					<TABLE width="100%">
						<TR>
							...
							<TD class="fontHead" width="200"><%# Container.DataItem("CalendarFolder")%></TD>
							<TD width="125">
