<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Control_Group_List.aspx.vb" Inherits="plmOnApp.Control_Group_List" %>
...
<HTML>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR vAlign="top">
					<TD>
						...
						<asp:datagrid id="DataGrid1" runat="server" DataKeyField="GroupId" AllowSorting="True">
             ...
             <asp:Button id="btnMigrateNewPermissions"  Text="Migrate New Permissions" OnClientClick="return ShowPopup();"  OnClick="btnMigrateNewPermissions_Click" runat="server" />
		</form>
	</body>
    <script type="text/javascript">
        ...
        function ShowPopup() {
            ...
            var result = window.confirm("Dear user! A few days ago we fixed the admin pages, and now they are working with new permissions. " +
                                        "You DON'T NEED to click this button after changing permissions anymore. In fact, IF YOU DO, your new permissions WILL BE " +
                                        "OVERWRITTEN with your old ones. Do you REALLY want to do that?");
            return result;
        }
    </script>
</HTML>
