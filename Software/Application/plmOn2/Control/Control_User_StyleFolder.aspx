...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Control_User_StyleFolder.aspx.vb" Inherits="plmOnApp.Control_User_StyleFolder" %>
...
<HTML>
	...
	<body>
		<form onkeypress="if(event.keyCode==13) {document.getElementById('btnImgSearch').click(); return false}"
			...
			<asp:datalist id="dlStyleType" runat="server" Width="100%" BorderColor="Silver" BorderStyle="Solid"
				BorderWidth="1px">
				...
				<ItemTemplate>
					<TABLE width="100%">
						<TR>
							...
							<TD class="fontHead" width="200"><%#Container.DataItem("StyleTypeDescription")%></TD>
							<TD width="125">
							...
							<TD>
								<asp:Panel id="pnlPartial" runat="server">
									<asp:CheckBox id="cbAccessView" runat="server" OnCheckedChanged="SelectedIndexChanged" AutoPostBack="True"
										CssClass="fontHead" Text="View"></asp:CheckBox>
									<asp:CheckBox id="cbAccessCreate" runat="server" CssClass="fontHead" Text='<%#GetSystemText("View") %>'></asp:CheckBox>
									<asp:CheckBox id="cbAccessModify" runat="server" CssClass="fontHead" Text='<%#GetSystemText("Create") %>'></asp:CheckBox>
