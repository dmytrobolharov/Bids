<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_Group_PlanningFolder.aspx.vb" Inherits="plmOnApp.Control_Group_PlanningFolder" %>
					...
					<TABLE width="100%">
						<TR>
							<TD width="20">
                                ...
                                <asp:HiddenField ID="hdnPlanningType" runat="server" Value='<%# Container.DataItem("PlanningTypeID").ToString() %>' />
                            </TD>
							<TD class="fontHead" width="200"><%# Container.DataItem("PlanningType")%></TD>
							<TD width="125">
