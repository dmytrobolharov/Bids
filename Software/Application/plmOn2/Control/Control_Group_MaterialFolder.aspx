...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Control_Group_MaterialFolder.aspx.vb" Inherits="plmOnApp.Control_Group_MaterialFolder" %>
...
<HTML>
	...
	<body>
		<form onkeypress="if(event.keyCode==13) {document.getElementById('btnImgSearch').click(); return false}"
            ...
            <ContentTemplate>
			<asp:datalist id="dlMaterialType" runat="server" Width="100%" BorderColor="Silver" BorderStyle="Solid"
				BorderWidth="1px">
				...
				<ItemTemplate>
					<TABLE width="100%">
						<TR>
							...
							<TD class="fontHead" width="200"><%#Container.DataItem("ComponentDescription")%></TD>
							<TD width="125">
