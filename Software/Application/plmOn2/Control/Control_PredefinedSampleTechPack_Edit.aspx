<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Control_PredefinedSampleTechPack_Edit.aspx.vb" Inherits="plmOnApp.Control_PredefinedSampleTechPack_Edit" %>
...
<HTML>
	...
	<body>
		<form id="Form1" method="post" runat="server">
            ...
            <asp:datagrid id="DataGrid1" runat="server" AllowSorting="True" DataKeyField="ReportSampleRequestSubmitPageID">
				<AlternatingItemStyle Height="20px" CssClass="AlternateItemTemplate"></AlternatingItemStyle>
				<ItemStyle Height="20px" CssClass="ItemTemplate"></ItemStyle>
				<HeaderStyle Height="25px" CssClass="TableHeader"></HeaderStyle>
				<PagerStyle Visible="False"></PagerStyle>
			</asp:datagrid>
            <asp:label id="SortOrder" runat="server" Visible="False" Text="ReportPageSort, ReportPageDescription, ReportPageName"></asp:label>
