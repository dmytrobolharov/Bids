<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_CompanyPopup_Class.aspx.vb" Inherits="plmOnApp.Control_CompanyPopup_Class" %>
                       ...
                       <Columns>
                        <asp:TemplateColumn HeaderStyle-Width="20" HeaderStyle-BorderWidth="0" ItemStyle-BorderWidth="0">
                            ...
                            <ItemTemplate>
                                ...
                                <input type ="hidden"  runat="server"  id="hdnSizeClass" /> 
                            </ItemTemplate>
                        </asp:TemplateColumn>                                    
                    </Columns> 
