...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Control_POMLibrary_Select.aspx.vb" Inherits="plmOnApp.Control_POMLibrary_Select"   %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title runat="server" id="PageTitle">POM Library</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<table style="BORDER-BOTTOM: orange thin solid; BORDER-LEFT-STYLE: none; BACKGROUND-COLOR: white"
				...
				<tr>
					<td>&nbsp;<asp:label id="lblHeader" runat="server" ForeColor="#E0E0E0" Font-Size="Medium" Font-Names="Tahoma,Verdana">Select POM Library...</asp:label></td>
				</tr>
			</table>
						...
						<TABLE class="TableHeader" height="25" cellSpacing="0" cellPadding="0" width="100%" bgColor="#ffffff"
							...
							<TR vAlign="middle">
								...
								<TD class="fontHead" align="right" width="110">
                                    <asp:Label ID="lblPOMperPage" runat="server" >POM per Page:</asp:Label></TD>
						...
						<asp:datagrid id="DataGrid1" runat="server" DataKeyField="POMLibraryID" AllowSorting="true">
                            ...
                            <Columns>
                                <asp:TemplateColumn>
                                    ...
                                    <ItemTemplate>
                                        <asp:CheckBox ID="chbPOMLibraryID" runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                            </Columns>
