...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_MilestoneLibrary_List.aspx.vb" Inherits="plmOnApp.Control_MilestoneLibrary_List" %>
    ...
    <table class="TableHeader" id="toolbar" cellspacing="0" cellpadding="0" width="100%" border="0" runat="server">
        <tr valign="middle">
            ...
            <td>
                ...
                <%--<cc1:BWImageButton ID="btnSort" runat="server" WindowHeight="400px" WindowWidth="400px"></cc1:BWImageButton>--%>
            </td>
            <td>
                &nbsp;
            </td>
