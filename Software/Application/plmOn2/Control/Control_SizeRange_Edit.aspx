...
<body>
    ...
    <table cellspacing="0" cellpadding="0" width="100%" border="0">
        <tr>
            ...
            <td class="fontHead" width="78" style="width: 78px; height: 17px">
                &nbsp;
            </td>
        ...
        <tr>
            ...
            <td class="fontHead" width="78" style="width: 78px">
                <asp:Label ID="lblCreatedByH" runat="server"></asp:Label>
            </td>
            <td>
                &nbsp;
                <asp:Label ID="lblCreatedBy" runat="server" CssClass="font">Label</asp:Label>
            </td>
        </tr>
        <tr>
            <td width="10">
            ...
            <td class="fontHead" width="78" style="width: 78px">
                <asp:Label ID="lblModifiedByH" runat="server"></asp:Label>
            </td>
            <td>
                &nbsp;
                <asp:Label ID="lblModifiedBy" runat="server" CssClass="font">Label</asp:Label>
            </td>
        </tr>
        <tr>
            <td width="10">
