<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Control_ColorGroup_New.aspx.vb" Inherits="plmOnApp.Control_ColorGroup_New" %>
				...
				<tr>
					<td vAlign="top" bgColor="#ffffff">
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr>
								<td>
									<div align="right"><asp:label id="lblHeader" runat="server" ForeColor="#E0E0E0" Font-Size="XX-Large" Font-Names="Tahoma,Verdana">Color Group</asp:label></div>
								</td>
							</tr>
						</table>
