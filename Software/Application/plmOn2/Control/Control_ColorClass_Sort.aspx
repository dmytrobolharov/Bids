...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_ColorClass_Sort.aspx.vb" Inherits="plmOnApp.Control_ColorClass_Sort" %>
				...
				<tr>
					...
					<td>
						<table border="0">
							...
							<tr>
								<td><asp:datagrid id="datagrid1" runat="server" EnableViewState="true" AutoGenerateColumns="False" DataKeyField="ColorClassID"
										...
										<Columns>
											<asp:TemplateColumn>
												...
												<HeaderTemplate>
													<asp:Label runat="server" CssClass="fontHead" ID="label3"><%# GetSystemText("ColorClassID")%></asp:Label>
												</HeaderTemplate>
												<ItemTemplate>
													<asp:Label runat="server" ID="lblColorClassID"></asp:Label>
												</ItemTemplate>
											</asp:TemplateColumn>
											<asp:TemplateColumn>
												<ItemStyle Width="200px"></ItemStyle>
												<HeaderTemplate>
													<asp:Label runat="server" CssClass="fontHead" ID="label1"><%#GetSystemText("ColorClassName")%></asp:Label>
												</HeaderTemplate>
												<ItemTemplate>
													<asp:Label runat="server" ID="lblColorClassName"></asp:Label>
												</ItemTemplate>
											</asp:TemplateColumn>
											<asp:TemplateColumn>
												<ItemStyle Width="40px"></ItemStyle>
