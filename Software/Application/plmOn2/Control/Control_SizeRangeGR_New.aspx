<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_SizeRangeGR_New.aspx.vb" Inherits="plmOnApp.Control_SizeRangeGR_New" %>
...
<body>
        ...
        <tr>
            ...
            <td>    
                ...
                <asp:RequiredFieldValidator ID="rvSizeRangeName" runat="server"
                    ControlToValidate="txtSizeRange" Display="Dynamic" ErrorMessage="*"> 
    ...
    <asp:panel id="pnlSizeRangeDetail" runat="server">		  
