...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Control_Group_ShareFolder.aspx.vb" Inherits="plmOnApp.Control_Group_ShareFolder" %>
				...
				<ItemTemplate>
					<TABLE width="100%">
						<TR>
							...
							<TD class="fontHead" width="200"><%#Container.DataItem("ShareFolder")%></TD>
							<TD width="125">
