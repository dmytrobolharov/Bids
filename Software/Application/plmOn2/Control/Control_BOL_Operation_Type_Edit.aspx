<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_BOL_Operation_Type_Edit.aspx.vb" Inherits="plmOnApp.Control_BOL_Operation_Type_Edit" %>
		 ...
		 <table class="TableHeader" id="toolbar1" cellspacing="0" cellpadding="0" width="100%" border="0" runat="server">
            <tr valign="middle">
                <td valign="middle" align="center" width="10">
                    ...
                    <cc1:ConfirmedImageButton ID="btnSaveType" runat="server" 
                    ...
                    <cc1:ConfirmedImageButton ID="btnDeleteType" runat="server" 
                    Message="NONE" CausesValidation="False"></cc1:ConfirmedImageButton>
	            </td>
        ...
        <table bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" 
                     ...
                     <table bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="1" 
                        ...
                        <tr valign="top" width="100%">  
                            <td align="left" width="100%">
                                ...
                                <asp:TextBox Width="200px" ID="txtType" runat="server" CssClass="fontHead" MaxLength="60"></asp:TextBox>
            ...
            <tr>                    
                <td align="left">                        
                    ...
                    <asp:Label ID="lblActiveT" runat="server"></asp:Label>
                </td>
