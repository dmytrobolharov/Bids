...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Control_GRMeasurements_Template_Link.aspx.vb" Inherits="plmOnApp.Control_GRMeasurements_Template_Link" %>
		...
		<form id="Form1" method="post" runat="server">
			<table class="TableHeader" id="toolbar" cellSpacing="0" cellPadding="0" width="100%" border="0"
				...
				<tr vAlign="middle">
					...
					<td>
						<cc1:confirmedimagebutton id="btnSave" runat="server"  Message="Do you want to link pom ?"></cc1:confirmedimagebutton>
					...
					<td vAlign="top" width="600"><asp:datagrid id="DataGrid1" runat="server" BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px"
							...
							<Columns>
								...
								<asp:TemplateColumn>
									...
									<ItemTemplate>
										<div align="center">
											<asp:Label id="lblAlternatescode" runat="server" Width="50"></asp:Label></div>
									</ItemTemplate>
								</asp:TemplateColumn>
								<asp:TemplateColumn>
									<HeaderTemplate>
