...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_GRMeasurements_Alternates.aspx.vb" Inherits="plmOnApp.Control_GRMeasurements_Alternates" %>
			...
			<TABLE class="TableHeader" id="toolbar" cellSpacing="0" cellPadding="0" width="100%" border="0"
				...
				<TR vAlign="middle">
					...
					<TD>
						...
						<cc1:confirmedimagebutton id="btnClose" Visible="false" runat="server" Message="NONE" OnClientClick="return btnClose_Click()"></cc1:confirmedimagebutton></TD>
				</TR>
			</TABLE>
