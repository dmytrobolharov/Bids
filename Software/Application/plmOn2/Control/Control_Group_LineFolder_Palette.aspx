...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_Group_LineFolder_Palette.aspx.vb" Inherits="plmOnApp.Control_Group_LineFolder_Palette" %>
				...
				<ItemTemplate>
					<TABLE width="100%">
						<TR>
							...
							<TD class="fontHead" width="200"><%#Container.DataItem("LinePaletteName")%></TD>
							<TD width="125">
