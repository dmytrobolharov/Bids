<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_TradePartnerVendorRate_List.aspx.vb" Inherits="plmOnApp.Control_TradePartnerVendorRate_List" %>
				...
				<TR vAlign="middle">
					...
					<TD>
						...
						<cc1:BWImageButton id="btnSort"  runat="server" WindowHeight="400px"
							WindowWidth="400px" Visible ="false" ></cc1:BWImageButton>
					</TD>
					<td>&nbsp;</td>
				</TR>
			</TABLE>
            ...
            <TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR vAlign="top">
					<TD>
						...
						<asp:datagrid id="DataGrid1" runat="server" AllowSorting="True" DataKeyField="TradePartnerVendorRateID">
