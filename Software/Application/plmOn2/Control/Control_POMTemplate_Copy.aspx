...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Control_POMTemplate_Copy.aspx.vb" Inherits="plmOnApp.Control_POMTemplate_Copy" %>
						...
						<TABLE class="TableHeader" height="25" cellSpacing="0" cellPadding="0" width="100%" bgColor="#ffffff"
							...
							<TR vAlign="middle">
								...
								<TD class="fontHead" align="right" width="110">
                                    <asp:Label ID="lblRecPerPage" runat="server"></asp:Label></TD>
								...
								<asp:TemplateColumn>
									...
									<ItemTemplate>
										<cc1:confirmedimagebutton id="imgBtnCopy" runat="server" CommandName="Copy" OnItemCommand="DataList1_ItemCommand"
											 Message="NONE" ToolTip="Click here to copy POM..."></cc1:confirmedimagebutton>
									</ItemTemplate>
								</asp:TemplateColumn>
							</Columns>
