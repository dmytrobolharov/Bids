<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BatchQ_JobGrid.aspx.vb" Inherits="plmOnApp.BatchQ_JobGrid" %>
...
<body>
    ...
    <div>		
		...
		<table style="BORDER-BOTTOM: orange thin solid; BORDER-LEFT-STYLE: none; BACKGROUND-COLOR: white"
			...
			<tr>
				<td>&nbsp;<asp:label id="lblHeader" runat="server" ForeColor="#666666" Font-Size="X-Large" Font-Names="Tahoma,Verdana"></asp:label></td>
			</tr>
		</table>
        ...
        <table cellSpacing="0" cellPadding="0" width="100%" border="0">
			<tr vAlign="top">
				<td>
					...
					<asp:datagrid id="DataGrid1" runat="server" AllowSorting="false" DataKeyField="<%#strPK%>">
						...
						<Columns>
						    <asp:TemplateColumn>
							    <HeaderTemplate>
								    <input type="checkbox" id="checkAll" onclick="CheckAll(this, 'chkSelect');" name="checkAll">
							    </HeaderTemplate>
							    <ItemTemplate>
