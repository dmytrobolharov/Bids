<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BatchQ_TechPack_Select.aspx.vb" Inherits="plmOnApp.BatchQ_TechPack_Select" %>
			...
			<tr valign="top">
				<td>
					...
					<table cellspacing="0" cellpadding="0" ><tr>
					    <td><asp:datagrid id="DataGrid1" runat="server" AllowSorting="false" DataKeyField="<%#BatchQueueTablePki%>">
					    ...
					    <%--<td valign ="top">
					        <table class="TableHeader" cellspacing="0" cellpadding="0" >
					            <tr height="25">
					                <td><asp:Label runat="server" ID="lblImagePP" CssClass="fontHead">Select option:</asp:Label></td>
					            </tr>
					            <tr >
					                <td>
					                    <asp:DropDownList runat="server" id="ddlDDNumPages">
							                <asp:ListItem Selected="True" Value="1">1 Image By Page</asp:ListItem>
							                <asp:ListItem Value="2">2 Images By Page</asp:ListItem>
							            </asp:DropDownList>
					                </td>
					            </tr>
					        </table>
