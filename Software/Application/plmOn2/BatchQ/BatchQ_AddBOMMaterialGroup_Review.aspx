<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BatchQ_AddBOMMaterialGroup_Review.aspx.vb" Inherits="plmOnApp.BatchQ_AddBOMMaterialGroup_Review" %>
...
<body>
    ...
    <div>
        ...
        <table id="Table2" class="TableHeaderGreen" cellspacing="0" cellpadding="0" width="100%" border="0"
	        runat="server">
	        <tr valign="middle">
		        <td valign="middle" align="center" width="10" height="27">
                    <img height="15" src="../System/Images/bbTbSCnr.gif" width="3" />
    ...
    <telerik:RadPane ID="RightPane" runat="server" Width="50%">      
                ...
                <table id="Table4" class="TableHeader" cellspacing="0" cellpadding="0" width="100%" border="0"
	                runat="server">
	                <tr valign="middle">
		                <td valign="middle" align="center" width="10" height="27">
                            <img height="15" src="../System/Images/bbTbSCnr.gif" width="3" />
                ...
                <asp:datagrid id="DataGrid2" runat="server" AllowSorting="false" DataKeyField="StyleMaterialCoreColorID">
				    <AlternatingItemStyle Height="20px" CssClass="AlternateItemTemplate"></AlternatingItemStyle>
					<ItemStyle Height="20px" CssClass="ItemTemplate"></ItemStyle>
					<HeaderStyle Height="25px" CssClass="TableHeader"></HeaderStyle>
					<PagerStyle Visible="False"></PagerStyle>
