<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BatchQ_ImageSearch.aspx.vb" Inherits="plmOnApp.BatchQ_ImageSearch" %>
...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        ...
        .imageDescriptionList td
        {
            width: auto;
        }
        
        .imageDescriptionList td.fontHead
        {
            padding-right: 15px;
        }
        
        .imageDescriptionList td.font span
        {
            overflow: hidden;
            text-overflow: ellipsis;
        }
			...
			<tr valign="top">
				<td>
					...
					<asp:DataList runat="server" ID="DataList1" RepeatDirection="Horizontal" DataKeyField="<%#BatchQueueTablePki%>">
					    ...
					    <ItemTemplate>
                            <table bordercolor="silver" cellspacing="0" cellpadding="0" width="100%" bgcolor="#ffffff" border="1">
							    <tr valign="top">
								    <td valign="top">
									    <table class="TableHeader" height="25" cellSpacing="0" cellpadding="0" width="100%" border="0">
										    <tr class="fontHead">
											    <td>&nbsp;
												    ...
												    <input type=radio value="<%# Eval("ImageID") %>" name="rdb" />
												    </td>
										    </tr>
									    </table>
								    </td>
								...
								<tr>
									<td class="imagePlaceList">
                                        <asp:Image id="imgListItem" runat="server"/>
                                    </td>
								</tr>
                                <tr>
							        <td class="imageDescriptionList">
