<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BatchQ_ImageReview.aspx.vb" Inherits="plmOnApp.BatchQ_ImageReview" %>
     ...
     <asp:imagebutton id="Imagebutton1" runat="server" Width="0px" Height="0px" />
        ...
        <table id="Table1" class="TableHeader" cellspacing="0" cellpadding="0" width="100%" border="0"
            ...
            <tr valign="middle">
                ...
                <td valign="top"><asp:Label runat="server" ID="Label2"><%= Me.GetSystemText("Selected Image")%></asp:Label></td>
            </tr>
        </table>         
		<table height="45" cellSpacing="0" cellpadding="0" width="100%" bgColor="#ffffff" border="0">		
			<tr>
				<td width="250" align="center" valign="middle"><asp:Image ID="imgThumb" runat="server" /></td>
				<td valign="top"><asp:placeholder id="plhXMLForm" runat="server" EnableViewState="False"></asp:placeholder></td>
			</tr>			
		</table>        
        ...
        <table class="TableHeaderGreen" cellspacing="0" cellpadding="0" width="100%" border="0"
	        ...
	        <tr valign="middle">
		        ...
		        <td><asp:Label runat="server" ID="lblStylesHdr"><%= Me.GetSystemText("Apply to:")%></asp:Label></td>
		        <td>&nbsp;</td>
	        </tr>
        </table> 
    ...
    <telerik:RadPane ID="RightPane" runat="server" Width="50%">            
                ...
                <table class="TableHeader" cellspacing="0" cellpadding="0" width="100%" border="0"
	                ...
	                <tr valign="middle">
		                ...
		                <td><%= Me.GetSystemText("Selected Pages")%></td>
	                </tr>
                </table> 
                <asp:datagrid id="DataGrid2" runat="server" AllowSorting="false" DataKeyField="WorkflowID">
				    <AlternatingItemStyle Height="20px" CssClass="AlternateItemTemplate"></AlternatingItemStyle>
					<ItemStyle Height="20px" CssClass="ItemTemplate"></ItemStyle>
					<HeaderStyle Height="25px" CssClass="TableHeader"></HeaderStyle>
					<PagerStyle Visible="False"></PagerStyle>
