<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Style_DimensionalBOM_ColorPalette.aspx.vb" Inherits="plmOnApp.Style.DimensionalBOM.Style_DimensionalBOM_ColorPalette" %>
    ...
    <form id="form1" runat="server" defaultbutton="imgBtnSearch">
			...
			<table class="TableHeader" id="toolbar" cellspacing="0" cellpadding="0" width="100%" border="0"
				...
				<tr valign="middle">
					...
					<td width="80"><cc1:confirmedimagebutton id="btnColor" runat="server" Message="NONE"></cc1:confirmedimagebutton></td>
					<td width="80"></td>
					<td>&nbsp;</td>
				</tr>
			</table>
