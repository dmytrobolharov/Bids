<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Style_DevelopmentSpec_Align.aspx.vb" Inherits="plmOnApp.Style.DevelopmentSpec.Style_DevelopmentSpec_Align" %>
<%@ Register TagPrefix="cc1" Namespace="Yunique.WebControls" Assembly="YSWebControls" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
	<head>
		<title>Spec Align</title>
						...
						<table width="100%" align="center">
							<tr>
								...
								<td align="center" width="40%"><FONT face="Microsoft Sans Serif" color="#000000" size="2"><B class="fonthead">
											<asp:label ID="lblSelUser" runat="server">Selected&nbsp;Users</asp:label></B></FONT>
								</td>
								<td width="10%"></td>
							</tr>
							<tr>
