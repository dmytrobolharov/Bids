					...
					<td valign="top" width="400">
						...
						<table cellSpacing="0" cellpadding="0" width="100%" bgColor="#cccccc" border="0">
							<tr bgColor="#ffffff">
								...
								<td width="100" bgcolor="#ffffff" class="fontHead"><asp:label id="lblStartDate" runat="server" CssClass="fontHead">Planned Start:</asp:label></td>
								<td bgcolor="#ffffff">
							...
							<tr bgColor="#f2f2f9">
								<td width="10" height="25">&nbsp;</td>
								<td width="100" bgcolor="#f2f2f9" class="fontHead"><asp:label id="lblDueDate" runat="server" CssClass="fontHead">Planned End:</asp:label>
								</td>
								<td bgColor="#f2f2f9">
							...
							<tr bgColor="#f2f2f9">
								...
								<td bgcolor="#f2f2f9">
                                    ...
                                    <asp:HiddenField ID="hdnStyleStatus" runat="server" />
							</tr>
                            <tr bgColor="#ffffff">
								<td width="10" height="25"</td>
								<td width="100" bgcolor="#ffffff" class="fontHead" style="HEIGHT: 12px"><asp:label id="lblActualStart" runat="server" CssClass="fontHead">Actual Start:</asp:label></td>
								<td bgcolor="#ffffff"><asp:label id="lblActualStartDate" runat="server" CssClass="font"></asp:label></td>
                            </tr>
							<tr bgColor="#f2f2f9">
								<td width="10" height="25"</td>
								<td width="100" bgcolor="#f2f2f9" class="fontHead"><asp:label id="lblActualEnd" runat="server" CssClass="fontHead">Actual End:</asp:label></td>
								<td bgcolor="#f2f2f9"><asp:label id="lblActualEndDate" runat="server" CssClass="font"></asp:label></td>
							</tr>
						</table>
					</td>
					<td valign="top">
