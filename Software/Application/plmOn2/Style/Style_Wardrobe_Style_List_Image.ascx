<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Style_Wardrobe_Style_List_Image.ascx.vb" Inherits="plmOnApp.Style.Wardrobe.Style_Wardrobe_Style_List_Image" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
