<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Style_3D_Files.aspx.vb" Inherits="plmOnApp.Style.Files3D.Style_3D_Files" %>
...
<body>
    ...
    <asp:DataList ID="DataList1" runat="server" RepeatLayout="Flow" RepeatDirection="Horizontal" DataKeyField="Style3DFileID"
        ...
        <EditItemTemplate>
            <table class="TableHeader" cellspacing="0" cellpadding="0" width="100%" border="0">
                <tr>
                    ...
                    <td>
                        ...
                        <asp:LinkButton ID="btnEditDownload" runat="Server" CommandName="download" OnClientClick="dont_show_wait_next_time();"></asp:LinkButton>
            ...
            <asp:HiddenField runat="server" ID="hdnFileShared" Value='<%# DataBinder.Eval(Container.DataItem, "Style3DFileShared").ToString %>' />
                ...
                <tr>
                    ...
                    <td class="font" colspan="2">
                        <asp:CheckBox ID="cbFileShared" runat="server" ForeColor="Red"
                            Checked='<%# Convert.ToBoolean(DataBinder.Eval(Container.DataItem, "Style3DFileShared")).ToString %>'>
                        </asp:CheckBox>
                    </td>
                </tr>
                <tr>                    
