...
<script type="text/javascript" language="javascript">
    ...
    function disable_waittext_for_calendar() {
        ...
        for (i = 0; i < allelements.length; i++)
            if (allelements[i].href.substr(0, 19) == 'javascript:calendar' || allelements[i].href.substr(0, 23) == 'javascript:customwindow' || allelements[i].href.substr(0, 27) == 'javascript:tradepopupwindow') 
...
'</div>');
           ...
           // document.getElementById("mainF").contentWindow.document.body.onunload = function () { show_wait_text(); busyBox.Show(); }
            document.getElementById("mainF").contentWindow.onbeforeunload = function () { 
                if (window.frames[1].document.location.href.indexOf("Style_Document_Edit.aspx") == -1) {
	...
	<FRAMESET cols="<%=FrameSize%>,*" bordercolor="#ebebeb" onload="">
		...
		<frame name="main" id="mainF" src="<%=URLMain%>" scrolling="auto" marginheight=0 marginwidth=0 onload="addUnload();">
	</FRAMESET>
