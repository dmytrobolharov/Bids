<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Style_DimensionalBOM_Read.aspx.vb" Inherits="plmOnApp.Style.DimensionalBOM.Style_DimensionalBOM_Read" %>
        ...
        <table cellspacing="1" width="80%">            
            <tr>
                <td nowrap="nowrap">
                    ...
                    <asp:DropDownList Enabled="false" ID="ddlDim1" runat="server">
                    </asp:DropDownList>
                ...
                <td nowrap="nowrap">
                    ...
                    <asp:DropDownList Enabled="false" ID="ddlDim2" runat="server">
                    </asp:DropDownList>
                ...
                <td nowrap="nowrap">
                    ...
                    <asp:DropDownList Enabled="false" ID="ddlDim3" runat="server">
                    </asp:DropDownList>
...
<%--    <asp:Panel ID="pnlQtyMgmt" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        $(document).ready(function () {
            if ($.support.cssFloat) { // check for not ie
