<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Style_Delete.aspx.vb" Inherits="plmOnApp.Style_Delete"%>
		...
		<form id="Form1" method="post" runat="server">
			<table cellspacing="0" cellpadding="0" width="100%" border="0" bgcolor="#ffffff">
				<tr>
					...
					<td>
						<asp:Label id="lblHeader" runat="server" CssClass="fontHead">You are about to delete this style</asp:Label></td>
				</tr>
			</table>
