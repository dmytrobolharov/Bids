<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Style_New_Copy_Final.aspx.vb" Inherits="plmOnApp.Style_New_Copy_Final" %>
					...
					<td>
						<table cellSpacing="0" cellpadding="0" width="100%" border="0">
							<tr>
								...
								<td width="100"><asp:checkbox id="chbStyleCarryOver" runat="server" CssClass="fontRed" Font-Bold="True" Text="Carry Over?"></asp:checkbox></td>
