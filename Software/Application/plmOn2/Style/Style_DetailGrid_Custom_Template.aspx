<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Style_DetailGrid_Custom_Template.aspx.vb" Inherits="plmOnApp.Style.DetailGrid.Style_DetailGrid_Custom_Template" %>
...
<body>
    <form id="form1" runat="server">
			...
			<asp:datagrid id="DataGrid1" runat="server" DataKeyField="TemplateDetailGridID" AutoGenerateColumns="False" AllowSorting="true">
