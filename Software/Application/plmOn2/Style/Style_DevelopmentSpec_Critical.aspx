<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Style_DevelopmentSpec_Critical.aspx.vb" Inherits="plmOnApp.Style.DevelopmentSpec.Style_DevelopmentSpec_Critical" %>
							...
							<Columns>
								<asp:TemplateColumn>
									...
									<ItemTemplate>
										...
										<asp:HiddenField ID="fx_chkDelete" runat="server" />
									</ItemTemplate>
								</asp:TemplateColumn>
								<asp:TemplateColumn>
									<HeaderTemplate>
