...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Style_NBOL_Template.aspx.vb" Inherits="plmOnApp.Style.BOLNew.Style_NBOL_Template" %>
			...
			<table cellSpacing="0" cellpadding="0" width="100%" border="0">
				<tr valign="top">
					<td>
						...
						<asp:datagrid id="DataGrid1" runat="server" DataKeyField="TemplateID" AutoGenerateColumns="False">
							...
							<Columns>
								<asp:TemplateColumn>
									...
									<ItemTemplate>
										...
										<asp:TextBox id="txtTemplateCode" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container.DataItem, "TemplateCode")%>'>
										</asp:TextBox>
									</ItemTemplate>
								</asp:TemplateColumn>
							</Columns>
