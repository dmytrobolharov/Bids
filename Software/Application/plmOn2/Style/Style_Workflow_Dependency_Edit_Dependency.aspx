<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Style_Workflow_Dependency_Edit_Dependency.aspx.vb" Inherits="plmOnApp.Style_Workflow_Dependency_Edit_Dependency" %>
...
<body>
    ...
    <telerik:RadGrid ID="dgrRequirements" runat="server" 
        ...
        <MasterTableView Width="100%" EditMode="InPlace" CommandItemDisplay="Top" DataKeyNames="WorkflowTemplateItemDepID, DependentOnWorkflowTemplateItemID, WorkflowStatusID" DataSourceID="SqlDataSource1" HorizontalAlign="NotSet" AutoGenerateColumns="False" ShowHeader="False">
            <Columns>
                ...
                <telerik:GridDropDownColumn DataField="WorkflowTemplateItemID" DataSourceID="SqlDataSource2"
                    HeaderText="Workflow" ListTextField="Workflow" ListValueField="WorkflowTemplateItemID"
                    UniqueName="WorkflowTemplateItemID" ColumnEditorID="GridDropDownListColumnEditor2">
                </telerik:GridDropDownColumn>
                ...
                <telerik:GridDropDownColumn DataField="WorkflowStatusID" DataSourceID="SqlDataSource3"
                    HeaderText="WorkflowStatus" ListTextField="WorkflowStatus" ListValueField="WorkflowStatusID"
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SQLCACHECONNECTION %>"></asp:SqlDataSource>
    
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:SQLCACHECONNECTION %>"></asp:SqlDataSource>
    
    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:SQLCACHECONNECTION %>"></asp:SqlDataSource>
    
    <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:SQLCACHECONNECTION %>"
        ProviderName="System.Data.SqlClient" SelectCommand="select * from pWorkflowRule order by WorkflowRuleDesc">
    </asp:SqlDataSource>
