<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Style_Marker_FromBF_ADD.aspx.vb" Inherits="plmOnApp.Style.Marker.Style_Marker_FromBF_ADD" %>
...
<HEAD>
		<title runat="server" id="PageTitle">Style_Marker_FromBF_ADD</title>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR vAlign="top">
					<TD>
						...
						<asp:datagrid id="Datagrid1" runat="server" AllowSorting="False" AutoGenerateColumns="false" DataKeyField="ID">
