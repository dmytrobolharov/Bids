<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Style_ColorwaySeasonal_Edit.aspx.vb" Inherits="plmOnApp.Style.ColorwaySeasonal.Style_ColorwaySeasonal_Edit" %>
...
<%@ Register TagPrefix="uc4" TagName="Style_Change_Alert" Src="Style_Change_Alert.ascx" %>
...
<div id="fixed_icons"><a href="../Help/Help_Folder.aspx?Folder=<%= Folder %>&HID=<%= HelpID %>" title="Help" target="_blank" id="yHelp"></a></div>
    <form id="form1" runat="server">
			...
			<asp:panel id="pnlChange" runat="server">
			    <uc4:Style_Change_Alert id="Style_Change_Alert1" runat="server"></uc4:Style_Change_Alert>
			</asp:panel>
...
<%--			<asp:Panel ID="pnlSeasonYear"  runat="server"  >		
            ...
            <br /> 
            <asp:datagrid id="dgColorway" runat="server" BorderStyle="NotSet" AllowSorting="true" DataKeyField="StyleColorwaySeasonYearID"
