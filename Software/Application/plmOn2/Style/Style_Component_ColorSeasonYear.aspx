<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Style_Component_ColorSeasonYear.aspx.vb" Inherits="plmOnApp.Style.Material.Style_Component_ColorSeasonYear" %>
        ...
        <table class="TableHeader" cellspacing="0" cellpadding="0" width="100%" border="0">
	            <tr>
		            ...
		            <td ><cc1:confirmedimagebutton 
		                id="btnAdd" runat="server" Message="NONE" ></cc1:confirmedimagebutton><asp:ImageButton 
		                id="btnClose" runat ="server" OnClientClick="return btnClose_Click()" />
		            </td>
	            </tr>
            </table>
            <table class="TableHeader" cellspacing="0" cellpadding="0" width="100%" border="0">
