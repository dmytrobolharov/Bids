<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Style_Link_Break.aspx.vb" Inherits="plmOnApp.Style_Link_Break" %>
<%@ Register TagPrefix="cc1" Namespace="Yunique.WebControls" Assembly="YSWebControls" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Break Links</title>
		 ...
		 <table cellspacing="0" cellpadding="0" width="100%" border="0">
          ...
          <cc1:ScrollingGrid ID="ScrollingGrid1" runat="server" Height="700px" Width="100%">
                  <asp:datagrid id="DataGrid1" runat="server" AutoGenerateColumns="False" 
                       DataKeyField="StyleID" BorderStyle="Solid">
