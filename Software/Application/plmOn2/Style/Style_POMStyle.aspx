...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Style_POMStyle.aspx.vb" Inherits="plmOnApp.Style.Measurements.Style_POMStyle" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<table style="BORDER-BOTTOM: orange thin solid; BORDER-LEFT-STYLE: none; BACKGROUND-COLOR: white"
				...
				<tr>
					<td>&nbsp;<asp:label id="lblMaterialHeader" runat="server" ForeColor="#E0E0E0" Font-Size="X-Large" Font-Names="Tahoma,Verdana">Select Style Spec</asp:label></td>
				</tr>
			</table>
						...
						<asp:datagrid id="DataGrid1" runat="server" AutoGenerateColumns="False">
							...
							<Columns>
								<asp:TemplateColumn>
									...
									<ItemTemplate>
										<cc1:confirmedimagebutton id="imgBtnCopy" runat="server" CommandName="Copy" OnItemCommand="DataList1_ItemCommand"
										 Message='<%#GetSystemText("Are you sure you want to copy this POM?")%>' ToolTip='<%#GetSystemText("Click here to copy POM...")%>' ></cc1:confirmedimagebutton>
										<asp:TextBox id="txtStyleNo" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "StyleNo")%>' Visible="false">
										</asp:TextBox>
									</ItemTemplate>
								</asp:TemplateColumn>
							</Columns>
