...
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Style_DimensionalBOM.ascx.vb" Inherits="plmOnApp.Style.DimensionalBOM.Style_DimensionalBOM2" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
