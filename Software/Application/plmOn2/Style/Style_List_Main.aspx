...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Style_List_Main.aspx.vb" Inherits="plmOnApp.Style_List_Main" %>
		...
		<form id="Form1" method="post" runat="server">
			<table class="TableHeader" id="toolbar" cellSpacing="0" cellpadding="0" width="100%" border="0"
				...
				<tr valign="middle">
					...
					<td width="400"><cc1:confirmedimagebutton id="btnNew" runat="server"  Message="NONE"
							CausesValidation="False"></cc1:confirmedimagebutton><cc1:confirmedimagebutton id="btnCopy" runat="server"  Message="NONE"
							CausesValidation="False"></cc1:confirmedimagebutton><cc1:confirmedimagebutton id="btnSearch" runat="server"  Message="NONE"
							CausesValidation="False"></cc1:confirmedimagebutton><cc1:confirmedimagebutton id="btnDelete" runat="server"  Message="NONE"
				...
				<table class="TableHeader" height="25" cellSpacing="0" cellpadding="0" width="100%"
					...
					<tr valign="middle">
						...
						<td class="FontHead">
							...
							<cc1:confirmedimagebutton id="btnCalDay" runat="server" CausesValidation="False" Message="NONE" ></cc1:confirmedimagebutton></td>
					</tr>
				</table>
					...
					<tr>
						<td valign="top">
							<asp:panel id="pnlWeek" runat="server">
								<cc2:ysxdayscalendar id="YSXDaysCalendar1" runat="server" TableBodyCssClass="CalendarBody" TableHeaderCssClass="CalendarHeader"
									TableWeekendBodyCssClass="CalendarBodyWeekend" TableWeekendHeaderCssClass="CalendarHeaderWeekend"
									HeaderDateFormat=" ddd, MMM dd" TableTodayBodyCssClass="CalendarBodyToday" TableTodayHeaderCssClass="CalendarHeaderToday"
									Days="7" TableTitleHeaderCssClass="CalendarTitleHeader" Width="100%" NextWeek='<img src="../System/Icons/arrow_right.gif"  border="0" />'
									PreviousWeek='<img src="../System/Icons/arrow_left.gif"  border="0" />'
									NextFormat="MMM dd" PreviousFormat="MMM dd"
									>
									<ItemTemplate>
										<%# GetCalendarLink(Container.DataItem("PKeyId").ToString, Container.DataItem("CalendarLinkId").ToString, Container.DataItem("CalendarLinkSubId").ToString, GetLocalTime ( Container.DataItem("CalendarDate")).ToString, Container.DataItem("CalendarType").ToString, Container.DataItem("CalendarStatus").ToString, Container.DataItem("CalendarDescription").ToString) %>
									</ItemTemplate>
								</cc2:ysxdayscalendar>
							</asp:panel>
