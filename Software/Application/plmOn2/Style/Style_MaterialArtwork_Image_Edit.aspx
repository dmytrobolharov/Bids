<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Style_MaterialArtwork_Image_Edit.aspx.vb" Inherits="plmOnApp.Style.ArtworkImage.Style_MaterialArtwork_Image_Edit" %>
					   ...
					   <tr>
						...
						<tr>
							...
							<td valign="top" style="height:150;" rowspan="2">	
							    <input id="txtStyleMaterialID" type="hidden" value='<%# DataBinder.Eval(Container.DataItem, "StyleMaterialID") %>' runat="server" />						   							
					...
					<table style="border-color:silver" cellspacing="2" cellpadding="2" width="100%" border="0">
					   <tr>
						...
						<tr>
							...
							<td valign="top" style="height:150;" rowspan="2">	
							    <input id="txtStyleColorwayArtworkID" type="hidden" value='<%# DataBinder.Eval(Container.DataItem, "StyleColorwayArtworkID") %>' runat="server" />						   							
								<input id="txtImageVersion" type="hidden" value='<%# DataBinder.Eval(Container.DataItem, "ImageVersion") %>' runat="server" />
								<input id="txtImageID" type="hidden" value='<%# DataBinder.Eval(Container.DataItem, "ImageID") %>' runat="server" />
							</td>						
						</tr>
