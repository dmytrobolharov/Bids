...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Style_DimensionalMultiBOMSelect.aspx.vb" Inherits="plmOnApp.Style.DimensionalBOM.Style_DimensionalMultiBOMSelect" %>
...
//		    }
			    ...
			    <table class="TableHeader" height="30" cellSpacing="0" cellpadding="0" width="100%" border="0">
			        <tr>                                           
                        <td>
                            ...
                            <asp:CustomValidator id="QtyValidator" ControlToValidate="txtApplyQty" ClientValidationFunction="ValidateQty" Display="Dynamic" 
                                                        ErrorMessage="*" ToolTip="Invalid decimal format!" runat="server"/>&nbsp;
    ...
    <script type='text/javascript'>
        function ValidateQty(sender, args) {
            var QtyString = document.getElementById(sender.controltovalidate).value;
            var regex = /<%= strRegExp %>/
            if (regex.test(QtyString)) {
                args.IsValid = true;
            } else {
                args.IsValid = false;
            }
