...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Style_DesignDetail_Copy.aspx.vb" Inherits="plmOnApp.Style.DesignDetail.Style_DesignDetail_Copy" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<table style="BORDER-BOTTOM: orange thin solid; BORDER-LEFT-STYLE: none; BACKGROUND-COLOR: white"
				...
				<tr>
					<td>&nbsp;<asp:label id="lblMaterialHeader" runat="server" ForeColor="#E0E0E0" Font-Size="X-Large" Font-Names="Tahoma,Verdana">Select Design Detail Copy</asp:label></td>
				</tr>
			</table>
						...
						<asp:datagrid id="DataGrid1" runat="server" DataKeyField="StyleID" AutoGenerateColumns="False">
							...
							<Columns>
								<asp:TemplateColumn>
									...
									<ItemTemplate>
										<cc1:confirmedimagebutton id="imgBtnCopy" runat="server" Message="NONE"
											 ToolTip='<%#GetSystemText("Click here to copy Style Design Detail")%>' OnItemCommand="DataList1_ItemCommand"
