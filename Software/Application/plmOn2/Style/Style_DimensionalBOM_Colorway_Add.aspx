...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Style_DimensionalBOM_Colorway_Add.aspx.vb" Inherits="plmOnApp.Style.DimensionalBOM.Style_DimensionalBOM_Colorway_Add" %>
...
<html>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<uc1:style_component_header id="Style_Component_Header1" runat="server" SMID='<%# Request.Querystring("SMID") %>' MTID='<%# Request.Querystring("MTID") %>' FS='<%# Request.Querystring("FS") %>' EnableViewState="False">
