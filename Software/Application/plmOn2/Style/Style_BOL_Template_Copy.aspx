<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Style_BOL_Template_Copy.aspx.vb"
    Inherits="plmOnApp.Style.BOL.Style_BOL_Template_Copy" %>
...
<body>
    ...
    <table class="TableHeader" id="TableHeader" cellspacing="0" cellpadding="0" width="100%"
        ...
        <tr valign="middle">
            ...
            <td>
                <cc1:ConfirmedImageButton ID="btnCopy" runat="server" ToolTip="Add..." Message="NONE"/>
