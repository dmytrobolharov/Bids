<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Style_ColorGroup_Add.aspx.vb" Inherits="plmOnApp.Style.ColorGroup.Style_ColorGroup_Add" %>
                    ...
                    <Columns>
                        <asp:TemplateColumn>
	                        ...
	                        <ItemTemplate>
		                        ...
		                        <%--<input type ="hidden"  runat="server"  id="hdnStyleColorGroupID" />--%>
