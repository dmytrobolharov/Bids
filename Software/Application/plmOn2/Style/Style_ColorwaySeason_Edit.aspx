<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Style_ColorwaySeason_Edit.aspx.vb" Inherits="plmOnApp.Style.ColorwaySeasonal.Style_ColorwaySeason_Edit" %>
...
<div id="fixed_icons"><a href="../Help/Help_Folder.aspx?Folder=<%= Folder %>&HID=<%= HelpID %>" title="Help" target="_blank" id="yHelp"></a></div>
    <form id="form1" runat="server">
            ...
            <asp:datagrid id="dgColorway" runat="server" BorderStyle="NotSet" AllowSorting="true"
