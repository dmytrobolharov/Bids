<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Style_Model_DELETE.aspx.vb" Inherits="plmOnApp.Style.Model.Style_Model_DELETE" %>
    ...
    <body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<table style="BORDER-BOTTOM: orange thin solid; BORDER-LEFT-STYLE: none; BACKGROUND-COLOR: white"
				...
				<tr>
					<td>&nbsp;<asp:label id="lblHeader" runat="server" ForeColor="#E0E0E0" Font-Size="Large" Font-Names="Tahoma,Verdana">Delete Model</asp:label></td>
				</tr>
			</table>
