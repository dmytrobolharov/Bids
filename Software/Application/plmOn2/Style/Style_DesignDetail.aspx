<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Style_DesignDetail.aspx.vb" Inherits="plmOnApp.Style.DesignDetail.Style_DesignDetail" %>
...
<html>
    ...
    <div id="fixed_icons"><a href="../Help/Help_Folder.aspx?Folder=<%= Folder %>&HID=<%= HelpID %>" title="Help" target="_blank" id="yHelp"></a></div>
		<form id="Form1" method="post" runat="server">
			...
			<asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="StyleDesignDetailID" BorderColor="#E0E0E0"
