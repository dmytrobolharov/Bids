...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Style_NBOL_Template_ReLink.aspx.vb" Inherits="plmOnApp.Style.BOLNew.Style_NBOL_Template_ReLink" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>UnLinked Items</title>
		...
		<form id="Form1" method="post" runat="server">
			<table class="TableHeader" id="toolbar" cellSpacing="0" cellPadding="0" width="100%" border="0"
				...
				<tr vAlign="middle">
					...
					<td>
						<cc1:confirmedimagebutton id="btnSave" runat="server"  Message="Do you want to link item(s)?"></cc1:confirmedimagebutton>
