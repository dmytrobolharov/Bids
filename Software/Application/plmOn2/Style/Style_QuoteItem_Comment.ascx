<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Style_QuoteItem_Comment.ascx.vb" Inherits="plmOnApp.Style.Quote.Style_QuoteItem_Comment" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<asp:panel id="Panel2" runat="server" CssClass="font" BorderWidth="1" Width="100%" BorderColor="Silver"
	...
	<TABLE cellSpacing="0" cellPadding="0" width="100%">
		<TR class="TableHeaderGreen">
			...
			<TD class="fontHead"><asp:Label ID="lblNewComm" runat="server" Text="New Comment:"></asp:Label></TD>
		</TR>
	...
	<asp:datalist id="DataList1" runat="server" BackColor="White" BorderStyle="Solid" BorderColor="WhiteSmoke"
		Width="100%" BorderWidth="0px" DataKeyField="StyleQuoteCommentID" OnEditCommand="DataList_EditCommand"
				...
				<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
					<TR class="TableHeader">
						...
						<TD>
							...
							<cc1:ConfirmedLinkButton id="Linkbutton4" runat="Server" CommandName="delete" 
								Message='<%#GetSystemText("Are you sure you want to Delete this comment?")%>' Visible="TRUE" NAME="Linkbutton4"></cc1:ConfirmedLinkButton>
							<asp:linkbutton id="Linkbutton3" runat="Server" CommandName="cancel" 
								NAME="Linkbutton3"></asp:linkbutton></TD>
					</TR>
					<TR>
						<TD class="font" width="20">&nbsp;</TD>
						<TD class="font" vAlign="top">
							<asp:TextBox id=txtComments runat="server" Width="350" Text='<%# DataBinder.Eval(Container.DataItem, "StyleQuoteComment").ToString  %>' TextMode="MultiLine" ToolTip='<%#GetSystemText("Enter your comments here...")%>' Height="150">
							</asp:TextBox></TD>
					<TR>
						<TD width="20">&nbsp;</TD>
