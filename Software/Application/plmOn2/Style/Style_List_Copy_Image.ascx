<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Style_List_Copy_Image.ascx.vb" Inherits="plmOnApp.Style_List_Copy_Image" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<%@ Register TagPrefix="ys001" Namespace="Yunique.WebControls" Assembly="YSWebControls" %>
<table class='<%= GetTableHeaderClass() %>' id="Table2" height="20" cellspacing="0" cellpadding="0" width="100%"
    border="0">
	<TR class="fontHead">
		...
		<TD height="25">
			<DIV align="left"><B><asp:label id="lblRecordCount" Visible="false" Runat="server"></asp:label>&nbsp;<asp:Label
                    ID="RecordCount" runat="server" ></asp:Label>
					</B></DIV>
			</B></TD>
		<TD height="25">
