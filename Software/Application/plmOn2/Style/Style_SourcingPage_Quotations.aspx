...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Style_SourcingPage_Quotations.aspx.vb" Inherits="plmOnApp.Style.Sourcing.Style_SourcingPage_Quotations" %>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR vAlign="top">
					<TD>
						...
						</asp:datagrid><asp:label id="SortOrder" runat="server" Visible="False" Text="StyleQuoteItemNo DESC"></asp:label></TD>
				</TR>
			</TABLE>
		</form>
	</body>
