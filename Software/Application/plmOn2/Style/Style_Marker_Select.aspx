<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Style_Marker_Select.aspx.vb" Inherits="plmOnApp.Style.Marker.Style_Marker_Select" %>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR vAlign="top">
					<TD>
						...
						<asp:datagrid id="DataGrid1" runat="server" DataKeyField="Marker_Code" >
