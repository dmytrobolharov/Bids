<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Style_Marker_FromBody_Select.aspx.vb" Inherits="plmOnApp.Style.Marker.Style_Marker_FromBody_Select" %>
...
<HEAD>
		<title runat="server" id="PageTitle">Style_Body</title>
...
<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server" defaultbutton="imgBtnSearch">
			<table class="TableHeader" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr vAlign="middle">
					<td><cc1:confirmedimagebutton id="btnClose" runat="server" Message="NONE" OnClientClick="window.close();"></cc1:confirmedimagebutton></td>
				</tr>
			</table>
			<table style="BORDER-BOTTOM: orange thin solid; BORDER-LEFT-STYLE: none; BACKGROUND-COLOR: white"
				height="45" cellSpacing="0" cellPadding="0" width="100%" bgColor="#ffffff" border="0">
				<tr>
					<td>&nbsp;<asp:label id="lblHeader" runat="server" ForeColor="#E0E0E0" Font-Size="Large" Font-Names="Tahoma,Verdana">Select Marker</asp:label></td>
				</tr>
			</table>
					...
					<TD>
						<TABLE class="TableHeader" height="25" cellSpacing="0" cellPadding="0" width="100%" bgColor="#ffffff"
							...
							<TR vAlign="middle">
								...
								<TD width="20"><asp:imagebutton id="btnImgNext" runat="server" 
                                        ImageUrl="../System/Icons/icon_next.gif" style="width: 16px"></asp:imagebutton></TD>
						...
						<asp:datagrid id="DataGrid1" runat="server" DataKeyField="BodyID" EnableViewState="False">
