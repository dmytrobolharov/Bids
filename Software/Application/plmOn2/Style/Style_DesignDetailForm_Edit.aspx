        ...
        <telerik:RadScriptManager runat="server" ID="RadScriptManager1" />
			<table class="TableHeader" id="toolbar" cellspacing="0" cellpadding="0" width="100%" border="0"
				...
				<tr valign="middle">
					...
					<td noWrap width="850">
					<cc1:confirmedimagebutton id="btnTextImageGoTo" runat="server"  Message="NONE" disabled="true"></cc1:confirmedimagebutton>
					<cc1:confirmedimagebutton id="btnSave" runat="server"  Message="NONE" disabled="true"></cc1:confirmedimagebutton>
					<cc1:bwimagebutton id="btnImageNew" runat="server" disabled="true"></cc1:bwimagebutton>
					<cc1:bwimagebutton id="btnImageSelect" runat="server" disabled="true"></cc1:bwimagebutton>
					<cc1:bwimagebutton id="btnImageSort" runat="server" disabled="true"></cc1:bwimagebutton>
					<cc1:confirmedimagebutton id="btnCopy" runat="server"  Message="NONE" disabled="true"></cc1:confirmedimagebutton>
					<cc1:bwimagebutton id="btnImageRemove" runat="server" disabled="true"></cc1:bwimagebutton>
					<cc1:confirmedimagebutton id="btnClose" runat="server"  Message="NONE" OnClientClick="return btnClose_Click()" disabled="true"></cc1:confirmedimagebutton>
                    <cc1:bwimagebutton id="btnChangeLog" runat="server"  CausesValidation="false" OnClientClick="javascript:Page_ValidationActive = false;" disabled="true"></cc1:bwimagebutton>				
					</td>
					...
					<table style="border-color:silver" cellspacing="2" cellpadding="2" width="100%" border="0">
						<tr>
							...
							<td valign="top" style="height:150;" rowspan="2">
							    <telerik:RadEditor runat="server" ID="txtComment" Width="680px" MaxTextLength="2000" EditModes="Design" spellchecks>
                                    <Tools>
