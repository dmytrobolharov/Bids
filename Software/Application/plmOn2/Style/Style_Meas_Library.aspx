<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Style_Meas_Library.aspx.vb" Inherits="plmOnApp.Style.Measurements.Style_Meas_Library" %>
...
<html>
	...
	<body >
		...
		{
			e=frm.elements[i];
			if (e.type == 'checkbox' && e.name.indexOf("chbPOMCompanyId") != -1)
			e.checked= actVar ;
		}
		}
