...
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Style_Component.ascx.vb" Inherits="plmOnApp.Style.Material.Style_Component2" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
	...
	<Columns>
	    <asp:TemplateColumn>
	        <ItemTemplate>
	            ...
	            <tr> <td >
                    <asp:datagrid id="DataGrid1" runat="server" Width="100%" AllowSorting="false" AllowPaging="false">
