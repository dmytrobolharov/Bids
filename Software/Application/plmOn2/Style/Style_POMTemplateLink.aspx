<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Style_POMTemplateLink.aspx.vb" Inherits="plmOnApp.Style.Measurements.Style_POMTemplateLink" %>
						...
						<asp:datagrid id="DataGrid1" runat="server" AutoGenerateColumns="False" DataKeyField="POMTempID">
							...
							<Columns>
								<asp:TemplateColumn>
									...
									<ItemTemplate>
										<cc1:confirmedimagebutton id="imgBtnCopy" runat="server"  Message='<%#GetSystemText("Are you sure you want to link this POM?")%>'
											ToolTip='<%#GetSystemText("Click here to link POM") & "..."%>' OnItemCommand="DataList1_ItemCommand" CommandName="Copy"></cc1:confirmedimagebutton>
