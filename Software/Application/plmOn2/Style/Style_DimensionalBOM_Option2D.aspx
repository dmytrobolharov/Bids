<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Style_DimensionalBOM_Option2D.aspx.vb" Inherits="plmOnApp.Style.DimensionalBOM.Style_DimensionalBOM_Option2D" %>
...
<div id="fixed_icons"><a href="../Help/Help_Folder.aspx?Folder=<%= Folder %>&HID=<%= HelpID %>" title="Help" target="_blank" id="yHelp"></a></div>
    ...
    <asp:DataGrid id="DataGrid1" runat="server" AllowSorting="false" DataKeyField="ItemDim3Id" >
