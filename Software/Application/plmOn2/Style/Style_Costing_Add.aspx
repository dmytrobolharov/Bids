...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Style_Costing_Add.aspx.vb" Inherits="plmOnApp.Style.Costing.Style_Costing_Add"%>
				...
				<Columns>
					...
					<asp:TemplateColumn>
						...
						<ItemTemplate>
							...
							<asp:DropDownList id="ddlDimensionalBOM" runat="server" CssClass="fontHead" Width="120"></asp:DropDownList>
						</ItemTemplate>
					</asp:TemplateColumn>
					<asp:TemplateColumn>
						<HeaderTemplate>
