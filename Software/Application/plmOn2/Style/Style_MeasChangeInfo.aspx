...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Style_MeasChangeInfo.aspx.vb" Inherits="plmOnApp.Style.Measurements.Style_MeasChangeInfo" %>
					...
					<td valign="top" width="100%" bgColor="#ffffff">					    
							<table class="TableHeader" cellspacing="0" cellpadding="0" width="100%" border="0">
								<tr>
									...
									<td><asp:label id="lblPreviousMeasHeader" runat="server">Previous Worksheet Information</asp:label></td>
								</tr>
							</table>							
				...
				<tr>
					<td valign="top" width="100%" bgColor="#ffffff">					    
						<table class="TableHeader" cellspacing="0" cellpadding="0" width="100%" border="0">
							<tr>
								<td valign="middle" align="center" width="10" height="25"><IMG height="15" src="../System/Images/bbTbSCnr.gif" width="3"></td>
								<td><asp:label id="lblMeasHeader" runat="server">Change Worksheet Information</asp:label></td>
							</tr>
						</table>							
				...
				<tr>
					<td valign="top" width="100%" bgColor="#ffffff">
					    <table class="TableHeader" cellspacing="0" cellpadding="0" width="100%" border="0">	
					        <tr>
								<td valign="middle" align="center" width="10" height="25"><IMG height="15" src="../System/Images/bbTbSCnr.gif" width="3"></td>
								<td><asp:label id="Label1" runat="server">Selection Options</asp:label></td>
							</tr>
						</table>	
						<asp:CheckBox ID="ChbPrimaryKeys" runat="server" CssClass="FontHead" Text="" checked="false" />
                        <br />								                		    							
		                <asp:CheckBox ID="ChbKeepsamplesizemeas" runat="server" CssClass="FontHead" Text="" checked="True" />
                        <br />
                        <asp:CheckBox ID="ChbOverrideDesc" runat="server" Text="" CssClass="FontHead" checked="false" />
                        <br />
			            <asp:CheckBox ID="ChbKeepExistingPOM" runat="server" Text="" CssClass="FontHead" checked="false"/>
                        <br />
                        <asp:CheckBox ID="ChbOverrideRules" runat="server" Text="" CssClass="FontHead" checked="True"/>	
                        <br />
                        <asp:CheckBox ID="chbRemoveRules" runat="server" Text="" CssClass="FontHead" checked="False"/>
		            </td>						
				</tr>
			</table>						
