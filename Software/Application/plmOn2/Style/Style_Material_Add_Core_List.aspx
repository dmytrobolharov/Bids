<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Style_Material_Add_Core_List.aspx.vb" Inherits="plmOnApp.Style.Material.Style_Material_Add_Core_List" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<table class="TableHeader" id="Table1" cellSpacing="0" cellpadding="0" width="100%" border="0"
				...
				<tr valign="middle">
					...
					<td><cc1:confirmedimagebutton id="btnClose" runat="server" OnClientClick="return btnClose_Click()"
