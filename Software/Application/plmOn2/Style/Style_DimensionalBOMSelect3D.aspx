...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Style_DimensionalBOMSelect3D.aspx.vb" Inherits="plmOnApp.Style.DimensionalBOM.Style_DimensionalBOMSelect3D" %>
...
<%--			         <asp:datagrid id="DataGrid1" runat="server"  BorderColor="#E0E0E0" BorderStyle="Solid" BorderWidth="1px"
                    ...
                    <asp:DataGrid id="DataGrid1" runat="server" AllowSorting="false" DataKeyField="DimRowId" >
	                    <AlternatingItemStyle Height="20px" CssClass="AlternateItemTemplate"></AlternatingItemStyle>
	                    <ItemStyle Height="20px" CssClass="ItemTemplate"></ItemStyle>
	                    <HeaderStyle Height="25px" CssClass="TableHeader"></HeaderStyle>
			...
			<asp:Panel ID="pnlPrice"  runat="server"> 
			    ...
			    <div id="divPrice">
                    ...
                    <asp:DataGrid id="DataGrid2" runat="server" AllowSorting="false" DataKeyField="DimRowId" >
	                    <AlternatingItemStyle Height="20px" CssClass="AlternateItemTemplate"></AlternatingItemStyle>
	                    <ItemStyle Height="20px" CssClass="ItemTemplate"></ItemStyle>
	                    <HeaderStyle Height="25px" CssClass="TableHeader"></HeaderStyle>
	                    <PagerStyle Visible="False"></PagerStyle>
			...
			<asp:Panel ID="pnlColor"  runat="server" >	
			 ...
			 <%--   <table cellspacing="0" cellpadding="0" width="100%" border="0">
                    ...
                    <asp:DataGrid id="DataGrid3" runat="server" AllowSorting="false" DataKeyField="DimRowId" >
	                    <AlternatingItemStyle Height="20px" CssClass="AlternateItemTemplate"></AlternatingItemStyle>
	                    <ItemStyle Height="20px" CssClass="ItemTemplate"></ItemStyle>
	                    <HeaderStyle Height="25px" CssClass="TableHeader"></HeaderStyle>
	                    <PagerStyle Visible="False"></PagerStyle>
			...
			<asp:Panel ID="pnlTreatment"  runat="server" >	
			    ...
			    <%--<table cellspacing="0" cellpadding="0" width="100%" border="0">
                    ...
                    <asp:DataGrid id="DataGrid4" runat="server" AllowSorting="false" DataKeyField="DimRowId" >
	                    <AlternatingItemStyle Height="20px" CssClass="AlternateItemTemplate"></AlternatingItemStyle>
	                    <ItemStyle Height="20px" CssClass="ItemTemplate"></ItemStyle>
	                    <HeaderStyle Height="25px" CssClass="TableHeader"></HeaderStyle>
	                    <PagerStyle Visible="False"></PagerStyle>
