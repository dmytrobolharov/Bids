			...
			<asp:Panel runat="server" ID="pnlContent" Visible="true">
			    ...
			    <table cellSpacing="0" cellPadding="0" width="100%" bgColor="white" border="0">
				    <tr vAlign="top">
					    ...
					    <td valign="top"><asp:label id="SortOrder" runat="server" Visible="False" Text="sortid"></asp:label><asp:image id="imgDesign" style="display:none" runat="server" BorderColor="Transparent"></asp:image></td>
