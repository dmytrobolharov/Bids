<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Style_Model_Select.aspx.vb" Inherits="plmOnApp.Style.Model.Style_Model_Select" %>
...
<HEAD>
		<title runat="server" id="PageTitle">Style_Model</title>
...
<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server" defaultbutton="imgBtnSearch">
			...
			<table style="BORDER-BOTTOM: orange thin solid; BORDER-LEFT-STYLE: none; BACKGROUND-COLOR: white"
				...
				<tr>
					<td>&nbsp;<asp:label id="lblHeader" runat="server" ForeColor="#E0E0E0" Font-Size="Large" Font-Names="Tahoma,Verdana">Select Model</asp:label></td>
				</tr>
			</table>
					...
					<TD>
						<TABLE class="TableHeader" height="25" cellSpacing="0" cellPadding="0" width="100%" bgColor="#ffffff"
							...
							<TR vAlign="middle">
								...
								<TD noWrap align="center" width="85"><asp:label id="lblPageCount" runat="server" CssClass="fontHead"></asp:label></TD>
								...
								<TD class="fontHead" align="right" width="110">
                                    <asp:Label ID="lblPOMperPage" runat="server" >Records per Page:</asp:Label></TD>
						...
						<asp:datagrid id="DataGrid1" runat="server" DataKeyField="Model_Code" >
