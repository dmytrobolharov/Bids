<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Style_3D_File.aspx.vb" Inherits="plmOnApp.Style.Files3D.Style_3D_File" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        window.onload = function () {
            ...
            canvas.attr("height", $(document).height() - 60);
