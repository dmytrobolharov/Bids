	...
	<head runat="server">
        ...
        <script type="text/javascript">
            function sortRows2(txtSort) {
                ...
                var currentTable = $('.dlSortable')
                if (isNaN(newSort)) {
                    newSort = 0;
                };
                var currentTable = $(txtSort).closest('.dlSortable');
                ...
                var firstRowVal = parseInt(currentTable.find('span.BOMColorChip:first').find("input[id$='hdnSort']").val(), 10);
                if (newSort < firstRowVal) {
                    newSort = firstRowVal;
                }
                else if (newSort > lastRowVal) {
                    newSort = lastRowVal;
                }
                ...
                else if (draggingRow.html() == lastRow.html()) {
                    if (newSort == firstRowVal) {
                        draggingRow.insertBefore(currentTable.find('span.BOMColorChip:first')); // And inserting our row before it
                        wasInserted = true;
                    }
                }
		...
		<form id="Form1" method="post" runat="server">
            ...
            <div id="divStyleColors" style="overflow: auto; height: 430px; border-bottom: 1px solid gainsboro;">
                <asp:Repeater runat="server" id="repeater1">
                   <HeaderTemplate>
                    <asp:Label ID="lblRepeater1" runat="server"></asp:Label><br />
                    <table>
                </HeaderTemplate> 
                <ItemTemplate>
                <tr>
                    <td>
                        <asp:Label ID="lblMaterial" runat="server"></asp:Label><br />
                    </td>
                    <td>
                       <asp:DataList id="dtlMaterials"
                               BorderColor="black"
                               CellPadding="5"
                               CellSpacing="5"
                ...
                <asp:Repeater ID="repeater2" runat="server">
                    <HeaderTemplate>
                        <asp:Label ID="lblRepeater2" runat="server"></asp:Label><br />
                        <table>
                    </HeaderTemplate> 
                    <ItemTemplate>
                        <tr>
