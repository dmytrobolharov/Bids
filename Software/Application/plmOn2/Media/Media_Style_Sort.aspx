...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Media_Style_Sort.aspx.vb" Inherits="plmOnApp.Media_Style_Sort" %>
	...
	<body>
		<form id="Form1" method="post" runat="server">
				...
				<TBODY>
					<TR vAlign="middle">
						...
						<TD vAlign="middle" align="left" width="400"><cc1:confirmedimagebutton id="btnSave" runat="server" Message="NONE" ></cc1:confirmedimagebutton>
							<cc1:confirmedimagebutton id="Confirmedimagebutton1" runat="server" Message="NONE"></cc1:confirmedimagebutton></TD>
						<TD></TD>
					</TR>
				</TBODY>
			</TABLE>
			<table style="BORDER-BOTTOM: orange thin solid; BORDER-LEFT-STYLE: none; BACKGROUND-COLOR: white"
				...
				<tr>
					<td>&nbsp;<asp:label id="lblHeader" runat="server" ForeColor="#E0E0E0" Font-Size="X-Large" Font-Names="Tahoma,Verdana">Custom</asp:label></td>
				</tr>
			</table>
