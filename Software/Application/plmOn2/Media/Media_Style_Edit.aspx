...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Media_Style_Edit.aspx.vb" Inherits="plmOnApp.Media_Style_Edit" %>
		...
		<form id="Form1" method="post" runat="server">
			<table class="TableHeader" id="toolbar" cellSpacing="0" cellPadding="0" width="100%" border="0"
				...
				<tr vAlign="middle">
					...
					<cc1:confirmedimagebutton id="btnDelete" runat="server"  Message="Are you sure you want to delete it?"></cc1:confirmedimagebutton>
