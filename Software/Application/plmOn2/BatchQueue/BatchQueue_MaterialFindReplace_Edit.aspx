<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BatchQueue_MaterialFindReplace_Edit.aspx.vb" Inherits="plmOnApp.BatchQueue_MaterialFindReplace_Edit" %>
			...
			<table cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr vAlign="top">
					<td>
						...
						<asp:datagrid id="DataGrid1" runat="server" DataKeyField="BatchQueueID" AllowSorting="True">
        ...
        <script language="javascript" type="text/javascript">
            ...
            function SelectAll(checkAllBox) {
                ...
                for (i = 0; i < frm.length; i++) {
                    e = frm.elements[i];
                    if (e.type == 'checkbox' && e.name.indexOf("chbBatchQueueID") != -1)
                        e.checked = actVar;
                }
            }
        </script>
