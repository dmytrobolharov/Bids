<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BatchQueue_Main.aspx.vb" Inherits="plmOnApp.BatchQueue_Main" %>
			...
			<table width="100%" height="90%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td valign="top" bgcolor="#ffffff"><table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td><div align="right">
										<asp:Label id="lblHeader" runat="server" Font-Size="XX-Large" ForeColor="Silver">Batch Queue</asp:Label></div>
								</td>
							</tr>
						</table>
