<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TechPack_Status_Edit.aspx.vb" Inherits="plmOnApp.TechPack_Status_Edit" %>
    ...
    <div id="fixed_icons"><a href="../Help/Help_Folder.aspx?Folder=<%= Folder %>&HID=<%= HelpID %>" title="Help" target="_blank" id="yHelp"></a></div>
		<form id="Form1" method="post" runat="server">
            ...
            <table style="border-bottom: orange thin solid; border-left-style: none; height: 24px; background-color: white"
				...
				<tr>
					<td height="24">&nbsp;<asp:label id="lbHeader" runat="server" Font-Names="Tahoma,Verdana" Font-Size="X-Large" ForeColor="#E0E0E0"><%= GetSystemText("Tech Pack") %>&nbsp;<%= GetSystemText("Status") %></asp:label></td>
				</tr>
			</table>
			<uc1:Style_Header id="Style_Header1" runat="server" IsCollapsible="true" IsCollapsed="true"></uc1:Style_Header>
					...
					<td valign="top">
						...
						<table cellspacing="0" cellpadding="0" width="100%" bgColor="#cccccc" border="0">
							<tr bordercolor="#cddeee" bgColor="#f2f2f9">
								...
								<td>&nbsp;
									<asp:CheckBox id="cbAddToComment" runat="server" Visible="true" CssClass="fontHead" Text="Add to Comment Page"></asp:CheckBox></td>
							</tr>
							<tr bgColor="#ffffff">
			...
			<table width="100%" height="300" border="1" cellpadding="0" cellspacing="0" bordercolor="#cccccc">
				<tr>
					...
					<td valign="top"><table class="TableHeaderOver" height="24" cellspacing="0" cellpadding="0" width="100%"
						...
						<asp:DataGrid id="DataGrid1" runat="server" DataKeyField="StyleTechPackChangeID" BorderColor="#E0E0E0"
