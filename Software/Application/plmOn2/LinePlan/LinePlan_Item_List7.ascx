<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="LinePlan_Item_List7.ascx.vb" Inherits="plmOnApp.LinePlan_Item_List7" %>
...
<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
	<TR vAlign="top">
		<TD>
            ...
            <asp:HiddenField ID="hdnCurrentIndex" runat="server" Value="0" /></TD>
	</TR>
</TABLE>