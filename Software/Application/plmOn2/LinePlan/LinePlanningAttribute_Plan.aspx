<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LinePlanningAttribute_Plan.aspx.vb" Inherits="plmOnApp.LinePlanningAttribute_Plan" %>
			...
			<TABLE class="TableHeader" id="toolbar" cellSpacing="0" cellPadding="0" width="100%" border="0"
				...
				<TR vAlign="middle">
					...
					<TD><asp:imagebutton id="btnInvSearch" runat="server" Height="0px" Width="0px" ImageUrl="../System/icons/1x1.gif"></asp:imagebutton>
                        ...
                        <cc1:confirmedimagebutton id="btnAttributeAllocationAdd" runat="server" Message="NONE"></cc1:confirmedimagebutton></TD>
					<td>&nbsp;</td>
				</TR>
			</TABLE>
