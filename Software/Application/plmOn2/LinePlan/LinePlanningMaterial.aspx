<%@ Page Language="vb" AutoEventWireup="false" Codebehind="LinePlanningMaterial.aspx.vb" Inherits="plmOnApp.LinePlanningMaterial"%>
			...
			<TABLE class="TableHeader" id="toolbar" cellSpacing="0" cellPadding="0" width="100%" border="0"
				...
				<TR vAlign="middle">
					...
					<TD><asp:imagebutton id="btnInvSearch" runat="server" Height="0px" Width="0px" ImageUrl="../System/icons/1x1.gif"></asp:imagebutton>
                        <cc1:confirmedimagebutton id="btnMaterialAdd" runat="server" Message="NONE"></cc1:confirmedimagebutton>
                        <cc1:confirmedimagebutton id="btnMaterialAllocationAdd" runat="server" Message="NONE"></cc1:confirmedimagebutton>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR vAlign="top">
					<TD>
						...
						<asp:datagrid id="DataGrid1" runat="server" DataKeyField="LinePlanMaterialID">
