<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LinePlanningStyle_Range_Remove.aspx.vb" Inherits="plmOnApp.LinePlanningStyle_Range_Remove" %>
							...
							<Columns>
							    <asp:TemplateColumn>
							        <ItemTemplate>
							            ...
							            <input type ="hidden"  runat="server"  id="hdnStyleSeasonYearID" />
							        </ItemTemplate>
							    </asp:TemplateColumn>
							</Columns>
