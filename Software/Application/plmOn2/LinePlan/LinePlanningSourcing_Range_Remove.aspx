<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LinePlanningSourcing_Range_Remove.aspx.vb" Inherits="plmOnApp.LinePlanningSourcing_Range_Remove" %>
    ...
    <form id="form1" runat="server">
        ...
        <table cellSpacing="0" cellPadding="0" width="100%" border="0" class="TableHeader">
			<tr>
				...
				<td>&nbsp;<asp:Label ID="lblTitle" runat="server" Text="">Silhouette</asp:Label></td>
			</tr>
		</table>
