<%@ Page Language="vb" AutoEventWireup="false" Codebehind="LinePlan_StyleChannel.aspx.vb" Inherits="plmOnApp.LinePlan_StyleChannel" %>
		...
		<form id="Form1" method="post" runat="server">
			<table class="tableHeader" id="toolbar" cellSpacing="0" cellPadding="0" width="100%" border="0"
				...
				<tr vAlign="middle">
					...
					<td>
						<asp:ImageButton id="btnSaveStyle" runat="server" ></asp:ImageButton><cc1:confirmedimagebutton id="btnClose" runat="server" Message="NONE" CausesValidation="False"></cc1:confirmedimagebutton></td>
				</tr>
			</table>			
