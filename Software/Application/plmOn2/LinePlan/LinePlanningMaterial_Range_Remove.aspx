<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LinePlanningMaterial_Range_Remove.aspx.vb" Inherits="plmOnApp.LinePlanningMaterial_Range_Remove" %>
		...
		<table cellSpacing="0" cellPadding="0" width="100%" bgColor="#ffffff" border="0">
			<tr>
				<td>&nbsp;<asp:label id="lblBodyHeader" runat="server" ForeColor="#E0E0E0" 
                        Font-Size="X-Large" Font-Names="Tahoma,Verdana">Material Folder</asp:label></td>
			</tr>
		</table>
