<%@ Page Language="vb" AutoEventWireup="false" Codebehind="LinePlanningTradePartner_Allocation.aspx.vb" Inherits="plmOnApp.LinePlanningTradePartner_Allocation" %>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<table style="BORDER-BOTTOM: orange thin solid; BORDER-LEFT-STYLE: none; BACKGROUND-COLOR: white"
				...
				<tr>
					<td>&nbsp;<asp:label id="lblTradePartnerVendor" runat="server" ForeColor="Gray" 
