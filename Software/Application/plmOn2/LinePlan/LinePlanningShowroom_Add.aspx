<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LinePlanningShowroom_Add.aspx.vb" Inherits="plmOnApp.LinePlanningShowroom_Add" %>
...
<body>
    <form id="form1" runat="server">
			...
			<table cellSpacing="0" cellPadding="0" width="100%" bgColor="#ffffff" border="0">
				<tr>
					<td>&nbsp;<asp:label id="lblHeader" runat="server" ForeColor="#E0E0E0" Font-Size="X-Large" Font-Names="Tahoma,Verdana">Showroom</asp:label></td>
				</tr>
			</table>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR vAlign="top">
					<TD>
						...
						<asp:datagrid id="DataGrid1" runat="server" DataKeyField="ShowroomID" BorderStyle="Solid" BorderWidth="1px">
