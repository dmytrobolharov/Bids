...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="LinePlanningAttribute_Remove.aspx.vb" Inherits="plmOnApp.LinePlanningAttribute_Remove" %>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR vAlign="top">
					<TD>
						...
						<asp:datagrid id="DataGrid1" runat="server" DataKeyField="LinePlanStyleAttributeID" BorderStyle="Solid" BorderWidth="1px" PageSize="50" >
