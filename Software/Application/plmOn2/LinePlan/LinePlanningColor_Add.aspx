...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="LinePlanningColor_Add.aspx.vb" Inherits="plmOnApp.LinePlanningColor_Add" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<!-- 
LinePlanColorPalette_Search.xml
LinePlanColorPalette_Default.xml
-->
<HTML>
	<HEAD>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR vAlign="top">
					<TD>
						...
						<asp:datagrid id="DataGrid1" runat="server" DataKeyField="ColorPaletteID" BorderStyle="Solid" BorderWidth="1px">
