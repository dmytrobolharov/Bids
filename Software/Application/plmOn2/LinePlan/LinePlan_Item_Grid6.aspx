<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LinePlan_Item_Grid6.aspx.vb" Inherits="plmOnApp.LinePlan_Item_Grid6" %>
    ...
    <form id="form1" runat="server">
			<table class="TableHeader" id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0"
				...
				<tr vAlign="middle">
					...
					<td>
					<cc1:confirmedimagebutton id="btnSave" runat="server" Message="NONE"  Visible="false"></cc1:confirmedimagebutton>
					<cc1:confirmedimagebutton id="btnBodyAllocation" runat="server"  Message="NONE"></cc1:confirmedimagebutton>
