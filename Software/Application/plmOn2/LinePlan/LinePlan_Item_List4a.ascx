<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="LinePlan_Item_List4a.ascx.vb" Inherits="plmOnApp.LinePlan_Item_List4a" %>
...
<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
	<TR vAlign="top">
		<TD>
			...
			<asp:datagrid id="DataGrid1" runat="server" DataKeyField="LinePlanItemID" BackColor="White">
