<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LinePlan_List_Grid.aspx.vb" Inherits="plmOnApp.LinePlan_List_Grid" %>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR vAlign="top">
					<TD>
						...
						<asp:datagrid id="DataGrid1" runat="server" DataKeyField="LinePlanID">
							<AlternatingItemStyle Height="20px" CssClass="AlternateItemTemplate"></AlternatingItemStyle>
							<ItemStyle CssClass="ItemTemplate"></ItemStyle>
							<HeaderStyle CssClass="TableHeader" Height="25px"></HeaderStyle>
							<PagerStyle Visible="False"></PagerStyle>
						</asp:datagrid><asp:label id="SortOrder" runat="server" Visible="False"></asp:label>
                        <asp:HiddenField ID="hdnCurrentPageIndex" runat="server" Value="0" />
                        </TD>
				</TR>
			</TABLE>
			</asp:Panel>
