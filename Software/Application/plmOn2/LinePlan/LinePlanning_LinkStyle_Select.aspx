<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LinePlanning_LinkStyle_Select.aspx.vb" Inherits="plmOnApp.LinePlanning_LinkStyle_Select" %>
		            ...
		            <td>
			            ...
			            <tr>
			                <td>
                                ...
                                <asp:datagrid id="DataGrid1" runat="server"  EnableViewState="true" DataKeyField="StyleID">
