...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="LinePlanningTradePartner_Range_Add.aspx.vb" Inherits="plmOnApp.LinePlanningTradePartner_Range_Add" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
			...
			<table cellSpacing="0" cellPadding="0" width="100%" bgColor="#ffffff" border="0">
				<tr>
					<td>&nbsp;<asp:label id="lblTradeHeader" runat="server" ForeColor="#E0E0E0" 
                            Font-Size="X-Large" Font-Names="Tahoma,Verdana">Agents & Vendors</asp:label></td>
				</tr>
			</table>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR vAlign="top">
					<TD>
						...
						<asp:datagrid id="DataGrid1" runat="server" DataKeyField="TradePartnerVendorID" 
		...
		<SCRIPT language="javascript">
			...
			{
				e=frm.elements[i];
				if (e.type == 'checkbox' && e.name.indexOf("chbTradePartnerVendorID") != -1)
				e.checked= actVar ;
			}
			}
		</SCRIPT>
