...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="LinePlanItemMultiCloth2_Body_Add.aspx.vb" Inherits="plmOnApp.LinePlanItemMultiCloth2_Body_Add" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Body Add</title>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR vAlign="top">
					<TD>
						...
						<asp:datagrid id="DataGrid1" runat="server" DataKeyField="LinePlanBodyItemID" BorderStyle="Solid" BorderWidth="1px" AllowSorting="true">
				            ...
				            <Columns>
                                <asp:TemplateColumn>
                                    <ItemTemplate>
                                        <input type="radio" name="rbSelected" value='<%# Eval("LinePlanBodyItemID") %>' />
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                            </Columns>
