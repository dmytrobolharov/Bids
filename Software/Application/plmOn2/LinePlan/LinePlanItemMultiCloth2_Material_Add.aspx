...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="LinePlanItemMultiCloth2_Material_Add.aspx.vb" Inherits="plmOnApp.LinePlanItemMultiCloth2_Material_Add" %>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE class="TableHeader" id="toolbar" cellSpacing="0" cellPadding="0" width="100%" border="0"
				...
				<tr vAlign="middle">
					...
					id="btnClose" runat="server" Message="NONE" ></cc1:confirmedimagebutton OnClientClick="return btnClose_Click()"></td>
				</tr>
			</TABLE>
				...
				<TR vAlign="top">
					<TD>
						...
						<asp:datagrid id="DataGrid1" runat="server" DataKeyField="MaterialID" 
                            BorderStyle="Solid" BorderWidth="1px" AllowSorting="true" 
