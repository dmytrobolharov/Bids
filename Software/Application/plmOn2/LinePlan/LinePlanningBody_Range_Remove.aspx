<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LinePlanningBody_Range_Remove.aspx.vb" Inherits="plmOnApp.LinePlanningBody_Range_Remove" %>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR vAlign="top">
					<TD>
						...
						<asp:datagrid id="DataGrid1" runat="server" AllowSorting="True" DataKeyField="LinePlanBodyItemID">
