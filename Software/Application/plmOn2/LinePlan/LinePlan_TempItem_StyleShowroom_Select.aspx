<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LinePlan_TempItem_StyleShowroom_Select.aspx.vb" Inherits="plmOnApp.LinePlan_TempItem_StyleShowroom_Select" %>
...
<body>
    <form id="form1" runat="server">
	    ...
	    <table cellSpacing="0" cellPadding="0" width="100%" bgColor="#ffffff" border="0">
			<TR>
				<TD>&nbsp;
					<asp:label id="lbHeader" runat="server" Font-Names="Tahoma,Verdana" Font-Size="X-Large" ForeColor="#E0E0E0"></asp:label></TD>
			</TR>
		</table>
	            ...
	            <td>
		            <table  class="TableHeader" height="25" cellspacing="0" cellpadding="0" width="100%" bgColor="#ffffff"
			            ...
			            <tr valign="middle">
				            ...
				            <td class="fonthead" align="right" width="110"><asp:Label ID="lblRecordsperPage" runat="server" Visible="true"></asp:Label></td>
		                ...
		                <td>
                                <asp:datagrid id="DataGrid1" runat="server"  EnableViewState="False" DataKeyField="StyleID" >
                                    ...
                                    <Columns>
                                        <asp:TemplateColumn>
                                            <HeaderTemplate>
                                                <input type="checkbox" onclick="SelectAll(this, 'chkSelected')" id="chkSelectAll" />
                                            </HeaderTemplate>
                                            <ItemTemplate>
		...
		<script language="javascript">
		    ...
		    function SelectAll(checkAllBox, obj) {
