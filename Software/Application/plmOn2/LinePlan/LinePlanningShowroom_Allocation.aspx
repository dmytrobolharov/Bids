<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LinePlanningShowroom_Allocation.aspx.vb" Inherits="plmOnApp.LinePlanningShowroom_Allocation" %>
...
<body>
    <form id="form1" runat="server">
			...
			<table style="BORDER-BOTTOM: orange thin solid; BORDER-LEFT-STYLE: none; BACKGROUND-COLOR: white"
				...
				<tr>
					<td>&nbsp;<asp:label id="lblShowroom" runat="server" ForeColor="Gray" 
