<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LinePlanningAttribute.aspx.vb" Inherits="plmOnApp.LinePlanningAttribute" %>
	    ...
	    <TABLE class="TableHeader" id="toolbar" cellSpacing="0" cellPadding="0" width="100%" border="0"
		    ...
		    <TR vAlign="middle">
			    ...
			    <TD><asp:imagebutton id="btnInvSearch" runat="server" Height="0px" Width="0px" ImageUrl="../System/icons/1x1.gif"></asp:imagebutton>
                    <cc1:confirmedimagebutton id="btnAttributeAdd" runat="server" Message="NONE"></cc1:confirmedimagebutton>
                    <cc1:confirmedimagebutton id="btnAttributeAllocationAdd" runat="server" Message="NONE" style="height: 24px"></cc1:confirmedimagebutton>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR vAlign="top">
					<TD>
						...
						<asp:datagrid id="DataGrid1" runat="server" DataKeyField="LinePlanStyleAttributeID" AllowSorting="true">
