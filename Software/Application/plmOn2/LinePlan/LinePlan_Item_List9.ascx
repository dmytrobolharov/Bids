<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="LinePlan_Item_List9.ascx.vb" Inherits="plmOnApp.LinePlan_Item_List9" %>
<%@ Register TagPrefix="cc1" Namespace="Yunique.WebControls" Assembly="YSWebControls" %>


<asp:datalist id="dlStyles" runat="server" DataKeyField="LinePlanShowroomStyleColorID" 
    ...
    <table id="tbItem" runat="server" bordercolor='#CCCCCC'  border="1"  cellpadding="0" cellspacing="0" >
        ...
        <tr><td align="center"><asp:datalist id="dlColors" runat="server" DataKeyField="StyleColorID" Width="100%"
                    ...
                    CellPadding="0" CellSpacing="0" RepeatColumns="5" OnItemDataBound="dlColors_ItemDataBound">
                        ...
                        <ItemTemplate>
                   		    <TABLE  width="250">
	                            <TR><TD valign="top" align="center"><asp:Image id="imgLineImage" runat="server" ></asp:Image></TD></TR>
