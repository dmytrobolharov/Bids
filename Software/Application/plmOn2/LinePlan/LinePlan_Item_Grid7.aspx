<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LinePlan_Item_Grid7.aspx.vb" Inherits="plmOnApp.LinePlan_Item_Grid7" %>
    ...
    <form id="form1" runat="server">
			<table class="TableHeader" id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0"
				...
				<tr vAlign="middle">
					...
					<td>
                        <cc1:confirmedimagebutton id="btnColorAllocation" runat="server"  Message="NONE" ></cc1:confirmedimagebutton>
