<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LinePlan_Item_Material.aspx.vb" Inherits="plmOnApp.LinePlan_Item_Material" %>
		         ...
		         <asp:DataList ID="dlGroups" runat ="server"  RepeatDirection="Vertical" Width="100%" RepeatColumns="1" >
		                 <ItemTemplate>
                            ...
                            <tr >
                                ...
                                <td  valign="top" style="width:100px;">
                                    <asp:PlaceHolder ID="pnlMaterial" runat ="server" ></asp:PlaceHolder>
                                                                    <br/>
