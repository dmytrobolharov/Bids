...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="LinePlanningTradePartner_Add.aspx.vb" Inherits="plmOnApp.LinePlanningTradePartner_Add" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Trade Partner Add</title>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR vAlign="top">
					<TD>
						...
						<asp:datagrid id="DataGrid1" runat="server" DataKeyField="TradePartnerVendorID" BorderStyle="Solid" BorderWidth="1px">
