<%@ Control Language="vb" AutoEventWireup="false" Codebehind="LinePlanningCopyImage.ascx.vb" Inherits="plmOnApp.LinePlanningCopyImage" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<TABLE class="TableHeader" id="Table2" height="20" cellSpacing="0" cellPadding="0" width="100%"
	...
	<TR class="fontHead">
		...
		<TD width="20" height="25">
			<DIV align="center">
			<asp:imagebutton id="btnImgFirst" runat="server" ImageUrl="../System/Icons/icon_first.gif" OnClick="ShowFirstPage"></asp:imagebutton>			
			</DIV>
		</TD>
		<TD width="20" height="25">
		...
		<TD width="20" height="25">
			<DIV align="center">
			   <asp:imagebutton id="btnImgNext" runat="server" ImageUrl="../System/Icons/icon_next.gif" OnClick="ShowNextPage"></asp:imagebutton>			
			</DIV>
		</TD>
		<TD width="20" height="25">
			<DIV align="center">
			   <asp:imagebutton id="btnImgLast" runat="server" ImageUrl="../System/Icons/icon_last.gif" OnClick="ShowLastPage"></asp:imagebutton>
			</DIV>
		</TD>
		<TD height="25">
			<DIV align="left"><B><asp:label id="lblRecordCount" Visible="true" Runat="server"></asp:label>&nbsp;
			<asp:Label ID="lblRecFound" runat="server" Text="Records Found"></asp:Label></B></DIV>
			</B></TD>
		<TD height="25">
