<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LinePlanningShowRoomStyle_Range_Remove.aspx.vb" Inherits="plmOnApp.LinePlanningShowRoomStyle_Range_Remove" %>
    ...
    <form id="form1" runat="server">
        ...
        <table cellSpacing="0" cellPadding="0" width="100%" border="0" class="TableHeader">
			<tr>
				...
				<td>&nbsp;<asp:Label ID="lblTitle" runat="server" Text="">Style</asp:Label></td>
			</tr>
		</table>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR vAlign="top">
					<TD>
						...
						<asp:datagrid id="DataGrid1" runat="server" AllowSorting="True" DataKeyField="LinePlanItemID">
							...
							<Columns>
							    <asp:TemplateColumn>
							        <ItemTemplate>
							            ...
							            <input type ="hidden"  runat="server"  id="hdnLinePlanID" />
							            <input type ="hidden"  runat="server"  id="hdnLinePlanRangeID" />
							        </ItemTemplate>
							    </asp:TemplateColumn>
							</Columns>
