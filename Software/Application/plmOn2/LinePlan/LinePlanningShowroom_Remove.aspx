...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="LinePlanningShowroom_Remove.aspx.vb" Inherits="plmOnApp.LinePlanningShowroom_Remove" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<head>
		<title>Showroom Remove</title>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR vAlign="top">
					<TD>
						...
						<asp:datagrid id="DataGrid1" runat="server" DataKeyField="ShowroomID" BorderStyle="Solid" BorderWidth="1px" PageSize="50" >
