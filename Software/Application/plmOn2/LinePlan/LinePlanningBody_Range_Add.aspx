<!--
LinePlanBody_Search_Default.xml
LinePlanBody_Default.xml
spx_LinePlanBodyItemRange_SELECT
spx_LinePlanBodyItem_INSERT
-->

<%@ Register TagPrefix="cc1" Namespace="Yunique.WebControls" Assembly="YSWebControls" %>
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="LinePlanningBody_Range_Add.aspx.vb" Inherits="plmOnApp.LinePlanningBody_Range_Add" %>
			...
			<table cellSpacing="0" cellPadding="0" width="100%" bgColor="#ffffff" border="0">
				<tr>
					<td>&nbsp;<asp:label id="lblBodyHeader" runat="server" ForeColor="#E0E0E0" 
                            Font-Size="X-Large" Font-Names="Tahoma,Verdana">Body Folder</asp:label></td>
				</tr>
			</table>
