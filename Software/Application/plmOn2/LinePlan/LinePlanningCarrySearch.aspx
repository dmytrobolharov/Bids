...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="LinePlanningCarrySearch.aspx.vb" Inherits="plmOnApp.LinePlanningCarrySearch" %>
			...
			<TABLE class="TableHeader" id="toolbar" cellSpacing="0" cellPadding="0" width="100%" border="0"
				...
				<tr vAlign="middle">
					...
					<td><asp:imagebutton 
					    ...
					    id="imgBtnClose" runat="server"  Message="NONE" Visible="true" OnClientClick="return btnClose_Click()"></cc1:confirmedimagebutton></td>
				</tr>
			</TABLE>
			<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
				<tr>
					<td>&nbsp;<asp:Label id="lblHeader" runat="server" Font-Names="Tahoma,Verdana" Font-Size="X-Large" ForeColor="#E0E0E0">Carry Over</asp:Label></td>
				</tr>
			</table>
