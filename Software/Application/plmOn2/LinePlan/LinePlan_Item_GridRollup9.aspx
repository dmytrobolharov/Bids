<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LinePlan_Item_GridRollup9.aspx.vb" Inherits="plmOnApp.LinePlan_Item_GridRollup9" %>
	    ...
	    <table class="TableHeader" id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0"
		    ...
		    <tr vAlign="middle">
			    ...
			    <td><asp:imagebutton id="btnInvSearch" runat="server" ImageUrl="../System/icons/1x1.gif" Width="0px"
							Height="0px"></asp:imagebutton><cc1:confirmedimagebutton id="btnClose" runat="server" Message="NONE" ></cc1:confirmedimagebutton>
