<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Share_Main.aspx.vb" Inherits="plmOnApp.Share_Main"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title runat="server" id="PageTitle">Share Folder</title>
			...
			<table width="100%" height="90%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td valign="top" bgcolor="#ffffff"><table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td><div align="right">
										<asp:Label id="lblHeader" runat="server" Font-Size="XX-Large" ForeColor="Silver">Share Folder</asp:Label></div>
								</td>
							</tr>
						</table>
