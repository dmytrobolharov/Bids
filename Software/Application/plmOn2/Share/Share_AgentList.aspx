<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Share_AgentList.aspx.vb" Inherits="plmOnApp.Share_AgentList"%>
<%@ Register TagPrefix="cc1" Namespace="Yunique.WebControls" Assembly="YSWebControls" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title runat="server" id="PageTitle">Share Agent List</title>
