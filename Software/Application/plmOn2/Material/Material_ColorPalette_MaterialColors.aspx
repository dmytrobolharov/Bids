<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Material_ColorPalette_MaterialColors.aspx.vb" Inherits="plmOnApp.Material_ColorPalette_MaterialColors" %>
    ...
    <form id="form1" runat="server">
        ...
        <table class="TableHeader" cellspacing="0" cellpadding="0" width="100%" border="0">
            <tr>
                ...
                <td>&nbsp;<asp:Label ID="lblColorPalette" runat="server"></asp:Label></td>
                <td>&nbsp;</td>
            </tr>
        </table>		    
