<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Material_Group_ColorsReplace.aspx.vb" Inherits="plmOnApp.Material_Group_ColorsReplace" %>
    ...
    <form id="form1" runat="server">
            ...
            <table class="TableHeader" cellspacing="0" cellpadding="0" width="100%" border="0">
	            <tr>
					...
					id="btnSelect" runat="server" Message="NONE" ></cc1:confirmedimagebutton>
		            </td>
	            </tr>
            </table>
            <table class="TableHeader" cellspacing="0" cellpadding="0" width="100%" border="0">
