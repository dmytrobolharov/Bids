<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="MaterialRequest_Document_Edit.aspx.vb" Inherits="plmOnApp.MaterialRequest_Document_Edit" %>
							...
							<TD vAlign="top">
								<TABLE cellSpacing="0" cellPadding="0" width="400" border="0">
									...
									<TR>
										<TD width="10" height="35">&nbsp;</TD>
										<TD class="fontHead" colSpan="2" height="35">&nbsp;&nbsp;
											<asp:CheckBox id="cbFileShared" visible="true" runat="server" ForeColor="Red" Text="<%# GetCheckBoxTextDefault() %>" Checked='<%# GetCheckBoxBooleanDefault(DataBinder.Eval(Container.DataItem, "MaterialDocumentShared").ToString)  %>'>
											</asp:CheckBox>
