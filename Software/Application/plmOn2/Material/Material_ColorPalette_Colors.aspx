	        ...
	        <table id="Table2" border="0" cellpadding="0" cellspacing="0" 
                ...
                <tr class="fontHead">
                    ...
                    <td height="25" width="20">
                        <div align="center">
                        <asp:imagebutton id="btnImgFirstRecord" runat="server" 
                                ImageUrl="../System/Icons/icon_first.gif" 
                                style="width: 16px"></asp:imagebutton> 
                                </div>
                    </td>
                    <td height="25" width="20">
                        <div align="center">
                        <asp:imagebutton id="btnImgPreviousRecord" runat="server" ImageUrl="../System/Icons/icon_Previous.gif" ></asp:imagebutton>                       
                                </div>
                    </td>
