<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Material_WorkflowPage_Edit.aspx.vb" Inherits="plmOnApp.Material_WorkflowPage_Edit" %>
    ...
    <div id="fixed_icons"><a href="../Help/Help_Folder.aspx?Folder=<%= Folder %>&HID=<%= HelpID %>" title="Help" target="_blank" id="yHelp"></a></div>
		<form id="Form1" method="post" runat="server">
            ...
            <table style="border-bottom: orange thin solid; border-left-style: none; height: 24px; background-color: white"
				...
				<tr>
					<td height="24">&nbsp;<asp:label id="lbHeader" runat="server" Font-Names="Tahoma,Verdana" Font-Size="X-Large" ForeColor="#E0E0E0"><%= strWorkflowPageName %>&nbsp;<%= GetSystemText("Status") %></asp:label></td>
				</tr>
			</table>
			<uc1:Material_Header id="Material_Header1" runat="server" IsCollapsible="true" IsCollapsed="true"></uc1:Material_Header>
			...
			<table width="100%" height="300" border="1" cellpadding="0" cellspacing="0" bordercolor="#cccccc">
				<tr>
					...
					<td valign="top"><table class="TableHeaderOver" height="24" cellspacing="0" cellpadding="0" width="100%"
						...
						<asp:DataGrid id="DataGrid1" runat="server" DataKeyField="MaterialChangeID" BorderColor="#E0E0E0"
