<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="Material_RequestSubmitComment.ascx.vb" Inherits="plmOnApp.Material_RequestSubmitComment" %>
                ...
                <table cellspacing="0" cellpadding="0" border="0">	
                    <tr >		
                        <td align="right" width="100">
                            <asp:CheckBox ID="chbSharedNew" runat="server" Text="Shared?&nbsp;&nbsp;" />
                            <asp:HiddenField runat="server" ID="hdnSharedNew" /></td>		
                        <td align="right" >    
                        ...
                        <table style="background-position: #fff bottom; border-bottom: #d8d9da 0px solid; border-left: #d8d9da 1px solid; background: #fff; width: 400px; border-top: #d8d9da 0px solid; border-right: #d8d9da 1px solid; TEXT-INDENT: 5px; ">
                            <tr>
                                <td>
                                    ...
                                    <asp:LinkButton ID="lnk_EditComment"  Font-Underline="True" runat="server" CommandName="edit" CssClass="fontHead" ForeColor="#0066CC" Visible='<%# ShowAddComment(Container.DataItem("CTeamID").ToString) %>'>(edit)</asp:LinkButton>
                                </td>
                            </tr>
                        </table>	
	        ...
	        <table cellspacing="0" cellpadding="0" width="100%" border="0">	
		        <tr >
			        <td>
                        ...
                        <asp:HiddenField runat="server" ID="hdnComment" Value='<%# DataBinder.Eval(Container.DataItem, "MaterialRequestSubmitComment").ToString  %>' />
                    </td>
		        </tr>
		        <tr>
		        ...
		        <tr class="TableHeader">
		            <td>
	                    <table cellspacing="0" cellpadding="0" border="0">	
		                    <tr >
			                    <td align="right" width="100">
		                            <asp:CheckBox ID="chbShared" runat="server" Text="Shared?&nbsp;&nbsp;" Checked='<%# ShowSharedComment(Container.DataItem("MaterialRequestSubmitCommentType").ToString) %>' />
                                    <asp:HiddenField runat="server" ID="hdnShared" Value='<%# ShowSharedComment(Container.DataItem("MaterialRequestSubmitCommentType").ToString) %>'/>
                                    </td>		
			                    <td align="right" >              
