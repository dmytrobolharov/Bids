<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Material_SeasonYearDelete.aspx.vb" Inherits="plmOnApp.Material_SeasonYearDelete" %>
    ...
    <form id="form1" runat="server">
        ...
        <table cellSpacing="0" cellPadding="0" width="100%" border="0" class="TableHeader">
			<tr>
				...
				<td>&nbsp;<asp:Label ID="lblTitle" runat="server" Text="">Season & Year </asp:Label></td>
			</tr>
		</table>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR vAlign="top">
					<TD>
						...
						<asp:datagrid id="DataGrid1" runat="server" AllowSorting="True" DataKeyField="MaterialSeasonYearID">
