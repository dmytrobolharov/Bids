...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Material_LabDip.aspx.vb" Inherits="plmOnApp.Material_LabDip" %>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<table style="BORDER-BOTTOM: orange thin solid; BORDER-LEFT-STYLE: none; BACKGROUND-COLOR: white"
				...
				<tr>
					<td>&nbsp;<asp:label id="lblHeader" runat="server" Font-Names="Tahoma,Verdana" Font-Size="X-Large" ForeColor="#E0E0E0">Lab Dip Folder</asp:label></td>
				</tr>
			</table>
