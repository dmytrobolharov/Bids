<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Material_List_History.aspx.vb" Inherits="plmOnApp.Material_List_History" %>
	...
	<body>
     <div id="fixed_icons"><a href="../Help/Help_Folder.aspx?Folder=<%= Folder %>&HID=<%= HelpID %>" title="Help" target="_blank" id="yHelp"></a></div>
		<form id="Form1" method="post" runat="server">
			...
			<asp:datalist id="Datalist1" runat="server" CssClass="font" Datakeyfield="MaterialID" BorderWidth="1px"
								...
								<table width="100%">
									<tr>
										<td width="85"><FONT size="1"><B>
                                            <asp:Label ID="Label1" runat="server" ><%# GetSystemText("Material No")%>:</asp:Label></B></FONT></td>
										<td><FONT size="1"><%# Container.DataItem("MaterialNo")%></FONT></td>
									</tr>
									<tr>
										<td width="85" style="height: 14px"><FONT size="1"><B>
                                            <asp:Label ID="Label2" runat="server" ><%# GetSystemText("Material Name")%>:</asp:Label></B></FONT></td>
										<td style="height: 14px"><FONT size="1"><%#Container.DataItem("MaterialName")%></FONT></td>
									</tr>
								</table>
					<INPUT id="txtMaterialNo" type="hidden" value='<%# DataBinder.Eval(Container.DataItem, "MaterialNo") %>' name="txtMaterialNo" runat="server"></td>
						</tr>
					</table>
				</ItemTemplate>
