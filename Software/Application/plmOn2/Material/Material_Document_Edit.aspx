<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Material_Document_Edit.aspx.vb" Inherits="plmOnApp.Material_Document_Edit"%>
...
<%--							  <cc1:ConfirmedImageButton ID="btnAttachMultipleFile" runat="server" Message="NONE"
        ...
        <table bordercolor="#999999" cellspacing="0" cellpadding="0" width="100%" border="0">
			<asp:datalist id="DataList1" runat="server" Width="100%" OnDeleteCommand="DataList_DeleteCommand"
				...
				DataKeyField="MaterialDocumentID" BackColor="White" BorderColor="WhiteSmoke" BorderStyle="Solid" BorderWidth="1px">
				<HeaderTemplate>
						<tr class="Toolbar">
