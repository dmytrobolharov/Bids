<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Material_Group_ColorsFolder.aspx.vb" Inherits="plmOnApp.Material_Group_ColorsFolder" %>
    ...
    <table class="TableHeader" id="toolbar" cellSpacing="0" cellPadding="0" width="100%" border="0"
		...
		<tr vAlign="middle">
			...
			<td width="80"><asp:imagebutton 
			    ...
			    id="btnClose" runat="server" OnClientClick="return btnClose_Click()" ></asp:ImageButton></td>
			<td width="80"></td>
			<td width="80"></td>
			<td>&nbsp;</td>
		</tr>
					...
					<tr>
						<td>&nbsp;
							<asp:label id="lblHeader" runat="server" ForeColor="Silver" 
                                Font-Size="X-Large" Font-Names="Tahoma,Verdana">Colors</asp:label></td>
					</tr>
				</table>
			</td>
		</tr>
