<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Material_LabDip_List.aspx.vb" Inherits="plmOnApp.Material_LabDip_List" %>
    ...
    <form id="form1" runat="server">
			<TABLE class="TableHeader" id="toolbar" cellSpacing="0" cellPadding="0" width="100%" border="0"
				...
				<TR vAlign="middle">
					...
					<TD><cc1:confirmedimagebutton id="btnPrint" runat="server" 
			...
			<table style="BORDER-BOTTOM: orange thin solid; BORDER-LEFT-STYLE: none; BACKGROUND-COLOR: white"
				...
				<tr>
					<td>&nbsp;<asp:label id="lblHeader" runat="server" ForeColor="#E0E0E0" Font-Size="X-Large" Font-Names="Tahoma,Verdana">Lab Dip Tracking</asp:label></td>
				</tr>
			</table>
				...
				<TR vAlign="top">
					<TD>
						...
						<asp:datagrid id="DataGrid1" runat="server" 
                            DataKeyField="MaterialTradePartnerLabDipSubmitID" AllowSorting="True">
