<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Material_RequestSubmitScheduleAdd.aspx.vb" Inherits="plmOnApp.Material_RequestSubmitScheduleAdd" %>
	        ...
	        <tr>
		        ...
		        <td>
                    <table cellSpacing="0" cellPadding="0" width="100%" border="0">
	                    <tr>
		                    <td width="25" height="50">&nbsp;<img src="../System/icons/icon_add.gif" /></td>
		                    <td><span class="fontHead">&nbsp;<asp:Label ID="lblSelectWF" runat="server" Text="Please select workflow items to be added..."></asp:Label></span></td>
	                    </tr>
                    </table>
		        </td>
	        </tr>
                 ...
                 <asp:datagrid id="dgMaterial" runat="server"
                                ...
                                <Columns>
					                <asp:TemplateColumn>
					                    <ItemTemplate>
					                        <asp:CheckBox  runat="server" id="chkColorSelect" AutoPostBack="true"/>
					                    </ItemTemplate>
					                </asp:TemplateColumn>
					            </Columns> 
                            </asp:datagrid>			
                <asp:datagrid id="dgMaterialWorkflow" runat="server" BorderStyle="NotSet" 
                 AutoGenerateColumns="false" DataKeyField="MaterialRequestWorkflowID"  
                 BorderWidth="1" BorderColor="#CCCCCC" CellPadding="1" BackColor="White" CellSpacing="0">
                    <AlternatingItemStyle Height="20px" CssClass="font"></AlternatingItemStyle>
                    <ItemStyle Height="20px" CssClass="font"></ItemStyle>
                    <HeaderStyle Height="20px" Width="100%" CssClass="TableHeader" HorizontalAlign="Center"></HeaderStyle>
					<Columns>
					    <asp:TemplateColumn>
					        <ItemTemplate>
        ...
        <asp:label id="SortOrder" runat="server" Visible="False"></asp:label>
            ...
            <script>
                function ResetCheckboxes() {
                    var datalist = document.getElementById('<%=dgMaterial.ClientID%>').childNodes[0];
                    ...
                    var datalist = document.getElementById('<%=dgMaterialWorkflow.ClientID%>').childNodes[0];
                    var tb = datalist.getElementsByTagName("input");
                    for (var i = 0; i < tb.length; i++) {
                        if (tb[i].type == "checkbox") {
                            tb[i].checked = false;
