...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Material_Link_Add_List.aspx.vb" Inherits="plmOnApp.Material_Link_Add_List" %>
			...
			<table cellSpacing="0" cellPadding="0" width="100%" bgColor="#ffffff" border="0">
				<tr>
					<td>&nbsp;<asp:label id="lblMaterialHeader" runat="server" Font-Names="Tahoma,Verdana" Font-Size="X-Large"
							ForeColor="#E0E0E0">Material</asp:label></td>
				</tr>
			</table>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR vAlign="top">
					<TD>
						...
						<asp:datagrid id="DataGrid1" runat="server" BorderWidth="1px" BorderStyle="Solid" DataKeyField="MaterialID" AllowSorting="True">
