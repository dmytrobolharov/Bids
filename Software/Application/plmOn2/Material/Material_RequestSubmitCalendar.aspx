<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Material_RequestSubmitCalendar.aspx.vb" Inherits="plmOnApp.Material_RequestSubmitCalendar" %>
		...
		<form id="Form1" method="post" runat="server">
          <wc1:Color_Wait ID="Color_Wait" runat="server" />
			<TABLE cellSpacing="0" cellPadding="0" width="100%" bgColor="#ffffff" border="0">
				<TBODY>
					<TR>
						<TD height="50">&nbsp;<asp:label id="lblHeader" runat="server" ForeColor="#E0E0E0" Font-Size="X-Large" Font-Names="Tahoma,Verdana">Material Folder...</asp:label>
						</TD>
					</TR>
				</TBODY>
			</TABLE>
