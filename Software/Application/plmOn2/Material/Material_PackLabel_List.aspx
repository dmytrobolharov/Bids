<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Material_PackLabel_List.aspx.vb" Inherits="plmOnApp.Material_PackLabel_List" %>
    ...
    <form id="form1" runat="server">
			<TABLE class="TableHeader" id="toolbar" cellSpacing="0" cellPadding="0" width="100%" border="0"
				...
				<TR vAlign="middle">
					...
					<asp:ImageButton id="btnSort"  runat="server" Visible="false"></asp:ImageButton></td>
				</TR>
			</TABLE>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR vAlign="top">
					<TD>
						...
						<asp:datagrid id="DataGrid1" runat="server" DataKeyField="MaterialPackLabelGroupID" AllowSorting="True">
