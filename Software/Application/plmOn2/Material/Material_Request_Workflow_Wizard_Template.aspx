...
<body>
 <div id="fixed_icons"><a href="../Help/Help_Folder.aspx?Folder=<%= Folder %>&HID=<%= HelpID %>" title="Help" target="_blank" id="yHelp"></a></div>
    <form id="form1" runat="server">
			...
			<br />
	       <table id="toolbar" style="BORDER-TOP: gray thin solid; BORDER-LEFT-STYLE: none; BACKGROUND-COLOR: gainsboro"
	            height="35" cellSpacing="0" cellPadding="0" width="100%" bgColor="gainsboro" border="0">
	            <TR>
		            <TD align="center" width="50">&nbsp;</TD>
		            <TD align="center" width="500">
			            <asp:imagebutton id="btnBack" runat="server" CausesValidation="false" Disabled="true"></asp:imagebutton>
			            <asp:imagebutton id="btnSave" runat="server" Disabled="true"></asp:imagebutton>
                        <asp:imagebutton id="btnGenerate" runat="server" Disabled="true"></asp:imagebutton>
                        <asp:imagebutton id="btnShare" runat="server" Disabled="true"></asp:imagebutton>
			            <asp:imagebutton id="btnNext" runat="server" 
                             Visible="False" Disabled="true"></asp:imagebutton>
		            </TD>
		            <TD align="center">&nbsp;</TD>
	            </TR>
            </table>
