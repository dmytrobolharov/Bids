			...
			<TABLE width="100%">
				<TR>
					<TD width="20" height="20">
						<asp:linkbutton id="btnEditImageComment" runat="Server" Text='<IMG border="0" alt="edit" src="../System/Icons/icon_edit.gif">'
				...
				<TR>
					...
					<TD width="100"><BR>
						...
						<cc1:ConfirmedLinkButton id="Linkbutton4" runat="Server" Text='<IMG border="0" alt="Delete" src="../System/Icons/icon_delete.gif">'
							CommandName="delete" Message='<%#GetSystemText("Are you sure you want to Delete this comment?")%>' Visible='TRUE'></cc1:ConfirmedLinkButton>
	...
	<asp:Panel  Runat ="server" ID="pnlAddNewComment" >
		<TABLE>
			<TR>
				...
				<asp:linkbutton id="btnNew" runat="Server" CssClass="fonthead" CommandName="new" >
