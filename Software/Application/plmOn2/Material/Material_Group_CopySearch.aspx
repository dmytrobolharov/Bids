<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Material_Group_CopySearch.aspx.vb" Inherits="plmOnApp.Material_Group_CopySearch" %>
...
<head runat="server">
    <title>Material Group Copy</title>
...
<div id="fixed_icons"><a href="../Help/Help_Folder.aspx?Folder=<%= Folder %>&HID=<%= HelpID %>" title="Help" target="_blank" id="yHelp"></a></div>
    <form id="form1" runat="server">
        ...
        <table cellSpacing="0" cellPadding="0" width="100%" border="0" class="TableHeaderTop">
			<tr height="30">
				<td align="center" width="10" height="30"><IMG height="15" src="../System/Images/bbTbSCnr.gif" width="3"></td>
				<td>&nbsp;<asp:Label ID="lblHeaderBar" runat="server" CssClass="fontHead"></asp:Label></td>
			</tr>
		</table>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR vAlign="top">
					<TD>
						...
						<asp:datagrid id="DataGrid1" runat="server" AllowSorting="True" DataKeyField="MaterialCoreID">
