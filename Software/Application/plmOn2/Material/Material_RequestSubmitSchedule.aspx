<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Material_RequestSubmitSchedule.aspx.vb" Inherits="plmOnApp.Material_RequestSubmitSchedule" %>
    ...
    <div id="fixed_icons"><a href="../Help/Help_Folder.aspx?Folder=<%= Folder %>&HID=<%= HelpID %>" title="Help" target="_blank" id="yHelp"></a></div>
		<form id="Form1" method="post" runat="server">
			...
			<table cellSpacing="1" cellPadding="0" width="100%" border="0">
                <tr>
                    <td class="fontHead"><asp:placeholder id="plhControlsHolder" runat="server" 
