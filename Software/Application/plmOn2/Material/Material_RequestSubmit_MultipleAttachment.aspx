<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Material_RequestSubmit_MultipleAttachment.aspx.vb" Inherits="plmOnApp.Material_RequestSubmit_MultipleAttachment" %>
    ...
    <table class="TableHeader" id="toolbar" cellspacing="0" cellpadding="0" width="100%"
        ...
        <tr valign="middle">
            ...
            <td>
                ...
                <cc1:ConfirmedImageButton ID="btnClose" runat="server" Message="NONE" OnClientClick="return btnClose_Click()" Visible="True" CausesValidation="False"></cc1:ConfirmedImageButton>                
            </td>
        </tr>
    </table>
