<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="Material_RequestSubmitAttachment.ascx.vb" Inherits="plmOnApp.Material_RequestSubmitAttachment" %>
...
<%@ Register TagPrefix="ycl" Namespace="Yunique.Core.Library" Assembly="Yunique.Core" %>
                <table height="25" cellSpacing="0" cellPadding="0" border="0" width="100%">
	                <tr class="TableHeader">
		                ...
		                <td align="right" ><%--<cc1:bwhyperlink  ID="btnAddAttach" runat="server" ForeColor="#0066CC" Font-Underline="True" Text='<IMG border="0" alt="Add" src="../System/Button/ButtonStream.ashx?BN=btn_add.gif">'></cc1:bwhyperlink>--%>
		                <cc1:BWHyperLink id="btnMultiUploadAttach" runat="server" ></cc1:BWHyperLink>
			                            ...
			                            <td Class="font">
                                            ...
                                            <table style="background-position: #fff bottom; border-bottom: #d8d9da 0px solid; border-left: #d8d9da 1px solid; background: #fff; width: 400px; border-top: #d8d9da 0px solid; border-right: #d8d9da 1px solid; TEXT-INDENT: 5px; ">
			                                            ...
			                                            <tr>
			                                                ...
			                                                <td width="18"><asp:ImageButton runat="server" ID="btnDownload" ImageUrl="../System/Icons/icon_file.gif" CommandName="download" OnClientClick="dont_show_wait_next_time();" /></td>
