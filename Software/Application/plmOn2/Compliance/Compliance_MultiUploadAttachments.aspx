<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Compliance_MultiUploadAttachments.aspx.vb" Inherits="plmOnApp.Compliance_MultiUploadAttachments" %>
    ...
    <table class="TableHeader" id="toolbar" cellspacing="0" cellpadding="0" width="100%"
        ...
        <tr valign="middle">
            ...
            <asp:ImageButton runat="server" ID="btnSave" OnClick="btnSave_Click" OnClientClick="return btnSave_Click()" Visible="False"  />
                ...
                <img runat="server" id="imgAttachfile" style="display: none;" onclick="Upload_Click();return false;" /> 
