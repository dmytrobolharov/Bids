<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Quote_Main.aspx.vb" Inherits="plmOnApp.Quote_Main"%>
			...
			<table width="100%" height="90%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td valign="top" bgcolor="#ffffff"><table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td><asp:Label id="lblHeader" runat="server" ForeColor="#E0E0E0" Font-Size="X-Large" Font-Names="Tahoma,Verdana">Quote Folder...</asp:Label>
								</td>
							</tr>
						</table>
