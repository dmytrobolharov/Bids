<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SampleRequest_Workflow_Submit_Spec_Library.aspx.vb" Inherits="plmOnApp.SampleRequest_Workflow_Submit_Spec_Library"   %>
					...
					<TD>
						<TABLE class="TableHeader" height="25" cellSpacing="0" cellPadding="0" width="100%" bgColor="#ffffff"
							...
							<TR vAlign="middle">
								...
								<TD class="fontHead" align="right" width="110"><asp:Label ID="lblPOMPerPage" runat="server" ></asp:Label></TD>
