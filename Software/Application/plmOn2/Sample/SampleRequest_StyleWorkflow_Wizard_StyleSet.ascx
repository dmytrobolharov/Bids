<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SampleRequest_StyleWorkflow_Wizard_StyleSet.ascx.vb" Inherits="plmOnApp.SampleRequest_StyleWorkflow_Wizard_StyleSet" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
	...
	<tr>
		<td>
			<TABLE cellSpacing="0" cellPadding="0" width="100%" align="center" bgColor="#ffffff" border="0">
				<TR>
					<TD width="50">&nbsp;</TD>
					<TD align="center" width="200"><FONT face="Microsoft Sans Serif" color="#000000" size="2"><B class="fonthead"><asp:Label ID="lblStyleAvailableH" runat="server"></asp:Label>
								</B></FONT></TD>
					<TD width="50"></TD>
					<TD align="center" width="200"><FONT face="Microsoft Sans Serif" color="#000000" size="2"><B class="fonthead"> <asp:Label ID="lblStyleSelectedH" runat="server"></asp:Label>
								 </B></FONT>
					</TD>
					<TD>&nbsp;</TD>
					<TD>&nbsp;</TD>
