...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SampleRequest_Calendar.aspx.vb" Inherits="plmOnApp.SampleRequest_Calendar" %>
    ...
    <div id="fixed_icons"><a href="../Help/Help_Folder.aspx?Folder=<%= Folder %>&HID=<%= HelpID %>" title="Help" target="_blank" id="yHelp"></a></div>
        ...
        <telerik:RadAjaxManager runat="server" ID="RadAjaxManager1" />
			<TABLE cellSpacing="0" cellPadding="0" width="100%" bgColor="#ffffff" border="0">
				<TBODY>
					<TR>
						<TD height="50">&nbsp;<asp:label id="lblHeader" runat="server" ForeColor="DarkGray" Font-Size="Large" Font-Names="Tahoma,Verdana" ></asp:label>
						</TD>
					</TR>
				</TBODY>
			</TABLE>
			...
			<TABLE class="TableHeader" height="25" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR vAlign="middle">
					...
					<TD class="FontHead"><cc1:confirmedimagebutton id="btnCalMonth" runat="server" Message="NONE"
							CausesValidation="False"></cc1:confirmedimagebutton><cc1:confirmedimagebutton id="btnCalWeek" runat="server" Message="NONE"
							CausesValidation="False"></cc1:confirmedimagebutton><cc1:confirmedimagebutton id="btnCalDay" runat="server" Message="NONE"
			...
			<%--<table id="tbSearch" cellSpacing="0" cellPadding="0" width="100%" bgColor="#ffffff" border="0"
				...
				<tr>
					...
					<TD width="125" height="25"><asp:dropdownlist id="ddlVendor" runat="server" Width="150px" AutoPostBack="True"></asp:dropdownlist></TD>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					<TD vAlign="top"><asp:panel id="pnlWeek" runat="server">
							<cc2:ysxdayscalendar id="YSXDaysCalendar1" runat="server" Width="100%" PreviousWeek='<img src="../System/Icons/arrow_left.gif"  border="0" />'
	                    ...
	                    <asp:panel id="pnlMonth" runat="server">
							<cc2:ysmonthlycalendar id="Calendar1" 
                            runat="server" 
                            CssClass="font" 
                            BorderWidth="1px" 
                            BorderStyle="Solid"
                            ...
                            <%# GetCalendarLink(Container.DataItem("PKeyId").ToString, Container.DataItem("CalendarLinkId").ToString, Container.DataItem("CalendarLinkSubId").ToString, Container.DataItem("CalendarDate").ToString, Container.DataItem("CalendarType").ToString, Container.DataItem("CalendarStatus").ToString, Container.DataItem("CalendarDescription").ToString, Container.DataItem("CalendarLinkSubId1").ToString, Container.DataItem("CalendarSN").ToString)%>									
							 ...
							 cellspacing="0" 
							 border="0" 
                            style="font-size:Medium;width:100%; border-collapse:collapse; height: 24px;">
                            <tr>
                            <td style="BORDER-TOP: #ffffc0 1px solid; HEIGHT: 36px; BACKGROUND-COLOR: #ffffc0" align="left" class="CalendarTitleHeader"><asp:HyperLink ID="hypPrevious" runat="server"></asp:HyperLink></td>
                            <td style="BORDER-TOP: #ffffc0 1px solid; HEIGHT: 36px; BACKGROUND-COLOR: #ffffc0" align="center" class="CalendarTitleHeader"><asp:Label ID="lblCurrent" runat="server"></asp:Label></td>
                            <td style="BORDER-TOP: #ffffc0 1px solid; HEIGHT: 36px; BACKGROUND-COLOR: #ffffc0" align="right" class="CalendarTitleHeader"><asp:HyperLink ID="hypNext" runat="server"></asp:HyperLink></td>
                            </tr>
                            </table>
                            <asp:panel id="Panel1" runat="server" Height="462px">
                                <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
                                Font-Size="8pt" Height="117%" ProcessingMode="Remote" Width="100%" 
