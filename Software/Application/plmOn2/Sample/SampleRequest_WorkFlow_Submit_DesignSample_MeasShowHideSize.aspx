...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SampleRequest_WorkFlow_Submit_DesignSample_MeasShowHideSize.aspx.vb" Inherits="plmOnApp.SampleRequest_WorkFlow_Submit_DesignSample_MeasShowHideSize" %>
		...
		<form id="Form1" method="post" runat="server">
			<table class="TableHeader" id="toolbar" cellSpacing="0" cellpadding="0" width="100%" border="0">
				<tr valign="middle">
					...
					<td><cc1:confirmedimagebutton id="btnSave" runat="server" Message="NONE" ></cc1:confirmedimagebutton><cc1:confirmedimagebutton id="btnSynchronize" runat="server" Message="NONE" ></cc1:confirmedimagebutton>
                    <cc1:confirmedimagebutton id="btnClose" runat="server" Message="NONE" OnClientClick="return btnClose_ClickbtnClose_Click()" ></cc1:confirmedimagebutton></td>
					<td></td>
				</tr>
			</table>
