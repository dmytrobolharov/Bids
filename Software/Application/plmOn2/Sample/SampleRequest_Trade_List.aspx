<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SampleRequest_Trade_List.aspx.vb" Inherits="plmOnApp.SampleRequest_Trade_List" %>
...
<HTML>
    ...
    <div id="fixed_icons"><a href="../Help/Help_Folder.aspx?Folder=<%= Folder %>&HID=<%= HelpID %>" title="Help" target="_blank" id="yHelp"></a></div>
		<form id="Form1" method="post" runat="server">
			<table style="BORDER-BOTTOM: royalblue thin solid; BORDER-LEFT-STYLE: none; BACKGROUND-COLOR: white"
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR vAlign="top">
					<TD>
						...
						<asp:datagrid id="DataGrid1" runat="server" AllowSorting="True" DataKeyField="TradePartnerID">
