...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SampleRequest_Workflow_Submit_Spec_Size.aspx.vb" Inherits="plmOnApp.SampleRequest_Workflow_Submit_Spec_Size" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<asp:datagrid id="DataGrid1" runat="server" BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px"
				...
				<Columns>
					<asp:TemplateColumn >
					<HeaderTemplate >
                        <asp:Label ID="lblHeaderSelect" runat="server" ><%#GetSystemText(" Select ")%></asp:Label></HeaderTemplate>
					...
					<asp:TemplateColumn >
					<HeaderTemplate >
                        <asp:Label ID="lblSelectSampleSize" runat="server" ><%#GetSystemText("Select Sample Size...") %></asp:Label></HeaderTemplate>
						<ItemTemplate>
