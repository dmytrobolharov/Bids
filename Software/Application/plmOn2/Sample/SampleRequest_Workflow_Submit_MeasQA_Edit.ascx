...
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SampleRequest_Workflow_Submit_MeasQA_Edit.ascx.vb" Inherits="plmOnApp.SampleRequest_Workflow_Submit_MeasQA_Edit" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
		...
		<TD vAlign="top" width="1%" bgColor="#ffffff">
			...
			<TABLE height="25" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR class="TableHeader">
					...
					<TD class="fontHead" width="1"><cc1:BWImageButton id="btnSampleChange" runat="server" /></TD>
					<TD class="fontHead">&nbsp;
