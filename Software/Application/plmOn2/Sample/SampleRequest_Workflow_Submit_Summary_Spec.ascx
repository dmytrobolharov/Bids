<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SampleRequest_Workflow_Submit_Summary_Spec.ascx.vb" Inherits="plmOnApp.SampleRequest_Workflow_Submit_Summary_Spec" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
