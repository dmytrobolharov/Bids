...
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SampleRequest_Workflow_Wizard_StyleSubmit.ascx.vb" Inherits="plmOnApp.SampleRequest_Workflow_Wizard_StyleSubmit" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
		...
		<td>
			<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" align="center" bgColor="#ffffff"
				...
				<TR>
					...
					<TD class="fontHead" style="HEIGHT: 19px" align="center" width="150"><asp:Label ID="lblStyleSetH" runat="server"></asp:Label></TD>
					<TD style="HEIGHT: 19px" align="center" width="20">&nbsp;</TD>
					<TD class="fontHead" style="HEIGHT: 19px" align="center" width="150"><asp:Label ID="lblProcessH" runat="server"></asp:Label></TD>
					<TD style="HEIGHT: 19px" align="center" width="20">&nbsp;</TD>
					<TD style="HEIGHT: 19px" align="center" width="200"><FONT face="Microsoft Sans Serif" color="#000000" size="2"><B class="fontHead"><asp:Label ID="lblSubmitAvailableH" runat="server"></asp:Label></B></FONT></TD>
					<TD style="HEIGHT: 19px" width="50"></TD>
					<TD style="HEIGHT: 19px" align="center" width="200"><FONT face="Microsoft Sans Serif" color="#000000" size="2"><B class="fontHead"><asp:Label ID="lblSubmitSelectedH" runat="server"></asp:Label>
							</B></FONT>
					</TD>
				...
				<TR>
					<TD>&nbsp;</TD>
					<TD align="center" width="150"><asp:listbox id="lstStyleSet" Height="250px" Width="150px" CssClass="fontHead" Runat="server"
