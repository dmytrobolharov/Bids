<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="SampleRequest_SeasonYearColor.ascx.vb" Inherits="plmOnApp.SampleRequest_SeasonYearColor" %>
        <table class="TableHeader" cellspacing="0" cellpadding="0" width="100%" height="30"
            ...
            <tr valign="middle">
                ...
                <td with="25">&nbsp;</td>
                <td width="20"><img src="../System/Icons/icon_colorway.gif" /></td>
                <td nowrap="nowrap">
