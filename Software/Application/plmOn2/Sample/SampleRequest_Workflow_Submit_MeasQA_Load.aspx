...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SampleRequest_Workflow_Submit_MeasQA_Load.aspx.vb" Inherits="plmOnApp.SampleRequest_Workflow_Submit_MeasQA_Load" %>
			...
			<asp:datagrid id="DataGrid1" runat="server" BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px"
				...
				<Columns>
					...
					<HeaderTemplate>                         
						...
						<ItemTemplate>
							<img id="Img1" alt="Linked" src="../System/Icons/icon_link.gif" runat="server" visible='<%# Eval("IsLinked") %>' />
						</ItemTemplate>
					</asp:TemplateColumn>
					<asp:TemplateColumn >
					<HeaderTemplate >                         
