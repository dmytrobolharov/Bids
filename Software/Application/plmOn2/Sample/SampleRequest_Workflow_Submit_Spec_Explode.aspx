...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SampleRequest_Workflow_Submit_Spec_Explode.aspx.vb" Inherits="plmOnApp.SampleRequest_Workflow_Submit_Spec_Explode" %>
			...
			<asp:datagrid id="dgGradeRules" runat="server" BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px"
				...
				<Columns>
					...
					<asp:TemplateColumn>
						...
						<HeaderTemplate>
							<DIV align="center">
                                <asp:Label ID="lblRev" runat="server"><%#GetSystemText("Rev")%></asp:Label></DIV>
						</HeaderTemplate>
						<ItemTemplate>
							<DIV align="center">
					...
					<asp:TemplateColumn>
						...
						<HeaderTemplate>
							<DIV align="center">
                                <asp:Label ID="lblFinal" runat="server"><%#GetSystemText("Final")%></asp:Label></DIV>
						</HeaderTemplate>
						<ItemTemplate>
							<DIV align="center">
								<asp:TextBox id="txtFinal" runat="Server" BorderWidth="1px" BorderStyle="Solid" BorderColor="#E0E0E0"
									columns="5" maxlength="10"></asp:TextBox></DIV>
						</ItemTemplate>
					</asp:TemplateColumn>
					<asp:TemplateColumn>
