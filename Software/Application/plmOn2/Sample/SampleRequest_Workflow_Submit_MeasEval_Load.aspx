...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SampleRequest_Workflow_Submit_MeasEval_Load.aspx.vb" Inherits="plmOnApp.SampleRequest_Workflow_Submit_MeasEval_Load" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<asp:datagrid id="DataGrid1" runat="server" BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px"
				...
				<Columns>
					...
					<asp:TemplateColumn ItemStyle-Width="18px">
					<HeaderTemplate>                         
                        <asp:Label ID="lblHeader2" runat="server"><img alt="Linked" src="../System/Icons/icon_link.gif" /></asp:Label>
					</HeaderTemplate>
						<ItemTemplate>
							<img alt="Linked" src="../System/Icons/icon_link.gif" runat="server" visible='<%# Eval("IsLinked") %>' />
						</ItemTemplate>
					</asp:TemplateColumn>
					<asp:TemplateColumn >
					<HeaderTemplate >                         
                        <asp:Label ID="lblHeader3" runat="server"><%#GetSystemText("Select Spec From")%>...</asp:Label>
					</HeaderTemplate>
						<ItemTemplate>
