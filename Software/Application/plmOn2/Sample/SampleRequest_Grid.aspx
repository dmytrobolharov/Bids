<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SampleRequest_Grid.aspx.vb" Inherits="plmOnApp.SampleRequest_Grid" %>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE class="TableHeader" id="toolbar" cellSpacing="0" cellPadding="0" width="100%" border="0"
				...
				<TR vAlign="middle">
					...
					<TD width="80"><cc1:confirmedimagebutton id="btnEditColorList" runat="server" Message="NONE"></cc1:confirmedimagebutton></TD>
					<td width="80"></td>
					<td width="75">&nbsp;</td>
					<td>&nbsp;</td>
				</TR>
					...
					<TD>
						<TABLE class="TableHeader" width="100%" height="25" border="0" cellPadding="0" cellSpacing="0"
							...
							<TR vAlign="middle">
								...
								<TD width="110" align="right" class="fontHead"><asp:Label ID="lblRecordsPerPage" runat="server" ></asp:Label>
</TD>
