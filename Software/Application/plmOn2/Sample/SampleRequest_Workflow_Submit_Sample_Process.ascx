<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SampleRequest_Workflow_Submit_Sample_Process.ascx.vb" Inherits="plmOnApp.SampleRequest_Workflow_Submit_Sample_Process" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
			...
			<TABLE width="100%" align="center" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0"
				...
				<TR>
					...
					<TD align="center" width="200" style="HEIGHT: 15px"><FONT face="Microsoft Sans Serif" color="#000000" size="2"><B class="fonthead">
                        <asp:Label ID="lblPAvailable" runat="server"></asp:Label></B></FONT></TD>
					<TD width="50" style="HEIGHT: 15px"></TD>
					<TD align="center" width="200" style="HEIGHT: 15px"><FONT face="Microsoft Sans Serif" color="#000000" size="2"><B class="fonthead">
                        <asp:Label ID="lblPSelected" runat="server"></asp:Label> </B></FONT>
					</TD>
