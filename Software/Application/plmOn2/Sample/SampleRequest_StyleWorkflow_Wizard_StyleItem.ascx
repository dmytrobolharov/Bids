<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SampleRequest_StyleWorkflow_Wizard_StyleItem.ascx.vb" Inherits="plmOnApp.SampleRequest_StyleWorkflow_Wizard_StyleItem" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
		...
		<td>
			<TABLE width="100%" align="center" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0">
				<TR>
					...
					<TD align="center" width="150" class="fonthead"><asp:Label ID="lblWorkflowH" runat="server"></asp:Label></TD>
					<TD align="center" width="20">&nbsp;</TD>
				...
				<TR>
					...
					<TD align="center" width="20">&nbsp;</TD>
					<TD align="center" width="150">
						<asp:listbox id="lstWorkflow" AutoPostBack="True" Runat="server" CssClass="fonthead" Width="150px"
							Height="250px"></asp:listbox></TD>
					<TD align="center" width="20">&nbsp;</TD>
