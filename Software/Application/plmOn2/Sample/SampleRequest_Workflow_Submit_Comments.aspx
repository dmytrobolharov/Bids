<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SampleRequest_Workflow_Submit_Comments.aspx.vb" Inherits="plmOnApp.SampleRequest_Workflow_Submit_Comments"   %>
...
<HTML>
    ...
    <div id="fixed_icons"><a href="../Help/Help_Folder.aspx?Folder=<%= Folder %>&HID=<%= HelpID %>" title="Help" target="_blank" id="yHelp"></a></div>
		<form id="Form1" method="post" runat="server" >
			<table class="TableHeader" id="toolbar" cellSpacing="0" cellPadding="0" width="100%" border="0"
				...
				<tr vAlign="middle">
					...
					<td><cc1:confirmedimagebutton id="btnSave" runat="server" ImageUrl="../System/Button/ButtonStream.ashx?BN=btn_save.gif" Message="NONE"></cc1:confirmedimagebutton><cc1:confirmedimagebutton id="btnClose" runat="server" ImageUrl="../System/Button/ButtonStream.ashx?BN=btn_close.gif" Message="NONE"></cc1:confirmedimagebutton></td>
					<td width="40"></td>
					<td></td>
				</tr>
			</table>
					...
					<TD>
						<TABLE class="TableHeader" height="25" cellSpacing="0" cellPadding="0" width="100%" bgColor="#ffffff"
							...
							<TR vAlign="middle">
								...
								<TD class="fontHead" align="right" width="110"><asp:Label ID="lblRecPerPage" runat="server" ></asp:Label></TD>
		...
		{
			e=frm.elements[i];
			if (e.type == 'checkbox' && e.name.indexOf("chbPOMLibraryID") != -1)
			e.checked= actVar ;
		}
		}
