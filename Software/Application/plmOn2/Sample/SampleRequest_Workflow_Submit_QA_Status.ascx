...
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SampleRequest_Workflow_Submit_QA_Status.ascx.vb" Inherits="plmOnApp.SampleRequest_Workflow_Submit_QA_Status" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
		...
		<TR>
            ...
            src="../System/Icons/icon_calendar.gif"></img></a>
					...
					<TR height="25">
						<TD width="10">&nbsp;</TD>
						<TD>
							<asp:TextBox id="txt_VendorBy" ondblclick="doubleclickVendor()" runat="server" Width="125px" CssClass="font"></asp:TextBox></TD>
						<TD>&nbsp;
