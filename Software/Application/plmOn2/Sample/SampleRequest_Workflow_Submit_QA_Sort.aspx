...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SampleRequest_Workflow_Submit_QA_Sort.aspx.vb" Inherits="plmOnApp.SampleRequest_Workflow_Submit_QA_Sort" %>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<table cellpadding="0" cellspacing="0" border="0">
				<tr valign="middle">
					<td width="150"><asp:label id="lblSortBy" Runat="server" CssClass="font" 
                            Font-Bold="True"></asp:label>&nbsp;<asp:dropdownlist id="ddlSortBy" Runat="server"></asp:dropdownlist></td>
