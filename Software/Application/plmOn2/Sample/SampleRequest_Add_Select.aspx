...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SampleRequest_Add_Select.aspx.vb" Inherits="plmOnApp.SampleRequest_Add_Select" %>
					...
					<TD>
						<TABLE class="TableHeader" width="100%" height="25" border="0" cellPadding="0" cellSpacing="0"
							...
							<TR vAlign="middle">
								...
								<TD width="100" class="fontHead">Thumbnail?</TD>
