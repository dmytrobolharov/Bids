...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SampleRequest_Workflow_Submit_Spec_Critical.aspx.vb" Inherits="plmOnApp.SampleRequest_Workflow_Submit_Spec_Critical" %>
					...
					<td vAlign="top" width="600"><asp:datagrid id="DataGrid1" runat="server" BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px"
							...
							<Columns>
								...
								<asp:TemplateColumn>
									<HeaderTemplate>
										<div align="center">
											<asp:Label id="lblHeaderPOM"  runat="server" /><%#GetSystemText("POM")%></div>
									</HeaderTemplate>
									<ItemTemplate>
										<DIV align="center">
								...
								<asp:TemplateColumn>
									<HeaderTemplate>
										<div align="left">
											<asp:Label id="lblHeaderPointMeasur" runat="server" /><%#GetSystemText("Point of Measurement")%></div>
									</HeaderTemplate>
									<ItemTemplate>
