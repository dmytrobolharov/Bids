<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SampleRequest_Workflow_Submit_DesignSample_MeasPOMTemplate_Library.aspx.vb" Inherits="plmOnApp.SampleRequest_Workflow_Submit_DesignSample_MeasPOMTemplate_Library" %>
		...
		<form id="Form1" method="post" runat="server">
           ...
           <table cellspacing="0" cellpadding="0" width="100%" border="0">
            ...
            <asp:datagrid id="DataGrid1" runat="server" DataKeyField="POMAlternatesID" 
				    ...
				    <ItemStyle Height="20px" CssClass="font ItemTemplate"></ItemStyle>
