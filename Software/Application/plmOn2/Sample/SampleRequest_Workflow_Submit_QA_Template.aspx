...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SampleRequest_Workflow_Submit_QA_Template.aspx.vb" Inherits="plmOnApp.SampleRequest_Workflow_Submit_QA_Template"   %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<table id="Table1" style="BORDER-BOTTOM: orange thin solid; BORDER-LEFT-STYLE: none; BACKGROUND-COLOR: white"
				...
				<tr>
					...
					<td class="fonthead"><asp:label id="lblHeader" runat="server" 
                            Font-Names="Tahoma,Verdana" Font-Size="Large" ForeColor="#999999" 
