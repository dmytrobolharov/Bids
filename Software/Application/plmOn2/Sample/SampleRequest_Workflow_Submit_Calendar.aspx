<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SampleRequest_Workflow_Submit_Calendar.aspx.vb" Inherits="plmOnApp.SampleRequest_Workflow_Submit_Calendar" %>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					<TD vAlign="top"><asp:panel id="pnlWeek" runat="server">
							<cc2:ysxdayscalendar id="YSXDaysCalendar1" runat="server" Width="100%" TableBodyCssClass="CalendarBody"
								TableHeaderCssClass="CalendarHeader" TableWeekendBodyCssClass="CalendarBodyWeekend" TableWeekendHeaderCssClass="CalendarHeaderWeekend"
								HeaderDateFormat=" ddd, MMM dd" TableTodayBodyCssClass="CalendarBodyToday" TableTodayHeaderCssClass="CalendarHeaderToday"
								Days="7" TableTitleHeaderCssClass="CalendarTitleHeader" NextWeek='<img src="../System/Icons/arrow_right.gif"  border="0" />'
								PreviousWeek='<img src="../System/Icons/arrow_left.gif"  border="0" />'
								NextFormat="MMM dd" PreviousFormat="MMM dd" >
								<ItemTemplate>
									<%# GetCalendarLink(Container.DataItem("PKeyId").ToString, Container.DataItem("CalendarLinkId").ToString, Container.DataItem("CalendarLinkSubId").ToString, Container.DataItem("CalendarDate").ToString, Container.DataItem("CalendarType").ToString, Container.DataItem("CalendarStatus").ToString, Container.DataItem("CalendarDescription").ToString,Request.QueryString("FDIM").ToString) %>
								</ItemTemplate>
							</cc2:ysxdayscalendar>
						</asp:panel><asp:panel id="pnlMonth" runat="server">
