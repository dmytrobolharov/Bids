...
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SampleRequest_Workflow_Submit_DesignSample_Edit.ascx.vb" Inherits="plmOnApp.SampleRequest_Workflow_Submit_DesignSample_Edit" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
							...
							<Columns>
								...
								<table style="display:none" cellspacing="0" cellpadding="0" width="100%" border="0">
									<tr class="fontHead">
										<td>&nbsp;</td>
										<td nowrap width="85">
                                            <asp:label runat="server" visible="false" ID="lblRows" CssClass="fontHead"><asp:Label ID="lblNumOfRows" runat="server"></asp:Label></asp:label>
                                        </td>
                                        <td>											
											<cc1:bwimagebutton id="btnPomLibraryTop" runat="server" Visible="true" WindowName="POMLibrary"></cc1:bwimagebutton>											
											<cc1:bwimagebutton id="btnPOMDelete" runat="server" Visible="true" WindowName="POMLibrary"  ></cc1:bwimagebutton> 
                                        </td>
									</tr>
								</table>
							</asp:panel>
...
<script language="javascript" type="text/javascript">
    ...
    if ($("*[name*='drlStatus']").val() == "3") {
        $("input:not([name*='drlStatus'])").attr("readonly", true);
    }
</script>
