...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SampleRequest_Workflow_Submit_GoTo.aspx.vb" Inherits="plmOnApp.SampleRequest_Workflow_Submit_GoTo" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<asp:datagrid id="DataGrid1" runat="server" BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px"
				...
				<Columns>
					...
					<asp:TemplateColumn>
                        <HeaderTemplate>
                            <asp:Label ID="lblSelectStylePage" runat="server"><%#GetSystemText("Select Style Page")%>...</asp:Label>
                        </HeaderTemplate>
						<ItemTemplate>
