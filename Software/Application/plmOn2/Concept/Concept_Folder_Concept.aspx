...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Concept_Folder_Concept.aspx.vb" Inherits="plmOnApp.Concept_Folder_Concept" %>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<table style="BORDER-BOTTOM: orange thin solid; BORDER-LEFT-STYLE: none; BACKGROUND-COLOR: white"
				...
				<tr>
					<td>&nbsp;<asp:label id="lblConceptHeader" runat="server" ForeColor="#E0E0E0" Font-Size="X-Large" Font-Names="Tahoma,Verdana">Concept Item...</asp:label></td>
				</tr>
			</table>
