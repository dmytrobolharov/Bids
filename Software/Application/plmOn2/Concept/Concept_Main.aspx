<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Concept_Main.aspx.vb" Inherits="plmOnApp.Concept_Main" %>
			...
			<table width="100%" height="90%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td valign="top" bgcolor="#ffffff"><table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td><div align="right">
										<asp:Label id="lbHeader" runat="server" ForeColor="#E0E0E0" Font-Size="X-Large" Font-Names="Tahoma,Verdana">Concept Folder</asp:Label></div>
								</td>
							</tr>
						</table>
